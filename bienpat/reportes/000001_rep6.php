...
else
	{
		...
		else
		{
			...
			if ($num>0)
			{
				...
				echo "<table border=1>";
				echo "<tr><td rowspan=4><IMG SRC='/MATRIX/images/medical/root/americas10.jpg' ></td>";
				echo "<td colspan=2><font size=5>PATOLOGIA LAS AMERICAS S.A.</font></td></tr>";
				echo "<tr><td colspan=2><font size=4 aling=center>NIT : 811.044.286-0</font><td></tr>";
