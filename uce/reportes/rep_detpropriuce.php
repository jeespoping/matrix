...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detpropriuce.php'; 
	}
...
//FECHA ULTIMA ACTUALIZACION  :13 de Mayo de 2010.                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detpropriuce.php' method='post'>";
 ...
 if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
 ...
 else // Cuando ya estan todos los datos escogidos
  {
   ...
   $query = " SELECT pphist,pping,ppfecha,ppperseva,ppcargoe,ppproc,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppcrite16,ppcrite17,ppcrite18,ppcrite19,ppcrite20,ppcrite21,ppcrite22,ppcrite23,ppcrite24,ppobserva,pppor"
           ."   FROM ".$empre1."_000001"
           ."  WHERE ppproc = '".$tpp."'" 
           ."    AND pppor < 100"
	...
	for ($i=1;$i<=$num1;$i++)
	 {
      ...
      echo "<table border=0 >";
      echo "<Tr >";
      echo "<td  bgcolor=#FFFFFF align=left width=100%><font size=1>&nbsp;$row2[30]</font></td>";
      echo "</tr >"; 
      echo "</table>";
      ...
      echo "<td  bgcolor=#FFFFFF align=left width=65%><font size=2 color=#FF0000>&nbsp;<b>".number_format($row2[31])."%</b></font></td>";
      echo "</tr >"; 
      echo "</table>";
