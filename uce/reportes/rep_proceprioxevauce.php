...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_proceprioxevauce.php'; 
	}
	
	function enter()

	{
		document.forms.rep_proceprioxevauce.submit();
	}
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_proceprioxevauce.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_proceprioxevauce' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    echo "<tr><td align=center colspan=4 bgcolor=#FFFFFF><font text color=#003366 size=2><b>U.C.E.</b></font></td></tr>";
