...
else
{
	...
	{
		echo "<form action='rep_hcortop.php?empresa=$empresa' method=post>";
		...
		echo"<tr><td bgcolor=#cccccc colspan=2>IMAGENES:</td><td align=center bgcolor=#cccccc ><input type='checkbox' name='wtip' value='s'></td></tr>";
	...
	{	
		...
		for ($y=0;$y<$nfechas;$y++)
		{
			...
			if($num>0)
			{
				...
				if ($wtip=='s')
				{
						if ((file_exists("/var/www/matrix/images/medical/hcortop/".$row['Img1']))==1)
							echo "<tr><td colspan=12 align='center'><img SRC='/matrix/images/medical/hcortop/".$row['Img1']."' width='300' height='200'></td></tr>";
						if ((file_exists("/var/www/matrix/images/medical/hcortop/".$row['Img2']))==1)
							echo "<tr><td colspan=12 align='center'><img SRC='/matrix/images/medical/hcortop/".$row['Img2']."' width='300' height='200'></td></tr>";
				}
				if ($wtip1=='s')
				{	
				...
				//		echo "<td  align=left colspan='4'  ><font size='3' face='arial'>";
						...
						if ($wtip=='s')
						{
								if ((file_exists("/var/www/matrix/images/medical/hcortop/".$seg['Img3']))==1)
									echo "<tr><td colspan=12 align='center'><img SRC='/matrix/images/medical/hcortop/".$seg['Img3']."' width='300' height='200'></td></tr>";
								if ((file_exists("/var/www/matrix/images/medical/hcortop/".$seg['Img4']))==1)
									echo "<tr><td colspan=12 align='center'><img SRC='/matrix/images/medical/hcortop/".$seg['Img4']."' width='300' height='200'></td></tr>";
						}
						if ($wtip1=='s')
						{	
