...
else
{
	...
	echo "<form name='Anexo1' action='anexo.php' method=post>";
	

	

	echo "<table border=1 align=center>";
	echo "<tr><td align=center bgcolor=#999999 colspan=6><font size=6 face='courier new'><b>PROMOTORA MEDICA LAS AMERICAS S.A.</font></b></font></td></tr>";
	echo "<tr><td align=center bgcolor=#cccccc colspan=6><font size=4 face='courier new'><b>ASAMBLEA ORDINARIA DE SOCIOS</b></font></font></td></tr>";
	echo "<tr><td align=center bgcolor=#cccccc colspan=6><font size=4 face='courier new'><b>Fecha : ".date("d-m-Y")."</b></font></font></td></tr>";
	echo "<tr><td align=center bgcolor=#dddddd><font face='courier new' size=2><b>CEDULA</b></font></td><td align=center bgcolor=#dddddd><font face='courier new' size=2><b>NOMBRE</b></font></td><td align=center bgcolor=#dddddd><font face='courier new' size=2><b>ACCIONES<br>PREF./94</b></font></td><td align=center bgcolor=#dddddd ><font face='courier new' size=2><b>ACCIONES<br>PREF./96</b></font></td><td align=center bgcolor=#dddddd><font face='courier new' size=2><b>ACCIONES<br>ORDINARIAS</b></font><td align=center bgcolor=#dddddd><font face='courier new' size=2><b>TOTAL<BR>ACCIONES</b></font></td></td></tr>";
	...
	echo "<tr><td bgcolor=#999999 colspan=3><font face='courier new' size=2><b>TOTAL ACCIONISTAS : ".number_format((double)$count,0,'.',',')."</b></font></td><td bgcolor=#999999 colspan=3><font face='courier new' size=2><b>TOTAL ACCIONES : ".number_format((double)$soc,0,'.',',')."</b></font></td></tr>";	
	echo"</table>";
}
?>
</body>
