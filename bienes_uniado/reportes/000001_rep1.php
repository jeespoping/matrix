...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rep1.php' method=post>";
		if(!isset($numero))
		{
			echo "<center><table border=0>";
			echo "<tr><td align=center><b>UNIDAD DE ADOLESCENTES LAS AMERICAS S.A.<b></td></tr>";
		...
		else
		{
			...
			if ($num>0)
			{
				...
				echo "<table border=1>";
				echo "<tr><td rowspan=4  align=center><IMG SRC='/MATRIX/images/medical/root/territorio.jpg'   width=50%></td>";
				echo "<td colspan=2><font size=5>UNIDAD DE ADOLESCENTES LAS AMERICAS S.A.</font></td></tr>";
				echo "<tr><td colspan=2><font size=4 aling=center>NIT : 811.045.583-8</font><td></tr>";
