...
{	            
  ...
  function mostrar_empresa($wemp_pmla)
     {  
	  ...
	  encabezado("Contingencia Kardex de Enfermería",$wactualiz, "clinica");  
     }
	...
	if(isset($wwhis) and isset($wwing))
	{
		...
		for ($i=1;$i<=$num;$i++)
		{
			...
			if ($num1 > 0)
			{
				...
				$contenido_html .= "<th><font size=3>Habitación "."</font></th>";
				...
				$contenido_html .= "<td align=center colspan=4>Médico(s) Tratantes</td>";
				$contenido_html .= "</tr>";
				...
				if (trim($wart) != "" or trim($wfre) != "" or $j > 0 or trim($row1["kardem"])!="")
				{
					...
					{   
						...
						$contenido_html .= "<td align=center><b>Observación</b></td>";
						$contenido_html .= "<td align=center><b>Vía Admón</b></td>";
						$contenido_html .= "</tr>";
				...
				$contenido_html .= "<td align=center><b>Rondas de Aplicación</b></td>";
				$contenido_html .= "<td align=center><b>Condición</b></td>";
