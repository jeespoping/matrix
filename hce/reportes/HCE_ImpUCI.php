<html>
<head>
  	<title>MATRIX Programa de Impresion UCI - UCE</title>
...
/**********************************************************************************************************************  
	   PROGRAMA : HCE_ImpUCI.php
	   Fecha de Liberación : 2015-09-09
	   Autor : Ing. Pedro Ortiz Tamayo
	   Version Actual : 2019-08-13
	   
	   OBJETIVO GENERAL : 
	   Este programa ofrece al usuario una interface gráfica que permite generar una impresion de los formularios de 
	   Evolucion UCI-UCE y Nota Medica UCI-UCE
...
else
{
	...
	echo "<form name='HCE_ImpUCI' action='HCE_ImpUCI.php' method=post>";
	...
	echo "<input type='HIDDEN' name= 'wfor1' value='".$wfor1."'>";
	echo "<input type='HIDDEN' name= 'wfor2' value='".$wfor2."'>";
	...
	if($row[0] == 0)
	{
		...
		echo "<tr><td id=tipoL09 colspan=5><IMG SRC='/matrix/images/medical/HCE/Triste.png' style='vertical-align:middle;'>NO EXISTE INFORMACION EN LA HCE PARA ESTE PACIENTE</td></tr>";
		echo "</table></center>";
	}
	...
	$queryI .= " select ".$empresa."_000002.Detdes,".$empresa."_".$wfor1.".movdat,".$empresa."_000002.Detorp,".$empresa."_".$wfor1.".fecha_data,".$empresa."_".$wfor1.".Hora_data,".$empresa."_000002.Dettip,".$empresa."_000002.Detcon,".$empresa."_000002.Detpro,".$empresa."_000001.Encdes,".$empresa."_000002.Detarc,".$empresa."_000002.Detume,".$empresa."_000002.Detimp,".$empresa."_".$wfor1.".movusu,".$empresa."_000001.Encsca,".$empresa."_000001.Encoim,".$empresa."_000002.Dettta,".$empresa."_000002.Detfor,".$empresa."_000001.Encfir,".$empresa."_000002.Detimc,".$empresa."_000002.Detccu from ".$empresa."_".$wfor1.",".$empresa."_000002,".$empresa."_000001 ";
	$queryI .= " where ".$empresa."_".$wfor1.".movpro='".$wfor1."' "; 
	$queryI .= "   and ".$empresa."_".$wfor1.".movhis='".$whis."' ";
	$queryI .= "   and ".$empresa."_".$wfor1.".moving='".$wing."' ";
	$queryI .= "   and ".$empresa."_".$wfor1.".fecha_data between '".$wfechai."' and '".$wfechaf."' "; 
	$queryI .= "   and ".$empresa."_".$wfor1.".movpro=".$empresa."_000002.detpro ";
	$queryI .= "   and ".$empresa."_".$wfor1.".movcon = ".$empresa."_000002.detcon ";
	...
	$queryI .= " UNION ALL ";
	$queryI .= " select ".$empresa."_000002.Detdes,".$empresa."_".$wfor2.".movdat,".$empresa."_000002.Detorp,".$empresa."_".$wfor2.".fecha_data,".$empresa."_".$wfor2.".Hora_data,".$empresa."_000002.Dettip,".$empresa."_000002.Detcon,".$empresa."_000002.Detpro,".$empresa."_000001.Encdes,".$empresa."_000002.Detarc,".$empresa."_000002.Detume,".$empresa."_000002.Detimp,".$empresa."_".$wfor2.".movusu,".$empresa."_000001.Encsca,".$empresa."_000001.Encoim,".$empresa."_000002.Dettta,".$empresa."_000002.Detfor,".$empresa."_000001.Encfir,".$empresa."_000002.Detimc,".$empresa."_000002.Detccu from ".$empresa."_".$wfor2.",".$empresa."_000002,".$empresa."_000001 ";
	$queryI .= " where ".$empresa."_".$wfor2.".movpro='".$wfor2."' "; 
	$queryI .= "   and ".$empresa."_".$wfor2.".movhis='".$whis."' ";
	$queryI .= "   and ".$empresa."_".$wfor2.".moving='".$wing."' ";
	$queryI .= "   and ".$empresa."_".$wfor2.".fecha_data between '".$wfechai."' and '".$wfechaf."' "; 
	$queryI .= "   and ".$empresa."_".$wfor2.".movpro=".$empresa."_000002.detpro ";
	$queryI .= "   and ".$empresa."_".$wfor2.".movcon = ".$empresa."_000002.detcon ";
	$queryI .= "   and ".$empresa."_000002.detvim in ('A','C') "; 
	$queryI .= "   and ".$empresa."_000002.Dettip != 'Titulo' "; 
	$queryI .= "   and ".$empresa."_000002.Detpro = ".$empresa."_000001.Encpro ";
