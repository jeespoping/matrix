<html>
<head>
  	<title>MATRIX Programa de Impresion Formulario</title>
...
/**********************************************************************************************************************  
	   PROGRAMA : HCE_PANY.php
	   Fecha de Liberación : 2018-03-28
	   Autor : Ing. Pedro Ortiz Tamayo
	   Version Actual : 2018-03-28
	   
	   OBJETIVO GENERAL : 
	   Este programa ofrece al usuario una interface gráfica que permite generar una impresion de cualquier formulario
	   de HCE,
...
else
{
	...
	echo "<form name='HCE_PANY' action='HCE_PANY.php' method=post>";
	...
	imprimir($conex,$empresa,$wdbmhos,$origen,$queryI,$whis,$wing,$key,$en,$wintitulo,$Hgraficas,$CLASE,$wsex,0,$TIT);
}
?>
