...
<head>
  ...
  <script type='text/javascript'>
	...
	/************************************************************************/		
	// Llama al script de impresi�n de los CTC para que traiga la impresi�n del CTC
	// del art�culo enviado
	...
	// Llama a este mismo script para hacer la impresi�n solo del medicamento correspondiente al CTC
	// para eso se envia el par�metro art
	...
	// Llama a este mismo script para hacer la impresi�n solo del medicamento correspondiente al CTC
	// para eso se envia el par�metro pro
...
<?php
    /******************************************************************
    * 	  			IMPRESI�N DE ORDENES M�DICAS					  *
    * ----------------------------------------------------------------*
    * Este script imprime la orden m�dica .							  *
    ******************************************************************/
	/*
	 ...
	 *	Mayo 4 de 2020: Jessica Madrid
							- Para el env�o de las ordenes por correo se modifica en la funci�n enviarPdf() el mensaje y asunto como vac�os ya
							  que el mensaje se construir� dinamicamente desde envioCorreoHCEOrdenes.php con los par�metros de root_000051 
							  mensajeCorreoEnvioOrdenesPaciente y mensajeCorreoEnvioOrdenesEntidad
	  ================================================================================================================================================
	 *	Abril 2 de 2020: Jessica Madrid
							- Se adiciona la opci�n de env�o por correo del pdf con las ordenes m�dicas, se habilita la opci�n si se recibe el 
							  par�metro enviarCorreo en on y se recibe el email en el par�metro emailEnviarCorreo
	  ================================================================================================================================================
	 *	Enero 17 de 2020: Jessica Madrid
							- Se la consulta del responsable para garantizar que muestre el responsable del ingreso correspondiente y no del �ltimo.
							- Se modifica la descripci�n del logo para que se visualice correctamente.
	 ================================================================================================================================================
	 *	Noviembre 21 de 2019: Edwin MG
							- Se imprime el c�digo de barras solo con el n�mero de la orden sin el tipo de orden
	 ================================================================================================================================================
	 *	Noviembre 19 de 2019: Jessica Madrid
							...
							- Se corrige la impresi�n ya que al generar el pdf no se visualiza correctamente la historia y la tarifa.
	 ================================================================================================================================================
	 *	Octubre 30 de 2019: Edwin MG
							- Se imprime el c�digo de barras de la historia y el n�mero de orden
	 ================================================================================================================================================
	 *	Abril 4 de 2019: Edwin Molina
							- Se muestra el nombre del procedimiento seg�n el cup (root_000012) en lugar del lenguage Am�ricas
	 ================================================================================================================================================
	 *	Diciembre 18 de 2017: Jessica Madrid
							- Se comenta el contenido de la funcion consultarDxs() y agrega el llamado a la funci�n consultarUltimoDiagnosticoHCE() 
							de comun.php que devuelve la lista de los diagn�sticos actuales del paciente
	 ================================================================================================================================================
	 ...
	 *						  examenes que est�n eliminados desde homologaci�n de examenes, es decir, que solo se encuentran en la tabla hce_000017.
	 ================================================================================================================================================
	 ...
	 *	Enero 12 de 2016 Veronica Arismendy 
							- Se modifica el archivo para agregar validaci�n si la impresi�n se solicit� desde rp_PacientesEgresadosActivosOrdenes.php
							tambi�n para agregar filtros dependiendo del tipo de orden que selecciono el usuario imprimir, con el fin de evitar que se le cargue
							todo en el pdf y por el contrario s�lo le salgan el tipo de ordenes que el solicit�.	 
	 ================================================================================================================================================
	 ...
	 * Enero 9 de 2015: Jonatan
							- Se imprimiran solamente los que tengan la variable Kadaan = '' sin tener en cuente si esta suspendido, segun esto
								solo se imprimir�n los que registre el medico y no los que reemplace farmacia.
	 ...
	 * Noviembre 21 de 2014: Jonatan
							- Si se estan imprimiendo las ordenes desde la pesta�a de alta se mostrara la cantidad, en caso contrario no.
	 ...
	 * Enero 29 de 2014: 	- Para las ordenes que tienen formulario emergente, se corrige la informaci�n del paciente, ya que si se imprim�a solo una orden de este tipo
	 *					   		no sal�a la informaci�n demogr�fica del paciente
	 *					 	- Ya no se imprime DIAGN�STICO QUE JUSTIFICA LA TRANSFUSI�N por que este ya fue eliminado del formulario de TRANSFUSIONES de HCE
	*						 - Para la impresi�n de orden de TRANSFUSI�N, se cambia observaciones por justificaci�n
	 * Enero 21 de 2014: 	- Se quita resumen de historia cl�nica para orden de hospitalizaci�n
	 *					 	- Se corrige el motivo al imprimir una orden de hospitalizaci�n ya que estaba mostrando para el motivo las observaciones
	 ******************************************************************/
...
function agregarTarjetaPDF( $contenido_pdf, $numero_tarjeta=1 ){
	...
	//Explicacion: Las medidas de una hoja tama�o carta son 21.59 x 27.94
	...
	$pdf->StartTransform();	
	$pdf->Rect($x, $y, 10, 6.8, 'CNZ'); //Aunque la celda mide 10x6.984, solo se muestra el contenido hasta 6.8 por si la tarjeta desborda el tama�o de la celda
...
function consultarDxs( $conex, $wemp_pmla, $whce, $his, $ing ){
	...
	// Funci�n que retorna la edad con base en la fecha de nacimiento
	...
	function pintarEncabezado($tituloOrden,$whistoria,$nroOrden, $wingreso, $cconombre)
	{
		...
		if(trim($ubicacion) == ''){
			...
			$ubicacion = $row_ubi['Cconom']."<br>Sin ubicaci�n asignada.";
		}
	...
	function pintarPiePagina($medtdo,$meddoc,$medno1,$medno2,$medap1,$medap2,$medreg,$espnom, $cod_med)
	{
		...
		$htmlpiepagina .= '				  </div></td>
							...
							<tr>
							  <td>
								&nbsp;Nombre del M�dico: '.$medap1.' '.$medap2.', '.$medno1.' '.$medno2.' <br />
								&nbsp;Identificaci�n: '.$medtdo.' '.$meddoc.' <br />
								&nbsp;Registro M�dico: '.$medreg.' <br />
		...
		// Inicio tabla pie de p�gina	
		$htmlpiepagina .= '
				<table style="border: 0px; width: 740px;" cellpadding="2" cellspacing="2">
				  <tbody>
					<tr>
					  <td style="text-align:center;" calss="descripcion">
						Diagonal 75B N. 2A-80/140 (057) 4 3421010 (057) 4 3412946 Medell�n, Colombia
					  </td>
					</tr>
				  </tbody>
				</table>';
		// Fin tabla pie de p�gina
...
// Si el usuario no est� registrado muestra el mensaje de error, modificacion hecha por Jaime Mejia
if(!isset($_SESSION['user']) && !isset($_GET['automatizacion_pdfs'])){
	echo "<br /> La sessi�n de usuario ha caducado. Vuelva a entrar a Matrix";
}
else	// Si el usuario est� registrado inicia el programa
{
	...
	************************************************/
	...
	// Se asigna el valor por defecto para el filtro de impresi�n
	$filtroArtImprimir = " AND Kadimp = 'on' "; 	// " AND Kadimp = 'on' ";
	$filtroProImprimir = " AND Detimp = 'on' ";

	// Si se llama desde la pesta�a de Otras ordenes, se establece que solo se va a imprimir
	// los procedimientos de la orden y no los medicamentos
	// Esto aplica solo para ordenes clinica por la pesta�a de alta
	if(isset($alt) && $alt=="on")
	{
	...
	// Si tipoimp viene con el valor impart se establece que solo se va a imprimir los art�culos
	...
	// Esto pasa cuando se llama desde la impresi�n de CTC, solo se imprime
	...
	// Arreglo que me guardar� la lista de medicamentos No Pos ordenados
	$medicamentosNoPos = array();

	// Arreglo que me guardar� la lista de procedimientos No Pos ordenados
	$examenesNoPos = array();
	...
	{
		/**************************************************************************
		********************* IMPRESI�N MEDICAMENTOS EXTERNOS *********************
		***************************************************************************/
		...
		//Si se imprime desde la pesta�a de alta si se muestra la cantidad.
		if($alt == 'on'){	
			...
			foreach($array_medicamentos as $key_medico => $array_paginas){
				...
				foreach($array_paginas as $key => $medicamentos){
					...
					if(count($medicamentos) > 1){
						...
						// Se define el filtro para consultar el m�dico tratante
						if(isset($ide) && $ide!="")
							$filtroMedico = " Meddoc = '".$ide."' ";
						else
							$filtroMedico = " Meduma = '".$key_medico."' ";

						// Consulto los datos del m�dico
						...
						// Se calculan las dimensiones para la imagen de la firma del m�dico
						dimensionesImagen($rowmed['Meddoc']);

						// Datos del m�dico tratante
						...
						foreach($medicamentos as $key1 => $row){
							...
							// Consulto el nombre de la codici�n
							$qCnd =  " SELECT Condes "
							...
							if($es_nutricion == 'on'){
								...
								if(count($insumosNPT)>0)
								{
									...
									{
										$kadobs1 .= "<br><br><b>Observaci�n:</b> ".strip_tags( substr( $row['Kadobs'], 0, strpos($row['Kadobs'], "<span" ) ) );
									}
								}
								else
								{
									...
									$html .= pintarEncabezado('ORDEN MEDICAMENTOS <br />Con CTC',$whistoria,'', $wingreso, $cconombre);
										...
										if($es_nutricion == 'on'){
											...
											if(count($insumosNPT)>0)
											{
												...
												if(trim($row['Kadobs'])!="" && strip_tags( substr( $row['Kadobs'], 0, strpos($row['Kadobs'], "<span" ) ) )!="")
												{
													$kadobs2 .= "<br><br><b>Observaci�n:</b>".strip_tags( substr( $row['Kadobs'], 0, strpos($row['Kadobs'], "<span" ) ) );
												}
											}
											else
											{
							...
							$html .= pintarEncabezado('ORDEN MEDICAMENTOS'.$subEncabezado,$whistoria,'', $wingreso, $cconombre);
								...
								if($es_nutricion == 'on'){
									...
									if(count($insumosNPT)>0)
									{
										...
										if(trim($row['Kadobs'])!="" && strip_tags( substr( $row['Kadobs'], 0, strpos($row['Kadobs'], "<span" ) ) )!="")
										{
											$kadobs3 .= "<br><br><b>Observaci�n:</b>".strip_tags( substr( $row['Kadobs'], 0, strpos($row['Kadobs'], "<span" ) ) );
										}
									}
									else
									{
											...
											$html .= pintarEncabezado('ORDEN MEDICAMENTOS <br />Con CTC',$whistoria,'', $wingreso, $cconombre);
												...
												if($es_nutricion == 'on'){
													...
													if(count($insumosNPT)>0)
													{
														...
														if(trim($row['Kadobs'])!="" && strip_tags( substr( $row['Kadobs'], 0, strpos($row['Kadobs'], "<span" ) ) )!="")
														{
															$kadobs4 .= "<br><br><b>Observaci�n:</b>".strip_tags( substr( $row['Kadobs'], 0, strpos($row['Kadobs'], "<span" ) ) );
														}
													}
													else
													{
	...
	//----
		...
		/******************* FIN IMPRESI�N MEDICAMENTOS EXTERNOS *******************/
