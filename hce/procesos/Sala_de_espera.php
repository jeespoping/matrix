...
function ponerConsulta($whce, $whis, $wing, $wusuario, $irhce)
   {
	  ...
	  for($i=1;$i<=$num;$i++)
		 {
		  ...
		  if ($wcur == "on")
			 echo "<td align=center><input type='radio' name='wirhce$i' id='wirhce$i' onclick='activarConsulta($whis, $wing, \"$wdpa\", \"$wtid\", $i)' checked></td>";
			   ...
			   echo "<td align=center><input type='radio' name='wirhce$i' id='wirhce$i' onclick='activarConsulta($whis, $wing, \"$wdpa\", \"$wtid\", $i, \"$irhce\")'>";
...
function mostrarPacientesComunes($wbasedato, $whce, $wemp_pmla, $wcco, $wusuario, $k)
 {
  global $conex;
  ...
  //Traigo los indicadores de sis el medico es de urgencias y ademas es Pediatra u Ortopedista, si no, es porque es general
  $q = " SELECT medurg, medped, medort "
...
//=========================================================================================================================================================================================
  ...
  //FORMA ================================================================
  echo "<form name='sala' action='sala_de_espera.php' method=post>";
  ...
  if(isset($consultaAjax))
	...
	switch($consultaAjax)
	  {
	    case 'activarcur':
		   echo ponerConsulta($whce, $whis, $wing, $wusuario, $irhce);
		 break;
		case 'conducta':
		  {
  ...
  mostrarPacientesComunes($wbasedato, $whce, $wemp_pmla, $wcco, $wusuario, $i);
  
  echo "</form>";
  
  if (isset($wsup) and $wsup=="on")  //Es superusuario
     echo "<meta http-equiv='refresh' content='300;url=Sala_de_espera.php?wemp_pmla=".$wemp_pmla."&wuser=".$wusuario."&user=".$user."'>";
	else 
       echo "<meta http-equiv='refresh' content='30;url=Sala_de_espera.php?wemp_pmla=".$wemp_pmla."&wuser=".$wusuario."&user=".$user."'>";
