...
//                  ACTUALIZACIONES 
//-------------------------------------------------------------------------------------------------------------------------------------------- 
			$wactualiz='2020-01-21';// para pasar a produccion la variable $esproduccion debe estar en true y de manera visual se quitan los puntos a $wactualiz
//--------------------------------------------------------------------------------------------------------------------------------------------  
...
else
{
	...
	$esproduccion = true; //  OJO , debe estar en true si la aplicacion ya pasa a produccion
...
<div>
 ...
 <tr>
		...
		<td colspan='5' class='fila2' width='120px' >
		  ...
		  <textarea   id='nroPrescripcion' name='nroPrescripcion' rows='4' style='width:90%' onkeypress='return soloNumerosymas(event);'></textarea>
...
//			$vlrcuotamoderadorafactura = 0;
			...
			if ( $cantart > 0 ){
				...
				if ( $cantidaddefacturas > 0 ){
					...
					{
						//18 de octubre 2019 
						//Por aqui voy , falta formatear los numeros para que aparezcan formateados cuando se selecciona la factura.
						$seleccionado = "";
...
//24 de Octubre , Freddy Saenz nuevos campos usadoos en el" . $wbasedatomipres . " de Facturacion
				...
				case "EstFacturacion"://estado de facturacion.
	...
	switch($accion)
	{
		case "consultarinfofacturacionyreporte"://Imprimir la facturacion
			...
			if ( $vID != 0 ){//ya se envio la facturacion //( $vIDFacturacion != 0 )
				...
				$wherestr = "SumID = '".$vID."' ";
				$vselectpre = "Sumjfa , Sumjre" ;
				$arrFila =  select1filaquery($vselectpre, $wbasedatomipres."_000037", $wherestr); //informacion de la prescripcion

				if ( count($arrFila) > 0){
					//
					$vfacturaciontxt2 = $arrFila['Sumjfa'];
					$vreporteentregatxt2 = $arrFila['Sumjre'];
					if ( $vfacturaciontxt2 != "" ){	
					//
