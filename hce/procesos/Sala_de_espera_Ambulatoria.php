...
function consultarAdmision($conex,$wemp_pmla,$cedula,$wtid,$wfechaact,$wcliame,$wbasedato,$whce)
{
      ...
      $resHistoria = mysqli_query($conex,$conHistoria) or die(mysqli_errno()." - Error en el query $conHistoria - ".mysqli_error());
	  ...
	  $resAdmision = mysqli_query($conex,$conAdmision) or die(mysqli_errno()." - Error en el query $conAdmision - ".mysqli_error());
