...
$wactualiz = "(Enero 23 2013)";

//==============================================================================================================================================\\
//Enero 23 de 2013	Juan C. Hdez.	Se modifica el tipo de campo Valida Edad de campo booleano a dropdown, con las opciones T:odos, P:ediatricos\\
//									N:eonatos y A:dultos                                                                                        \\
//==============================================================================================================================================\\
...
//echo "wdettip : ".$wdettip."<br>";
		...
		echo "<td><b>".$wcar_obl[$k].$wnom_variables[$k]."</b></td>";
		if (isset($wdetved) and $wdetved!="")    
		   {
		    echo "<td><SELECT name='wdetved' ".$wvalidacion[$k]." onchange='enter()'>";
			switch ($wdetved)
			  {
			   case "T":   
		          {
