 ...
 * MODIFICACIONES
 *
 * Octubre 8 de 2021	Sebasti�n Nevado	Se agrega funcionalidad de mipres obligatorio basado en par�metro mipresEnListaMedicamentosOrdenes. Valida que antes de ordenar el medicamento, tenga c�digo mipres si es nopos, contributivo, paciente de eps y ordenador sea m�dico. Valida por Webservice la existencia del mipres para permitir guardar.
 ...
 *									y debe haber por lo menos un sitio anat�mico y tipo de muestra seleccionados
 * Enero 22 de 2020		Edwin MG	Una vez guardado las ordenes despu�s de firmar se deja todos los examenes como viejos
 * Octubre 30 de 2019	Edwin 		Se hacen modificaciones varias para interoperabilidad con ordenes (LABORATORIO, HIRUKO)
 * Junio 5 de 2019		Edwin MG	Se valida el tiempo de recarga de la mensajer�a kardex
 * Noviembre 15 de 2018	Edwin 		Se agrega validaci�n de alergias de medicamentos al prescribir los medicamentos, es decir, 
 ...
 * Julio 9 de 2018 		Edwin 		Se busca los articulos anteriores por ajax para que la carga inicial sea m�s liviana
 * Julio 3 de 2018 		Edwin 		Al dar clic sobre la pesta�a auditor�a se consulta la auditor�a correspondiente para le paciente
 * Febrero 13 de 2018 	Edwin 		Los medicamentos ordenados desde una ayuda diagn�stica o por protocolo comienzan desde la ronda actual
 * Febrero 8 de 2018 	Edwin 		No se tienen en cuenta la frecuencia para cambiar la fecha y hora de inicio del medicamento
 * Noviembre 28 de 2017 Jessica 	Se env�a el usuario como par�metro al ajax 37 ya que la funci�n consultarProtocolo() de 
 *									ordenes.inc.php quedaba sin este.
 * Noviembre 27 de 2017 Jessica 	Se agrega el numero de la pesta�a como par�metro a la funcion mostrar_mensaje() para que guarde 
 *									en el campo oculto pestanasVistas cuando haga clic en las pesta�as y as� enviarlo en las funciones 
 ...
 * Abril 27 de 2017 		Se muestra el formato de control a los m�dicos una vez grabe la orden.
 * Marzo 7 de 2017 			Para los CTC de responsables contributivos se modifica el tama�o del iframe del ministerio para que no se salga de la modal cuando la pagina tiene zoom.
 ...
 * Agosto 3 de 2016 	Se modifica la modal de prescripci�n de NPT para que solo se permita ordenar NPT seguras teniendo en cuenta ciertas condiciones.
 ...
 *						un campo que dice cual era las observaciones iniciales del dextrometer en la funci�n inicializarJquery.
 * Junio 16 de 2016		Al cambiar la frecuencia de dosis unica se borra la dosis m�xima 
 * Junio 10 de 2016		Se corrige horario especial que guarda 24:00:00 en vez de 00:00:00 
 * Mayo 20 de 2016		Los articulos pueden tener configurado en Base de datos d�as de tratamiento por defecto y dosis m�xima (movhos_000059). Se corrige error
 *						en que ten�a prevalencia la configuraci�n por defecto de los medicamentos y no lo ordenado por el medico.
 * Marzo 23 de 2016		- Se a�ade la funcionalidad de procedimientos agrupados, modal que permite seleccionar varios procedimientos a la vez, las acciones
 ...
 * Mayo 16 de 2016 		Se a�ade la funcionalidad de procedimientos agrupados, modal que permite seleccionar varios procedimientos a la vez, 
 ...
 *						Por cada procedimiento se pueden adicionar medicamentos y son obligatorios de acuerdo a la configuraci�n de cada procedimiento.
 *						Cuando se cambia el estado a realizado, pendiente de resultado o cancelado se suspenden los medicamentos asociados.
 *						Si uno de los medicamentos tiene como minimo una aplicaci�n el procedimiento no podr� ser cancelado.
 * Mayo 13 de 2016		Se corrige error cuando no se llena ctc de medicamentos y se ordena nuevamente el medicamento no ped�a ctc.
 * Mayo 10 de 2016		Al cargar un protocolo (funcion eleccionMedicamento), si un procedimiento no trae informaci�n por ajax no se muestra en la orden.
 * Mayo 5 de 2016		Se cambia el campo oculto entidad_responsable por el nit de la empresa(cliame_000024) para evitar hacer split por gui�n que puede generar errores.
 ...
 * Diciembre 04 de 2015	Para los insumos de infusiones se revisa que tenga la via de administraci�n que trae por defecto el articulo gen�rico o si no se deja por defecto la v�a
 *						la primera v�a que tenga el medicamento.
 * Noviembre 11 de 2015	Si en el buscador de medicamentos se cambia la unidad de medida o de presentaci�n no se borra la dosis ingresada, el cambio se encuentra en
 *						la funci�n filtrarMedicamentosPorCampo.
 * Octubre 04 de 2015	Se inicializa variale conctc que estaba causando un error cuando se eleg�a un medicamento NO POS en horario especial
 * Junio 02 de 2015	Si se cambia la frecuencia de un medicamento de d�as anteriores, se actualiza la fecha y hora de inicio como corresponde.
 * Mayo 15 de 2015 Se repara la eliminacion de varios examenes al mismo tiempo.
 * Abril 15 de 2014	Se agrega validaci�n para cuando la pesta�a de altas est� inactiva
 * Marzo 25 de 2015	Se valida que no se permite poner 0 en d�as de tratamiento ni en dosis m�xima
...
//contiene una cadena con todos los articulos que deber�an tener CTC despu�s de grabar los articulos
var artsGrabadosCTC = "";
...
function marcarCambioRealizarEnServicio( cmp, enServcio, externo, indice, contexamen ){
	...
	// var msg = "En donde se realizar� el estudio <b>"+$( "#wnmexamen"+contexamen ).val()+"</b>?<br><br>En el servicio d�nde se encuentra el paciente puede realizarse por uno de los siguientes motivos: ";
	
	// if( enServcio ){
		// msg += "<br><br>- Por que se realizar� en la unidad hospitalaria ";
	// }
	...
	var msg = "En donde se realizar� el estudio <b>"+$( "#wnmexamen"+contexamen ).val()+"</b>?";
	
	msg += "<br><br><b>Relizar en el servicio o en un servicio externo:</b> Indica que el estudio se realizar� en el servicio d�nde se encuentra el paciente o se remite a otra instituci�n diferente a las sedes de AUNA";
	// ya sea por qu� el equipo requerido en la unidad interna (Cardiolog�a, imagenlog�a, laboratorio, etc ) no se encuentra disponible u otro motivo";
	
	msg += "<br><br><b>Realizar en la unidad de Ayuda diagn�stica:</b> Indica que el estudio se realizar� en una unidad interna de las sedes de la cl�nica (Cardiolog�a, imagenolog�a, etc )";
	...
	$( "<div style='color: black;height: 250px;' title='REALIZAR EN SERVICIO?' class='dvRealizarEnServicio'>"+msg+"</div>" ).dialog({
		...
		buttons	: {
			...
			"Realizar en la unidad de Ayuda diagn�stica": function() {
					let __self = this;
					jConfirm( "Esta decisi�n no puede ser modificada. Est� seguro(a) que se realizar� en la Unidad diagn�stica correspondiente?","ALERTA", function(r){
						if(r){
							cmp.checked = true;
							cmp.value = 'off';
							$( __self ).dialog( "close" );
			...
			$( data ).each(function(x){
				...
				newSpan.click(function(){
						...
						if( !$( this ).hasClass( "selected" ) ){
							...
							//Creo un iframe que mostrar� la informaci�n
...
function validarEntradaDecimalSoloUnPuntoNPT(id,e) { 
	...
	{
		// Obtenemos el n�mero del atributo tabindex al que se le dio enter y le sumamos 1
		...
		{
			// Si no se encontro ning�n elemento, se retorna false
			return false;
		}
...
function validarEleccionInsumosNPT(indice,tipoProtocolo){
	...
	{
		mensajeValidacion += "- El tiempo de infusi�n debe ser mayor o igual a 10 horas \n";
	}
	
	if( parseInt(tiempoInfusionNPT)>24)
	{
		mensajeValidacion += "- El tiempo de infusi�n debe ser menor o igual a 24 horas \n";
	}
...
function salirSinGrabarModalNPT(indice,tipoProtocolo){
	...
	jConfirm( "No se grabar� el medicamento en la ordenes. Desea continuar?", "ALERTA", function( resp ){
		if( resp ){
...
function recalcularValoresNPT()
{
	...
	$('table[id=tablaNutricionesNPT] input[id^=NPT_Formula_]').each(function(){
		...
		{			
			try 
			{
				...
				jAlert("Error en la configuraci�n de las formulas","ALERTA");
	...
	// // ========================================================================
	// //					PAR�METROS NUTRICIONALES Y FARMAC�UTICOS
	// // ========================================================================
		...
		if(idFijo != "NPT_Formula_" && idFijo != "NPT_FMF1_" && idFijo != "NPT_FMF2_" && idFijo != "NPT_FMVAF1_" && idFijo != "NPT_FMVAF2_" && idFijo != "NPT_FMVAF3_")
		{
			...
			if(formulaParamNutricYFarmace != "")
			{
				...
				try 
				{
					...
					jAlert("Error en la configuraci�n de las formulas de par�metros nutricionales y farmac�uticos","ALERTA");
					$("#btnGrabarNPT").attr('disabled', 'disabled');
				}
			}
		}
	...
	$('table[id=tablaNutricionesNPT] input[id^=NPT_PRESCRIPCION]').each(function(){
		...
		{			
			try 
			{
				...
				jAlert("Error en la configuraci�n de las formulas del volumen","ALERTA");
				$("#btnGrabarNPT").attr('disabled', 'disabled');
			}
		}
		...
		{			
			try 
			{
				...
				jAlert("Error en la configuraci�n de las formulas de la correcci�n purga","ALERTA");
				$("#btnGrabarNPT").attr('disabled', 'disabled');
			}
		}
	});
		...
		for (var i = 0; i < procAgrupados[x].length; i++) 
		{
			...
			for( var u in procAgrupados[x][i].medicamentos )
			{
				...
				if(procAgrupados[ x ][i].medicamentos[ u ].tipoProtocolo == tipoProtocolo && procAgrupados[ x ][i].medicamentos[ u ].posicionActual == idxElemento)
				{
					...
					{
						// jAlert("No se agreg� el medicamento: "+descMedi+" porque no llen� el CTC de medicamentos");
						// alert("No se agreg� el medicamento: "+descMedi+" porque no llen� el CTC de medicamentos");
			...
			if(cantMedSinCTC == 1 && cantMed== 1)
			{
				...
				$('#trExAgru'+x).remove();
				// alert("No se agreg� el procedimiento y el medicamento: "+descMedi+" porque no llen� el CTC de medicamentos");
			}
...
function agregarMedicamentoPorProcAgrupado(codArt,frec,via,dosisArt,tipoOrdenAgrup,codProcAgrup,codMedicament)
{
	...
	administracion = via;			// V�as de administraci�n
	condicion = "";				// Condiciones de suministro
	var dosis = dosisArt;				// Dosis
	var observaciones = "";		// Observaciones

	presentacion = '';			// Presentaciones o formas farmac�uticas
	medida = '';				// Unidades de medida
	// var fechaInicio = '';		// Fecha y hora de inicio de aplicaci�n
	var fechaInicio = $("#whfinicioN999").val();		// Fecha y hora de inicio de aplicaci�n
	var dosisMax = '';			// Dosis a aplicar
	var diasTto = '';			// D�as de tratamiento
...
//	    		seleccionarComponente("",reemplazarTodo(item," ","_"));
				 ...
				 * 3: Nombre gen�rico del articulo
				 * 4: Tipo protocolo
						...
						if( procAgrupados[x][i].codigo ==  id_chk)
						{
							...
							for( var z in arrMedicamentos ){
								...
								if( procAgrupados[x][i].medicamentos[z] ) {
									...
									//modificar campos en la pesta�a medicamentos
		...
		if( totalChecks-1 == posInputs ){
			...
			if(medEliminados!="")
			{
				if(arrMedQuitar.length > 0)
				{
					...
					// cadenaMensajeProcAgrupados += "Se elimin� el medicamento: "+$.trim(medEliminados.substr(0,medEliminados.length-1))+"\n";
					
					// buscElim = cadenaMensajeProcAgrupados.search("Se elimin� el medicamento: "+$.trim(medEliminados.substr(0,medEliminados.length-1))+"\n");
					// if(buscElim == -1)
					// {
...
function ModificarProcedimientosAgrupado(tipoOrden,contadorActual){
						...
						if( procAgrupados[x][i].codigo ==  id_chk)
						{
							...
							for( var z in arrMedicamentos ){
								...
								else
								{
									...
									// campos en la pesta�a medicamentos de solo lectura
	...
	if(mensajeFinal!="")
	{
		// jAlert("Se elimin� el medicamento: "+medEliminados.substr(0,medEliminados.length-1), "ALERTA" );
...
/********************************************************************************************************************************************
 *Esta funci�n se llama cada vez que se elimina un articulo o no se desea agregar el articulo a la orden medica
 ********************************************************************************************************************************************/
function quitarArticuloDextrometer( frecuencia, codigoArticulo ){
	/****************************************************************************************
	 * Si el articulo es del dextrometer
	 * No se deja poner la opci�n del dextrometer
	 *****************************************************************************************/
...
function adicionarArticuloInsulina(){
	...
	//De ser as� la suspendido si ya ha sido grabado con anterioridad
		...
		if( frec.length > 0 ){
			...
			if( agregarInsulina ){
				...
				if( codigoArticulo == artIns.val() ){
					...
					//Si el articulo est� suspendido, lo activo
	...
	if( agregarInsulina ){
		...
		//variable global para saber si se est� agregando por dextrometer
		...
		//La funci�n continua en la funci�n result del campo con id wnombrefamilia del buscador de familia
...
function seleccionarInsulina( cmp ){
	...
	if( opSelected ){
		...
		if( opSelected.data( "vias") ){
			...
			//Las vias por defecto est�n como atributos data
	...
	if( opSelected ){
		...
		if( opSelected.data( "unidad") ){
			...
			//Las unidades por defecto que est�n como atributos data
...
function changeRangoDextrometer( cmp ){
	...
	// Si es un rango minimo siempre ser� par
...
function agergarFilaDextormeter(){
	...
	//Consulto los �ltimos campos minimo y m�ximo qu� hab�an
	...
	//Por defecto se colo un rango igual al �ltimo rango que se ten�a
	//comenzando con un rango m�nimo que ser�a el �ltimo rango mayor + 1
...
function eliminarFilaDextrometer( cmp ){
	...
	//Consulto cu�l es el valor para el rango m�nimo
...
function mostrarCtcProcedimientos2( codExamen, cuentaExamenes, cadenaExamSinCTC, cadenaCTCExamGuardado ){
	...
	try{
		...
		if( $.trim( ajax.responseText ) != '' ){
			...
			//Creo el div que contendr� todos los ctc de procedimientos
...
function traeJustificacionHCE2(campoChk,campoDestino,historia,ingreso,wemp_pmla,wbasedatohce){
	...
	{
		if(confirm('Desea borrar el texto de la justificaci�n?'))
		{
	...
	try{
		...
		ajax.onreadystatechange=function(){
			if (ajax.readyState==4 && ajax.status==200){
				...
				{
					// jAlert('No se encontr� resumen de histor�a cl�nica para el paciente','ALERTA');
	...
	try{
		...
		ajax.onreadystatechange=function(){
			if (ajax.readyState==4 && ajax.status==200){
				...
				{
					// jAlert('No se encontr� diagnostico de histor�a cl�nica para el paciente','ALERTA');
...
function mostrarCtcArticulos3( codArticulo, protocolo, id, idFamilia, deAlta, cadenaSinCTC, cadenaCTCGuardado  ){
	...
	//el ctc si es el �ltimo medicamento
	var hayMasHE = 0;
	...
	//Si es uno significa que es el ultimo y si es 0 significa que no ten�a horario especial
	if( hayMasHE == 1 || hayMasHE == 0 ){
		...
		for( var x = 0; x < tbsContenedores.length; x++ ){
			...
			//Buscar todos los medicamentos que tengan el mismo c�digo
		...
		try{
			...
			if( $.trim( ajax.responseText ) != '' ){
				...
				//Si ya hab�a un CTC igualo todos los campos al Ctc encontrado
				if( divEncontrado ){
					...
					for( var i = 0; i < camposBuscar.length; i++ ){
						...
						for( var j = 0; j < varCmps.length; j++ ){
							...
							//Significa que lo debo igualar al CTC que ya hab�a encontrado
							//A excepci�n de posolog�a y dosis por d�a
...
function inhabilitarDiasTratamientoModalLEV( cmp ){
	...
	if( $( "#waccN\\.12" ).eq(0).val().split(",")[0] == 'N' ){	//D�as de tratamiento
...
function inhabilitarDiasTratamientoModalIC( cmp ){
	...
	if( $( "#waccN\\.13" ).eq(0).val().split(",")[0] == 'N' ){	//Dosis m�xima
...
function eliminarArtIgualesMultiples( codigoArticulo, familia, pActivo ){
	for( var x = 0; x < multiplesMedicamentos.length; x++ ){
		...
		if( multiplesMedicamentos[x][0] == codigoArticulo ){
			//C�mo es el articulo a elminar lo quito de la lista
		...
		if( datosFinales && datosFinales.length > 0 ){
			switch( datosFinales.tipoArt ){
				...
				case 'LEVIC':
					...
					//Si no se agrega el �ltimo medicamento se borra todo el articulo LEV o IC
					if( $( "#wnmmed"+tipPro+(elementosLev-1) ).length == 0 ){
						...
						//Dejo la condici�n correspondiente de acuerdo al tipo para el articulo con codigo IC0000 o LV0000
						...
						/************************************************************************************************
						 * No permite que se pueda modificar el Lev o la infusion en ning�n campo una vez creado
						 ************************************************************************************************/
...
function agregarMultiplesArticulos(){
	...
	//verifico si hay m�s articulos en lista
	if( multiplesMedicamentos && multiplesMedicamentos.length > 0 ){
		...
		switch( multiplesMedicamentos[0].tipoArt ){
			...
			case 'HE':
				...
				//Creo variable global con los datos de la �ltima carga para hacer operaciones posteriores
...
function modificarCambiosLEV(){
	...
	/************************************************************************************************************************
	 * Valido que sea valido la selecci�n de insumos
	 * - Se puede escoger un electrolito pero no debe haber nada escrito en en los campos vol/diligencia
	 * - Si se escoge un electr�lito con vol/dil tiene que haber una soluci�n elegida por lo menos
	 * - Si se escoge una soluci�n esta debe tener una frecuencia
	 ************************************************************************************************************************/
	$( "[id^=frecsol]", $( "#listaComponentesLEV" ) ).each(function(x){
		...
		if( $( "#check_insumo" + idx )[0].checked ){
			if( $( this ).val() == '' ){
				...
				//Se valida que halla una soluci�n elegida si hay algo escrito en vol/dil
			...
			if( $.trim( $( "#cantidad_insumo" + idx ).val() ) == "" ){
				...
				if( $( "#tdCbSol"+idx ).length == 0 )
					...
					msgError = "Ingrese un valor para <b>VOL/TOTAL</b> de la soluci�n";
			}
		}
	});
	...
	if( frecDi == "" ){
		msgError = "Debe seleccionar una <b>UNIDAD</b> para <b>VELOCIDAD DE INFUSI�N</b>.";
		todoOk = false;
	}
	...
	if( todoOk ){
		...
		if( frecDi == "" ){
			msgError = "Debe ingresar un valor para <b>VELOCIDAD DE INFUSI�N</b>.";
			todoOk = false;
		}
	}

	/************************************************************************************************************************************************
	 * Para levs, si se est� modificando y hay electrolito seleccionado se debe obligar a que se ingrese un valor para el electrolito
	 ************************************************************************************************************************************************/
	if( tieneElectrolito ){
...
function modificarCambiosIC(){
	...
	if( todoOk ){
		...
		if( true ){
			...
			administracionLQ 	= $( "#wviadmon"+tipoProtocolo+indice ).val();		// V�as de administraci�n
			condicionLQ 		= $( "#wcondicion"+tipoProtocolo+indice ).val();
			observacionesLQ 	= $( "#wtxtobsadd"+tipoProtocolo+indice ).val();
			fechaInicioLQ 		= $( "#wfinicio"+tipoProtocolo+indice ).val();	// Fecha y hora de inicio de aplicaci�n
...
/******************************************************************************************
 * Cambia la velocidad de infusi�n, ya sea para los LEVs o las IC
 ******************************************************************************************/
...
/************************************************************************************
 * Valida que el campo cmp tenga un valor m�nimo
 ************************************************************************************/
...
function validarEntradaDecimalMaxDca( cmp, icIdo, e ){
	...
	// return validarEntradaDecimal(event);
	var patron = /^\d+(\.\d{0,2})?$/	//expresi�n regular de decimal
 ...
 * Si es un LEV o IC tipo ser� LQ e indice traer� el ido del articulo
 ********************************************************************************************************************/
...
/****************************************************************************************************************
 * Est� funci�n  busca todos los articulos que componen la Infusi�n continua y coloca la misma observaci�n
...
function actualizarInsumoLev( idxLev ){
	...
	// artLevs[ "LQ"+parseInt(elementosLev) ] = {
		...
		// idoLev: '',												//Ido del LEV
		// insCod: arrInsumo[0],									//C�dio del insumo
		...
		// insVto: arrInsumo[5] == 'ele' ? '': arrInsumo[1],		//Volumen total de la soluci�n
	...
	$.ajax({
			...
			data:{
				...
				insCdc:				artLevs[ idxLev ].insCdc,	//C�digo de dosis calculada
...
/************************************************************************************
 * Muestra los datos guardados para una infusi�n
 ************************************************************************************/
function mostrarIC( valLevIdo ){
	...
	if( mostrar ){
		...
		for( var x in objAux ){
			...
			//Busco si es un electrolito o una soluci�n
			var tipo = 'sol';
			...
			//El dato se coge de cualquier soluci�n o electrolito por que es igual para todos lo medicamentos
		...
		//Se deja el Ido del articulo LEV que se est� mostrando
		...
		if( $( "#modificaIC" ).val() == 'on' && parseInt( $( "#idoMostrado", $( "#listaComponentesIC" ) ).val() ) ){
			...
			/********************************************************************************
			 * Valido si se permite dosis m�xima o no
			 ********************************************************************************/
			//Dejo por defecto d�as de tratamiento y dosis m�ximos como editables

			//Debo validar los permisos para los d�as m�ximos y d�as de tratamiento
			var perDtto = $( "#waccN\\.12" ).val().split( "," )[0] == 'S' ? true: false;
			var perDmax = $( "#waccN\\.13" ).val().split( "," )[0] == 'S' ? true: false;

			//Miro si por condicio�n se permite
			var condicion = $( "#wcondicion"+codLev ).val();
			if( condicion != "" ){
				perDtto = dmaPorCondicionesSuministro[ condicion ].pdt;	//permite d�as de tratamiento
				perDmax = dmaPorCondicionesSuministro[ condicion ].pdm;	//permite dosis m�xima
			}
			else{
				perDtto = false;
				perDmax = false;
...
/*****************************************************************
 * Funci�n llamada desde cerrarModalArticulos
 *
...
function eliminarArtsLevPorIdx( codLev ){
	...
	try{
		...
		objAux[j] = "";	//Solo se requiere el indice y se crea para borrar los del c�digo tipo LQ0000
	}
	catch(e){
	}
...
//Marca como impreso un articulo en la pesta�a de alta.
...
/*****************************************************************************************************************************
 * Agrega un nuevo registro al Maestro de Estudios y Ayudas Diagn�stcas por medio de AJAX
 ******************************************************************************************************************************/
function agregarNuevoExamenAlta()
{
	...
	{
		alert('El nombre de la ayuda o procedimiento no puede estar vac�o');
		return false;
	}
 ...
 * El objeto estar� formado de la siguiente forma:
 *
 * accionesOrdenes: [
 *		{	tipoProtocolo-Idx1:[
 *				param1: valor1,
...
/************************************************************************************************************************
 * Esta funci�n ejecuta las acciones de Suspender Articulo, eliminar Articulo o eliminar procedimiento seg�n el caso
 ************************************************************************************************************************/
...
function cerrarFormHCE(contExamen,basedatohce,formTipoOrden,historia,ingreso,alta,hce)
{
	...
	// Consulto si el formulario ha sido diligenciado en la historia cl�nica electr�nica
	...
	try{
		...
		ajax.onreadystatechange=function()
		{
			if (ajax.readyState==4 && ajax.status==200){
				...
				{
					if(confirm("Si sale de este formulario sin grabar, el examen ser� eliminado de la orden?"))
					{
						$.unblockUI();
...
// Cuando es adici�n m�ltiple de medicamentos esta funci�n se encarga de abrir los formatos CTC
// de los medicamentos NO POS que puedan haber en esta adici�n m�ltiple
// Enero 30 de 2012
...
// Cuando es adici�n por Horario Especial esta funci�n se encarga de abrir la modal de art�culos
 ...
 * Marzo 12 de 2013
 *
 * Busco los cambios que hallan del CTC y en caso de alg�n cambio se muestra nuevamente la informaci�n
...
function buscarCambiosCTC( dvCodArt ){
	...
	if( document.getElementById( "hiArtsNoPos" ) ){
		...
		for( var i = 0; i < 1; i++ ){
			...
			//Aqu� debo buscar el campo que contiene los objetos para compara cambios
 ...
 * Cumple la misma funci�n que isset en PHP
 **********************************************************************/
 ...
 * Cumple la misma funci�n que trim en PHP
 **********************************************************************/
 ...
 * Junio 19 de 2012
 *
 * Carga articulos del kardex del d�a anterior no suspendidos
 **********************************************************************/
			...
			if (ajax.readyState==4 && ajax.status==200){
				...
				if($.trim( ajax.responseText ) != ""){
					...
					for( var i = 0; i < listaArticulos.length; i++ ){
						...
						//Oculto el boton para traer los medicamentos del d�a anterior
...
function agregarDosisMaxPorCondicion( tipo, indice, campo ){
	...
	//Si no existe campo no se ejecuta la funci�n
	if( !campo ){
		return;
	}
	...
	if( campo.id == "wcondicionsum" || campo.id == "wfrecuencia" ){
		...
		if( campo.id == "wfrecuencia" ){
			...
			//Si tiene una condici�n que no permita dosis m�ximas
			//no se deja poner dosis m�xima
			if( $( "#wcondicionsum" ).val() )
		...
		if( campo.id != "wfrecuencia" ){
			...
			if( condicion != '' ){
				...
				var valPdm = dmaPorCondicionesSuministro[ condicion ].pdm;	//Permite dosis m�xima
				var valPdt = dmaPorCondicionesSuministro[ condicion ].pdt;	//Permite d�as de tratamiento
				...
				if( !valPdm ){
					...
					//Verific� si hay dosis m�xima por frecuencia
	...
	if( campo && campo.id.substr(0,10) == "wcondicion" || campo.id.substr(0,7) == "wperiod" ){
		...
		if( campo.id.substr(0,7) != "wperiod" ){
			...
			if( condicion != '' ){
				...
				//Predomina el perfil que tenga el m�dico, si no puede modificar dosis m�ximas o d�as de tratamiento no se puede modificar
				//as� la condici�n tenga la opci�n de modificarlo
				//var valPdm = $( "#waccN\\.13" ).eq(0).val().split(",")[0] == 'N' ? false: valPdm;	//Dosis m�xima

				//Si la condici�n permite dosis m�xima se revisa
				//que el usuario pueda modificar dosis m�xima
				if( valPdm ){
					var valPdm = $( "#waccN\\.13" ).eq(0).val().split(",")[0] == 'N' ? false: valPdm;	//Dosis m�xima
				}

				//Si la condici�n permite d�as de tratamiento se revisa
				//que el usuario pueda modificar dosis m�xima
				if( valPdt ){
					var valPdt = $( "#waccN\\.12" ).eq(0).val().split(",")[0] == 'N' ? false: valPdt;		//D�as de tto
				}
...
// Esta variable defin�a si se mostraba los mensajes de validaci�n de datos
// Estaba condicionada para no mostrar el mensaje la segunda vez que ocurriera
// Se comenta porque si no se cumple la condici�n siempre se debe mostrar el mensje de validaci�n
// var mostrarAviso = 1;

// Determina si la adici�n del medicamento es por horario especial
var horarioEspecial = false;
// Si contHorarioEspecial = 1; asi sea adici�n por horario especial
// se saca mensaje 'El medicamento ya existe. Desea agregarlo?'
var contHorarioEspecial = 0;

// Cadena que contendr� los art�culos de los que ya se ha mostrado el mensaje que son NO POS
var msjNoPos = '';

// Guardar� los datos de art�culos y procedimientos NO POS cuando se ingresan por adici�n m�ltiple, de modo
// que se pueda llamar al final la ventana modal del formulario CTC para cada art�culo o procedimiento NO POS
strPendientesCTC = "";

// Guardar� los datos de art�culos DA cuando se ingresan por horario especial
strPendientesModal = "";


// Determina si la adici�n de medicamentos es m�ltiple (por ejemplo: Importar protocolo o Insumos Liquidos Endovenosos)
...
function eleccionMedicamento(porProtocolo, mipresEnListaMedicamentos)
{
	...
	// Si no es adici�n de medicamentos por protocolo haga la validaci�n de datos
	if(porProtocolo!=1)
	{
		//////////////////////////////////////////////////////////////////////
		//////// ASIGNACI�N DE VARIABLES PARA LOS DATOS INGRESADOS ///////////
		...
		var presentaciones = document.getElementById( "wpresentacion" );			// Presentaciones o formas farmac�uticas
		...
		/*
		* Modificaci�n: se agrega columna "# Mipres" en caso de tener par�metro activo
		...
		*/
		...
		{
			numPrescripcionMipres = (document.getElementById( "wnumprescripcionmipres" )) ? document.getElementById( "wnumprescripcionmipres" ).value : '';				// N�mero de prescripci�n de mipres
		...
		var viasAdministracion = document.getElementById( "wadministracion" );		// V�as de administraci�n
		var fechaInicio = document.getElementById( "wfinicioaplicacion" ).value;	// Fecha y hora de inicio de aplicaci�n
		var condiciones = document.getElementById( "wcondicionsum" );				// Condiciones de suministro
		var diasTto = document.getElementById( "wdiastratamiento" ).value;			// D�as de tratamiento
		var dosisMax = document.getElementById( "wdosismaxima" ).value;				// Dosis m�xima
		...
		// Se asigna el valor a la variable para la presentaci�n o forma farmac�utica
		...
		////// FIN ASIGNACI�N DE VARIABLES PARA LOS DATOS INGRESADOS /////////
		//////////////////////////////////////////////////////////////////////
		...
		// Si no se ha ingresado el nombre de la familia o art�culo, muestre el mensaje correspondiente
		if( document.getElementById( "wnombrefamilia" ).value == "" || document.getElementById( "wnombrefamilia" ).value == " " )
		{
			jAlert("Debe ingresar el nombre del art�culo","ALERTA");
			document.getElementById( "wnombrefamilia" ).focus();
			return;
		}
		
		/*
		* Modificaci�n: alerta en caso de que el n�mero de prescripci�n de mipres sea obligatorio, es paciente de EPS, y contributivo, y medicamento no pos
		* Autor: sebastian.nevado
		* Fecha: 2021-10-04
		*/
		...
		{
			jAlert("Debe ingresar el N�mero de Prescripci�n Mipres","ALERTA");
		...
		///////// FIN VALIDACI�N DE LOS DATOS INGRESADOS /////////////////////
		//////////////////////////////////////////////////////////////////////
		...
		// 2012-12-14
		/*
		// Se comenta porque ya esta validaci�n se va a hacer en PHP por medio de AJAX
	...
	// 2013-01-14
	// Si es adici�n de medicamentos por protocolo
	else
	{

		/*
		// Ya no es necesario usarlas como array porque el ciclo se hace abajo cuando se agrega cada art�culo
			...
			if( $.trim( ajax.responseText ) != '' )
			{
				if($.trim( ajax.responseText ) != "No se encontraron coincidencias")
				{
					...
					for (var ipro=0;ipro<protocolos.length-1;ipro++)
					{
						...
						administracion[ipro] = protocolo[2];		// V�as de administraci�n
						condicion[ipro] = protocolo[3];				// Condiciones de suministro
						dosisMax[ipro] = protocolo[4];				// Dosis m�xima
						...
						fechaInicio = '';	// Fecha y hora de inicio de aplicaci�n
						diasTto = '';			// D�as de tratamiento
					}
					*/
				}
			}
	...
	// 2013-01-14
	// Si no es adici�n de medicamentos por protocolo
	if(porProtocolo!=1)
	{
		...
		//	    		seleccionarComponente("",reemplazarTodo(item," ","_"));
						...
						var grupoMedicamento = item[8];
						// 2012-08-02
						// Se cambia para que tome el valor seleccionado en la adici�n del medicamento y no el de la tabla de articulos
						...
						funcInternaLimpiarBuscador();
						jAlert("No se encuentran art�culos con tarifas", "ALERTA");
					}
				}
		...
		else
		{
			...
			//cambioFecha = false;	// Me indica si en la funci�n calcularFechaInicio ya se paso a las rondas del d�a siguiente
		...
		function funcInternaAgregar(ipro)
		{
			...
			if( ipro<protocolos.length-1 )
			{
				...
				if(protocolo[6]=='Medicamentos')
				{
					...
					administracion = protocolo[2];			// V�as de administraci�n
	...
	function funcInternaLimpiarBuscador()
	{
		...
		// ya que la nueva estructura no permite obtenerlo por posici�n en la tabla
...
function eleccionMedicamentoAlta()
{
	...
	var presentaciones = document.getElementById( "wpresentacionimp" );			// Presentaciones o formas farmac�uticas
	...
	var viasAdministracion = document.getElementById( "wadministracionimp" );		// V�as de administraci�n
	var fechaInicio = document.getElementById( "wfinicioaplicacionimp" ).value;	// Fecha y hora de inicio de aplicaci�n
	var condiciones = document.getElementById( "wcondicionsumimp" );				// Condiciones de suministro
	var diasTto = document.getElementById( "wdiastratamientoimp" ).value;			// D�as de tratamiento
	var dosisMax = document.getElementById( "wdosismaximaimp" ).value;				// Dosis m�xima
	...
	administracion = document.getElementById( "wadministracionimp" ).value;		// V�as de administraci�n
	...
	{
		alert("Debe ingresar el nombre del art�culo");
	...
	if(selPresentacion>-1)
	{
		...
		if(presentacionMed=="" || presentacionMed==" ")
		{
			alert("Debe seleccionar una presentaci�n");
	...
	if(selViaAdministracion>-1)
	{
		...
		if(viaAdministracion=="" || viaAdministracion==" ")
		{
			alert("Debe seleccionar una v�a de administraci�n");
 ...
 *
 * Se crea un objeto JSON para manejar los articulos. Este objeto solo contendr� el tipo de protocolo
 * e indice de cada insumo agregado. Esto se hace ya que los articulos se encuentran en el script
 * y toda su informaci�n se sabe de acuerdo a estos datos. A continuaci�n se explica el objeto JSON
 * que se crea:
 * Nivel 1: [INF] � [LEV] 				: Indica que tipo de articulo.
 * Nivel 2: [ tipPro+Indice ]	: Indica el el articulo generico lev o inf que contiene los insumos
 * Nivel 3: []							: Contiene toda la inforamci�n faltante de los insumos LEV o INF
 *
 * El detalle del nivel 3 es:
 * ins									: Insumo
 * ele									: Indica si es electrolito o no
 * vel									: Volumen del electrolito
 * vdi									: Volumen de diluci�n
 * vto									: Volumen total
...
function eleccionMedicamentosInsumos( strInsumos, indice, tipPro, tipo )
{
	...
	for (var ipro=0;ipro<filasInsumo.length-1;ipro++)
	{
		...
		administracion = administracionLQ;		// V�as de administraci�n
		condicion = condicionLQ;				// Condiciones de suministro
		if( $.trim( condicion ) == "" )
			condicion = ( tipo == "IC" ) ? $( "#condicionIC" ).val(): $( "#condicionLEV" ).val();					// Condiciones de suministro Siempre se deja est� condici�n por defecto
		dosis = arrInsumo[1];				// Dosis
		observaciones = observacionesLQ;			// Observaciones
		insumoDispensable = arrInsumo[2];
		presentacion = '';			// Presentaciones o formas farmac�uticas
		medida = '';						// Unidades de medida
		fechaInicio = fechaInicioLQ;	// Fecha y hora de inicio de aplicaci�n
		dosisMax = dosisMaxLQ;				// Dosis a aplicar
		diasTto = diasTtoLQ;			// D�as de tratamiento

		if( tipo == "IC" ){
			observaciones = $( "#txObservacionesIC", $( "#"+contLEV ) ).val();
			dosisMax = $( "#inDmaxIC", $( "#"+contLEV ) ).val();			// Dosis a aplicar
			diasTto  = $( "#inDttoIC", $( "#"+contLEV ) ).val();			// D�as de tratamiento
		}
		else{
			observaciones = $( "#txObservacionesLEV", $( "#"+contLEV ) ).val();
			dosisMax = $( "#inDmaxLEV", $( "#"+contLEV ) ).val();			// Dosis a aplicar
			diasTto  = $( "#inDttoLEV", $( "#"+contLEV ) ).val();			// D�as de tratamiento
		}

		/************************************************************************************************************
		 * Si el articulo tiene volumen por diluci�n significa que hay que recalcular la dosis
		 * La dosis es la requerida por d�a
		 ************************************************************************************************************/
		var sumDosis = 0;
		if( arrInsumo[3] != "" ){
		...
		artLevs[ "LQ"+parseInt(elementosLev*1+ipro*1) ] = {
			...
			insVto: arrInsumo[5] == 'ele' ? '': arrInsumo[1],		//Volumen total de la soluci�n
			insFdi: $( "#slFrecDilLev", $( "#"+contLEV ) ).val(),	//Frecuencia de dilucion
			insVfd: $( "#txFrecDilLev", $( "#"+contLEV ) ).val(),	//Valor de la frecuencia de diluci�n
			...
			sinSol:	( filasInsumo.length-1 == 1 && tipo == 'IC' ) ? 'on' : 'off'	//Sin soluci�n
		}
		/*************************************************************************************************/
...
// Variables globales que ayudar� a llevar la secci�n anterior desplegada
var filaIdAnt = "";
var divIdAnt = "";
var filaTituloIdAnt = "";
var claseFilaAnt = "";
...
// 2012-11-08
/*************************************************************************
* Funci�n que permite desplegar el detalle de la familia de medicamentos *
**************************************************************************/
function mostrarDetalleFlia( campo, filaId, divId, filaTituloId, claseFila )
{
	if (document.getElementById)
	{
		...
		if(el.style.display == 'none')
		{
			...
			// Esto para que cambie de color cuando el detalle de la familia est� desplegado
...
// 2012-11-16
/*************************************************************
* Funci�n que oculta el �ltimo detalle de familia desplegado *
**************************************************************/
...
function autocompletarParaBusqueMedicamentosPorFamilia(){
	...
	// Se hace el llamado AJAX para traer los resultados a la funci�n autocomplete
	...
	$("#wnombrefamilia").autocomplete("ordenes.inc.php?consultaAjaxKardex=31&wemp_pmla="+document.forms.forma.wemp_pmla.value+"&basedatos="+document.forms.forma.wbasedato.value+"&wcenmez="+document.getElementById('wcenmez').value+"&historia="+document.forms.forma.whistoria.value+"&ingreso="+document.forms.forma.wingreso.value, {
		...
		// Arrays de relaci�n con los articulos
		...
		for( var i = 0; i < item.length; i++ ){
			...
			// Si viene precedido de - es art�culo, comienza la asignaci�n de los arreglos de relaci�n y del arreglo arArticulos
			if( item[i].substr(0,1) == "-" ){
			...
			//al nombre generico o comercial seg�n corresponda
			if( item[i].substr(0,1) == "<" ){
		...
		// 2012-07-09
		// Se adiciona seleccione al select de presentaci�n de medicamentos
		...
		// Quedan definidos los arrays derelaci�n y de art�culos que tambi�n se usaran en otras funciones
		arRelacionesUnidad = arRelUnidad;
		...
		// Se asigna din�micamente las opciones a los selects wunidad, wpresentacion, wadministracion
		...
		//Si solo hay una presentaci�n para escoger ejecuto la funci�n
		if(arPresentaciones.length == 1){
...
/************************************************************************************************************************
 * Autocompletar para la busqueda de medicamentos por familias en la pesta�a Alta
 * @return
 ************************************************************************************************************************/
function autocompletarParaBusqueMedicamentosPorFamiliaAlta(){
	...
	$("#wnombrefamiliaimp").autocomplete("ordenes.inc.php?consultaAjaxKardex=31&wemp_pmla="+document.forms.forma.wemp_pmla.value+"&basedatos="+document.forms.forma.wbasedato.value+"&wcenmez="+document.getElementById('wcenmez').value+"&historia="+document.forms.forma.whistoria.value+"&ingreso="+document.forms.forma.wingreso.value, {
		...
		/////////////////////////////////////////////////////////////////////////////////////////
		// Se reestablece valores vacio para los campos que hayan sido llenados
		//document.getElementById( "regletaGrabacionimp" ).style.display = 'none';	//Oculto la regleta de grabaci�n si est� activa

		if(!esLiquidoEndovenoso)
		{
			document.getElementById( "wdosisfamiliaimp" ).disabled = false;			//Activo el campo de dosis si est� inactivo
			document.getElementById( "wdosisfamiliaimp" ).value = '';
		}
		else
		{
 ...
 * tipoConsulta: define si se va a filtrar con base en presentaci�n o con base en presntacion y unidad
 * @return
 ************************************************************************************************************************/
function filtrarMedicamentosPorCampo(tipoConsulta,posnombre){
	...
	// Si se ha seleccinado alguna presentaci�n
	if(document.getElementById('wpresentacion'+posnombre).selectedIndex!='-1')
	{
		...
		// definici�n de par�metros para el llamado AJAX
		...
		// Llamado AJAX para obtener los datos de b�squeda de medicamentos
		// Con los nuevos filtros de presentaci�n y/o unidad
		try{
			ajax=nuevoAjax();
		...
		for( var i = 0; i < item.length; i++ ){
			...
			if( item[i].substr(0,1) == "�" ){
				...
				{
					//Si es no pos, es contributivo, es un m�dico, y el paciente es de EPS, debe registrar Mipres
					if(valorPos != 'P' && numPrescripcionMipres && $( "#pacEPS" ).val() == 'on' && $( "#esMedico" ).val() == 'on' && $( "#esContributivo" ).val())
					{
						...
						jAlert("El medicamento \"" + item[0] + "\" es NO POS, debe llenar el MIPRES en la plataforma del Ministerio de Salud antes de grabar el medicamento. A continuaci�n, se abrir� una nueva ventana para realizar registro en MIPRES. Luego, usted deber� volver a esta ventana a continuar el registro.","ALERTA",function(){
		...
		if(document.getElementById('wdosisfamilia'))
		{
			...
			// Se comenta, la dosis siempre viene vac�a
		...
		*/
		...
		// Quedan definidos los arrays de relaci�n y de art�culos que tambi�n se usaran en otras funciones
...
function inicializarJquery(){
	...
	//Funci�n para cerrar la modal al preguntar por el diagn�stico para articulos de control
	$( "#btCerrarDx" ).click(function(){
		if( $("#inCopyCIE10" ).val() != '' ){
			$.unblockUI();
		}
		else{
			jAlert( "Debe ingresar un <b>diagn�stico</b>.", "ALERTA" );
		}
	}).attr({
		disabled: true,
	});
...
//    			debugger;
	...
	// 2012-07-03
	// Inicializa accordion para los ex�menes realizados
	$("#acExamenes").accordion({ collapsible: true });
...
/****************************************************************************************************************************************************************
 * Inicializa el autocompletar de jquery para procedimientos y ayudas diangosticos segun el filttro seleccionado, esta funci�n se llama cada vez que
...
// validarTipoOrdenAgrupada();
    ...
    if( document.getElementById('wnomproc')){
		...
		// 2012-06-27
		// Se comenta y se reemplaza por la siguiente l�nea debido a que estaba trayende 2 valores por cada selecci�n que se hacia
		// Cuando se desplegaba las opciones y se seleccionaba y daba 'Enter' en una, se agregaba �sta y la anterior a las ordenes
...
/*****************************************************************************************************************************
 * Confirma y redirecciona a la creaci�n del kardex
 ******************************************************************************************************************************/
...
// funcInternas es una funcion que se ejecuta una vez termine el llamado al funcion agregarExamen y es opcional. Esta funci�n no tiene parametros.
function seleccionarAyudaDiagnostica(centroCostos,codExamen,nombreExamen,tipoEstudio,anatomia,codigoCups,consecutivoOrden,nombreCentroCostos,esAyudaHospitalaria, requiereJustificacion, noPos, generaOrdenIndividual, aydJustificacion, funcInternas, datosAdicionales, esOfertado, realizaUnidad ){
	...
	//Indica si debe mostrar modal al m�dico para que indique si el estudio se realiza en la unidad del paciente o en laboratorio
	...
	// /**************************************************************************************************
	 // * Aqu� muestro la modal con los datos adicionales del examen
	 // **************************************************************************************************/
...
function cancelarOrden(centroCostos,consecutivoOrden){
	...
	jConfirm( "Esta seguro de cancelar la orden "+consecutivoOrden+"?", 'Cancelar orden', function(r) {
		 if(r){
			/****************************************************************************************************************
			 * Creo la acci�n para ejecutarla al momento de guardar
			 ****************************************************************************************************************/
...
function confirmarGeneracion(){
	...
	if(historia && ingreso){
		...
		alert("No se encontr� historia, ingreso y fecha en los parametros de entrada.");
	}
}
/******************************************************************************************************************************
...
/*****************************************************************************************************************************
 * Este metodo encapsula la creaci�n din�mica de cada campo, segun las acciones asociadas y su tipo.
 *
...
function consultarKardex(){
	...
	if(!nroDocumento || nroDocumento == ''){
		alert("Debe especificar un n�mero de documento de paciente v�lido.");
		return;
	}
...
//			alert( "Se grabar� y cerrar� la orden, tenga en cuenta que este NO HA SIDO confirmada." );
		}
 ...
 ******************************************************************************************************************************/
 /*****************************************************************************************************************************
 * Invocaci�n generica del calendario para fecha inicial de suministro
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Invocaci�n generica del calendario para fecha final de suministro
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Invocacion generica del calendario para la fecha de realizaci�n examen
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Seleccion de un componente para adicionarse a la infusi�n
 ******************************************************************************************************************************/
function seleccionReemplazo(valor){
	if(valor != null){
		...
		alert("No se captur� identificador de medicamento a modificar");
	}
}
/*****************************************************************************************************************************
				...
				if(elemento.tagName != 'DIV'){
					...
					if(grupo == 'CTR'){
						...
						if($("#medicamentosControlAuto").val() == 'on'){
							alert("Este medicamento se encuentra en el grupo de control.  La f�rmula de control se generar� automaticamente al grabar.");
						}else{
					...
					// Se establece si la cadena msjNoPos ya tiene el codigo del art�culo actual
...
/*****************************************************************************************************************************
 *Punto de entrada de la generaci�n del kardex
 ******************************************************************************************************************************/
function enter() {
	var historia = document.forms.forma.whistoria.value;
	var valido = true;
...
/*****************************************************************************************************************************
 *Invoca acci�n de grabaci�n del kardex, del encabezado y paso de las temporales a las tablas definitivas.
 ******************************************************************************************************************************/
function grabarKardex(wimprimir){
		...
		if(cantNPTAgregadas>0)
		{
			//Suspender las nutriciones pendientes en cada pesta�a
		...
		// if( $( "#enUrgencias" ).val() != 'on' ){
			...
			// $( "[id^=wpendiente]" ).filter("[value=on]").each(function(){
				// if( $( "#esEnfermera" ).val() == 'on' ){
					...
					// //El medicamento por tanto debe comenzar m�nimo 30 minutos despues del tiempo actual
	    ...
	    for( x in arCTCArticulos ){
		   ...
		   if( buscarCambiosCTC( x ) ){
			   //Se deja quemado los ultimos dos campo, ya que con los �ltimos cambios no se requieren
		...
		if(valido){
			...
			/****************************************************************************************************
			 * Valido que no se pueda grabar el kardex con velocidad de diluci�n vaci�
			 ***************************************************************************************************/
			...
			//El encabezado del kardex se encuentra dividido en las pesta�as
...
//			var arrProtocolos = new Array("%","N","A","U","Q","2","4");
			...
			if( $( "#pacEPS" ).val() == 'on' && !$("#esContributivo").val()){
				...
				if( $.trim( artsGrabadosCTC ) != '' ){
					//Se graban los datos que no han sido le�dos c�mo leidos
					$.ajax({
						url: "ordenes.inc.php",
						type: "POST",
						data:{
			...
			*********************************************************************************************************************/
				...
				var mipresEnListaMedicamentosOrdenes = $("#mipresEnListaMedicamentosOrdenes").val(); //Valor del par�metro.
				//Si es enfermera, muestra el popup, si es m�dico, solo procede como si cerraran el popup
...
//		grabarEsquemaDextrometer();
		...
		// Llamo a la ventana de impresi�n de la orden
		if(wimprimir=='imp' || wimprimir=='impexa'|| wimprimir=='imppro' || wimprimir=='cenimp' || wimprimir=='cenimpexa' || wimprimir=='cenimppro')
		{
			...
			{
				alert("Debe firmar digitalmente para poder realizar la impresi�n de a orden");
			}
		}
		else
		{
...
/*****************************************************************************************************************************
 * Tipo de cambio en la pesta�a y seccion
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Crea din�micamente una fila en el detalle de medicamentos
 *
 * Dependiendo del tipo de protocolo se agregar� a una lista u otra, los protocolos actuales son:
 *
...
//	idFilaNueva = 'tr'+ tipoProtocoloAux + posicionActual;
	...
	if(!elementoAnteriorDetalle || elementoAnteriorDetalle.value != '' || posicionActual == 0){
		...
		var columna5 = document.createElement("td");		//Condici�n de suministro
		...
		if(document.getElementById('mipresEnListaMedicamentosOrdenes').value == '1' || document.getElementById('mipresEnListaMedicamentosOrdenes').value == '2')
		{
			var colNumMipres = document.createElement("td");		//N�mero de prescripci�n MIPRES
		}
...
//		cntDetalleKardex.appendChild(fila);
		...
		//alert("Debe ingresar la informaci�n del articulo actual antes de adicionar uno nuevo");
	}
}
/*****************************************************************************************************************************
 * Crea din�micamente una fila nueva para agregar una infusi�n
 ******************************************************************************************************************************/
function agregarInfusion(){
	...
	var columna3 = document.createElement("td");		//Componentes de la infusi�n
	var columna4 = document.createElement("td");		//Observaciones infusi�n
...
/*****************************************************************************************************************************
 * Agrega din�micamente una nueva fila para un examen de laboratorio nuevo
 ******************************************************************************************************************************/
...
//	iHTMLOrden += "</div></td></tr>";
	...
	if(puedeAgregar){
		...
		/*******************************************************************************************
		 * verificando si hay un examen igual para el mismo d�a
		 *******************************************************************************************/
		...
		if( permitir_registro == true){
			...
			// if( !confirm( "El examen "+nombExamen+" ya existe para el mismo d�a. �Desea agregarlo?" ) ){
			...
			jConfirm( "El examen "+nombExamen+" ya existe para el mismo d�a. �Desea agregarlo?", "Alerta", function( resp ){
				if( resp ){
		...
		alert('Por favor ingrese la informaci�n del examen antes de agregar uno nuevo.');
	...
	function mostrarModalAdicionesExamen(){
		...
		/**
		 * Se le pregunta al m�dico si el estudio se realiza en la unidad en que se encuentra al paciente o no
		 */
		function funcInternaAgregarExamen(){
			...
			// if( realizaUnidad ){
				...
				// jConfirm( "El estudio <b>" + reemplazarTodo(nombreExamen,"_"," ") + "</b> se realizar� en el centro de costos <b>" + $( "#nombreServicioActual" ).val() + "</b>?", "ALERTA", function( resp ){
					// if( resp ){
						// esOfertado = false;
		...
		//	columna1.align = "center";
			...
			********************************************************************************/
			...
			if( !crearOrden ){
				...
				// Muestra el numero de orden si se ocult� al agregar procedimientos agrupados
...
//	iHTMLOrden += "</div></td></tr>";
	...
	if(puedeAgregar){
		...
		if( permitir_registro == true){
			...
			if( !confirm( "El examen ya existe para el mismo d�a. �Desea agregarlo?" ) )
				return false;
...
function consultarOrdenesPendientes(wemp_pmla,wempresa,wbasedato,whis,wing)
{
	...
	//var parametros = "consultaAjaxKardex=33&wemp_pmla="+wemp_pmla+"&wempresa="+wempresa+"&wbasedato="+wbasedato					+"&whis="+whis+"&wing="+wing+"&wfecini="+document.forms.forma.wfecini.value+"&wfecfin="+document.forms.forma.wfecfin.value+"&wtiposerv="+document.forms.forma.wtiposerv.value+"&wprocedimiento="+document.forms.forma.wprocedimiento.value+"&westadodet="+westadodet;
		...
		var totalExamenes = tabla.rows.length - 3;	// se resta 3 porque se omiten las filas de busqueda r�pida y encabezado
		var countRowSpan = 1;
...
function adicionarMedico(){
	if(document.forms.forma.wselmed && document.forms.forma.wselmed.value != ''){
		...
		alert("Debe seleccionar un m�dico para poder agregarlo.");
	}
}
/*****************************************************************************************************************************
 * Validaci�n de la grabaci�n de una nueva dieta
 ******************************************************************************************************************************/
function adicionarDieta(){
 ...
 /*****************************************************************************************************************************
 * Validaci�n de la eliminaci�n de una dieta
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Valida la grabaci�n de una infusi�n
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Validaci�n antes de quitar un articulo de la lista de medicamentos
 ******************************************************************************************************************************/
...
//	debugger;
	...
	if(codigoArticulo == ''){
		...
		{
			var msg = "Si sale del CTC el medicamento no ser� tenido en cuenta";
		}
...
/*****************************************************************************************************************************
 * Validaci�n antes de quitar una infusi�n
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Validaci�n antes de quitar un examen de laboratorio
 ******************************************************************************************************************************/
...
//	var codigoExamen = document.getElementById('wexamenlab'+idxElemento).value;
	...
	if( !ctc ){
		...
		if(hce != 'on'){
			...
			var msg = "Si no llena el CTC el examen no ser� tenido en cuenta para la orden. �Seguro desea cerrar?";

		}
	}

	//Si el cierre es desde hce no mostrara el mensaje de confirmacion: "Si no llena el CTC el examen no ser� tenido en cuenta para la orden. �Seguro desea cerrar?"
...
/*****************************************************************************************************************************
 * Define que valor toma el campo a grabar seg�n el campo que se haya modificado
 *****************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Debido que para la pesta�a de alta se usaron campos que estan en otras pesta�as
 * Se crea esta funci�n que determina cual cambi� y graba seg�n este cambio
 * Si cambian los dos prevalece el valor del campo de la pesta�a original, no la de alta
 *****************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Debido que para la pesta�a de alta se usaron campos que estan en otras pesta�as
 * Se crea esta funci�n que determina cual cambio y graba seg�n este cambio
 * Si cambian los dos prevalece el valor del campo de la pesta�a original, no la de alta
 *****************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Validaci�n de la grabaci�n de un medicamento
 *****************************************************************************************************************************/
...
//		valido = false;
	...
	if(deAlta!='on')
	{
		if(valido && (!via || via.value == '')){
			alert('Debe seleccionar la v�a de administraci�n: '+ datosArticulos);
			valido = false;
		}
	}
	...
	// 2013-02-06
	// Esta validaci�n sal�a al grabar a�n estando las fechas bien en el formulario
	// Se comenta porque mas abajo se hace la validaci�n correcta de estos datos
	/*
	if(valido && (!esFechaMayorIgual(fechaInicio,fechaKardex))){
		alert('La fecha de inicio de administraci�n del art�culo debe ser mayor o igual a la fecha actual: '+ datosArticulos);
		valido = false;
	}
	*/


	/*Si la hora actual de validaci�n est� entre las cero horas y las cuatro horas, todas las horas son permitidas
	 * Quiere decir esto que desde las seis de la ma�ana empiezan a haber restricciones de horario
	 */
...
//				valido = false;
	...
	//Si tiene permisos para dosis m�xima
	var perDmax = $( "#waccN\\.13" ).val().split( "," )[0] == 'S' ? true: false;
	...
	if( !articulosGrabadoAnteriormente && valido && $( "#wesantibiotico"+tipoProtocolo+idxElemento ).val() == "on" ){
		if( !$( "#wprofilaxis"+tipoProtocolo+idxElemento )[0].checked && !$( "#wtratamiento"+tipoProtocolo+idxElemento )[0].checked ){
			/*if( $( "#wdiastto"+tipoProtocolo+idxElemento ).val()*1 == 0  && $( "#wdosmax"+tipoProtocolo+idxElemento ).val()*1 == 0 )
				jAlert( "Debe seleccionar si el antibiotico es por <b>PROFILAXIS</b> o <b>TRATAMIENTO</b> y <br>Debe ingresar un valor mayor a 0 en d&iacute;as de tratamiento o dosis m&aacute;xima<br>para el antibi�tico <b>"+codigoArticulo+"-"+nombreArticulo+"</b>", "ALERTA" );
			else
				jAlert( "Debe seleccionar si el antibiotico es por <b>PROFILAXIS</b> o <b>TRATAMIENTO</b> para el antibi�tico <b>"+codigoArticulo+"-"+nombreArticulo+"</b>", "ALERTA" );*/
				
			
			
			var msg = "Debe seleccionar si el antibiotico es por <b>PROFILAXIS</b> o <b>TRATAMIENTO</b> ";
			if( $( "#wdiastto"+tipoProtocolo+idxElemento ).val()*1 == 0  && $( "#wdosmax"+tipoProtocolo+idxElemento ).val()*1 == 0 ){
				//Si permite dosis m�xima
				if( perDmax )
			...
			msg += "para el antibi�tico <b>"+codigoArticulo+"-"+nombreArticulo+"</b>";
 ...
 /*****************************************************************************************************************************
  * Validaci�n de la grabaci�n de un medicamento para evitar validacion del dia actual contra inicio del tratamiento
  ******************************************************************************************************************************/
...
//		valido = false;
 ...
 /*****************************************************************************************************************************
  * Validaci�n de la grabaci�n de un medicamento unicamente para uso del perfil
  ******************************************************************************************************************************/
 function grabarArticuloPerfil(idxElemento){
 	...
 	******/
 	...
 	if(!codigoArticulo || codigoArticulo == ''){
 		alert('No se captur� el codigo del articulo actual');
 		valido = false;
 	}

 	//Si se va a reemplazar el articulo se debe avisar
	if(valido && (codigoArticuloNuevo && codigoArticuloNuevo != '')){
		if(confirm('Esta seguro de reemplazar el art�culo ' + codigoArticulo+'-'+cd[2]+ ' con ' + document.getElementById('wnmmed'+idxElemento).value + '?')){
			...
			while(elemento){
				...
				if(elemento && elemento.innerHTML != ''){
					...
					if(temp[0] == codigoArticuloNuevo){
						alert("No se puede reemplazar el articulo " + cd[2] + " por el articulo " + cdNuevo[2] + " este ya se encuentra en la lista de art�culos.");
						valido = false;
						break;
					}
					*/
...
/*****************************************************************************************************************************
 * Validaci�n para realizar la grabaci�n de un examen
 ******************************************************************************************************************************/
function grabarExamen(idxElemento, grbAut ){
	...
	if(altExamen!="on")
	{
		if(isset(document.getElementById('hexcco'+idxElemento)) && document.getElementById('hexcco'+idxElemento))
		{
			...
			// Permite unificar el valor de los campos de la pesta�a Alta y la pesta�a Otras Ordenes
			...
			try{
				//Busco si el examen est� chequeado o no
		...
		//	var vecIdExamen = document.getElementById('wexamenlab'+idxElemento).value.split("|");
			...
			*/
			...
			if( (justificacion == "" || justificacion == " " || justificacion == "." ) && reqJus == "on" ){
				alert( "Especificar una justificaci�n para la ayuda o procedimiento: "+nomExamen );
				valido = false;
			}
		}
		else
 ...
 ******************************************************************************************************************************/
/*****************************************************************************************************************************
 * Llamada ajax para inserci�n del esquema dextrometer
 ******************************************************************************************************************************/
	...
	try{
		...
		ajax.onreadystatechange=function()
		{
			if (ajax.readyState==4 && ajax.status==200)
			{
				...
				//Las filas que contienen la informaci�n son las filas con posici�n 3 o m�s
				if( auxtb.rows.length > 3 ){
					//Se a�ade las filas con posicion 3 o m�s a la tabla
...
/*****************************************************************************************************************************
 * Llamada ajax para inserci�n del medico tratante
 ******************************************************************************************************************************/
...
//							alert( contenedor.innerHTML );
 ...
 /*****************************************************************************************************************************
 * Llamada de inserci�n de dieta nueva en el kardex
 ******************************************************************************************************************************/
function insertarDietaKardex(idRegistro, historia, ingreso, fechaKardex, usuario){
 ...
 /*****************************************************************************************************************************
 * Llamada ajax para la grabaci�n de una nueva infusi�n
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Llamada ajax para la inserci�n o modificaci�n de un articulo
 ******************************************************************************************************************************/
...
//		$.unblockUI();
		...
		switch(respuesta[0]){
			...
			case '1':
				 ...
				 * de confirmaci�n, se cambia su estado a off
				 ******************************************************************/
				if( articuloNewMod ){
				...
				$( "#wmodificado"+tipoProtocolo+idElemento ).val( "N" );	//Se deja marcado c�mo no modificado
...
//				$.growlUI('',mensaje);
			...
			case '4':
				articuloNewMod = true;
				mensaje = "El articulo se modific� correctamente, tenga en cuenta que ya estaba dispensado completamente.";
 ...
 /*****************************************************************************************************************************
  * Llamada ajax para la modificaci�n de un articulo en el perfil farmacologico
  ******************************************************************************************************************************/
 	...
 	try{
 		...
 		ajax.onreadystatechange=function()
 		{
 			if (ajax.readyState==4 && ajax.status==200)
 			{
 				...
 				switch(respuesta[0]){
 					case '0':
 						mensaje = "No se pudo modificar el art�culo.";
 						break;
 					case '1':
						...
						elemento.value = "";
						mensaje = "El art�culo se ha reemplazado correctamente.";
 						break;
 					case '2':
 						...
 						mensaje = "El art�culo se ha modificado correctamente.";
 						break;
 					case '3':
 						mensaje = "El art�culo no se puede modificar si se encuentra suspendido.";
 						break;
 					default:
 						mensaje = "No especificado: "+$.trim( ajax.responseText );
 						break;
...
function suspenderArticulo(idxElemento,tipoProtocolo,confirmar){
	...
	if( confirmar ){
		...
		//if(confirm("�Desea "+accion+" la administraci�n del medicamento?")){
		 jConfirm( "�Desea "+accion+" la administraci�n del medicamento?", accion+' medicamento', function(r) {
			 if(r){
				//Alterno la suspension del medicamento
				if(fila.className == 'suspendido'){
					estaSuspendido = 'off';
...
// function suspenderArticulo(idxElemento,tipoProtocolo){
	...
	// //Confirmacion de suspension
	// if(confirm("�Desea cambiar la suspensi�n/activaci�n de la administraci�n del medicamento?")){
...
// }
/*****************************************************************************************************************************
 * Llamada a ajax para realizar la grabaci�n de un examen nuevo
 ******************************************************************************************************************************/
function grabarExamenElemento(codExamen,nomExamen,historia,ingreso,fecha,observaciones,estadoExamen,fechaDeSolicitado,usuario,consecutivoOrden,firma,observacionesOrden,cod_procedi,justificacion,idElemento, nroItem,impExamen,firmHCE,altExamen,grbAut,datosAdicionales,datoOrdenAnexa,esOfertado,usuarioTomaMuestra,realizarEnServicio,horaDeSolicitado){
	...
	try{
		...
		if( grabado ){
			...
			//Si es agragado desde la pesta�a de examenes
			if( fila.id.substr(0,7) != 'trExImp' ){
				...
				//Si es agregado desde la pesta�a alta
			...
			if( grbAut ){	//Es verdadero si se llama desde los botones de impresi�n o grabar
...
/*****************************************************************************************************************************
 * Llamada a ajax para realizar la grabaci�n la aprobaci�n del regente
 ******************************************************************************************************************************/
 	...
 	try{
 		...
 		ajax.onreadystatechange=function()
 		{
 			if (ajax.readyState==4 && ajax.status==200)
 			{
 				switch($.trim( ajax.responseText )){
 					case '0':
 						mensaje = "No se pudo grabar la aprobaci�n del regente";
 						break;
 					case '1':
 						if(document.getElementById('wchkapr').checked){
 							mensaje = "El perfil se aprob� por el regente.";
 						} else {
 							mensaje = "El perfil NO se aprob� por el regente.";
 						}
						break;
	 				default:
	 					mensaje = "No especificado: "+$.trim( ajax.responseText );
...
function quitarAlergia(fecha){
 ...
 /*****************************************************************************************************************************
 * Llamado a ajax para la eliminaci�n de un medico tratante
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Llamado a ajax para la eliminaci�n de una alergia
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Llamado ajax para funci�n de eliminaci�n de dieta
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Llamada ajax para eliminaci�n del articulo
 ******************************************************************************************************************************/
...
/*****************************************************************************************************************************
 * Llamada ajax para eliminaci�n de una infusi�n
 ******************************************************************************************************************************/
...
function seleccionarArticulo(codigo, nombreComercial, nombreGenerico, origen, grupo, forma, unidad, pos, unidadFraccion, cantFracciones,
	...
	$.alerts.okButton = "S�";		//Dejo por defecto el valor s� para el boton de aceptar
...
//			idx = elementosDetalle-1;
	...
	//Mayo 20 de 2016
	//Si el m�dico seteo dosis m�xima o un d�a de tratamiento
	//los campos de dosis m�xima preconfigurados y d�as de tratamientos se dejan vac�os
	...
	var cntDetalleKardex = document.getElementById("detKardexAddN");	//Al agregar un medicamento nuevo siempre est� en este contenedor
	...
	if(posicionActual > 0){
		...
		if(elemento){
			...
			/************************************************************************************************************************************
			 * Si el articulo es generico (DA0000, DD0000, DC0000, ... ) se busca en la lista de articulos y si est� con la misma fecha y
			...
			if( codigo.toUpperCase() == "DA0000" ){
				...
				while( cambioArticulo ){
					...
					//Se busca todos los articulos con el mismo c�digo
			...
			if(existe && !horarioEspecial){
				...
				if( artLevs[ tipoProtocoloAux+idx ] ){
					...
					if( artLevs[ tipoProtocoloAux+idx ].insInf != 'on' ){	//Si es un LEV
						 ...
						 *	1. Es un electrolito
						 *	2. Si solo se ha elegido soluci�n y ning�n electrolito para el lev
						 ********************************************************************************/
						...
						//Si es una soluci�n pregunto solo si desea agregar solo si no hay un electrolito para el lev
						if( !esLevInsPregunta ){
					...
					else if( artLevs[ tipoProtocoloAux+idx ].insInf == 'on' && artLevs[ tipoProtocoloAux+idx ].insEle == 'on' ){	//Si es una infusi�n
			...
			$.when( objDfr.promise() ).then(function(x){
				...
				$.when( objDfr.promise() ).then(function(x){
					...
					if( exist_fam_atc ){
						...
						jConfirm( "El paciente ya tiene ordenado al menos un medicamento del mismo grupo terape�tico <b>("+txtFamsATC+")</b><br>"+txtArtsFamsATC+"Desea agregar el medicamento?","ALERTA DUPLICIDAD TERAPEUTICA",function(x){
							if(!x){
								var trEliminar = document.getElementById("trFil"+idx);
								cntDetalleKardex.removeChild(trEliminar);
					...
					$.when( objDfr.promise() ).then(function(x){
						...
						if(x)
						{
							/*Modificaci�n: Se agrega para validar par�metro de tarifas
							Autor: sebastian.nevado
							Fecha: 04/08/2021
							*/
						...
						$.when( objDfr.promise() ).then(function(x){
							...
							if(!adicionar){
								...
								if((document.getElementById('mipresEnListaMedicamentosOrdenes').value == '1' || document.getElementById('mipresEnListaMedicamentosOrdenes').value == '2') && document.getElementById('wnumprescripcionmipres')){
									informacion += "<br><br><b>N�mero prescipci�n Mipres:</b> " + numPresMipres;
								}
								...
								if(elemento.tagName != 'DIV'){
									...
									if(grupo == 'CTR'){
										//Verifica si se genera la formula de control de forma automatica.
										if($("#medicamentosControlAuto").val() == 'on'){
											jAlert("Este medicamento se encuentra en el grupo de control.  La f�rmula de control se generar� automaticamente al grabar.","ALERTA",function(){
									...
									if( esAntibiotico ){
										...
										//No permito que la dosis m�xima sea superior a la 24/frecuencia
										$( "#wdosmax"+tipoProtocoloAux+idx ).change(function(){
											if( $( "#wprofilaxis"+tipoProtocoloAux+idx )[0].checked ){
												...
												if( $( this ).val() > dmaxSup ){
													jAlert( "La dosis m�xima no debe ser superior a "+dmaxSup, "ALERTA" );
													$( this ).val( dmaxSup );
												}
											}
										});
				...
				//					debugger;
									...
									if( esAntibiotico ){
										...
										//Asigno funci�n al boton cerrar
										btnCerrar.click(function(){
											// $.unblockUI();
											// setTimeout( function(){ fnInternaCTC() }, 500 );
											jConfirm( "Est� seguro que desea eliminar el art�culo","ALERTA",function(x){
												if(x){
												$.unblockUI();
										...
										//Asigno funci�n al boton Grabar
											...
											if( $( "#dvModalFiltroAntibiotico [name=ckFiltroAntibiotico]:checked" ).length > 0 ){
												if( inFiltroDtto.val()*1 > 0 || inFiltroDmax.val()*1 > 0  ){
													...
													if( inFiltroDtto.val()*1 <= 0 && inFiltroDmax.val()*1 <= 0 && perDmax )
														...
														//Muestra el mensaje solo si tiene permiso para dosis m�xima
												...
												filtroMsg = "Debe seleccionar si el antibi�tico es por <b>PROFILAXIS</b> o <b>TRATAMIENTO</b>";
											}
										...
										//Si tiene permisos para dosis m�xima, permito escribir las dosis m�xima
										if( !perDmax ){
											inFiltroDmax.attr({
												disabled:true,
												readOnly:true,
										...
										//No permito que la dosis m�xima sea superior a la 24/frecuencia
										//Asigno el evento change al filtro de Dosis m�xima
										...
										//No permito que la dosis m�xima sea superior a la 24/frecuencia
										//Asigno el evento change al filtro de D�as de tratamiento
											...
											if(avisoNoPos == -1 && pos == 'N'){
												...
												if( $( "#esMedico" ).val() == 'on' ){
													...
													if(validar_entidad != -1){
														...
														//Solo motrar� mensaje si el par�metro est� apagado.
								...
								$.alerts.okButton = "Aceptar";		//Dejo por defecto el valor s� para el boton de aceptar
...
function verificarVelocidadInfusion(){
	...
	var habilitar = true;
	//Si no hay nada seleccionado en dosis calculada se puede seleccionar velocidad de infusi�n
	$( "[id^=inICDca]", $( "#listaComponentesIC" ) ).each(function(x){
...
function adicionarComponenteArticuloIC(codigo,nombre,i,esDispensable,cantidadFracciones,cmp,ele){
	...
	if(document.getElementById('check_insumo'+i).checked)
	{
		...
		var tipMed = voldil.length > 0 ? 'ele': 'sol' ;	//Indico si es soluci�no electrolito
	...
	else
	{
		...
		//Esto solo aplica para la Infusi�n contiuna
	...
	try{
		...
		ajax.onreadystatechange=function()
		{
			if (ajax.readyState==4 && ajax.status==200){
				if($.trim( ajax.responseText ) == "1"){
					$.unblockUI();
					$.growlUI('','Aprobaci�n/desaprobaci�n realizada exitosamente');
				}
			}
		}
		if ( !estaEnProceso(ajax) ) {
	...
	try{
		$( cmp ).change(function(){
			...
			if( $( "[id^=wesantibiotico]", fila ).val() != 'on' || $( "[name^=wfiltroantibiotico]:checked", fila ).length == 0 ){
				...
				var cnd = $( "[id^=wcondicion]", fila ); //Condici�n
...
/**
 * Funci�n para b�squeda de prescripci�n de mipres por n�mero, v�a webservice
 * @by: sebastian.nevado
 * @date: 2021/10/08
 */
 ...
 */
 function validarExistenciaNumeroMipres(nroPrescripcionMipres)
 {
	 ...
	 $.ajax({
		 ...
		 success:function(respuesta) {
			 ...
			 //Si el tama�o es menor a 1 es porque no encontr� resultado
			 ...
			 {
				 aRespuesta['exito'] = false;
				 aRespuesta['mensaje'] = 'El n�mero de prescripci�n Mipres ingresado no existe.';
			 }
			 else
			 {
				 aRespuesta['exito'] = true;
				 aRespuesta['mensaje'] = 'El n�mero de prescripci�n Mipres ingresado existe.';
			 }
			 //$.unblockUI();
		 }
	 });
 ...
 /**
 * Funci�n para b�squeda de prescripci�n de mipres por n�mero en medicamentos del d�a
 * @by: sebastian.nevado
 * @date: 2021/10/08
 */
function validarNumeroMipresUsado(nroPrescripcionMipres)
{
	...
	$.ajax({
		...
		success:function(respuesta) {
			...
			{
				aRespuesta['exito'] = false;
				aRespuesta['mensaje'] = 'El n�mero de prescripci�n Mipres fue ingresado para otro medicamento..';
			}
			else
			{
				aRespuesta['exito'] = true;
				aRespuesta['mensaje'] = 'El n�mero de prescripci�n Mipres ingresado no ha sido registrado.';
			}
			//$.unblockUI();
		}
	});
