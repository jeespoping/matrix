...
/***********************************************************************************************************
 * Programa		:	Administración de empresas hce
 * Fecha		:	2013-06-14
 ...
 ***********************************************************************************************************
 ...
 Actualizaciones:
 2016-06-17:  Arleyda Insignares C. Se Adiciona en tabla 'Entidades' opción para adicionar Nit a la 
...
//************cuando la pagina este lista...**********//
   ...
   function BuscarEntidad(objvalor){
   	    if (objvalor!='')
   	    {
   	    	// Buscar si el código ya existe en la tabla de Entidades
   	    	var vencontro= 0;
...
//FIN*LLAMADOS*AJAX******************************************************************
	...
	function vistaInicial(){
		...
		encabezado("ADMINISTRACIÓN DE EMPRESAS HCE", $wactualiz, "clinica");
