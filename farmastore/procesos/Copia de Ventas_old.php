...
//FECHA ULTIMA ACTUALIZACION :
  $wactualiz="(Versión Abril 28 de 2005)"; 
//DESCRIPCION
//==================================================================================================================================
...
{	            
  ...
  if (isset($wdirpac)) //Si ya fue digitado el nombre del cliente    
     echo "<td align=left bgcolor=".$wcf." colspan=".($wcol-8)."><b><font text color=".$wclfg."> Dirección: </font></b><INPUT TYPE='text' NAME='wdirpac' VALUE='".$wdirpac."'></td>";       //wdirpac
    else 
       echo "<td align=left bgcolor=".$wcf." colspan=".($wcol-8)."><b><font text color=".$wclfg."> Dirección: </font></b><INPUT TYPE='text' NAME='wdirpac' VALUE='SIN DATO'></td>";         //wdirpac
