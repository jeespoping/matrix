...
//RUTA DEL SCRIPT: matrix\FARMASTORE\Reportes\RepCartera.php
...
if($user == ''){
	...
	$wbasedato='farstore';
  	...
  	$wnomprog="RepCartera.php";  //nombre del reporte
  	...
  	echo "<form action='RepCartera.php' method=post name='forma'>";
  ...
  if (!isset($wfecini) or !isset($wfecfin) or !isset($wfuecod) or !isset($bandera))
  	{
    	...
    	echo "</table>";
  		...
  		echo "<A href='RepCartera.php?wfecini=".$wfecini."&wfecfin=".$wfecfin."&wfuecod=".$vecFue[0]."'><center>VOLVER</center></A><br>";
