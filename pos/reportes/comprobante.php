...
else
{
	...
	echo "<tr><td align=center colspan='2' bgcolor=".$AzulClar."><font size=3 text color=#FFFFFF><b>$wnomcco</b></font></td></tr>";
	...
	if (!isset($fecha))
	{
		...
		echo "<tr><td align=left bgcolor=".$AzulClar."><font size=3 color='#FFFFFF'><b>FECHA </b></font></td>";
		echo "<td align=center  bgcolor=".$AzulClar."><input type='text' name='fecha' size='9'></font></td></table>";
		...
		******************************************************************************************/
		...
		echo "<table border='1'>";
		echo "<tr><td  align='center' colspan='4' bgcolor='".$AzulClar."'><font size='3' color='$blanco'><b>MOVIMIENTO DE VENTAS</b></td></tr>";
		echo "<tr><td  bgcolor='".$AguaOsc."'><b>NUMERACIÓN DE DOCUMENTOS</td>";
		echo "<td bgcolor='".$AguaOsc."'><b>INICIAL</b></td>";
		echo "<td bgcolor='".$AguaOsc."'><b>FINAL</b></td>";
		echo "<td bgcolor='".$AguaOsc."'><b>TOTAL</b></td></tr>";

		echo "<tr><td>Factura Automática</td>";
		echo "<td>".$vent["fact"]["ini"]."</td>";
		echo "<td>".$vent["fact"]["fin"]."</td>";
		echo "<td>".$vent["fact"]["num"]."</td></tr>";


		echo "<tr><td>Factura Manual</td>";
		echo "<td>".$vent["facM"]["ini"]."</td>";
		echo "<td>".$vent["facM"]["fin"]."</td>";
		echo "<td>".$vent["facM"]["num"]."</td></tr>";


		echo "<tr><td>Recibo</td>";
		echo "<td>".$vent["rec"]["ini"]."</td>";
		echo "<td>".$vent["rec"]["fin"]."</td>";
		echo "<td>".$vent["rec"]["num"]."</td></tr>";


		echo "<tr><td>Nota Crédito</td>";
		echo "<td>".$vent["nc"]["ini"]."</td>";
		echo "<td>".$vent["nc"]["fin"]."</td>";
		echo "<td>".$vent["nc"]["num"]."</td></tr>";

		echo "<tr><td>Devolución</td>";
		echo "<td>".$vent["dev"]["ini"]."</td>";
		echo "<td>".$vent["dev"]["fin"]."</td>";
		echo "<td>".$vent["dev"]["num"]."</td></tr>";

		echo "<tr><td>Anulación</td>";
		...
		echo "<tr><td bgcolor='".$AguaOsc."'><font size='3'><b>RESUMEN DE VENTAS</b></td>";
		echo "<td bgcolor='".$AguaOsc."'><b>VENTA</b></td>";
		echo "<td bgcolor='".$AguaOsc."'><b>IVA</b></td>";
		echo "<td bgcolor='".$AguaOsc."'><b>TOTAL</b></td></tr>";
		...
		if ($numPiv > 0) {
			...
			echo "<td bgcolor='".$AmarClar."'><b>$".number_format($sub['ven'],2,".",",")."</b></td>";
			echo "<td bgcolor='".$AmarClar."'><b>$".number_format($sub['piv'],2,".",",")."</b></td>";
			echo "<td bgcolor='".$AmarClar."'><b>$".number_format($sub['tot'],2,".",",")."</b></td></tr>";
		}
		...
		echo "<tr><td  bgcolor='".$AmarClar."'><b>TOTAL VENTAS</td>";
		echo "<td bgcolor='".$AmarClar."'><b>$".number_format($sub['ven']-$ncsub['ven'],2,".",",")."</b></td>";
		echo "<td bgcolor='".$AmarClar."'><b>$".number_format($sub['piv']-$ncsub['piv'],2,".",",")."</b></td>";
		echo "<td bgcolor='".$AmarClar."'><b>$".number_format($sub['tot']-$ncsub['tot'],2,".",",")."</b></td></tr>";

		echo "<tr><td  align='center' colspan='4' bgcolor='".$AzulClar."'><font size='3' color='$blanco'><b>MOVIMIENTO DE ANTICIPOS</b></td></tr>";

		echo "<tr><td colspan='3'>Coopagos</td>";
		echo "<td>$".number_format($copag,2,".",",")."</td>";

		echo "<tr><td colspan='3'>Cuotas moderadoras</td>";
		echo "<td>$".number_format($cumod,2,".",",")."</td>";//2007-03-05

		echo "<tr><td colspan='3'  bgcolor='".$AmarClar."'><b>TOTAL ANTICIPOS</b></td>";
		echo "<td bgcolor='".$AmarClar."'>$".number_format($totant,2,".",",")."</td>";

		echo "<tr><td  align='center' colspan='4' bgcolor='".$AzulClar."'><font size='3' color='$blanco'><b>MOVIMIENTO DE CAJA</b></td></tr>";

		echo "<tr><td colspan='4' bgcolor='".$AguaOsc."'><b>FORMAS DE PAGO</b></td>";

		echo "<tr><td colspan='3'>Abonos a Cartera Por Beneficiario</td>";
		echo "<td>$".number_format($totabo,2,".",",")."</td>";

		echo "<tr><td colspan='3'>Ventas de Contado</td>";
		echo "<td>$".number_format($totcon,2,".",",")."</td>";

		echo "<tr><td colspan='3' bgcolor='".$AmarClar."'><b>Total Ventas de Contado</b></td>";
		echo "<td bgcolor='".$AmarClar."'><b>$".number_format(($totabo+$totcon),2,".",",")."</b></td>";

		echo "<tr><td colspan='3'>Ventas a Crédito</td>";
		echo "<td>$".number_format($totcre,2,".",",")."</td>";


		echo "<tr><td colspan='3' bgcolor='".$AmarClar."'><b>TOTAL FORMAS DE PAGO</b></td>";
		echo "<td bgcolor='".$AmarClar."'><b>$".number_format(($totabo+$totcon+$totcre),2,".",",")."</b></td>";
		//echo "<td bgcolor='".$AmarClar."'><b>$".round($totabo+$totcon+$totcre)."</b></td>";

		echo "<tr><td colspan='2' bgcolor='".$AguaOsc."'><b>MEDIOS DE PAGO</b></td>";
		echo "<td colspan='1' bgcolor='".$AguaOsc."'><b># TRANSACCIONES</b></td>";
		echo "<td colspan='1' bgcolor='".$AguaOsc."'><b>TOTAL</b></td>";
		$totfp=0;
		$tottra=0;
		if ($numFP > 0) {
			for($i=0;$i<$numFP;$i++){
				echo "<tr><td colspan='2'>".ucfirst(strtolower($fp['fpa'][$i]))."</td>";
		...
		echo "<tr><td colspan='2' bgcolor='".$AmarClar."'><b>TOTAL VENTAS</td>";
		echo "<td align='center' bgcolor='".$AmarClar."'><b>".$tottra."</b></td>";
		echo "<td bgcolor='".$AmarClar."'><b>$".number_format($totfp,2,".",",")."</b></td>";
