...
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> Rcarnom.php Ver. 2014-10-27</b></font></tr></td></table>
</center>
<?php
include_once("conex.php");
/**********************************************************************************************************************  
	   PROGRAMA : Rcarnom.php
	   Fecha de Liberacion : 2005-09-29
	   Autor : Ing. Pedro Ortiz Tamayo
	   Version Actual : 2014-10-27
	   
	   OBJETIVO GENERAL : 
	   Reporte del estado de la cartera x usuario x empresa con Farmastore
	   
	   REGISTRO DE MODIFICACIONES :
	   .2014-10-27
	   		Se actualiza el logo de la presentacion.
	   
	   .2008-12-01
	   		Se modifico el programa para seleccionar los 5 ultimos caracteres del usuario que viene de MATRIX y se busa en
	   		Servinte.
	   		
	   .2006-02-15
	   		Se modifico el programa en el query de la tabla 46 para incluir los solamente los prestamos con estado en "on".
	  	
	   .2005-12-30
	   		Se modifico el programa para mostrar correctamente el saldo pendiente.
...
else
{
	...
	echo "<form name='Rcarnom' action='Rcarnom.php' method=post>";
	...
	if (!isset($codigo) or !isset($wemp) or !isset($wtip) or (strtoupper ($wtip) != "S" and strtoupper ($wtip) != "T"))
	{
		...
		echo "<tr><td align=center bgcolor=#000066 colspan=5><font color=#ffffff size=6><b>EXTRACTO DE CARTERA X NOMINA </font><font color=#33CCFF size=4>&nbsp&nbsp&nbspVer. 2014-10-27font></b></font></td></tr>";
		...
		$query = "SELECT Nomusu  from ".$empresa."_000036 where Nomusu='".$key."' group by Nomusu ";
	...
	else
	{
		...
		if($wsw == 1)
		{
			...
			echo "<tr><td align=center bgcolor=#000066 colspan=2><font color=#ffffff size=6><b>EXTRACTO DE CARTERA X NOMINA </font><font color=#33CCFF size=4>&nbsp&nbsp&nbspVer. 2014-10-27</font></b></font></td></tr>";
