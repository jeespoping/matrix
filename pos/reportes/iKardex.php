...
else
{
	...
	else
	{
		...
		$query = "SELECT Kxmcod, Kxmdes, Kxmuni, Kxmgru, Kxmcsi, Kxmvsi, Kxmcen, Kxmven, Kxmcsa, Kxmvsa, Kxmcsf, Kxmvsf, Kxmcdi, Kxmvdi, Kxmvro, Kxmdro   from ".$empresa."_000012 ";
		$query .= " where  Kxmano = ".$wano;
		$query .= "     and  Kxmmes = ".$wmes;
		$query .= "     and  Kxmcco = '".substr($wcco,0,strpos($wcco,"-"))."'";
		if($wind == "S")
