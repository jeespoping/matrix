...
/***********************************Consulto las devouciones sin nota credito********************/
      ...
      echo "<tr><td align=center colspan=2 bgcolor=".$wcf2."><font size=6 text color=#FFFFFF><b>COSTO DE LAS DEVOLUCIONES POR LINEA</b></font></td></tr>";
      echo "</tr>";  
      echo "</center></table >";
	  	...
	  	for ($i=0;$i<$num;$i++)
	   	{
			...
			$query= $query. "WHERE fdeffa='".$vector[$i][1]."' and fdenve='".$vector[$i][0]."' ";
