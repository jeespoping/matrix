...
else
{
	...
	echo "<form name='ac' action='ac.php' method=post>";
	...
	if(!isset($wano))
	{
		...
		{
			case "farstore":
				echo "<tr><td align=center colspan=2><b>LAS AMERICAS FARMASTORE<b></td></tr>";
			break;
		}
		echo "<tr><td align=center colspan=2>INFORMES</td></tr>";
		echo "<tr><td bgcolor=#cccccc align=center>Año</td><td bgcolor=#cccccc align=center>";
		switch($grupo)
		{
			case "farstore":
				$query = "SELECT Actano from farstore_000092 GROUP BY Actano";
			break;
		}
	...
	else
	{
		...
		{
			case "farstore":
				$query = "select Actano, Actcod, Actfec, Actnom   from  farstore_000092 ";
		...
		{
			case "farstore":
				echo "<tr><td align=center colspan=2><IMG SRC='/matrix/images/medical/pos/logo_farstore.png' width=50%></td></tr>";
			break;
		}
		echo "<tr><td align=center bgcolor=#000066 colspan=2><font color=#ffffff size=4><b>INFORMES DE ".$wano."</font><font color=#33CCFF size=4>&nbsp&nbsp&nbspVer. 2007-12-28</font></b></font></td></tr>";
		echo "</table><br>";  
		echo "<table border=0 align=center>";
