...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Calculo de Maximos y Minimos</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b>maxmin.php Ver. 2008-05-13</b></font></tr></td></table>
</center> 
<?php
...
else
{
	...
	echo "<form name='maxmin' action='maxmin.php' method=post>";
	

	

	echo "<input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
	if(!isset($wdias) or !isset($wpto) or !isset($wbod) or !isset($war1) or !isset($war2))
	{
		echo "<center><table border=0>";
		echo "<tr><td align=center colspan=2><b>PROMOTORA MEDICA LAS AMERICAS S.A.<b></td></tr>";
		echo "<tr><td align=center colspan=2>CALCULO DE MAXIMOS Y MINIMOS</td></tr>";
		...
		echo "<tr><td bgcolor=#cccccc align=center>Punto de Venta</td>";
		echo "<td bgcolor=#cccccc align=center><input type='TEXT' name='wpto' size=4 maxlength=4></td></tr>";
		echo "<tr><td bgcolor=#cccccc align=center>Bodega Asociada</td>";
		echo "<td bgcolor=#cccccc align=center><input type='TEXT' name='wbod' size=4 maxlength=4></td></tr>";
	...
	else
	{
		...
		echo "<tr><td align=center bgcolor=#999999><font size=6 face='tahoma'><b>CALCULO DE MAXIMOS Y MINIMOS</font><font size=2> <b>Ver. 2008-05-13</b></font></b></font></td></tr>";
		$color="#dddddd";
		...
		echo "<tr><td bgcolor=".$color." align=center><font face='tahoma'><b>Punto de Venta : </b>".$wpto."</td></tr>";
		echo "<tr><td bgcolor=".$color." align=center><font face='tahoma'><b>Bodega Asociada : </b>".$wbod."</td></tr>";
		...
		$query .= " WHERE  Karcco in ('".$wpto."','".$wbod."')";
