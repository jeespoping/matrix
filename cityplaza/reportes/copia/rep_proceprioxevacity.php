...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_proceprioxevacity.php'; 
	}
	
	function enter()

	{
		document.forms.rep_proceprioxevacity.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//citypla_000001     : Tabla Procesos Priritarios.                                                                                              |                                                                      |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_proceprioxevacity.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_proceprioxevacity' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    echo "<tr><td align=center colspan=4 bgcolor=#FFFFFF><font text color=#003366 size=2><b>IMAGENOLOGIA CITY PLAZA</b></font></td></tr>";
    ...
    $query1 = "SELECT pperso,ppperseva,count(*) as cant"
            ."   FROM ".$empre1."_000001 "
