...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detpropricity.php'; 
	}
	
	function enter()
	{
		document.forms.rep_detpropricity.submit();
	}
...
//FECHA CREACION			  :FEBRERO 22 DE 2013.                                                                                            |
//FECHA ULTIMA ACTUALIZACION  :FEBRERO 22 DE 2013.                                                                                            |
//TABLAS UTILIZADAS :                                                                                                                       |
//citypla_000001      : Tabla de Procesos prioritarios UNIDAD DEL SUEÑO                                                                      |
//==========================================================================================================================================
include_once("root/comun.php");
$conex = obtenerConexionBD("matrix");

$wactualiz="1.0 22-Febrero-2013";
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detpropricity.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
 if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_detpropricity' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
   ...
   $query = " SELECT ppfecha,ppperseva,ppcargoe,ppproc,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppcrite16,ppcrite17,ppcrite18,ppcrite19,ppcrite20,ppobserva,pppor"
           ."   FROM ".$empre1."_000001"
           ."  WHERE ppproc = '".$tpp."'" 
           ."    AND pppor < 100"
