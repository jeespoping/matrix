...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafpropricity.php'; 
	}
	
	function enter()
	{
		document.forms.grafpropricity.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//citypla_000002     : Tabla de Bases de datos totales por proceso prioritario.                                                               |
//citypla_000001     : Tabla de movimiento procesos prioritarios.                                                                             |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
	...
	//Forma
	echo "<form name='forma' action='grafpropricity.php' method='post'>";
	echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";

	if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
	{
		echo "<form name='grafpropricity' action='' method=post>";
