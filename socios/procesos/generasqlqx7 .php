...
*/     
	 ...
	 echo "<td align=center bgcolor=#C0C0C0 colspan=1><b><font text color=#003366 size=2>Conexion: </font></b>";   
     echo "<SELECT MULTIPLE SIZE='3' NAME='conexion[]'>"; 
	 echo "<OPTION VALUE='1' SELECTED>PROMOTORA";
	 echo "<OPTION VALUE='2' SELECTED>LABORATORIO";
	 echo "<OPTION VALUE='3' SELECTED>PATOLOGIA";
	 echo "<OPTION VALUE='4' SELECTED>CLINICA DEL SUR";
	 echo "</SELECT>";
	 
	 $conexion= $_REQUEST['conexion'];
	 foreach($conexion as $conexio)
	 echo $conexio;
