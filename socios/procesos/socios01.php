...
Function validar_datos($ced,$ap1,$nom,$nac,$des,$coa,$cob,$tic,$pri,$int,$acc,$tac) 
{	    
   global $msgerr;   
   ...
   if ( !is_numeric($tic))
    {
      $msgerr=$msgerr." El Nro de Titulos Cancelados debe ser numerico. ";   
    }      
   if ( !is_numeric($pri))
    {
      $msgerr=$msgerr." El Nro de Acciones Privilegiadas debe ser numerico.";   
    } 
   if ( !is_numeric($int))
    {
      $msgerr=$msgerr." Los Intereses pagados privilegiados debe ser numerico.";   
    }       
   if ( !is_numeric($acc))
    {
      $msgerr=$msgerr." El Nro de Acciones ordinarias debe ser numerico.";   
    }
   if ( !is_numeric($tac))
    $msgerr=$msgerr." El Nro total de Acciones debe ser numerico.";   
   else
     if ($tac<>($pri+$acc))     
      $msgerr=$msgerr." El total de acciones no esta correcto.";   
...
// Capturo el tipo de usuario para saber que puede hacer
        ...
        $x1=explode('-',$user); 
        $query = "SELECT usrtip FROM socios_000012 Where usrcod = '".$x1[1]."'";
        ...
        if ( $nroreg > 0 )                   //Encontro
        {
	      $registro = mysql_fetch_row($resultado);
 	      $wtipousr=$registro[0];
	      if ( ($wtipousr=="C") and ( $wproceso<>"Nuevo") ) 
	      {
		    $fecha = date("Y-m-d");
	        $hora = (string)date("H:i:s"); 
     	    $query = "INSERT INTO socios_000011 VALUES ('socios','".$fecha."','".$hora."','".$user."','Maestro Socios','Consulto','".$wcod."','".$user."','')";
 ...
 else
 {
    ...
    if (isset($wtid))
    {
	 ...
	 if($c1[0]  == "05" )      
      echo "<option SELECTED>05- Pasaporte</option>";        
     else  
      echo "<option>05- Pasaporte</option>";  
    }  
    else
	{		
	 echo "<option>01- Nit</option>";
  ...
  {	 	 
   ...
   {
   ?>
    <td align=center bgcolor=#DDDDDD colspan=1><a href='javascript:window.open("<?php echo "../fotos/".$wced.".jpg" ?>",  "_blank", "align=CENTER, height=150, width=100, left=400, top=30, status=yes, toolabar=no, //scrollbar=yes, menubar=no");;void(0)' target="_self">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</a>
   <?php  
   }  
   else
...
//     ****************************     APARTIR DE AQUI CAPTURAMOS LOS DATOS DE LAS ACCIONES  **************************** //
   ...
   if ($wtipousr=="A")  // Puede modificar datos de Acciones
    if (isset($wnum))
    ...
    if (isset($wnum))
     echo "<INPUT TYPE='text' NAME='wnum' size=15 disabled='disabled' VALUE='".$wnum."'></INPUT></td>"; 
    else
     echo "<INPUT TYPE='text' NAME='wnum' size=15 disabled='disabled'></INPUT></td>";   
  ...
  {  
    ...
    echo "<input type='TEXT' name='wfec' size=10 maxlength=10  id='wfec' disabled='disabled' value=".$wfec." class=tipo3>";
    ...
    if ($wtipousr=="A")  // Puede modificar datos de Acciones
     ...
     if (isset($wtic))
      echo "<INPUT TYPE='text' NAME='wtic' size=15 disabled='disabled' VALUE='".$wtic."' onkeypress='teclado()'></INPUT></td>"; 
     else
      echo "<INPUT TYPE='text' NAME='wtic' size=15 disabled='disabled' onkeypress='teclado()'></INPUT></td>";          
    ...
    if ($wtipousr=="A")  // Puede modificar datos de Acciones
     ...
     if (isset($wint))
      echo "<INPUT TYPE='text' NAME='wint' size=10 maxlength=4 disabled='disabled' VALUE='".$wint."' onkeypress='teclado()'></INPUT></td>"; 
     else
      echo "<INPUT TYPE='text' NAME='wint' size=10 maxlength=4 disabled='disabled' onkeypress='teclado()'></INPUT></td>";       
      
    echo "<td align=center bgcolor=#DDDDDD colspan=1><b><font text color=#003366 size=2>A C C I O N E S</font></b><br>";
    echo "<b><font text color=#003366 size=2>Privilegiadas: </font></b>";
    if ($wtipousr=="A")  // Puede modificar datos de Acciones
     if (isset($wpri))
      echo "<INPUT TYPE='text' NAME='wpri' size=10 VALUE='".$wpri."' onkeypress='teclado()'></INPUT>"; 
     else
      echo "<INPUT TYPE='text' NAME='wpri' size=10 onkeypress='teclado()'></INPUT>";          
    else 
     if (isset($wpri))
      echo "<INPUT TYPE='text' NAME='wpri' size=10 disabled='disabled' VALUE='".$wpri."' onkeypress='teclado()'></INPUT>"; 
     else
      echo "<INPUT TYPE='text' NAME='wpri' size=10 disabled='disabled' onkeypress='teclado()'></INPUT>";          
     
    echo "<b><font text color=#003366 size=2>Ordinarias: </font></b>";
    if ($wtipousr=="A")  // Puede modificar datos de Acciones
     if (isset($wacc))
      echo "<INPUT TYPE='text' NAME='wacc' size=10 VALUE='".$wacc."' onkeypress='teclado()'></INPUT></td>"; 
     else
      echo "<INPUT TYPE='text' NAME='wacc' size=10 onkeypress='teclado()'></INPUT></td>";    
    else
     if (isset($wacc))
      echo "<INPUT TYPE='text' NAME='wacc' size=10 disabled='disabled' VALUE='".$wacc."' onkeypress='teclado()'></INPUT></td>"; 
     else
      echo "<INPUT TYPE='text' NAME='wacc' size=10 disabled='disabled' onkeypress='teclado()'></INPUT></td>";   
      
    echo "<td align=center bgcolor=#DDDDDD colspan=1><b><font text color=#003366 size=2>Totales</font></b><br>";
    if ($wtipousr=="A")  // Puede modificar datos de Acciones
     if (isset($wtac))
      echo "<INPUT TYPE='text' NAME='wtac' size=10 VALUE='".$wtac."' onkeypress='teclado()'></INPUT></td>"; 
     else
      echo "<INPUT TYPE='text' NAME='wtac' size=10 onkeypress='teclado()'></INPUT></td>";    
    else
     if (isset($wtac))
      echo "<INPUT TYPE='text' NAME='wtac' size=10 disabled='disabled' VALUE='".$wtac."' onkeypress='teclado()'></INPUT></td>"; 
     else
      echo "<INPUT TYPE='text' NAME='wtac' size=10 disabled='disabled' onkeypress='teclado()'></INPUT></td>";    
      
  if (!isset($wdiv))   // Si no esta seteada entonces la inicializo con la fecha actual
    $wdiv=date("Y-m-d");
    
    echo "<tr><td align=LEFT colspan=2 bgcolor=#DDDDDD><b><font text color=#003366 size=2>Ultimo dividendo pagado: </font></b>"; 
    if ($wtipousr=="A")  // Puede modificar datos de Acciones
    {  
   	 $cal="calendario('wdiv','1')";
	 echo "<input type='TEXT' name='wdiv' size=10 maxlength=10  id='wdiv' readonly='readonly' value=".$wdiv." class=tipo3><button id='trigger5' onclick=".$cal.">...</button>";
	 ?>
	  <script type="text/javascript">//<![CDATA[
     ...
     echo "<input type='TEXT' name='wdiv' size=10 maxlength=10  id='wdiv' disabled='disabled' value=".$wdiv." class=tipo3>";
    echo "<br>"; 

    // manejo de campos con CheckBox 
    if ($wtipousr=="A")  // Puede modificar datos de Acciones
    {
     if ($wvot=="" or $wvot=="off")	//Si no esta seteado o esta en off lo pinto
       echo "<INPUT TYPE = 'Checkbox' NAME = 'wvot' ><b><font text color=#003366 size=2>Voto por poder </font></b><br>";
     else // Si esta seteado y esta ON lo pinto y activo con CHECKED
     {
      if ($wvot=="on")
       echo "<INPUT TYPE = 'Checkbox' NAME = 'wvot' CHECKED ><b><font text color=#003366 size=2>Voto por poder </font></b><br>";
     }
    }  
    else
    {   
     if ($wvot=="" or $wvot=="off")	//Si no esta seteado o esta en off lo pinto
      echo "<INPUT TYPE = 'Checkbox' NAME = 'wvot' disabled='disabled'><b><font text color=#003366 size=2>Voto por poder </font></b><br>";
     else // Si esta seteado y esta ON lo pinto y activo con CHECKED
     {
      if ($wvot=="on")
       echo "<INPUT TYPE = 'Checkbox' NAME = 'wvot' disabled='disabled' CHECKED ><b><font text color=#003366 size=2>Voto por poder </font></b><br>";
     }  
    }
    ...
    if ($wtipousr=="A")  // Puede modificar datos de Acciones
    {
     if ($wdel=="" or $wdel=="off")	//Si no esta seteado o esta en off lo pinto
      echo "<INPUT TYPE = 'Checkbox' NAME = 'wdel' ><b><font text color=#003366 size=2>Voto por delegacion </font></b><br>";
     else // Si esta seteado y esta ON lo pinto y activo con CHECKED
     {
      if ($wdel=="on")
       echo "<INPUT TYPE = 'Checkbox' NAME = 'wdel' CHECKED ><b><font text color=#003366 size=2>Voto por delegacion </font></b><br>";
     }
    }  
    else
    {   
     if ($wdel=="" or $wdel=="off")	//Si no esta seteado o esta en off lo pinto
      echo "<INPUT TYPE = 'Checkbox' NAME = 'wdel' disabled='disabled'><b><font text color=#003366 size=2>Voto por delegacion </font></b><br>";
     else // Si esta seteado y esta ON lo pinto y activo con CHECKED
     {
      if ($wdel=="on")
       echo "<INPUT TYPE = 'Checkbox' NAME = 'wdel' disabled='disabled' CHECKED ><b><font text color=#003366 size=2>Voto por delegacion </font></b><br>";
     }  
    }
    ...
    echo "<td align=CENTER colspan=2 bgcolor=#DDDDDD><b><font text color=#003366 size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Acciones&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Firmo Acuerdo<br>Estado:&nbsp;&nbsp;&nbsp;</font></b>"; 
	...
	if ($wtipousr=="A")  // Puede modificar datos del Acciones
       echo "&nbsp;&nbsp;&nbsp;<select name='wfir' >";
    else
       echo "&nbsp;&nbsp;&nbsp;<select disabled='disabled' name='wfir' >";
    if (isset($weac))
    {$c11=explode('-',$wfir);     // Del combo tomo el codigo
     if($c11[0] == "S" ) 
...
<!--
  ...
  -->
  <BUTTON TYPE=BUTTON value="Grupo Familiar" onclick="javascript:window.open('socios02.php?wcod= <?phpPHP echo $wcod; ?>&windicador=PrimeraVez&wproceso=Nuevo','socios',' Top=200, Left=150, width=670, height=300, resizable=YES, Scrollbars=YES')">Grupo Familiar </BUTTON>
  <BUTTON TYPE=BUTTON value="Informacion Academica" onclick="javascript:window.open('socios03.php?wcod= <?phpPHP echo $wcod; ?>&windicador=PrimeraVez&wproceso=Nuevo','socios',' Top=200, Left=100, width=900, height=350, resizable=YES, Scrollbars=YES')">Informacion Academica </BUTTON>
  <BUTTON TYPE=BUTTON value="Especialidades" onclick="javascript:window.open('socios04.php?wcod= <?phpPHP echo $wcod; ?>&windicador=PrimeraVez&wproceso=Nuevo','socios',' Top=200, Left=100, width=900, height=300, resizable=YES, Scrollbars=YES')">Especialidades </BUTTON>

  <!--
  <BUTTON TYPE=BUTTON value="Vinculacion a Sociedades" onclick="javascript:window.open('socios01.php?wcod= <?phpPHP echo $wcod; ?>','socios',' Top=200, Left=150, width=300, height=300, resizable=YES, Scrollbars=YES')">Vinculacion a Sociedades </BUTTON>
 -->  
<?php  
   if ( isset($weac) )
   {
    ...
    {
?> 
      <BUTTON TYPE=BUTTON value="Mvto de acciones" onclick="javascript:window.open('socios06.php?wcod= <?phpPHP echo $wcod; ?>&windicador=PrimeraVez&wproceso=Nuevo','socios',' Top=250, Left=150, width=770, height=320, resizable=YES, Scrollbars=YES')">Mvto de Acciones </BUTTON>
<?php  }
...
if ( isset($wced) and $wced<>'' and isset($wap1) and $wap1<>''  and ($windicador <> "PrimeraVez"))
{
  ...
  if (isset($wtic))    // Hay que controlar pues si la variable esta disabled='disabled' queda sin setear asi tenga valor
   validar_datos($wced,$wap1,$wnom,$wnac,$wdes,$wcoa,$wcob,$wtic,$wpri,$wint,$wacc,$wtac);
  else
   validar_datos($wced,$wap1,$wnom,$wnac,$wdes,$wcoa,$wcob,0,0,0,0,0);
  
  if ($wvot=="") $wvot="off"; else $wvot="on";
  if ($wdel=="") $wdel="off"; else $wdel="on"; 
  ...
  { 
   ...
   {   
     ...
     {
  	       $c1=explode("-",$wtid);
  	       if (($wtipousr=="M") or ($wtipousr=="I"))   // Solo puede modificar datos demograficos
  	       { 
	         $query = "Update socios_000001 SET soctid='".$c1[0]."',socreg='".$wreg."',socsex='".$c2[0]."'"
               ...
               .",socpol='".$wpol."',socmon='".$wmon."',socemp='".$wemp."',socvig='".$wvig."',socaso='".$waso."',socobs='".$wobs."'"
               ." Where socced = '".$wcod."'";
            }     
            else
            {
	         if ($wtipousr=="A")  // Solo puede modificar datos de Acciones
	         {
	          $query = "Update socios_000001 SET "
               ." socnum='".$wnum."',socfec='".$wfec."',soctic=".$wtic.",socpri=".$wpri.",socint=".$wint.",socacc=".$wacc.",socdiv='".$wdiv."'"
               .",socobs='".$wobs."',socact='".$c9[0]."',soceac='".$c10[0]."',socfir='".$c11[0]."',soctac=".$wtac.",socvot='".$wvot."',socdel='".$wdel."'"
               ." Where socced = '".$wcod."'";
             }  
            }
	   ...
	   if ($resultado)
	   {
        ...
        $fecha = date("Y-m-d");
        $hora = (string)date("H:i:s");
	    $query = "INSERT INTO socios_000011 VALUES ('socios','".$fecha."','".$hora."','".$user."','Maestro Socios','Modifico','".$wced."','".$user."','')";
	    $resultado2 = mysql_query($query,$conex);
       } 
	   else
	   {
     ...
     else
     {
      ...
      $fecha = date("Y-m-d");
	  $hora = (string)date("H:i:s");
	  if ($wtipousr=="A")  // Los usuarios tipo A tienen Control total graban todo hasta lo de Acciones
	  {
         $query = "INSERT INTO socios_000001 VALUES ('socios','".$fecha."','".$hora."','".$wced."','".$c1[0]."','".$wreg."','".$c2[0]
                 ."','".$wap1."','".$wap2."','".$wnom."','".$wnac."','".$c3[0]."','".$c4[0]."','".$c5[0]."','".$wdes."','".$wcoa              
                 ."','".$wcob."','".$wdir."','".$c6[0]."','".$c7[0]."','".$wapa."','".$wtre."','".$wtof."','".$wtce."','".$c8[0]  
                 ."','".$wpol."','".$wmon."','".$wemp."','".$wvig."','".$waso."','".$wnum."','".$wfec."',".$wtic.",".$wpri
                 .",".$wint.",".$wacc.",'".$wdiv."','".$wvot."','".$wdel."',".$wtac.",'".$wobs."','".$c9[0]."','".$c10[0]."','".$c11[0]."','".$user."','')";  
      }
	  else    // Es usuario tipo I los campos de acciones no son grabados por ellos y se entran como modificacion por un usuario tipo A
	  {
         $query = "INSERT INTO socios_000001 VALUES ('socios','".$fecha."','".$hora."','".$wced."','".$c1[0]."','".$wreg."','".$c2[0]
                 ."','".$wap1."','".$wap2."','".$wnom."','".$wnac."','".$c3[0]."','".$c4[0]."','".$c5[0]."','".$wdes."','".$wcoa              
                 ."','".$wcob."','".$wdir."','".$c6[0]."','".$c7[0]."','".$wapa."','".$wtre."','".$wtof."','".$wtce."','".$c8[0]  
                 ."','".$wpol."','".$wmon."','".$wemp."','".$wvig."','".$waso."','0','".$wfec."',0,0,0,0,"
                 ."'".$wdiv."','off','off',0,'".$wobs."','".$c9[0]."','A','N','".$user."','')";  
	  }  
	  $resultado = mysql_query($query,$conex);
	  if ($resultado)
      {
   	    echo "<br><tr><td bgcolor=#33FFFF colspan=6 align=center>Registro Adicionado</td></tr>";
   	    $query = "INSERT INTO socios_000011 VALUES ('socios','".$fecha."','".$hora."','".$user."','Maestro Socios','Ingreso','".$wced."','".$user."','')";
	    $resultado2 = mysql_query($query,$conex);
      } 
	  else
	  {
