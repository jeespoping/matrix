...
$query = "Select espdes,count(*) From socios_000001,socios_000004,socios_000010"
       . " Where socact='A' And socced=espced AND espesp=espcod Group by 1 order by 2 desc"; 
...
$graph->title->Set("SISTEMA DE INFORMACION DE SOCIOS - SOCIOS POR ESPECIALIDAD - TOTAL ".$wtot ); 
