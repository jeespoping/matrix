...
. " And cardetano = '".$wano."'"
. " And cardetmes = '".$wmes."'"
. " And cardetfec > '20190601'"       // Como esta fue la fecha de inicio la utilizo para acelerar notablemente el query
. " And cardetanu = '0' "
...
$graph->title->Set("PROGRAMA Inst Mujer SOM - TOTAL CARGOS HOSPITALIZACION Y AYUDAS ".number_format($wtot,0));
