<HTML>
<HEAD>
<TITLE>Reporte de atenciones Programa Inst Mujer SOM</TITLE>
</HEAD>
<BODY>
...
//Forma
echo "<form name='paf53som' action='paf53som.php' method=post>";  

 if ($wproceso=="Borrar")
 {   
	 $query = "DELETE FROM pafsom_000003 Where ateced = '".$wced."' And atefec = '".$wfec."' And atehor = '".$whor."'";   
 ...
 if (!isset($wfec1) or !isset($wfec2))
 {
    ...
    echo "<tr>";
	echo "<tr><td align=CENTER colspan=4 bgcolor=#DDDDDD><b><font text color=#003366 size=2>Reporte de atenciones programa Inst Mujer SOM<br></font></b>";   
	echo "</tr>";
...
/*****/	
   ...
   $query = "SELECT codigo,Descripcion FROM citasom_000010 Group By codigo,Descripcion Order By codigo"; 	         
...
/****/	
 ...
 else      // Cuando ya estan todos los datos escogidos
 {
    ...
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=4><i>Reporte de atenciones programa Inst Mujer SOM</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=4><i>Periodo: ".$wfec1." Al ".$wfec2."</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>PROGRAMA: paf53som.php Ver. 2015/10/26<br>AUTOR: JairS</font></b><br>";
    echo "</table>";
    ...
    {   
        ...
        $query = "SELECT Descripcion FROM citasom_000010 WHERE codigo='".$registro[0]."' Group By Descripcion"; 
        ...
        if ( $registroB = mysql_fetch_row($resultadoB) )      //  Encontro 
		 ...
		 {		
            ...
            echo "<td><A HREF='paf51som.php?wfec=".$registro[1]."&whor=".$registro[2]."&wced=".$registro[3]."&windicador=PrimeraVez&wproceso=Modificar' TARGET='_blank' >Editar</A>";	     
            echo "<td><A HREF='paf53som.php?wfec=".$registro[1]."&whor=".$registro[2]."&wced=".$registro[3]."&windicador=PrimeraVez&wproceso=Borrar' >Borrar</A></td></tr>";	     
