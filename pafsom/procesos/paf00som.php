...
<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Sistema de Informacion Inst Mujer Programa SOM
<br><td colspan=1 align=center><A HREF='paf01som.php?windicador=PrimeraVez&wproceso=Nuevo' TARGET='_blank' >Adicionar nueva Orden</A></td>
</font></strong> 
</div> 
...
$sql="SELECT * FROM pafsom_000001 Where pafest='X'";
$res=mysql_query($sql); 
$NumeroAnulados=mysql_num_rows($res);


$sql="SELECT paffre,pafced,pafape,pafnom,pafcco,paftip,id,pafest,paffre,paffci,pafexa,pafser  FROM pafsom_000001 ".$criterio.$criterio2;
    ...
    <?php 
     ...
     {	  
       ...
       if ($registro[0]=="1")    // Si prioridad es 1 permito anular
        echo "<td><A HREF='paf10som.php?wid=".$wid."' TARGET='_blank' >Anular</A></td>";	     
     } 
     else
     {
...
<hr noshade style="color:CC6666;height:1px"> 
<div align="center"><font face="verdana" size="-2"><a class="p" href="paf00som.php">::Inicio::</a></font></div> 
<form action="paf00som.php" method="get"> 
<center>
<table border="0" cellspacing="0" cellpadding="0" align="center">   
<?php
    echo "Sin Asignar: ";
...
echo "<meta http-equiv='refresh' content='900;url=paf00som.php'>";
?> 
