...
<div align="center"><strong><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Sistema de Informacion Programa Inst Mujer SOM><td colspan=1 align=center></td><br>Archivo de Usuarios Inst Mujer SOM</font></strong></div> 
...
$sql="SELECT Afi_identific,Afi_apellido1,Afi_apellido2,Afi_nombres,Afi_sexo,Afi_fechanaci, Afi_tip_cotiza_, Afi_pafsom_codigo, Excento_pago_moderador,Pl_pac_descripcion FROM pafsom_000002 ".$criterio;
$res=mysql_query($sql); 
...
echo "<th bgcolor='#CCCCCC'><a class='ord' href='paf04som.php' TARGET='_New'>Sexo <IMG SRC='Icon_05.ico' ALT='Genera Grafico por Sexo'></a></th>"; 
echo "<th bgcolor='#CCCCCC'><a class='ord' href='paf05som.php' TARGET='_New'>Fecha Nac/to <IMG SRC='Icon_05.ico' ALT='Genera Grafico por grupos de Edad'></a></th>"; 
...
echo "<th bgcolor='#CCCCCC'><a class='ord' href='paf06som.php' TARGET='_New'>Rango <IMG SRC='Icon_05.ico' ALT='Genera Grafico por Rango de usuario'></a></th>";  
...
?> 
   ...
   -->
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b><?php echo $registro["Afi_pafsom_codigo"]; ?></b></font></td>
	 ...
	 if ($reg["empresa"]<>"99")   // Si es un usuario de la empresa 99 no lo deja generar ordenes
       {
			...
			{	
				...
				echo '</script>';
				echo "<td><A HREF='paf01som.php?wid=".$wid."&windicador=PrimeraVez&wproceso=Nuevo' TARGET='_blank'>Generar</A></td>";	    
			}
			else
			{
				echo "<td><A HREF='paf01som.php?wid=".$wid."&windicador=PrimeraVez&wproceso=Nuevo' TARGET='_blank'>Generar</A></td>";	    
...
<hr noshade style="color:CC6666;height:1px"> 
<div align="center"><font face="verdana" size="-2"><a class="p" href="paf02som.php">::Inicio::</a></font></div> 
<form action="paf02som.php" method="get"> 
