...
$query = "SELECT Afi_paf_codigo ,count(*)  FROM pafsom_000002 GROUP BY Afi_paf_codigo  "; 
...
$graph->title->Set("PROGRAMA Inst Mujer SOM - USUARIOS POR RANGO - TOTAL USUARIOS ".$wtot ); 
