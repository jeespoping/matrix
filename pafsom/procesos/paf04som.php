...
$query = "SELECT Afi_sexo,count(*)  FROM pafsom_000002 GROUP BY Afi_sexo "; 
//$query = "SELECT Afi_tip_cotiza_ ,count(*)  FROM pafsom_000002 GROUP BY Afi_tip_cotiza_  "; 
...
$graph->title->Set("PROGRAMA Inst Mujer SOM - USUARIOS POR SEXO - TOTAL USUARIOS ".$wtot ); 
