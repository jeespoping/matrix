...
$query = "SELECT YEAR(CURDATE())-substr(Afi_fechanaci,7,4)  AS EDAD  FROM pafsom_000002"; 
...
$graph->title->Set("PROGRAMA Inst Mujer SOM - USUARIOS POR EDADES - TOTAL USUARIOS ".$wtot ); 
