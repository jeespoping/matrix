<html>
<head>
<title>MATRIX - [Formulario Formato de Acciones Correctivas_12]</title>
...
session_start();
//Encabezado
encabezado("Formularios de Acciones Correctivas",$wactualiz,"Clinica");
 ...
 $hoy=date("Y-m-d");	
   ...
   IF ($codi=='0102899')
   {
    ...
    $row = mysql_fetch_array($err);
   	...
   	$query1=" SELECT `Accco` ,`Accconom` ,`Acconse`,`Acncac`,`Acres`,`Acftesele`,`Acotrfte`,`Ac1p`,`Ac2p`,`Ac3p`,`Ac4p`,`Ac5p`,`Acacc1`,`Acres1`,`Acfec1`,`Acacc2`,`Acres2`,`Acfec2`,`Acacc3`,`Acres3`,`Acfec3`,`Acacc4`,`Acres4`,`Acfec4`,`Acacc5`,`Acres5`,`Acfec5`,`id` " 
           ."   FROM `proceso_000012`"  
           ."  WHERE `Accco` LIKE '1080'"
           ."  UNION ALL "
           ." SELECT `Accco` ,`Accconom` ,`Acconse`,`Acncac`,`Acres`,`Acftesele`,`Acotrfte`,`Ac1p`,`Ac2p`,`Ac3p`,`Ac4p`,`Ac5p`,`Acacc1`,`Acres1`,`Acfec1`,`Acacc2`,`Acres2`,`Acfec2`,`Acacc3`,`Acres3`,`Acfec3`,`Acacc4`,`Acres4`,`Acfec4`,`Acacc5`,`Acres5`,`Acfec5`,`id` " 
           ."   FROM `proceso_000012`"  
   ...
   //<INPUT type=button value='Nivel De Escolaridad' onclick='javascript: abrirVentana(\"det_registro.php?id=0&pos1=nomina&pos2=0&pos3=0&pos4=000005&pos5=0&pos6=nomina&tipo=P&Valor=&Form=000005-nomina-C-Nivel de Escolaridad&call=0&change=0&key=nomina&Pagina=1&r[0]=".$registro[1]."&r[1]=".$registro[2]."&r[2]=".$registro[5]."\")'>";
   
     echo "<table border=0>";
     echo "<Tr>";
	// $hypernew="<A HREF='/matrix/det_registro.php?id=0&pos1=proceso&pos2=0&pos3=0&pos4=000012&pos5=0&pos6=proceso&tipo=P&Valor=&Form=000012-proceso-formato acciones correctivas&call=1&change=0&key=proceso&Pagina=1&r[0]=".$row[0]."' target='new'>Nuevo</a>";
	// echo "<td align=left><font size=1>".$hypernew."</td>";
     echo "<td>";
     echo "<align=left><INPUT type=button value='NUEVO' onclick='javascript: abrirVentana(\"/matrix/det_registro.php?id=0&pos1=proceso&pos2=0&pos3=0&pos4=000012&pos5=0&pos6=proceso&tipo=P&Valor=&Form=000012-proceso-formato acciones correctivas&call=1&change=0&key=proceso&Pagina=1&r[0]=".$row[0]."\")'>";
     echo "</td>";
	...
	for ($i=1;$i<=$num1;$i++)
	 {
	  ...
	  $query2 = "CREATE TEMPORARY TABLE if not exists tmp as "
	           ." SELECT count(*) as can"
               ."   FROM ".$empre1."_000013" 
               ."  WHERE accco   = '".$row2[0]."' "
               ."    AND Acconse = '".$row2[2]."' "
