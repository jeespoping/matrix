...
<script type="text/javascript">
	function enter()
	{
		document.forms.rep_cumplixprouci.submit();
	}
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_cumplixprouci.php' method='post'>";
...
if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  ...
  $query = " SELECT ppproc,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppcrite16,ppcrite17,ppcrite18,ppcrite19,ppcrite20,ppcrite21,ppcrite22,ppcrite23,ppcrite24,ppcrite25"
           ."   FROM ".$empre1."_000001"
           ."  WHERE ppproc = '".$tpp."'" 
    ...
    for ($i=1;$i<=$num1;$i++)
	 {
	  ...
	  IF ($row2[22]=='on')
      {
      	$arrecrit[21]=$arrecrit[21]+1;
      }
	  IF ($row2[23]=='on')
      {
      	$arrecrit[22]=$arrecrit[22]+1;
      }
	  IF ($row2[24]=='on')
      {
      	$arrecrit[23]=$arrecrit[23]+1;
      }
	  IF ($row2[24]=='on')
      {
      	$arrecrit[23]=$arrecrit[23]+1;
      ...
      echo "<td  bgcolor=#FFFFFF align=center><font size=1><b>".number_format(($arrecrit[21]/$num1)*100)."%</b></font></td>";
      echo "<td  bgcolor=#FFFFFF align=center><font size=1><b>".number_format(($arrecrit[22]/$num1)*100)."%</b></font></td>";
      echo "<td  bgcolor=#FFFFFF align=center><font size=1><b>".number_format(($arrecrit[23]/$num1)*100)."%</b></font></td>";
      echo "<td  bgcolor=#FFFFFF align=center><font size=1><b>".number_format(($arrecrit[24]/$num1)*100)."%</b></font></td>";
      echo "</tr >";
      echo "</table>";
