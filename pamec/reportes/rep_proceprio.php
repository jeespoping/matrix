...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_proceprio.php'; 
	}
	
	function enter()

	{
		document.forms.rep_proceprio.submit();
	}
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_proceprio.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_proceprio' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    echo "<tr><td align=center colspan=4 bgcolor=#FFFFFF><font text color=#003366 size=2><b>U.C.I.</b></font></td></tr>";
    ...
    $quer1 = "CREATE TEMPORARY TABLE if not exists tempora1 as "
            ...
            ."  FROM ".$empre1."_000008 left join ".$empre1."_000001"
            ."    ON papp=ppproc"
	...
	$query1 = "SELECT SUBSTRING(ppfecha,6,2) as mes,ppproc as pp,count(*) as cant,patotal as total"
            ."   FROM ".$empre1."_000001 left join ".$empre1."_000008"
            ."     ON ppproc=papp" 
