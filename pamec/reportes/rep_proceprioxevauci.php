...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_proceprioxevauci.php'; 
	}
	
	function enter()

	{
		document.forms.rep_proceprioxevauci.submit();
	}
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_proceprioxevauci.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_proceprioxevauci' action='' method=post>";
