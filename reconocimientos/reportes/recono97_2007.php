...
//==========================================================================================================================================
//PROGRAMA				      :Reporte de conrol de ingreso de empleados.                                                                   
//AUTOR				          :Jair  Saldarriaga Orozco.                                                                        
//FECHA CREACION			  :Octubre 31 DE 2007.                                                                                
//FECHA ULTIMA ACTUALIZACION  :31 de octubre de 2007.                                                                             
//DESCRIPCION			      :Empleados mas votados por Ccosto

$wactualiz="Ver. 2007-06-28";
...
else  ///////////              Cuando ya estan capturados todos los datos      ///////////////////////////
{
	...
	$query="Select ccovot,codemp,cconom from votset,cocco where ccovot=ccocod order by ccovot,codemp";
    $resultado = odbc_do($conexN,$query); 
