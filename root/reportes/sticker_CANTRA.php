<html>
<head>
  <title>MATRIX Sticker De Pacientes Unidad de Transplante de Medula</title>
</head>
<body BGCOLOR="">
<BODY TEXT="#000000">
<?php
...
else
{
	...
	echo "<form action='sticker_CANTRA.php' method=post>";
	

	

	if(!isset($whis) or !isset($wnum) or $wnum < 1 or $wnum > 9 or !isset($wip))
	{
		echo "<center><table border=0>";
		echo "<tr><td align=center colspan=2><b>STICKER DE PACIENTES DE TRANSPLANTE DE MEDULA Ver. 2011-03-28</b></td></tr>";
		...
		echo "<tr><td bgcolor=#cccccc>IP Impresora</td><td bgcolor=#cccccc align=center><input type='TEXT' name='wip' value='132.1.21.115' size=15 maxlength=15></td></tr>";
	...
	else
	{
		...
		if(odbc_fetch_row($err_o))
		{
			...
			if($longC < 12)
			{
				...
				$paquete=$paquete."V02,3,L,".chr(34)."TARIFA".chr(34).chr(13).chr(10);
				...
				$paquete=$paquete."A150,135,0,2,1,1,N,".chr(34)."SEX:".chr(34)."V06".chr(13).chr(10);
				$paquete=$paquete."A60,155,0,2,1,1,N,".chr(34)."ING:".chr(34)."V07".chr(13).chr(10);
				$paquete=$paquete."A150,155,0,2,1,1,N,".chr(34)."TAR:".chr(34)."V02".chr(13).chr(10);
				$paquete=$paquete."B245,140,0,1,2,4,40,N,V02".chr(13).chr(10);
