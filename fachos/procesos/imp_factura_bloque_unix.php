       ...
       // $htmlFactura .= "<div align='center' style='position: absolute;top:".$wtop."px;left:".$wleft."px'>";
        ...
        while( odbc_fetch_row($resdes) )
        {
            ...
            if($cont<$limite_conceptos && !$cx_no_pos) //********************************************************************
            {
                ...
                $htmlFactura .= "<td style='width:39mm;font-size:9pt;' align='left'>".$wtde."</td>";                 //Descripci�n tercero
                $htmlFactura .= "<td style='width:22mm;font-size:10pt;' align='right'>".number_format( $valor_clinica, 0,'.', ',' )."</td>";    //Valor cl�nica
        ...
        if ($cx_no_pos)
        {
            // if (isset($wnopos) && $wnopos == '2')
            {
                ...
                $htmlFactura .= "<td style='width: 22mm;font-size:10pt;' align='right'>".number_format( $total_clinica, 0,'.', ',' )."</td>";    //Valor cl�nica
            ...
            if(isset($wnopos) && $wnopos == '3' && $hay_paf)  // 2012-11-16 para mostrar todo lo que es del concepto tipo PAF
            {
                ...
                $htmlFactura .= "<td style='width: 39mm;font-size:9pt;' align='left'>&nbsp;</td>";                 //Descripci�n tercero
                $htmlFactura .= "<td style='width: 22mm;font-size:10pt;' align='right'>".number_format( $total_clinica_paf, 0,'.', ',' )."</td>";    //Valor cl�nica
        ...
        $htmlFactura .= "<td align='right' valign='middle' style='border-top: 1px solid #000000; font-size:10pt;'>".number_format( $total_clinica, 0,'.', ',' )."</td>";	//Valor cl�nica
       ...
       /* if($wparam=="1")
		...
		if ($num > 0){
			...
			echo "<tr><td class='fila2' height='37' valign='bottom' colspan='2' align='center'>
					<b>El n�mero m�ximo de copias a imprimir es de ".$wmaximo_paginas."</b>
				</td></tr>";
			...
			echo "<tr><td class='fila2' height='37' valign='bottom' colspan='2' align='center'>
			Quedan <b>".$row[0]."</b> facturas pendientes de impresi�n
			</td></tr>";
