...
<script type="text/javascript">
    ...
    function regresar(){
       ...
       window.location = "imp_factura_unix2.php?wemp_pmla="+wemp_pmla+"&wparam=1";
    }
...
//==================================================================================================================================
//PROGRAMA                   : imp_factura_unix2.php
...
*/
  ...
  function imprimir_factura($wfactura, $wparam){
      ...
      while( odbc_fetch_row($res) )
		...
		// --> 	Parametro multiplicador para impresion, esto es porque a lo ancho 1mm en el html no es igual a 1mm en el papel de impresora
		//		1mm en el papel impreso equivale a 1.67 mm en el html.
		$mult = 1.67;
						
        $htmlFactura  .= " <div class='nobreak' style='position: absolute;top:1mm;left:3mm'>";
		
		// --> 1ra fila: Fecha y fecha de venciemiento
        $htmlFactura .= "
		<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm; height:".(5*$mult)."mm; font-size:10pt;'  class='monoespaciado'>
			<tr>		
				<td style='width:".(124*$mult)."mm;' align='center'>No. ".$wfactura."</td>";
        
		$htmlFactura .= "<td style='width:".(8*$mult)."mm;' 	align='center' >".substr($wfec,8,2)."</td>";            //Fecha
        $htmlFactura .= "<td style='width:".(8*$mult)."mm;'		align='center' >".substr($wfec,5,2)."</td>";            //Fecha
        $htmlFactura .= "<td style='width:".(15*$mult)."mm;' 	align='center' >".substr($wfec,0,4)."</td>";            //Fecha
        $htmlFactura .= "<td style='width:".(8*$mult)."mm;' 	align='center' >".substr($wfev,8,2)."</td>";            //Fecha de vencimiento
        $htmlFactura .= "<td style='width:".(8*$mult)."mm;' 	align='center' >".substr($wfev,5,2)."</td>";            //Fecha de vencimiento
        $htmlFactura .= "<td style='width:".(15*$mult)."mm;' 	align='center' >".substr($wfev,0,4)."</td>";            //Fecha de vencimiento                                                             //Espacio vacio
        $htmlFactura .= "</tr>";
        $htmlFactura .= "</table>";
       ...
       /* $htmlFactura .= "<table cellspacing='0' cellpadding='0' style='width:185mm;font-size:11pt;height:8mm;'  class='monoespaciado'>";
        ...
        $htmlFactura .= "<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;font-size:10pt;height:".(8)."mm;'  class='monoespaciado'>";
        $htmlFactura .= "	<tr>";
        $htmlFactura .= "		<td align='left'	style='width:".(73*$mult)."mm;font-size:8pt;padding-top:".(2)."mm;padding-left:".(2*$mult)."mm' valign='top'>".$wres."</td>"; 		// Nombre responsable
        $htmlFactura .= "		<td align='center' 	style='width:".(30*$mult)."mm;'>".$wced."</td>";  				// NIT responsable
        $htmlFactura .= "		<td align='center' 	style='width:".(55*$mult)."mm;font-size:8pt;padding-top:".(2)."mm' valign='top'>&nbsp</td>";   // Domicilio responsable
        $htmlFactura .= "		<td align='center' 	style='width:".(20*$mult)."mm;'>&nbsp</td>";   					// Telefono responsable
        $htmlFactura .= "	</tr>";
        $htmlFactura .= "</table>";
        ...
        $htmlFactura .= "	<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;font-size:10pt;height:".(8)."mm;' class='monoespaciado'>";
        $htmlFactura .= "		<tr>";
        $htmlFactura .= "			<td style='width:".(96*$mult)."mm;padding-top:".(1)."mm;padding-left:".(2*$mult)."mm;font-size:9pt' 	align='left' 	>".$wpac."</td>"; 	//Paciente
        $htmlFactura .= "			<td style='width:".(8*$mult)."mm;'												align='center' 	>".substr($wfec,8,2)."</td>";	//Fecha de ingreso
        $htmlFactura .= "			<td style='width:".(8*$mult)."mm;' 												align='center' 	>".substr($wfec,5,2)."</td>";	//Fecha de ingreso
        $htmlFactura .= "			<td style='width:".(15*$mult)."mm' 												align='center' 	>".substr($wfec,0,4)."</td>";	//Fecha de ingreso
        $htmlFactura .= "			<td style='width:".(8*$mult)."mm' 												align='center' 	>".substr($wfec,8,2)."</td>";	//Fecha de ingreso
        $htmlFactura .= "			<td style='width:".(8*$mult)."mm' 												align='center' 	>".substr($wfec,5,2)."</td>";	//Fecha de ingreso
        $htmlFactura .= "			<td style='width:".(15*$mult)."mm' 												align='center' 	>".substr($wfec,0,4)."</td>";	//Fecha de ingreso
        $htmlFactura .= "			<td style='width:".(28*$mult)."mm' 												align='center' 	>".$whis."-".$wing."</td>";	//Fecha de ingreso
		$htmlFactura .= "		</tr>
							</table>";
         ...
         $htmlFactura .= "<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;height:73mm;'  class='monoespaciado' ><tr><td valign='top'>";
         $htmlFactura .= "<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;font-size:9pt; valign:top;' class='monoespaciado'>";
         $htmlFactura .= "<tr style='height:35mm'>";
         $htmlFactura .= "<td style='width:".(14*$mult)."mm;'>&nbsp;</td>";  //Espacio muerto
         $htmlFactura .= "<td style='width:".(50*$mult)."mm;'>&nbsp;</td>";  //Espacio muerto
         $htmlFactura .= "<td style='width:".(39*$mult)."mm;'>&nbsp;</td>";  //Espacio muerto
         $htmlFactura .= "<td style='width:".(22*$mult)."mm;' align='right' valign='bottom'>&nbsp;</td>";  //Encabezado CLINICA
         $htmlFactura .= "<td style='width:".(22*$mult)."mm;' align='right' valign='bottom'>&nbsp;</td>"; //Encabezado TERCEROS
         $htmlFactura .= "<td style='width:".(35*$mult)."mm;' align='right' valign='bottom'>&nbsp;</td>"; //Encabezado TOTAL
         $htmlFactura .= "</tr>";
         ...
         if( $imprimirDetallePaquete == "on" ){
            ...
            while( odbc_fetch_row($resdes) )
            {
                ...
                // {
                    ...
                    $htmlFacturaDetalle .= "<tr style='height:".(4*$mult)."mm'>";
                    $htmlFacturaDetalle .= "<td style='width:".(14*$mult)."mm;font-size:9pt;' align='center'>".$wcon2105."</td>";               //Codigo concepto
                    $htmlFacturaDetalle .= "<td style='width:".(50*$mult)."mm;font-size:9pt;' align='left'>".substr($wcde2105,0,28)."</td>";    //Descripcion concepto
                    $htmlFacturaDetalle .= "<td style='width:".(39*$mult)."mm;font-size:9pt;' align='left'>".$wtde2105."</td>";                 //Descripción tercero
                    $htmlFacturaDetalle .= "<td style='width:".(22*$mult)."mm;font-size:10pt;' align='right'>&nbsp;</td>";    //Valor clínica
                    $htmlFacturaDetalle .= "<td style='width:".(22*$mult)."mm;font-size:10pt;' align='right'>&nbsp;</td>";    //Valor tercero
                    $htmlFacturaDetalle .= "<td style='width:".(38*$mult)."mm;font-size:10pt;' align='right'>".number_format( $wval2105, 0,'.', ',' )."</td>";
         ...
         $htmlFactura .= "<td style='width:".(14*$mult)."mm;font-size:9pt;' align='center'>".$codigo."</td>";               //Codigo concepto
         $htmlFactura .= "<td style='width:".(50*$mult)."mm;font-size:9pt;' align='left'>".$descripcion."</td>";    //Descripcion concepto
         $htmlFactura .= "<td style='width:".(39*$mult)."mm;font-size:9pt;' align='left'>&nbsp;</td>";                 //Descripción tercero
         $htmlFactura .= "<td style='width:".(22*$mult)."mm;font-size:10pt;' align='right'>&nbsp</td>";    //Valor clínica
         $htmlFactura .= "<td style='width:".(22*$mult)."mm;font-size:10pt;' align='right'>&nbsp;</td>";    //Valor tercero
         $htmlFactura .= "<td style='width:".(35*$mult)."mm;font-size:10pt;padding-right:".(2*$mult)."mm' align='right'>".number_format( $wval, 0,'.', ',' )."</td>";
         $htmlFactura .= "</tr>";
         $wval += $wval2105;
         if( $imprimirDetallePaquete == "on" ){
        ...
        $total_neto = $subtotal+$iva-$cop_cmo_frq-$ant_exc;
          ...
          //Forma de pago
         $htmlFactura .= "<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;font-size:9pt;height:30mm;' class='monoespaciado'>";
         ...
         $htmlFactura .= "<td style='width:".(23*$mult)."mm;'></td>";
         $htmlFactura .= "<td style='width:".(38*$mult)."mm;padding-right:".(1*$mult).";padding-top:".(2*$mult)."' align='right' valign='top'>".number_format( $wval, 0,'.', ',' )."<br>".number_format( $wval, 0,'.', ',' )."<br><br><br><br>".number_format( $cop_cmo_frq, 0,'.', ',' )."<br>".number_format( $total_neto, 0,'.', ',' )."</td>";
         $htmlFactura .= "</tr>";
         $htmlFactura .= "</table>";
        ...
        $htmlFactura .= "<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;height:18mm; font-size:9pt;' class='monoespaciado'>";
        $htmlFactura .= "<tr>";
        $htmlFactura .= "<td style='width:".(109*$mult)."mm;'>&nbsp;</td>"; //Espacio muerto, aqui va donde dice  ELABORADO POR      RECIBI CONFORME
       ...
       $htmlFactura .= "<td style='width:".(76*$mult)."mm;margin-top:15mm;' align='left' valign='top'>";
        ...
        if($existen_facturas=='off')
		{
			...
			echo "<META HTTP-EQUIV='REFRESH' CONTENT='0;imp_factura_unix2.php?wemp_pmla=".$wemp_pmla."&wparam=".$wparam."'>";
		} 
		  else{
			...
			echo "<META HTTP-EQUIV='REFRESH' CONTENT='5;imp_factura_unix2.php?wemp_pmla=".$wemp_pmla."&wparam=".$wparam."'>";
...
function imprimir_factura_detalle($wfactura, $wparam, $wnopos, $wimpresora, $wffa, $fechaIngresoEvolucion)
{
    ...
    while( odbc_fetch_row($res) )
    {
       ...
       $htmlFactura   = "<style>
		...
		// border:1px;border-style:dotted dotted dotted dotted
		...
		$htmlFactura  .= " 
		<div id='htmlImpFactura'>
		<div class='nobreak' style='position: absolute;top:".($wtop*$mult)."mm;left:".($wleft*$mult)."mm'>";
        // --> 1ra fila: Fecha y fecha de venciemiento
        $htmlFactura .= "
		<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm; height:".(5*$mult)."mm; font-size:10pt;'  class='monoespaciado'>
			<tr>		
		...
		$htmlFactura .= "<td style='margin-top:".(4*$mult)."mm; width:".(8*$mult)."mm;' 	align='center' >".substr($wfec,8,2)."</td>";            //Fecha
        $htmlFactura .= "<td style='margin-top:".(4*$mult)."mm; width:".(8*$mult)."mm;'		align='center' >".substr($wfec,5,2)."</td>";            //Fecha
        $htmlFactura .= "<td style='margin-top:".(4*$mult)."mm; width:".(15*$mult)."mm;' 	align='center' >".substr($wfec,0,4)."</td>";            //Fecha
        $htmlFactura .= "<td style='margin-top:".(4*$mult)."mm; width:".(8*$mult)."mm;' 	align='center' >".substr($wfev,8,2)."</td>";            //Fecha de vencimiento
        $htmlFactura .= "<td style='margin-top:".(4*$mult)."mm; width:".(8*$mult)."mm;' 	align='center' >".substr($wfev,5,2)."</td>";            //Fecha de vencimiento
        $htmlFactura .= "<td style='margin-top:".(4*$mult)."mm; width:".(15*$mult)."mm;' 	align='center' >".substr($wfev,0,4)."</td>";            //Fecha de vencimiento
       ...
       $htmlFactura .= "</table>";
        ...
        $htmlFactura .= "<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;font-size:10pt;height:".(8)."mm;'  class='monoespaciado'>";
        $htmlFactura .= "	<tr>";
        $htmlFactura .= "		<td align='left'	style='width:".(73*$mult)."mm;font-size:8pt;padding-top:".(2)."mm;padding-left:".(2*$mult)."mm' valign='top'>".trim(substr($wres,0,50))."</td>"; 		// Nombre responsable
        $htmlFactura .= "		<td align='center' 	style='width:".(30*$mult)."mm;'>".trim($wcod)."-".$wdiv."</td>";  				// NIT responsable
        $htmlFactura .= "		<td align='center' 	style='width:".(55*$mult)."mm;font-size:8pt;padding-top:".(2)."mm' valign='top'>".$domicilioResponsable."</td>";   // Domicilio responsable
        $htmlFactura .= "		<td align='center' 	style='width:".(20*$mult)."mm;'>".substr($wtel,0,8)."</td>";   					// Telefono responsable
        $htmlFactura .= "	</tr>";
        $htmlFactura .= "</table>";
        ...
        $htmlFactura .= "	<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;font-size:10pt;height:".(8)."mm;' class='monoespaciado'>";
        $htmlFactura .= "		<tr>";
        $htmlFactura .= "			<td style='width:".(96*$mult)."mm;padding-top:".(1)."mm;padding-left:".(2*$mult)."mm;font-size:9pt' 	align='left' 	>".substr($wpac,0,42)."</td>"; 	//Paciente
        $htmlFactura .= "			<td style='width:".(8*$mult)."mm;'												align='center' 	>".substr($wfecing,8,2)."</td>";	//Fecha de ingreso
        $htmlFactura .= "			<td style='width:".(8*$mult)."mm;' 												align='center' 	>".substr($wfecing,5,2)."</td>";	//Fecha de ingreso
        $htmlFactura .= "			<td style='width:".(15*$mult)."mm' 												align='center' 	>".substr($wfecing,0,4)."</td>";	//Fecha de ingreso
        //si es de ayudas diagnosticas no muestra fecha de salida
        if(odbc_fetch_row($err_ay))
		{
			$htmlFactura .= "		<td style='width:".(8*$mult)."mm;' 	align='center'>".$wfecegr."</td>";   //Fecha de salida
			$htmlFactura .= "		<td style='width:".(8*$mult)."mm;' 	align='center'>".$wfecegr."</td>";   //Fecha de salida
			$htmlFactura .= "		<td style='width:".(15*$mult)."mm;' align='center'>".$wfecegr."</td>";   //Fecha de salida
		}
        $htmlFactura .= "			<td style='width:".(8*$mult)."mm;' 	align='center'>".substr($wfecegr,8,2)."</td>";   	//Fecha de salida
        $htmlFactura .= "			<td style='width:".(8*$mult)."mm;' 	align='center'>".substr($wfecegr,5,2)."</td>";   	//Fecha de salida
        $htmlFactura .= "			<td style='width:".(15*$mult)."mm;' align='center'>".substr($wfecegr,0,4)."</td>";   	//Fecha de salida
        $htmlFactura .= "			<td style='width:".(28*$mult)."mm' 	align='center'>".$whis."-".$wing."</td>";    		//Estadia
        $htmlFactura .= "		</tr>";
        $htmlFactura .= "	</table>";

        $htmlFactura .= "	<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;font-size:10pt;height:".(8)."mm;'  class='monoespaciado'>";
        $htmlFactura .= "		<tr>";
        $htmlFactura .= "			<td style='width:".(69*$mult)."mm;padding-left:".(4*$mult)."mm;padding-top:".(1)."mm;'	align='left'>".trim($tipoDocumento." - ".$wcep)."</td>";	//Documento de identidad del paciente
        $htmlFactura .= "			<td style='width:".(116*$mult)."mm;' 																>HOSPITALIZADO - PENSIONADO</td>";				//Tipo de atencion
        $htmlFactura .= "		</tr>";
        $htmlFactura .= "	</table>";

        $htmlFactura .= "	<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm; height:".(8)."mm;'  class='monoespaciado' ><tr><td></td></tr></table>"; //Linea en blanco es donde va la Resolucion de la DIAN 
        ...
        $htmlFactura .= "<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;height:".(73)."mm;'  class='monoespaciado'>
							<tr>
								<td valign='top' style=''>";
        $htmlFactura .= "			<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;font-size:9pt; valign:top;' class='monoespaciado'>";
        $htmlFactura .= "				<tr style='height:".(4)."mm'>";
        $htmlFactura .= "					<td style='width:".(14*$mult)."mm;'>&nbsp;</td>";  //Espacio muerto
        $htmlFactura .= "					<td style='width:".(50*$mult)."mm;'>&nbsp;</td>";  //Espacio muerto
        $htmlFactura .= "					<td style='width:".(39*$mult)."mm;'>&nbsp;</td>";  //Espacio muerto
        $htmlFactura .= "					<td style='width:".(22*$mult)."mm;' align='right' valign='bottom'>CLINICA</td>";  //Encabezado CLINICA
        $htmlFactura .= "					<td style='width:".(22*$mult)."mm;' align='right' valign='bottom'>TERCEROS</td>"; //Encabezado TERCEROS
        $htmlFactura .= "					<td style='width:".(38*$mult)."mm;' align='right' valign='bottom'>TOTAL</td>"; //Encabezado TOTAL
        $htmlFactura .= "				</tr>";
        ...
        while( odbc_fetch_row($resdes) )
        {
            ...
            if($cont<$limite_conceptos && !$cx_no_pos) //********************************************************************
            {
                //$htmlFactura .= "<tr style='height:0.4cm'>";
                $htmlFactura .= "<tr style='height:".(4)."mm'>";
                $htmlFactura .= "	<td style='width:".(14*$mult)."mm;font-size:9pt;' 								align='center'>".$wcon."</td>";               //Codigo concepto
                $htmlFactura .= "	<td style='width:".(50*$mult)."mm;font-size:9pt;padding-left:".(2*$mult)."mm' 	align='left'>".substr($wcde,0,28)."</td>";    //Descripcion concepto
                $htmlFactura .= "	<td style='width:".(39*$mult)."mm;font-size:9pt;' 								align='left'>".$wtde."</td>";                 //Descripción tercero
                $htmlFactura .= "	<td style='width:".(22*$mult)."mm;font-size:10pt;' 								align='right'>".number_format( $valor_clinica, 0,'.', ',' )."</td>";    //Valor clínica
                $htmlFactura .= "	<td style='width:".(22*$mult)."mm;font-size:10pt;' 								align='right'>".(($sumar_clinica_tercero) ? '&nbsp;' : number_format( $valor_tercero, 0,'.', ',' ))."</td>";    //Valor tercero
                $htmlFactura .= "	<td style='width:".(38*$mult)."mm;font-size:10pt;' 								align='right'>".number_format( $wval, 0,'.', ',' )."</td>";
                $htmlFactura .= "</tr>";
            }
        ...
        if ($cx_no_pos)
        {
            // if (isset($wnopos) && $wnopos == '2')
            {
                //$htmlFactura .= "<tr style='height:0.4cm'>";
                $htmlFactura .= "<tr style='height:".(4)."mm'>";
                $htmlFactura .= "	<td style='width:".(14*$mult)."mm;font-size:9pt;' 									align='center'>&nbsp;</td>";               //Codigo concepto
                $htmlFactura .= "	<td style='width: ".(50*$mult)."mm;font-size:9pt;padding-left:".(2*$mult)."mm' 		align='left'>".substr($wcde,0,28)."</td>";    //Descripcion concepto
                $htmlFactura .= "	<td style='width: ".(39*$mult)."mm;font-size:9pt;' 									align='left'>&nbsp;</td>";                 //Descripción tercero
                $htmlFactura .= "	<td style='width: ".(22*$mult)."mm;font-size:10pt;' 								align='right'>".number_format( $total_clinica, 0,'.', ',' )."</td>";    //Valor clínica
                $htmlFactura .= "	<td style='width: ".(22*$mult)."mm;font-size:10pt;' 								align='right'>".number_format( $total_terceros, 0,'.', ',' )."</td>";    //Valor tercero
                $htmlFactura .= "	<td style='width ".(38*$mult)."mm;font-size:10pt;' 									align='right'>".number_format( $total, 0,'.', ',' )."</td>";
                $htmlFactura .= "</tr>";
            }
            ...
            if(isset($wnopos) && $wnopos == '3' && $hay_paf)  // 2012-11-16 para mostrar todo lo que es del concepto tipo PAF
            {
                ...
                $htmlFactura .= "<tr style='height:".(4)."mm;'>";
                $htmlFactura .= "	<td style='width:".(14*$mult)."mm;font-size:9pt;' 								align='center'>".$cod_paf_con."</td>";               //Codigo concepto
                $htmlFactura .= "	<td style='width: ".(50*$mult)."mm;font-size:9pt;padding-left:".(2*$mult)."mm' 	align='left'>".substr($desconPaf,0,28)."</td>";    //Descripcion concepto
                $htmlFactura .= "	<td style='width: ".(39*$mult)."mm;font-size:9pt;' 								align='left'>&nbsp;</td>";                 //Descripción tercero
                $htmlFactura .= "	<td style='width: ".(22*$mult)."mm;font-size:10pt;' 							align='right'>".number_format( $total_clinica_paf, 0,'.', ',' )."</td>";    //Valor clínica
                $htmlFactura .= "	<td style='width: ".(22*$mult)."mm;font-size:10pt;' 							align='right'>".number_format( $total_terceros_paf, 0,'.', ',' )."</td>";    //Valor tercero
                $htmlFactura .= "	<td style='width: ".(38*$mult)."mm;font-size:10pt;' 							align='right'>".number_format( $total_desc_paf, 0,'.', ',' )."</td>";
                $htmlFactura .= "</tr>";
        ...
        if($cont>=$limite_conceptos)
        {
            ...
            $htmlFactura .= "	<td align='left' colspan='2' style='font-size:9pt;padding-left:".(2*$mult)."mm'>OTROS SERVICIOS, Ver Anexo</td>";    //Descripcion concepto
        ...
        $htmlFactura .= "<tr style='height:".(4)."mm;'>";
        $htmlFactura .= "	<td align='center'></td>";
        $htmlFactura .= "	<td align='left' colspan='2' valign='middle' style='padding-left:".(2*$mult)."mm'>TOTAL GENERAL DE LOS SERVICIOS:</td>";	//Descripcion concepto
        ...
        //Forma de pago
        $htmlFactura .= "<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;font-size:9pt;height:".(30)."mm;' class='monoespaciado'>";
        $htmlFactura .= "	<tr>";
        $htmlFactura .= "		<td style='width:".(124*$mult)."mm;padding-left:".(8*$mult)."' valign='top'><br>".montoescrito( $total_neto )."</td>";  //***********************************************
        $htmlFactura .= "		<td style='width:".(23*$mult)."mm;'></td>";
        $htmlFactura .= "		<td style='width:".(38*$mult)."mm;padding-right:".(1*$mult).";padding-top:".(4*$mult)."' align='right' valign='top'>".number_format( $total, 0,'.', ',' )."<br>".number_format( $total_descuento, 0,'.', ',' )."<br>".number_format( $subtotal, 0,'.', ',' )."<br>".number_format( $iva, 0,'.', ',' )."<br>".number_format( $ant_exc, 0,'.', ',' )."<br>".number_format( $cop_cmo_frq, 0,'.', ',' )."<br>".number_format( $total_neto, 0,'.', ',' )."</td>";
        $htmlFactura .= "	</tr>";
        $htmlFactura .= "</table>";
        ...
        $htmlFactura .= "<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm;height:".(18)."mm; font-size:9pt;' class='monoespaciado'>";
        $htmlFactura .= "	<tr>";
        $htmlFactura .= "		<td style='width:".(109*$mult)."mm;'>&nbsp;</td>";	//Espacio muerto, aqui va donde dice  ELABORADO POR      RECIBI CONFORME
        //$htmlFactura .= "<td style='width:7.3cm' align='left' valign='top'><font size='1'>".$observacion."</font></td>";		//Observaciones
       ...
       $htmlFactura .= "		<td style='width:".(76*$mult)."mm;' align='left' valign='top'>";
        ...
        $htmlFactura .= "<table cellspacing='0' cellpadding='0' style='width:".(185*$mult)."mm; height:".(3)."mm; font-size:8pt;' class='monoespaciado'>";
        $htmlFactura .= "	<tr>";
        $htmlFactura .= "		<td align='left' valign='top' style='padding-left:".(8*$mult)."'><br>Fecha: ".$logfec." &nbsp;  &nbsp; Hora: ".$loghor." &nbsp;  &nbsp; Usu.: ".$logusu." &nbsp; &nbsp; Term.: ".$logter." &nbsp;  &nbsp;  Per.: ".$logper." </td>";		//Pie de pagina de la factura
        $htmlFactura .= "	</tr>";
        $htmlFactura .= "</table>";
        $htmlFactura .= "</div>";
        $htmlFactura .= "</div>";
...
else
{
    ...
    echo "<form name='impfacunix' id='impfacunix' action='imp_factura_unix2.php' method=post>";
