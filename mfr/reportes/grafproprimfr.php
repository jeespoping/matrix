...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafproprimfr.php'; 
	}
	
	function enter()
	{
		document.forms.grafproprimfr.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//mfr_000002     : Tabla de Bases de datos totales por proceso prioritario.                                                               |
//mfr_000001     : Tabla de movimiento procesos prioritarios.                                                                             |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
	...
	//Forma
	echo "<form name='forma' action='grafproprimfr.php' method='post'>";
	echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";

	if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
	{
		echo "<form name='grafproprimfr' action='' method=post>";
