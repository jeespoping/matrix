...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_proceprioxevamfr.php'; 
	}
	
	function enter()

	{
		document.forms.rep_proceprioxevamfr.submit();
	}
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_proceprioxevamfr.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_proceprioxevamfr' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    $query1 = "SELECT pperso,ppperserva,count(*) as cant"
            ."   FROM ".$empre1."_000001 "
