...
<script type="text/javascript">
	function enter()
	{
		document.forms.rep_cumplixpromfr.submit();
	}
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_cumplixpromfr.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_cumplixpromfr' action='' method=post>";
  ...
  $query = " SELECT ppproc,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppcrite16,ppcrite17,ppcrite18"
           ."   FROM ".$empre1."_000001"
           ."  WHERE ppproc = '".$tpp."'" 
