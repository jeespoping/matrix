<HTML>
<HEAD>
<TITLE>Reporte General de Ordenes PAF SALUD TOTAL</TITLE>
	<style type="text/css">
...
//Forma
echo "<form name='paf13total' action='paf13total.php' method=post>";  
 ...
 if (!isset($wfec1) or !isset($wfec2))
 {
    ...
    echo "<tr>";
	echo "<tr><td align=CENTER colspan=1 bgcolor=#DDDDDD><b><font text color=#003366 size=2>Reporte General de Ordenes PAF Salud Total<br></font></b>";   
	echo "</tr>";
...
/****/
 ...
 else      // Cuando ya estan todos los datos escogidos     **********************************************************************
 {
    ...
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>Reporte General de Ordenes PAF SALUD TOTAL</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>Periodo: ".$wfec1." Al ".$wfec2."</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>PROGRAMA: paf13total.php Ver. 2015/11/26<br>AUTOR: JairS</font></b><br>";
    echo "</table>";
