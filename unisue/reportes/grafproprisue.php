...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafproprisue.php'; 
	}
	
	function enter()
	{
		document.forms.grafproprisue.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//unisue_000002     : Tabla de Bases de datos totales por proceso prioritario.                                                               |
//unisue_000001     : Tabla de movimiento procesos prioritarios.                                                                             |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
	...
	//Forma
	echo "<form name='forma' action='grafproprisue.php' method='post'>";
	echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";

	if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
	{
		echo "<form name='grafproprisue' action='' method=post>";
