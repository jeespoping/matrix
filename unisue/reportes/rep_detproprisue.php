...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detproprisue.php'; 
	}
	
	function enter()
	{
		document.forms.rep_detproprisue.submit();
	}
...
//FECHA CREACION			  :ENERO 14 DE 2013.                                                                                            |
//FECHA ULTIMA ACTUALIZACION  :ENERO 14 DE 2013.                                                                                            |
//TABLAS UTILIZADAS :                                                                                                                       |
//unisue_000001      : Tabla de Procesos prioritarios UNIDAD DEL SUEÑO                                                                      |
//==========================================================================================================================================
include_once("root/comun.php");
$conex = obtenerConexionBD("matrix");

$wactualiz="1.0 14-Enero-2013";
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detproprisue.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
 if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_detproprisue' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
   ...
   $query = " SELECT pping,ppfecha,ppperseva,ppcargoe,ppproc,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppcrite16,ppcrite17,ppcrite18,ppcrite19,ppcrite20,ppobserva,pppor"
           ."   FROM ".$empre1."_000001"
           ."  WHERE ppproc = '".$tpp."'" 
           ."    AND pppor < 100"
           ."    AND ppfecha between '".$fec1."' and '".$fec2."'"
           ."  ORDER BY ppfecha,ppperseva,pping";
	...
	for ($i=1;$i<=$num1;$i++)
	 {
	  ...
	  echo "<table border=0>";	
      echo "<tr>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=100><font size='1' color='#000000'><b>INGRESO:</b></font></td>"; 
      ...
      echo "<td  bgcolor=#FFFFFF align=center width=70><font size=1>&nbsp;$row2[1]</font></td>";
      echo "</tr>";
      echo "</table>";
      ...
      echo "<td  bgcolor=#FFFFFF ><font size=1>&nbsp;$row2[2]</font></td>";
      ...
      echo "<table border=0 >";
      echo "<Tr >";
      echo "<td  bgcolor=#FFFFFF align=left width=100%><font size=1>&nbsp;$row2[25]</font></td>";
      echo "</tr >"; 
      echo "</table>";
      ...
      echo "<td  bgcolor=#FFFFFF align=left width=65%><font size=2 color=#FF0000>&nbsp;<b>".number_format($row2[26])."%</b></font></td>";
      echo "</tr >"; 
      echo "</table>";
