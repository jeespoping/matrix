...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_proceprioxevasue.php'; 
	}
	
	function enter()

	{
		document.forms.rep_proceprioxevasue.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//unisue_000001     : Tabla Procesos Priritarios.                                                                                              |                                                                      |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_proceprioxevasue.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_proceprioxevasue' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    echo "<tr><td align=center colspan=4 bgcolor=#FFFFFF><font text color=#003366 size=2><b>UNIDAD DEL SUEÑO</b></font></td></tr>";
