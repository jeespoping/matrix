...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_procepriosue.php'; 
	}
	
	function enter()

	{
		document.forms.rep_procepriosue.submit();
	}
...
//unisue_000002     : Tabla plan anual x proceso prioritario                                                                                   |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_procepriosue.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_procepriosue' action='' method=post>";
