...
<script>
    function ira()
    {
	 document.cotizaciones03.wmar.focus();
	}
</script>
...
<script type="text/javascript">
	function enter()
	{
		document.forms.cotizaciones03.submit();   // Ojo para la funcion cotizaciones03 <> cotizaciones03  (sencible a mayusculas)
	}

	function vaciarCampos()
	{
	 document.forms.cotizaciones03.wmar.value = '';
	 document.forms.cotizaciones03.wpre.value = '';
     document.forms.cotizaciones03.wbar.value = '';
     document.forms.cotizaciones03.wreg.value = '';
     document.forms.cotizaciones03.wvec.value = 'dd-mm-aaaa';
     document.forms.cotizaciones03.wcum.value = '';
     document.forms.cotizaciones03.wact.value = '';     
     document.forms.cotizaciones03.wcot.value = '';
     document.forms.cotizaciones03.wiva.value = '';
     document.forms.cotizaciones03.wsug.value = '';          
	 document.forms.cotizaciones03.wobs.value = ''; 
    }
...
$wactualiz="PROGRAMA: cotizaciones03.php Ver. 2017-10-03   JairS - AngelaO";
...
{	    
   ...
   {
      $todok = false;
      $msgerr=$msgerr." Debe existir Marca Comercial, Referencia y Laboratorio Fabricante.<br> ";
   }
...
*/         
   ...
   {
      $todok = false;
      $msgerr=$msgerr." Debe indicar si es un Dispositivo Médico con precio regulado.<br> ";
   }   
...
echo "<form name='cotizaciones03' action='cotizaciones03.php' method=post>";  
...
echo "<tr><td align=center colspan=6 bgcolor=#C3D5F7><font size=4 text color=#000000><b>DATOS DEL DISPOSITIVO MEDICO O INSUMO A COTIZAR</b></font></tr>";
   $query = "SELECT concod,connom,conuni,conmes,conano FROM cotizaci_000002 Where concod = '".$wcod."' Order by connom";
...
if ($windicador == "PrimeraVez") 
{
   ...
   $query = "SELECT cotmar,cotpre,cotbar,cotreg,cotvec,cotcla,cotact,cotcot,cotiva,cotsug,cotobs FROM cotizaci_000004"
...
echo "<tr><td align=center colspan=6 bgcolor=#C3D5F7><font size=4 text color=#000000><b>PARAMETROS TECNICOS DEL DISPOSITIVO MEDICO O INSUMO</b></font></tr>";
echo "<tr><td align=center colspan=6 bgcolor=#C3D5F7><font size=3 text color=#000000><b>Recuerde que la presentación comercial se indica en unidad mínima de venta, unidad de empaque</b></font></tr>";
echo "<tr><td align=center colspan=6 bgcolor=#C3D5F7><font size=3 text color=#000000><b>Tenga en cuenta que el valor a cotizar es de acuerdo a la unidad mínima de venta del dispositivo médico o insumo</b></font></tr>";



    echo "<tr><td align=center bgcolor=#8991AF colspan=2><b><font text color=#003366 size=3>Marca Comercial, Referencia y Laboratorio Fabricante:</font></b><br>";
    if (isset($wmar))
    ...
    echo "<td align=center bgcolor=#8991AF colspan=2><b><font text color=#003366 size=3>Posee código de identificación?, cual?:</font></b><br>";
    if (isset($wbar)) {
    ...
    echo "<td align=center bgcolor=#8991AF colspan=2><b><font text color=#003366 size=3>Clasificacion de riesgo:</font></b><br>";
    if (isset($wcum))
    ...
    echo "<td align=center bgcolor=#8991AF colspan=1><b><font text color=#003366 size=3>Dispositivo Médico con precio regulado (Control directo):</font></b><br>";
    if (isset($wsug))
...
//   en la base de datos va a aparecer 1 para SI y 2 para NO
 ...
 //    echo "<INPUT TYPE='text' NAME='wsug' size=15 onkeypress='teclado()'></INPUT></td>";
    ...
    // $wproceso y wnit son variables escondidas que enviaremos cada vez a travez del formulario	   	   	     
   	...
   	echo "<li><A HREF='cotizaciones02.php'style='color: aliceblue'>Regresar</A>";
   	echo "</td></tr>";	
  ...
  { 
   ...
   {	     
     ...
     $query = "SELECT cotano,cotnit,cotcod,cotcot "
             ." FROM cotizaci_000004 Where cotano = '".$wano."' And cotnit = '".$wnit."' And cotcod = '".$wcod."'";
     ...
     else
     {
      ...
      $fecha = date("Y-m-d");
	  $hora = (string)date("H:i:s");		      
      $query = "INSERT INTO cotizaci_000004 VALUES ('cotizaci','".$fecha."','".$hora."','".$wano."','".$wnit."','".$wcod."','".$wmar
