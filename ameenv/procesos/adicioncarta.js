    ...
    $(document).on('click', '#grabar',  function(  ){
        ...
        if (opcion) {
           ...
           $.post("enviocartas.php",
                {
                accion: "siete",
                carta :parseInt(sessionStorage.getItem('carta')),
                datos:datos
                },
                function(data){
...
function evento_empresa() {
    ...
    function(data){
        ...
        if(json.error){
            ...
            $("#nombre").val(json.empresa);
            sessionStorage.setItem('nit',parseInt(json.nit));
            sessionStorage.setItem('carta',parseInt(json.carta));
