...
<html> 
<head> 
<title>Consulta entrega cuentas de cobro</title> 
...
<div align="center"><strong><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Consulta entrega cuentas de cobro</div> 
...
if (isset($_GET["criterio"]))
{
 ...
 { 
   ...
   if ( checkDateTime($txt_criterio) )
    ...
    $criterio = " AND ( envahent like '%" . $txt_criterio . "%' or envahdes like '%" . $txt_criterio . "%' or envahrec like '%" . $txt_criterio . "%' or envahrad like '%" . $txt_criterio . "%') "; 
  }
}
...
$sql="Select envahnro ENVIO,envahfec FEC_SELLO,envahent ENTREGA,envahDES DESTINO,envahrec RECIBE,envahgui NROGUIA,envahrad AS RADICADO"; 
...
$sql="Select ENVIO,FEC_SELLO,ENTREGA,DESTINO,RECIBE,NROGUIA,RADICADO"; 
...
<?php      for($i=1; $i <= $numCampos; $i++)
        ...
        $query="Select envencnit,empnom From caenvenc,inemp"
     	      ." Where envencfue='80' And envencdoc=".odbc_result($res,1)." And envencnit=empcod";
...
<div align="center"><font face="verdana" size="-2"><a class="p" href="ameenv99.php">::Inicio::</a></font></div> 
<form action="ameenv99.php" method="get"> 

<table border="0" cellspacing="0" cellpadding="0" align="center">         
Criterio de busqueda: 
<input type="text" name="criterio" size="22" maxlength="150"> 
<input type="submit" value="Buscar/Refrescar">  Consultas por 'Entrega' o 'Recibe' se hace  por codigo de usuario.
</table> 
