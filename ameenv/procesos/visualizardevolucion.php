...
<div class="container">
	...
	<div class="row ">
        ...
        <input Type="texto" class="form-control" id='codigo' placeholder="Digite el id de la devolucion"  required></input>
        </div>
...
<h1>Facturas contenidas en la devolucion</h1>
...
<a class="btn btn-primary" href="devolucioncartasfront.php" role="button" target="_blank">Nueva Devolucion</a>
</body>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="visualizardevolucion.js"></script>
