...
function guardarNuevaOpcion(){
	...
	if($("#posicion").val() != "" && $("#descripcion").val() != "" && $("#nueva_imagen").val() != ""){
		...
		var ruta = "administrar_herramientas_c.php";
		...
		$.ajax({
			...
			{		
				if(datos.error){									
					...
					$("#tituloMensaje").html("Confirmación");								
					...
					echo "						
						<tr class='".$fila."'>
							<form id='opcionBarra_".$contador."' enctype='multipart/form-data' method='post'> 
								...
								<td>
									<span id='span_descripcionOpcion".$contador."' style='background-color:".$fondofila.";border:".$fondofila.";text-align:center'> ".$rowBarra["Obades"]."</span> 
									<input class='form-control input-sm' id='descripcionOpcion".$contador."' name='descripcion' type='text' value='".utf8_encode($rowBarra["Obades"])."' style='display:none;'>
								</td>
