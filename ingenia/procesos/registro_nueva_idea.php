...
$(document).ready(function(){
	...
	$("#btnAdmin").click(function(){
		...
		location.href = "administracion_ideas.php?wemp_pmla="+idEmpresa;
    });	
	...
	$("#adminHerramientas").click(function(){		
		var idEmpresa = $("#IdEmpresa").val();
		location.href = "administrar_herramientas.php?wemp_pmla="+idEmpresa;
    });	
...
<div class="principalCompleto">
	<div class="principal">
		...
		<div class="row">
			...
			<div class="parteb">
				<br>
				<div class="panel panel-primary"><div class="panel-heading"><b>EJES DE INNOVACI&Oacute;N</b></div></div>
				<div class='partea2'> 
				<div class="wrapper">
				  <div class="item">
				...
				<div class="terminosyCondiciones">
					...
					<?php
						...
						echo "<span style='float:center;'>".$textTerminosCondiciones."</span>"
					?>				
					<br><br>
			...
			<div class="modal-dialog modal-lg ">
			  <div class="modal-content">
				...
				<div class="modal-body" style="padding:10px 40px;">
					...
					<form role="form" id="formRegistro">	
						...
						<table width="100%">
						 ...
						 <br>
						<label for="eje"><span class="obligatorio">*</span> Ubique su idea en alguno de los ejes de innovaci&oacute;n:</label>
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-success" id="enviarForm" disabled > Env&iacute;ar</button>
