		...
		$row = mysql_fetch_assoc($result);			
				...
				if($modificar){
					...
					$htmlRespuesta .= "	<tr class='fila1'>
							<td width='30%'><b>Eje de cambio:</b> </td>
							<td width='70%'>
...
function modificarEstado(id){
	...
	$.post("administracion_ideas_c.php",
		{
			consultaAjax:   'on',
	...
	$.post("administracion_ideas_c.php",
		{
			...
			modificarEje:   true
				...
				$("#tituloIdea").html("Evaluación de idea # "+ id);				
	...
	$.post("administracion_ideas_c.php",
		{
			...
			idIdea:        	id
				...
				$("#titResultadoEvaluacion").html("Resultado de la evaluación idea # "+ id);	
				var objRespuesta = $.parseJSON(respuesta);			
	...
	function calcularTotalEval(){			
		...
		switch(valTot){
			...
			case 6 : decripcionPuntaje = "Idea no innovadora";
					   break;		   
			case 9 : decripcionPuntaje = "Innovación para la institución";
					   break;	
			case 12 : decripcionPuntaje = "Innovación para la institución y para el mercado";
					   break;					   
		}
			...
			<div class="parteb">				
				...
				<tr>
					...
					while($row = mysql_fetch_assoc($res)) {		
						echo "<td style='background-color:".$row["Estcol"]."; height:25px; border-radius: 6px; '>&nbsp;&nbsp;".utf8_encode($row["Estdes"])."&nbsp;&nbsp;</td>
						";
					}
					?>
					</tr>
				...
				while($row = mysql_fetch_assoc($res)) {		
					...
					echo "<tr class='".$fila."'>";
						echo "	
							...
							<td>
								".utf8_encode($row["Descripcion"]). "<br>
						...
						if($row["Ideest"] != "01"){						
							echo "&nbsp;&nbsp;<img src='../../images/medical/ingenia/glyphicons-530-list-alt.png' width='19px' height='19px' title='Ver resultado evaluación' 
        ...
        <div class="modal-body" style="padding:10px 40px;">
			...
			<form id="formEvaluacion">
				...
				<table>
					<tr>
						<td width='60%'>
							<label for='descripcion'> &iquest;Es una propuesta diferente en la institución?</label>
						</td>
						<td width='10%'>
					...
					<tr>
						<td colspan="3">
							<label>Calificación descritiva:</label> <span id="textoCalificacion" >Idea no innovadora</span>
	...
	<div class="modal fade" id="modificarEstadoIdea" role="dialog">
		<div class="modal-dialog modal-lg ">
			<div class="modal-content">
				...
				<div class="modal-body" style="padding:10px 40px;" id="bodyModificarIdea">
					...
					<div>
						...
						<select class="form-control" id="nuevoEstado">
							...
							<option value="06">En implementación</option>
							<option value="07">En operación</option>
						</select>
					</div>
					<div>				
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-success" id="btnCambioEstado" >Guardar modificación</button>
					<button type="submit" class="btn btn-danger btn-default pull-right" data-dismiss="modal" onClick="javascript:location.reload()">Cerrar</button>
				</div>
			</div>      
		</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="padding:10px 40px;" id="bodyAnalisis">
					...
					<form id="formAnalisis">
						...
						<br>						
						<div>				
							<label for='facEconomica'><span class='obligatorio'>*</span> Factibilidad económica</label>	
