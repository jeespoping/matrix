...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detpropritmo.php'; 
	}
	
	function enter()
	{
		document.forms.rep_detpropritmo.submit();
	}
...
//FECHA CREACION			  :MAYO 22 DE 2014.                                                                                             |
//FECHA ULTIMA ACTUALIZACION  :22 de MAYO de 2014.                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//tmo_000002        : Tabla de Procesos prioritaris TMO.                                                                                    |
//==========================================================================================================================================
include_once("root/comun.php");
$conex = obtenerConexionBD("matrix");

$wactualiz="1.0 22-Mayo-2014";
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detpropritmo.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
 if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_detpropritmo' action='' method=post>";
	...
	for ($i=1;$i<=$num1;$i++)
	 {
      ...
      echo "<td align=LEFT bgcolor=#FFFFFF width=150><font size='1' color='#000000'><b>HISTORIA CLINICA:</b></font></td>"; 
      echo "<td  bgcolor=#FFFFFF align=center width=100><font size=1>&nbsp;$row2[1]</font></td>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=150><font size='1' color='#000000'><b>INGRESO:</b></font></td>"; 
