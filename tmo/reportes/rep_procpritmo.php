...
<script type="text/javascript">
	function enter()
	{
		document.forms.rep_procpritmo.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//tmo_000001        : Tabla de plan Anual.                                                                                                  |
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_procpritmo.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";

 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
   	echo "<form name='rep_procpritmo' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    echo "<tr><td align=center colspan=4 bgcolor=#FFFFFF><font text color=#003366><b>TRASPLANTE DE MÉDULA ÓSEA</b></font></td></tr>";
