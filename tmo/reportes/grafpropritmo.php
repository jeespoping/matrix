<html>
<head>
<title>MATRIX - [REPORTE GRAFICA PROCESOS PRIORITARIOS TMO]</title>

<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafpropritmo.php'; 
	}
	
	function enter()
	{
		document.forms.grafpropritmo.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//tmo_000001     : Tabla de Bases de datos totales por proceso prioritario.                                                                 |
//tmo_000002     : Tabla de movimiento procesos prioritarios.                                                                               |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='grafpropritmo.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
 {
	echo "<form name='grafpropritmo' action='' method=post>";
