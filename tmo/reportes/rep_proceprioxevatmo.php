...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_proceprioxevatmo.php'; 
	}
	
	function enter()

	{
		document.forms.rep_proceprioxevatmo.submit();
	}
...
//FECHA ULTIMA ACTUALIZACION  : MAYO 22 DE 2014.                                                                                            |
//DESCRIPCION			      : Este reporte sirve para observar x evaluador a quienes a evaluado.                                          |
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//tmo_000002     : Tabla Procesos Prioritarios.                                                                                             |                                                                      |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_proceprioxevatmo.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_proceprioxevatmo' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    echo "<tr><td align=center colspan=4 bgcolor=#FFFFFF><font text color=#003366 size=2><b>TRASPLANTE DE MÉDULA ÓSEA</b></font></td></tr>";
	 ...
	 if (is_int ($i/2))
      ...
      $row1 = mysql_fetch_array($err1);
	   ...
	   if ($persant==$row1[0] )
	    ...
	    {
	     echo "<tr><td align=center colspan=1 bgcolor=#006699><font text color=#FFFFFF size=2><b>TOTAL PERSONAL QUE EVALUO : </b></font></td><td align=center><font text size=3><b>".number_format($toteva)."</b></td></tr>";
