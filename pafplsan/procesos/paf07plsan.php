...
. " And cardetano = '".$wano."'"
. " And cardetmes = '".$wmes."'"
. " And cardetfec > '2020-02-28'"       // Como esta fue la fecha de inicio la utilizo para acelerar notablemente el query
. " And cardetanu = '0' "
...
$graph->title->Set("PROGRAMA PLUS SANITAS - TOTAL CARGOS HOSPITALIZACION Y AYUDAS ".number_format($wtot,0));
