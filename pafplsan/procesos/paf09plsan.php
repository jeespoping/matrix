...
echo "<table border=1>";
echo "<tr><td align=center bgcolor=#DDDDDD colspan=2><b><font text color=#003366 size=3><i>AUTORIZACION DE SERVICIOS PROGRAMA PLUS SANITAS</font></b>";
echo "<tr><td align=center bgcolor=#DDDDDD colspan=2><b><font text color=#003366 size=3><i>CLINICA LAS AMERICAS</font></b><br>";

     $query="SELECT Id,paffec,pafnom,pafape,pafced,paftel,pafran,paftip,pafdia,pafexa,pafcco,Seguridad,pafobs From pafplsan_000001 WHERE Id =".$wid; 
     ...
     if ($nroreg > 0)      //  Encontro 
     {
      ...
      $query = "SELECT Excento_pago_moderador,Afi_fechanaci FROM pafplsan_000002 Where Afi_identific='".$registro[4]."'";  
      ...
      $query = "SELECT ccocod,cconom FROM costosyp_000005 WHERE Ccoemp = '01' and ccocod='".$registro[10]."'";
      $resultado = mysql_query($query);
      $nroreg = mysql_num_rows($resultado);
      if ($nroreg > 0)      //  Encontro 
      {
