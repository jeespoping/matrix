...
$query = "SELECT Afi_paf_codigo ,count(*)  FROM pafplsan_000002 GROUP BY Afi_paf_codigo  "; 
...
$graph->title->Set("PROGRAMA PLUS SANITAS - USUARIOS POR RANGO - TOTAL USUARIOS ".$wtot ); 
