...
<html> 
<head> 
<title>Sistema de Informacion Programa PLUS SANITAS</title> 
...
<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Sistema de Informacion Programa PLUS SANITAS
<br><td colspan=1 align=center><A HREF='paf01plsan.php?windicador=PrimeraVez&wproceso=Nuevo' TARGET='_blank' >Adicionar nueva Orden</A></td>
</font></strong> 
</div> 
...
if (isset($_GET["criterio"]))
{
 ...
 { 
   $txt_criterio = $_GET["criterio"]; 
     $criterio = " where (pafced like '%" . trim($txt_criterio) . "%' or pafape like '%" . trim($txt_criterio) . "%' or pafnom like '%" . trim($txt_criterio) . "%' or pafcco like '%"
...
$sql="SELECT * FROM pafplsan_000001 Where pafest='X'";
$res=mysql_query($sql); 
$NumeroAnulados=mysql_num_rows($res);


$sql="SELECT paffre,pafced,pafape,pafnom,pafcco,paftip,id,pafest,paffre,paffci,pafexa,pafser  FROM pafplsan_000001 ".$criterio.$criterio2;
...
echo "<th bgcolor='#CCCCCC'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina = ".$pagina."&orden=pafape&criterio=".$txt_criterio."'>Apellidos</a></th>"; 
...
echo "<th bgcolor='#CCCCCC'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina = ".$pagina."&orden=pafser&criterio=".$txt_criterio."'>Tipo Serv</a></th>"; 
...
{ 
 ...
 { 
  ...
  if ($diferencia_dias > 20)    // Con color rojo
  {
   ?> 
   <!-- tabla de resultados --> 
...
<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><b><?php echo $registro["paffre"];
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><b><?php echo $registro["pafape"]; ?></b></font></td> 
...
<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF9900"><b><?php echo $registro["paffre"];
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF9900"><b><?php echo $registro["pafape"]; ?></b></font></td> 
...
<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b><?php echo $registro["paffre"]; 
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b><?php echo $registro["pafape"]; ?></b></font></td> 
    ...
    <?php 
     ...
     {	  
       $wid=$registro[6];
       echo "<td><A HREF='paf01plsan.php?wid=".$wid."&windicador=PrimeraVez&wproceso=Modificar' TARGET='_blank' >Editar</A></td>";	
       ...
       if ($registro[0]=="1")    // Si prioridad es 1 permito anular
        echo "<td><A HREF='paf10plsan.php?wid=".$wid."' TARGET='_blank' >Anular</A></td>";	     
     } 
     else
     {
...
<hr noshade style="color:CC6666;height:1px"> 
<div align="center"><font face="verdana" size="-2"><a class="p" href="paf00plsan.php">::Inicio::</a></font></div> 
<form action="paf00plsan.php" method="get"> 
<center>
<table border="0" cellspacing="0" cellpadding="0" align="center">   
<?php
    echo "Sin Asignar: ";
...
echo "<meta http-equiv='refresh' content='900;url=paf00plsan.php'>";
?> 
