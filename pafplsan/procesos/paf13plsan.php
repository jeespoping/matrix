...
//Forma
echo "<form name='paf13plsan' action='paf13plsan.php' method=post>";  
 ...
 if (!isset($wfec1) or !isset($wfec2))
 {
    ...
    echo "<tr>";
	echo "<tr><td align=CENTER colspan=1 bgcolor=#DDDDDD><b><font text color=#003366 size=2>Reporte General de Ordenes PLUS SANITAS<br></font></b>";   
	echo "</tr>";
...
/****/	
   ...
   $query = "SELECT ccocod,cconom FROM costosyp_000005 where Ccoemp = '01' Order By cconom"; 	         
...
/****/
 ...
 else      // Cuando ya estan todos los datos escogidos     **********************************************************************
 {
    ...
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>Reporte General de Ordenes PLUS SANITAS</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>Periodo: ".$wfec1." Al ".$wfec2."</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>PROGRAMA: paf13plsan.php Ver. 2020/02/19<br>AUTOR: JairS</font></b><br>";
    echo "</table>";
   ...
   { 
     ...
     $archivo = fopen("ordenesplsan.txt","w"); 
    ...
    {        
       ...
       // TOMO EL NOMBRE DEL DX
	    ...
	    $query = "SELECT ccocod,cconom FROM costosyp_000005 WHERE Ccoemp = '01' and ccocod = '".$registro[11]."'";
        $resultadoB=mysql_query($query); 
        if ( $registroB = mysql_fetch_row($resultadoB) )      //  Encontro 
        {
         echo "<td colspan=1 align=center bgcolor='".$wcf."'><font text color=#003366 size=1>(".$registroB[0].") ".$registroB[1]."</td>";	
	...
	echo "<li><A href='ordenesplsan.txt'>Presione Clic Derecho Para Bajar El Archivo ...</A>";
