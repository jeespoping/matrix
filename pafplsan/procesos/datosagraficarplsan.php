...
echo "<form name='datosagraficar' action='datosagraficar.php' method=post>";  

  //Cuerpo de la pagina
  echo "<table align='center' border=0>";
  echo "<tr>";
  echo "<tr><td align=CENTER colspan=4 bgcolor=#DDDDDD><b><font text color=#003366 size=4>Generacion de graficos programa Plus Sanitas en un periodo<br></font></b>";   
  echo "</tr>";
  ...
  if (!isset($wfec2))   // Si no esta seteada entonces la inicializo en el ultimo dia del mes actual con formato aaaa-mm-dd
  {
	...
	{ 
      if (isset($PrimeraVez))  //La primera vez no muestre esta linea
        echo "<tr><td align=CENTER colspan=4 bgcolor=#DDDDDD><A HREF='graficos_pafplsan.php?wind=".$wind."&wfec1=".$wfec1."&wfec2=".$wfec2."' >Graficar <IMG SRC='Icon_05.ico' ALT='Genera Grafico de los datos'></A></td>";	     
      else
        $PrimeraVez="N";
    }
echo "</table>";
