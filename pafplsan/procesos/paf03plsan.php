...
//Forma
echo "<form name='paf03plsan' action='paf03plsan.php' method=post>";  
 ...
 else      // Cuando ya estan todos los datos escogidos
 {
	...
	$archivo = fopen("paf03plsan.txt","w"); 
	
	$query="SELECT id,paffec,pafced,pafape,pafnom,pafexa FROM  pafplsan_000001"
    ...
    { 
      ...
      */
	  ...
	  { // Busco las citas con codigo que empiece por "EC"
        $query ="SELECT cod_med,cod_exa,fecha,Hi,Hf,Edad,fecsol from citaplsa_000001 where Activo='A' And cedula='".$registro[2]."'"
	...
	echo "<li><A href='paf03plsan.txt' >Presione Clic Derecho Para Bajar El Archivo ...</A>";
    echo "<br>";
