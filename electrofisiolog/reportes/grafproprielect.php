...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafproprielect.php'; 
	}
	
	function enter()
	{
		document.forms.grafproprielect.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//electro_000002    : Tabla de Bases de datos totales por proceso prioritario.                                                              |
//electro_000001    : Tabla de movimiento procesos prioritarios.                                                                            |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
	...
	//Forma
	echo "<form name='forma' action='grafproprielect.php' method='post'>";
	echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";

	if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
	{
		echo "<form name='grafproprielect' action='' method=post>";
