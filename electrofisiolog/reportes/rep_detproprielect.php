...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detproprielect.php'; 
	}
	
	function enter()
	{
		document.forms.rep_detproprielect.submit();
	}
...
//FECHA CREACION			  :MAYO 10 DE 2012.                                                                                             |
//FECHA ULTIMA ACTUALIZACION  :10 de MAYO de 2012.                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//electro_000001                : Tabla de Procesos prioritarios M.F.R.                                                                     |
//detselecciones                : Tabla detalle de selecciones                                                                              | 
//==========================================================================================================================================
include_once("root/comun.php");
$conex = obtenerConexionBD("matrix");

$wactualiz="1.0 10-Mayo-2012";
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detproprielect.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
 if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_detproprielect' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
   ...
   $query = " SELECT pphist,pping,ppfecha,ppperseva,ppcargoe,ppproc,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppcrite16,ppobserva,pppor"
           ."   FROM ".$empre1."_000009"
           ."  WHERE ppproc = '".$tpp."'" 
           ."    AND pppor < 100"
	...
	for ($i=1;$i<=$num1;$i++)
	 {
      ...
      echo "<table border=0 >";
      echo "<Tr >";
      echo "<td  bgcolor=#FFFFFF align=left width=100%><font size=1>&nbsp;$row2[22]</font></td>";
      echo "</tr >"; 
      echo "</table>";
      ...
      echo "<td  bgcolor=#FFFFFF align=left width=65%><font size=2 color=#FF0000>&nbsp;<b>".number_format($row2[23])."%</b></font></td>";
      echo "</tr >"; 
      echo "</table>";
