...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_proceprioelect.php'; 
	}
	
	function enter()

	{
		document.forms.rep_proceprioelect.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//electro_000001     : Tabla Procesos Priritarios.                                                                                            |
//electro_000002     : Tabla plan anual x proceso prioritario.                                                                                |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_proceprioelect.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_proceprioelect' action='' method=post>";
