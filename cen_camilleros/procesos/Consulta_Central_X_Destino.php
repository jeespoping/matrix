...
else
{
    ...
    $conex = obtenerConexionBD("matrix");
  	                                                             ...
  	                                                             // =*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*= //
    $wactualiz="(Octubre 09 de 2013)";                            // Aca se coloca la ultima fecha de actualizacion de este programa //
	                                                             // =*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*= //
	//=============================================================================================================================================															 
	//ACTUALIZACIONES
	//Octubre 09 de 2013
	...
	function seleccionar_destino()
	  {
       ...
       $q = " SELECT codigo, nombre "
           ...
           ."  WHERE central = '".$wcentral."'"
           ."    AND unidad != 'INACTIVO' "
		   ."  UNION"
		   ."  SELECT tipcod, tipdes "
	   ...
	   echo "<tr class=fila1><td align=center><font size=5>Seleccione el tipo de cama solicitado: </font></td></tr>";
	   echo "</table>";
	   echo "<br><br><br>";
	   echo "<center><table>";
	   echo "<tr><td align=center><select name='wdestino' onchange='enter()'>";
	   echo "<option> </option>";    
	   for ($i=1;$i<=$num;$i++)
	     {
	...
	if (isset($destino))
	    echo "<input type='HIDDEN' id=wdestino value='".$wdestino."'>";
		
		
	if ($westado_central=="on" and isset($wdestino))   
	  { 
	   ...
	   echo "<br><br>";
	   echo "<center><table>";
       echo "<tr><td><A HREF='Consulta_Central_X_Destino.php?wemp_pmla=".$wemp_pmla."&wcentral=".$wcentral."'>Retornar</A></td></tr>";
       echo "</table></center>";
	  }
     else
       {
