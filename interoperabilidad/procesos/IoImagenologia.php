...
function consultarPacienteConCita($conex, $wemp_pmla, $wmovhos, $historia, $ingreso, $tipoDocumento, $nroDocumento, $cup, $cco_sede, $fecha = '')
{
            ...
            switch ($accion) {
                ...
                case 'crearMensaje':
                    ...
                    if (empty($idCita)) {
                        ...
                        $id = $idCita;
                        actualizarMovimiento($conex, $wmovhos, $id, $datosCita);
                        $rows = consultarDatosPorId($conex, $wmovhos, $id);
                        $datosCita = traducirCamposPorRegistro($rows);
                        $datosCita['cup'] = $cup;
                    }
