 ...
 * @return array|void un arreglo con la información de los cargos pendientes por enviar en la interoperabilidada de dinámica
 */
function consultarEstudiosfacturacion($conex, $whce, $wmovhos, $historia, $ingreso)
{
    ...
    while ($row = mysql_fetch_array($res)) {
        ...
        /** Verificamos si el usuario viene de la forma C-usuario para tomar unicamente el código del usuario**/
...
/**
 * Permite enviar las ordenes por la interoperabilidad de dinámica dependiendo del tipo de envio que reciba
 * @param $conex Conexión para la bd
...
function insertarOrden($conex, $wemp_pmla, $historia, $ingreso, $tipoenvio)
{
     ...
     * ORDENES: Si se realiza el procedimiento desde el módulo de ordenes, se deben leer de las tablas donde se guardan las ordenes
     * FACTURACION: Si se realiza el procedimiento desde el módulo de facturación de cargos, se deben leer las tablas donde se guardan los cargos
     */
        ...
        foreach ($datos as $arrXML) {
            ...
            if (!empty($respuesta)) {
                ...
                if ($status == "S") {
                     ...
                     * segun las tablas de cada operación
                     */
                    if ($tipoenvio == "ORDENES") {
        ...
        if ((isset($valorRespuesta)) && !(empty($valorRespuesta))) {
            if ((isset($wemp_pmla)) && !(empty($wemp_pmla))) {
                ...
                if ($tipoRespuesta == "resultados") {
                    ...
                    /** Separamos el valor de la orden para obtener el tipo de orden, el número de orden y el tipo de respuesta **/
                    ...
                    if ($item !== false) {
                         ...
                         * de la orden es a una orden enviada desde FACTURACIÓN, si esta variable no está definida,
