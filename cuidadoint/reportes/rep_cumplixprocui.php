...
<script type="text/javascript">
	function enter()
	{
		document.forms.rep_cumplixprocui.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//cuiint_000002     : Tabla de Procesos Prioritarios.                                                                                       |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_cumplixprocui.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_cumplixprocui' action='' method=post>";
  ...
  $query = " SELECT ppproc,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15"
           ."   FROM ".$empre1."_000002"
           ."  WHERE ppproc = '".$tpp."'" 
