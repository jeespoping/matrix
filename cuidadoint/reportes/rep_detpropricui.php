...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detpropricui.php'; 
	}
	
	function enter()
	{
		document.forms.rep_detpropricui.submit();
	}
...
//FECHA CREACION			  :ENERO 18 DE 2013.                                                                                            |
//FECHA ULTIMA ACTUALIZACION  :ENERO 18 DE 2013.                                                                                            |
//TABLAS UTILIZADAS :                                                                                                                       |
//cuiint_000002      : Tabla de Procesos prioritarios CUIDADO INTEGRAL                                                                      |
//==========================================================================================================================================
include_once("root/comun.php");
$conex = obtenerConexionBD("matrix");

$wactualiz="1.0 18-Enero-2013";
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detpropricui.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
 if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_detpropricui' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
   ...
   $query = " SELECT ppfecha,ppperseva,ppcargoe,ppproc,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppobserva,pppor"
           ."   FROM ".$empre1."_000002"
           ."  WHERE ppproc = '".$tpp."'" 
           ."    AND pppor < 100"
           ."    AND ppfecha between '".$fec1."' and '".$fec2."'"
           ."  ORDER BY ppfecha,ppperseva";
	...
	for ($i=1;$i<=$num1;$i++)
	 {
      ...
      echo "<td  bgcolor=#FFFFFF align=center width=70><font size=1>&nbsp;$row2[0]</font></td>";
      echo "</tr>";
      echo "</table>";
      ...
      echo "<td  bgcolor=#FFFFFF ><font size=1>&nbsp;$row2[1]</font></td>";
	  ...
	  echo "<td  bgcolor=#FFFFFF align=center><font size=1><b>$row2[4]</b></font></td>";
      ...
      echo "<table border=0 >";
      echo "<Tr >";
      echo "<td  bgcolor=#FFFFFF align=left width=100%><font size=1>&nbsp;$row2[19]</font></td>";
      echo "</tr >"; 
      echo "</table>";
      ...
      echo "<td  bgcolor=#FFFFFF align=left width=65%><font size=2 color=#FF0000>&nbsp;<b>".number_format($row2[20])."%</b></font></td>";
      echo "</tr >"; 
      echo "</table>";
