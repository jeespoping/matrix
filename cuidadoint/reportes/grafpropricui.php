...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafpropricui.php'; 
	}
	
	function enter()
	{
		document.forms.grafpropricui.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//cuiint_000003     : Tabla de Bases de datos totales por proceso prioritario.                                                               |
//cuiint_000002     : Tabla de movimiento procesos prioritarios.                                                                             |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
	...
	//Forma
	echo "<form name='forma' action='grafpropricui.php' method='post'>";
	echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";

	if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
	{
		echo "<form name='grafpropricui' action='' method=post>";
