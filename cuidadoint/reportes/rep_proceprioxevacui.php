...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_proceprioxevacui.php'; 
	}
	
	function enter()

	{
		document.forms.rep_proceprioxevacui.submit();
	}
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_proceprioxevacui.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_proceprioxevacui' action='' method=post>";
