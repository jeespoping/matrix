...
// Modificaciones:
//																															                 |
// Agosto 30 de 2012 (Viviana Rodas) Se modifican las consultas agregando la tabla movhos_000020 para imprimir en orden las habitaciones.    | 
// Junio 15 de 2012 (Viviana Rodas) Se agregaron las funciones consultaCentrosCostos y dibujarSelect que listan los centros de costos en 
//                  orden alfabetico, de un grupo seleccionado y dibujarSelect que construye el select de dichos centros de costos		     |
// Noviembre 29 de 2011	(Edwin MG)	En la cosulta principal, se verfica que los articulos de CM, no existan en SF para evitar duplicados
//

// ==========================================================================================================================================
$wactualiz = "2012-08-30";
    ...
    if (!isset($wcco))
     {
      elegir_centro_de_costo();
    ...
    else // Cuando ya estan todos los datos escogidos
       {
        ...
        ////////////////////
        ////////////////////
		echo "<br>".$q = "DROP TEMPORARY TABLE IF EXISTS TEMPO";
		$res = mysql_query($q,$conex) or die ("Error: ".mysql_errno()." - en el query: ".$q." - ".mysql_error());

		echo "<br>".$q = " CREATE TEMPORARY TABLE if not exists TEMPO as "
         ...
         echo "<br>".$q = " SELECT ubihac, ubisac, cconom, art, ubihis, ubiing, pacno1, pacno2, pacap1, pacap2, sum(sal), artuni, " .$wbasedato."_000020.habcod, " .$wbasedato."_000020.habord "
