...
else
{
	...
	echo "<form action='ListadoDev.php'  method=post>";
	...
	else
	{
		...
		for ($k=0;$k<count($wccoe);$k++)
		{
			...
			if ($contador>0)
			{
				...
				echo "<tr><th align=CENTER bgcolor=DDDDDD colspan='7'><font size=2>".$wccoe[$k]."-".$wccodes[$k]."</font></th></tr>";
		...
		echo "<tr>";
		echo "<td colspan=4 bgcolor=DDDDDD>TOTALES</td>";
