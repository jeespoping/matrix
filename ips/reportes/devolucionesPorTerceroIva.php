...
else
{
	...
	else
	{
		...
		if ($rango1==1)
		{
			...
			$q = " SELECT menfac, menfec, mdeart, venffa, fdefac, fentip, fenres,  fencod, empnit, empnom, SUM(ROUND((Mdecan*vdevun/(1+(vdepiv/100))),0)-vdedes*Mdecan/vdecan) + SUM(ROUND((((Mdecan*vdevun/(1+(vdepiv/100)))-vdedes*Mdecan/vdecan)*(vdepiv/100)),0)), '-', SUM(ROUND((((Mdecan*vdevun/(1+(vdepiv/100)))-vdedes*Mdecan/vdecan)*(vdepiv/100)),0)) "
		...
		if ($rango2==1)
		{
			...
			$q = " SELECT menfac, menfec, mdeart, venffa, fdefac, fentip, fenres,  fencod, empnit, empnom, SUM(ROUND((Mdecan*vdevun/(1+(vdepiv/100))),0)-vdedes*Mdecan/vdecan) + SUM(ROUND((((Mdecan*vdevun/(1+(vdepiv/100)))-vdedes*Mdecan/vdecan)*(vdepiv/100)),0)), rdenum, , SUM(ROUND((((Mdecan*vdevun/(1+(vdepiv/100)))-vdedes*Mdecan/vdecan)*(vdepiv/100)),0)) "
			."    FROM $table, ".$wbasedato."_000016, ".$wbasedato."_000017, ".$wbasedato."_000019,  ".$wbasedato."_000018, ".$wbasedato."_000024  "
		...
		{			
			...
			while (($i<$contador) and ($wtipemp==$vector[$i][5]))
			{
				...
				while (($i<$contador) and ($wtipemp==$vector[$i][5]) and ($wempresa==$vector[$i][6]))
				{
					if ($wtipemp != "01-PARTICULAR")
					{
						...
						echo "<td ALIGN=RIGHT>".number_format($vector[$i][12],0,'.',',')."</td>";
					...
					$wtoIemp = $wtoIemp + $vector[$i][12];
					$wtoItem = $wtoItem + $vector[$i][12];
					$wtoIgen = $wtoIgen + $vector[$i][12];
				...
				if ($wtipemp != "01-PARTICULAR")
				{
					...
					echo "<td bgcolor=FFFFCC ALIGN=RIGHT><b>".number_format($wtoIemp,0,'.',',')."</b></td>";
			...
			echo "<td bgcolor=CCCCFF ALIGN=RIGHT><b>".number_format($wtoItem,0,'.',',')."</b></td>";
		...
		echo "<td ALIGN=RIGHT bgcolor=CCFFCC><b>".number_format($wtoIgen,0,'.',',')."</b></td>";
		...
		if ($rango1==1)
		{
			...
			$q = " SELECT menfac, menfec, mdeart, venffa, vennfa, ventcl, venfec,  vencod, empnit, empnom, SUM(ROUND((Mdecan*vdevun/(1+(vdepiv/100))),0)-vdedes*Mdecan/vdecan) + SUM(ROUND((((Mdecan*vdevun/(1+(vdepiv/100)))-vdedes*Mdecan/vdecan)*(vdepiv/100)),0)), tranum, SUM(ROUND((((Mdecan*vdevun/(1+(vdepiv/100)))-vdedes*Mdecan/vdecan)*(vdepiv/100)),0)) "
		...
		if ($rango2==1)
		{
			...
			$q = " SELECT menfac, menfec, mdeart, venffa, vennfa, ventcl, venfec,  vencod, empnit, empnom, SUM(ROUND((Mdecan*vdevun/(1+(vdepiv/100))),0)-vdedes*Mdecan/vdecan) + SUM(ROUND((((Mdecan*vdevun/(1+(vdepiv/100)))-vdedes*Mdecan/vdecan)*(vdepiv/100)),0)), rdenum, SUM(ROUND((((Mdecan*vdevun/(1+(vdepiv/100)))-vdedes*Mdecan/vdecan)*(vdepiv/100)),0)), sum(Mdecan) "
			."    FROM $table, ".$wbasedato."_000016, ".$wbasedato."_000017,  ".$wbasedato."_000024  "
			."   WHERE Menfec between '".$wfecini2."'"
			."     AND '".$wfecfin2."'"
			."     AND Mencco = '".$wccoe[0]."' "
		...
		while ($i < $contador)
		{
			...
			while (($i<$contador) and ($wtipemp==$vector[$i][5]))
			{
				...
				if ($wtipemp != "01-PARTICULAR")
				{
					echo "<tr><td colspan=10 bgcolor=FFFFCC><b>Empresa: ".$vector[$i][6]."-".$vector[$i][7]."<b></td></tr>";
					echo "<th align=CENTER bgcolor=DDDDDD><font size=2>Nº NOTA</font></th>";
					echo "<th align=CENTER bgcolor=DDDDDD><font size=2>FECHA</font></th>";
					echo "<th align=CENTER bgcolor=DDDDDD><font size=2>FUENTE</font></th>";
					echo "<th align=CENTER bgcolor=DDDDDD><font size=2>FACTURA</font></th>";
