...
//2012-08-06	Camilo Zapata: Se le dió al reporte la hoja de estilos que tienen los demas programas de matrix.
//2012-08-02	Camilo Zapata: Se modificó el script para que agregue la fecha de la última compra de cada articulo cuando se hace la consulta del reporte de manera detallada.
session_start();
...
else
{
	...
	$qcon = "  SELECT Concod "
			...
			."	  AND Conauc = 'on'"	//afecta última compra
