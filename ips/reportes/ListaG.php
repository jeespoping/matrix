...
else
{
	...
	if(!isset($wfecha))
	{
		...
		echo "<tr><td align=center colspan=4 id=tipo19> Ver. 2008-03-12</td></tr>";
	...
	else
	{
		...
		echo "<tr><td align=left id=tipo20>Ver. 2008-03-12</td></tr><tr><td align='center'><input type=button value='Cerrar ventana' onclick='javascript:window.close();'></td></tr></table>";
