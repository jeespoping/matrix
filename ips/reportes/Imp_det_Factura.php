 ...
 */
 ...
 $q = " SELECT fenffa, fenfac, fenfec, fencod, fennit, empnom, fenval, fenviv, fencop, fencmo, fendes, fenabo, fenvnd, fenvnc, fensal, fenesf, "
     ...
     ."   FROM ".$wbasedato."_000018, ".$wbasedato."_000024, ".$wbasedato."_000049 " //.$wbasedato."_000100 "
 ...
 while ( $row100 = mysql_fetch_assoc( $rs100 ) ){
     $wtid = $row100['Pactdo'];
 }
	 ...
	 echo "<td align=center class='fila2' colspan=1>&nbsp;<b>DETALLE DE CARGOS POR FACTURA</b>&nbsp;</td>";
     ...
     if ($num1 > 0)
        {
         ...
         if ($wtiene_paq == "off")
            {
		     while ($j <= $num1)
		        {
		         echo "<tr>";
			     echo "<td align=left class='fila2' colspan=10><b>Concepto:".$row1[1]." : ".$row1[2]."</b></td>";
			     echo "</tr>";
			     $wcodcon=$row1[1];
			     $wnomcon=$row1[2];
         ...
         echo "<tr>";
	     echo "<td align=LEFT colspan=6 class='fila1'><b>Total Cuenta :</b></td>";
	     if ($wtiene_paq == "off")
	        {
