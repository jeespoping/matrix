...
if(!isset($_SESSION['user'])){
	...
	if( (!isset($fecini) && !isset($fecfin) ) || ( $fecini > $fecfin ) ){
		...
		echo "<form name='encabezado' action='RepVentaXAsesorpru.php?wemp_pmla=06' method='post'>";
		echo "<br><br>";
		...
		$contenidoLog = $contenidoLog.date(" (Y-m-d")."-".date("H:i:s) ").": Factura $cont1 Consultando ventas por asesor...*-> \r\n";
		...
		echo "<form action='RepVentaXAsesorpru.php?wemp_pmla=06' method='post'>";
