<html>
<head>
  <title>REPORTE DE CARTERA DE FACTURAS NO ENVIADAS</title>
...
echo "<form action='RepEstCar.php' method=post name='forma'>";
  $wentidad="    CLINICA DEL SUR     ";
  $hora = (string)date("H:i:s");
  $wnomprog="-RepEstCar.php-";  //nombre del reporte
...
//	echo "<td bgcolor=".$wcf." align=center width='80%'><b><font text color=".$wclfg.">FECHA FINAL DE FACTURACION  (AAAA-MM-DD): </font></b><INPUT TYPE='text' NAME='wfecfin' value=".$wfecfin." SIZE=10></td>";
...
//MUESTRA DE DATOS DEL REPORTE
else
  {
    ...
    echo "<tr><td><B>Facturacion:</B>  CLINICA DEL SUR</td>";
	...
	echo "</table></br>";
    echo "<A href='RepEstCar.php?wfecini=".$wfecini."&amp;wfecfin=".$wfecfin."&amp;wtip=".$wtip."&amp;west=".$west."&amp;wemp=".$wemp."&amp;wfue=".$wfue."&amp;bandera='1'><center>VOLVER</center></A><br>";
...
// si son todos los costos los empresas meto todas en un vector para luego preguntarlas en un for 
	...
	if ($wfue =='%-Todas las fuentes')
			{
				$q2 = " SELECT empcod, empnom, empnit,fenffa, fenfac, fenval+fenabo+fencmo+fencop, fenfec, fenesf "
					."     FROM  ".$wbasedato."_000018,".$wbasedato."_000024 "
					."     WHERE  fenfec between '".$wfecini."'"
					."     AND '".$wfecfin."'"
					."     AND fenesf like '".$westado."' " 		  		
					."     AND fenesf != '' "
					."     AND (fenffa =  '".$wfuente."' or fenffa =  '".$wfuente1."')"
    ...
    echo "</table>";
	echo "</br><center><A href='RepEstCar.php?wfecini=".$wfecini."&amp;wfecfin=".$wfecfin."&amp;wfue=".$wfue."&amp;wtip=".$wtip."&amp;west=".$west."&amp;wemp=".$wemp."&amp;bandera='1'>VOLVER</A></center>";   
}
}
?>
</body>
