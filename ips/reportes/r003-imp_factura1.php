...
//version 2008-08-05
//ACTUALIZACIONES
//2008-08-05: Se le coloca la direccion y el telefono para cuando el responsable es particular
session_start();
		...
		if (isset($wfactura))
		{
    		...
    		if($num > 0)
			{
				$row = mysql_fetch_array($err);
			 	...
			 	$wemptel=$row[5];
			 	//2008-08-05
			 	if ($wempdir=="NO APLICA")
			 	{
			 		$query = "SELECT Ingdie "
			 	            ."  FROM ".$empresa."_000018, ".$empresa."_000101 "
				            ." WHERE fenffa = '".$wfact[0]."'"
				            ."   AND fenfac = '".$wfact[1]."-".$wfact[2]."'"
			                ."   AND Fenhis = Inghis " 
			                ."   AND Fening = Ingnin ";
