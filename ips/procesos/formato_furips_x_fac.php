...
<?php
   ...
   ******************************************************************/
	 ...
	 * Modificado:
	 * 2019-04-02	Jessica		- En el campo No factura / cuenta de cobro debe mostrar el n�mero de factura electr�nica, por tal motivo 
	 * 							  se agrega el prefijo al n�mero de factura.
	 ...
	 * 2018-06-22 	Edwin MG	- Al validar la tabla inpac para verificar si el paciente est� activo, se valida con el ingreso seleccionado. Antes de est� publicaci�n, la
	 *							  validaci�n con el ingreso estaba comentada
	 * 2013-09-24 - Se quit� el gui�n del n�mero de factura, para esto la variable $num_factura se le hace un str_replace. Este gui�n se debi� quitar
	 * por solicitud de facturaci�n ya que la malla validadora del fosyga no reconoce estos n�meros de facturas con el gui�n - Mario Cadavid
	 * 2012-11-29 - Se implement� la consulta de eventos catastr�ficos debido que solo se estaba llenando el formato cuando el evento
	 * es accidente de tr�nsito, con este cambio ya llena los datos del formato tambi�n cuando es un evento catastr�fico - Mario Cadavid
	...
	if($tbpac!="")
	{
		...
		*/
		...
		$where = " pachis='".trim($historia)."' "
				 ." AND pacnum='".trim($ingreso)."' "; //2018-06-22 Se activa nuevamente esta l�nea ( antes: --2012/08/17 ya que no busca en inpac bien )
		...
		else
		{
			...
			if( $fueOrigen != '01' ){
				...
				else
				{
					...
					$impresion.= "<tr><td align=center bgcolor='#cccccc'><A NAME='Arriba'><font size=5>FORMULARIO DE RECLAMACI�N DE ACCIDENTES</font></a></tr></td>";
    ...
    <tr>
      ...
      <table style="border: 0pt none ; width: 100%; text-align: left; margin-left: auto; margin-right: auto;" cellpadding="2" cellspacing="2">
		...
		<tbody>
		  ...
		  <td style="width: 8%;">
			<img style="width: 44px; height: 51px;" alt="Escudo de Colombia" src="//mtx.lasamericas.com.co/matrix/images/medical/IPS/escudo-colombia.jpg">
		  </td>
    ...
    <tr>
      ...
      <table style="border: 0pt none ; width: 100%; text-align: left; margin-left: auto; margin-right: auto;" cellpadding="2" cellspacing="2">
		...
		<tbody>
		  ...
		  <td style="width: 8%;">
			<img style="width: 44px; height: 51px;" alt="Escudo de Colombia" src="//mtx.lasamericas.com.co/matrix/images/medical/IPS/escudo-colombia.jpg">		  </td>
