...
//				AND cedula NOT IN (SELECT pacdoc FROM {$wbasedato}_000100 WHERE pacdoc = cedula AND pacact = 'on' )
	...
	echo "<br><br>";
	echo "<center><a href='../../citas/procesos/000001_prx5.php?empresa=$solucionCitas' target='_blank'>Asignar cita</a></center>";
	
	echo "<meta name='met' id='met' http-equiv='refresh' content='60;url=pantallaAdmisionpru.php?wemp_pmla=$wemp_pmla&slDoctor=$slDoctor'>";
