<html>
<head>
  	<title>MATRIX Impresion de Facturas y Anexos ver. 2010-04-06</title>
</head>
<body  BGCOLOR="FFFFFF">
<BODY TEXT="#000066">
<?php
...
else
{
	...
	else
	{
		...
		$query = "select Fenfac,Vencco from ".$empresa."_000018,".$empresa."_000016  ";
		...
		for ($i=0;$i<$num;$i++)
		{
			...
			if($i % 2 == 0)
				...
				$color="#ffffff";
			echo "<tr><td bgcolor=".$color."><font face='tahoma' size=2>".$row[0]."</font></td><td bgcolor=".$color."><font face='tahoma' size=2><A HREF='/matrix/pos/procesos/Imp_facemp.php?wbasedato=".$empresa."&wnrofac=".$row[0]."&wcco=".$row[1]."' target = '_blank'>Factura</font></td><td bgcolor=".$color." align=right><font face='tahoma' size=2><A HREF='/matrix/pos/reportes/anexo1.php?empresa=".$empresa."' target = '_blank'>Anexo 1</font></td><td bgcolor=".$color." align=right><font face='tahoma' size=2><A HREF='/matrix/pos/reportes/anexo2.php?empresa=".$empresa."' target = '_blank'>Anexo 2</font></td><td bgcolor=".$color." align=right><font face='tahoma' size=2><A HREF='/matrix/pos/reportes/anexo3.php?empresa=".$empresa."' target = '_blank'>Anexo 3</font></td></tr>";	
		}
		echo"</table>";
	}
}
