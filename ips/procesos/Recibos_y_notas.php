...
{	
	                         ...
	                         if ($wtotfpa == ($wtotvcafac))
	                            {
				                 ...
				                 echo "<td align=center bgcolor=#99FFCC colspan=".($wcol)."><font size=2><b><A href='imp_documento.php?wnrodoc=".strtoupper($wnrodoc)."&amp;wfuedoc=".$wcodfue[0]."&amp;wbasedato=".$wbasedato."&amp;wcco=".$wcco."' TARGET='_blank'>Imprimir_Documento</A></b></font></td>";
  ...
  if (isset($wfuente) and isset($wnrodoc) and $wfuente != "" and $wnrodoc != "") 
     echo "<td align=center colspan=7 bgcolor=#ffcc66><font color=#000066 size=5><A href='Imp_documento.php?wnrodoc=".strtoupper($wnrodoc)."&amp;wfuedoc=".$wfuente."&amp;wbasedato=".$wbasedato."&amp;wcco=".$wcco."'> Imprimir Documento</A></font></td>";
