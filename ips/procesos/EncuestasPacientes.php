...
*/
	...
	function cerrarEncuesta (encuesta, mostrarMensaje)
	{
		...
		var contestadas = 0;
		$('input[name^="iCheck_'+encuesta+'"]').each(function (index) {
			var name = this.name;
	...
	switch($accion)
	{
		case "traerppal":
		{
			...
			if($res = mysql_query($select_tablas,$conex))
			{
				...
				$html.="<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>".encabezado("Encuestas De Pacientes".$nombreformulario."", $wactualiz, "clinica")."</div>";
		...
		case "traerEncuestas":
		{
			...
			$select = "SELECT encumage_000060.Enccod, encumage_000060.Encdes, encumage_000060.Encvid, encumage_000060.Encenc, encumage_000060.Encgen,encumage_000060.Encest 
				         FROM encumage_000060 LEFT JOIN ".$wbasedato."_000049 ON (encumage_000060.Encenc = ".$wbasedato."_000049.Encenc AND ".$wbasedato."_000049.Enchis='".$historia."-".$ingreso."' ) 
						 WHERE  ((encumage_000060.Enccco='".$wcco."' AND Encgen ='off' AND encumage_000060.Encest !='off' AND encumage_000060.Encdia ='*' AND Enchfo ='*' AND Enchca ='*' AND Enchva ='*'  AND encumage_000060.Enctem ='*' AND encumage_000060.Encemp ='*' AND encumage_000060.Encafi ='*' ))
						    OR  ( encumage_000060.Encemp ='".$wempresa."' AND Encgen ='off' AND encumage_000060.Encest !='off' AND encumage_000060.Encdia ='*' AND Enchfo ='*' AND Enchca ='*' AND Enchva ='*' AND encumage_000060.Enccco ='*' AND encumage_000060.Enctem ='*'  AND encumage_000060.Encafi ='*' )
							OR  ( Encgen ='on' AND encumage_000060.Encest !='off' AND encumage_000060.Encdia ='*' AND Enchfo ='*' AND Enchca ='*' AND Enchva ='*' AND encumage_000060.Enccco ='*' AND encumage_000060.Enctem ='*' AND encumage_000060.Encemp ='*' AND encumage_000060.Encafi ='*')
							OR  (".$wbasedato."_000049.Encenc !='null')
							GROUP by encumage_000060.Enccod";
