...
if( $peticionAjax == "enviarMsj" ){
    ...
    $mensaje2            = '<div usuarioEscritor="'.$wusuario.'"><font size="1" color="#638cb5">'.$hora.'...<br></font><font size="1" color="#638cb5"><b>'.$wnombreUsuario.' '.$wapellidoUsuario.' </b></font><br><font style="font: 110% sans-serif;" color="#638cb5">'.$msj.'</font><br></div><br>';
...
if( $peticionAjax == "buscarMensajesSinLeer" ){
    ...
    $query = " SELECT Msjure, Msjuen, Fecha_data, Hora_data, msjcoc, Msjtxt, id
    ...
    <script type="text/javascript">
                                ...
                                if( tipoChatActual == "usuario" || tipoChatActual == "" ){
                                    if( usuarioEnvia == usuarioConvActual  ){
                                        ...
                                        if( $(".conversacionesActivas[usuario='"+usuarioConvActual+"']").attr("usuario") == undefined ){
                                            ...
                                            $("#contendor_conversaciones").html(nuevaConversacion);
                                        }else{
        ...
        function nuevoChat( obj ){
            ...
            if( $(padreReceptor).attr("id") == "lista_conversaciones" ){
                $(obj).tooltip("destroy");
                $(obj).remove();
                /*var nuevoObjeto  = $(obj).clone(true);
                nuevoObjeto.attr("mensajePendiente","off");
                $(nuevoObjeto).find("img").remove();
                $(obj).tooltip("destroy");
                $("#lista_usuarios_conectados").append( nuevoObjeto );
                $(obj).remove();*/
            }
        ...
        function buscarElementos( e, input ){
            ...
            if( $.trim($(input).val()) == "" ){
                ...
                $("#"+lista).show();
                $("#"+lista+">li").hide();
                //$("#"+lista+">li[nombre*='"+$(input).val().toUpperCase()+"'][conversacionReciente!='on']").show();
            ...
            if( $(".conversacionesActivas[usuario='"+codigoReceptor+"']") != undefined ){
                ...
                $(conversacionClone).find("div").each(function(){
                    ...
                    if( $(this).attr("usuarioEscritor") == codigoReceptor ){
                        ...
                        $(this).find("font").attr("color", "#638cb5");
...
?>
    <form align='center' id='form_ppal'><br>
        ...
        <center><div id='contenedorPpal' align='center' style='display:block'>
            ...
            <div class='contenedorSecundario' align='center'>
                <div align='left'>
                    <span class='subtituloPagina2' style='cursor:pointer;'><font size='2' id='receptor_actual'></font></span>
                </div>
                        ...
                        <div id='div_mensajes' class='fila2 mensajes'>
                            ...
                            <div id='div_txt' align='left'>
                                <div style='float:left; width:80%; height:90%;'>
                                    <textarea id='txt_nuevoMensaje'disabled class='estilotextarea' onKeypress='validarTecla(event, this);'></textarea>
                                </div>
                                <div style='float:right; width:20%; height:90%;' align='left'>
                                    <input type='button' value='Enviar' id='btn_enviar' disabled onclick='enviarMsj();'></div>
                                </div>
                                <div style='width:100%; height:10%; padding-top:8px;' align='left'>
                                    ...
                                    <table style='border:1; width:60%;'>
                                        ...
                                        <!--<tr><td style='widht:60px;' nowrap='nowrap'><lu class='lista_conversaciones_recientes listasUsuarios' style='list-style-image: url("../../images/medical/root/conectados.png");' listaNumero='1'></lu></td><td style='widht:60px;' nowrap='nowrap'><lu class='lista_conversaciones_recientes listasUsuarios' style='list-style-image: url("../../images/medical/root/conectados.png");' listaNumero='2'></lu></td><td style='widht:60px;' nowrap='nowrap'><lu class='lista_conversaciones_recientes listasUsuarios' style='list-style-image: url("../../images/medical/root/conectados.png");' listaNumero='3'></lu></td></tr>-->
                                        <tr>
                                            ...
                                            <td style='widht:40px;' nowrap='nowrap'><lu class='lista_conversaciones_recientes listasUsuarios' style='width:30px; list-style-image: url("../../images/medical/root/conectados.png");' listaNumero='6'></lu></td></tr>
                                    </table>
                                </div>
                        </div>
        ...
        </div></center><!-- fin contenedor principal-->
    </form>
