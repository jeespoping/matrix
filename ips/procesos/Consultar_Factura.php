...
// SE hizo un filtro en la funcion ver_factura, no en el query sino en la parte donde se arma el html, que pregunta si un médico tiene mas de
//un registro en el maestre de médicos, con el fin de que solo coja el activo, en caso de que solo tenga un registro se permite pintar normal-
//mente                                                                                                                 \\
//========================================================================================================================================\\
// DICIEMBRE 29 DE 2011: Luis Haroldo Zapata Arismendy
//
// Se organiza el reporte para se muestre en pantalla en orden de fecha, fuente y número de factura.                                                                                                                                   \\
...
// Se quito la condición "medest = 'on'" en la consulta de conceptos  - Frederick Aguirre																										  \\
//
//
// S E P T I E M B R E  28  DE 2011:                                                                                                      \\
//________________________________________________________________________________________________________________________________________\\
// Se adicionó la condición "medest = 'on'" en la consulta de conceptos ya que se estaba mostrando registros para doctores que estan      \\
// deshabilitados - Mario Cadavid																										  \\
//																																		  \\
//________________________________________________________________________________________________________________________________________\\
// M A R Z O  30  DE 2011:                                                                                                         		  \\
//________________________________________________________________________________________________________________________________________\\
// En el detalle de la factura se adicionó la columna "Causa / Observacion" donde se muestra las causas  de devoluciones o glosas y las   \\
// observaciones que se hagan a los documentos 																							  \\
//																																		  \\
//________________________________________________________________________________________________________________________________________\\
//D I C I E M B R E  30  DE 2010:                                                                                                         \\
//________________________________________________________________________________________________________________________________________\\
//En las consultas de facturas por far_pmla se estaban repitiendo las filas con los mismos registros, se modifico el Query y se corrigió  \\
//Tambien se actualizó los estilos de la aplicación basándose en la hoja de estilos por defecto del programa							  \\
//                                                                                                                                        \\
//________________________________________________________________________________________________________________________________________\\
...
//________________________________________________________________________________________________________________________________________\\
//Se hace modificacion a la anulación de las facturas, porque se detecto que generan facturas como excedente, pero en realidad son        \\
...
//identificación del paciente o inclusive por ambos o en combinación con el resto de campos de la pantalla.                               \\
//                                                                                                                                        \\
//________________________________________________________________________________________________________________________________________\\
...
//muestra el valor de cada documento, cuando se trata de envios o radicación muestra el valor de todo el envio o radicación y cuando es   \\
	  ...
	  if ((!isset($wfue) and !isset($wfac)) or ((!isset($whis) or !isset($wing) and !isset($whis) and !isset($wval)) or (!isset($wdoc) or !isset($wnom) and !isset($wdoc) and !isset($wnom))))
	     {
		  ...
		  echo "</tr>";
		   echo "<tr>";
		  	echo "<td align=left class='fila1' colspan='2'><b> Documento de Identificación: </b></td><td colspan='2' class='fila2'> <INPUT TYPE='text' NAME='wdoc' SIZE=34 ></td>";
		  echo "</tr>";
		  echo "<tr>";
		 ...
		 /* echo "<table border='0'><tr>";
		  ...
		  echo "<td align=left class='fila1'><b> Documento de Identificación: </b>&nbsp; <INPUT TYPE='text' NAME='wdoc' SIZE=34 ></td>";
		  echo "</tr></table></td>";*/
		  echo "</div>";
		  echo "</fieldset></div>";
		 }
