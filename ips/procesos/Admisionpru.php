...
<!--
	...
	function ajaxquery(fila,id,wdat,wdep,wnin,weda,empresa,querys,querysR,wpos,wposR,numero,numeroR,wmaxing,wact,idCita,wemp2)
	{
		...
		st=st+"&went="+x[36]+"&wdie="+x[37]+"&wtee="+x[38]+"&wtar="+x[42]+"&word="+x[39]+"&wpol="+x[40]+"&wnco="+x[41]+"&weda="+x[45]+"&amb="+x[48];
		...
		ajax.open("POST", "admisionpru.php",true);
...
function pintarInfoPaciente( $id ){
	...
	if( $rows = mysql_fetch_array( $res ) ){
		...
		echo "<td><font color='red'><b>Paciente con Cita:</b></font></td>";
		echo "</tr>";
		echo "<tr align=center>";
...
function valgen($conex,$wtdox,$wdocx,$wap1x,$wno1x,$wfnax,$whisx,$whinx,$wdirx,$wtelx,$wmunx,$wbarx,$wdepx,$wofix,$wceax,$wnoax,$wteax,$wdiax,$wpaax,$wninx,$wfeix,$whinx,$wtpax,$wnitx,$wentx,$wordx,$wpolx,$wncox,$wdiex,$wteex,$werr,$e)
{
	global $empresa;
	...
	{
		$e=$e+1;
		$werr[$e]="ERROR O NO DIGITO OFICIO U OCUPACION";
	}
	if(!validar4($wceax))
	{
		$e=$e+1;
		$werr[$e]="ERROR O NO DIGITO  CEDULA DEL ACUDIENTE";
	}
	if(!validar4($wnoax))
	{
		$e=$e+1;
		$werr[$e]="ERROR O NO DIGITO  NOMBRE DEL ACUDIENTE";
	}
	if(!validar4($wteax))
	{
		$e=$e+1;
		$werr[$e]="ERROR O NO DIGITO  TELEFONO DEL ACUDIENTE";
	}
	if(!validar4($wdiax))
	{
		$e=$e+1;
		$werr[$e]="ERROR O NO DIGITO  DIRECCION DEL ACUDIENTE";
	}
	if(!validar4($wpaax))
	{
		$e=$e+1;
		$werr[$e]="ERROR O NO DIGITO  PARENTESCO DEL ACUDIENTE";
	}
...
function MOD_ING($conex,$whisx,$wtdox,$wdocx,$wtatx,$wap1x,$wap2x,$wno1x,$wno2x,$wfnax,$wsexx,$westx,$wdirx,$wtelx,$wmunx,$wbarx,$wdepx,$wzonx,$wtusx,$wofix,$wceax,$wnoax,$wteax,$wdiax,$wpaax,$wninx,$wfeix,$whinx,$wseix,$wtinx,$wcaix,$wtpax,$wnitx,$wentx,$wordx,$wpolx,$wncox,$wdiex,$wteex,$wtarx,$werr,$e)
{
	global $empresa;
...
function ACT_ING($conex,$whisx,$wtdox,$wdocx,$wtatx,$wap1x,$wap2x,$wno1x,$wno2x,$wfnax,$wsexx,$westx,$wdirx,$wtelx,$wmunx,$wbarx,$wdepx,$wzonx,$wtusx,$wofix,$wceax,$wnoax,$wteax,$wdiax,$wpaax,$wninx,$wfeix,$whinx,$wseix,$wtinx,$wcaix,$wtpax,$wnitx,$wentx,$wordx,$wpolx,$wncox,$wdiex,$wteex,$wtarx,$wambx,$werr,$e)
{
	global $empresa;
	...
	else
	{
		...
		if ($num == 0)
		{
			...
			if($num1 == 0)
			{
				...
				$fecha = date("Y-m-d");
				$hora = (string)date("H:i:s");
				$query = "insert ".$empresa."_000100 (medico,fecha_data,hora_data, Pachis, Pactdo, Pacdoc, Pactat, Pacap1, Pacap2, Pacno1, Pacno2, Pacfna, Pacsex, Pacest, Pacdir, Pactel, Paciu, Pacbar, Pacdep, Paczon, Pactus, Pacofi, Paccea, Pacnoa, Pactea, Pacdia, Pacpaa, Pacact, seguridad) values ('";
				$query .=  $empresa."','";
				$query .=  $fecha."','";
				$query .=  $hora."','";
				$query .=  $whisx."','";
...
else
{
	...
	echo "<form name='admision' action='admisionpru.php' method=post>";
	...
	if(isset($ok) and $ok == 2)
	{
		...
		$wdia=strtoupper($wdia);
		if(valgen($conex,$wtdo,$wdoc,$wap1,$wno1,$wfna,$whis,$whin,$wdir,$wtel,$wmun,$wbar,$wdep,$wofi,$wcea,$wnoa,$wtea,$wdia,$wpaa,$wnin,$wfei,$whin,$wtpa,$wnit,$went,$word,$wpol,$wnco,$wdie,$wtee,&$werr,&$e) and ((!isset($change) and $wnin == ($wninb + 1)) or (isset($change) and $wnin == $wninb)))
		{
			if(isset($amb))
			{
				$ambx="SI";
			...
			if(isset($change))
			{
				if(MOD_ING($conex,$whis,$wtdo,$wdoc,$wtat,$wap1,$wap2,$wno1,$wno2,$wfna,$wsex,$west,$wdir,$wtel,$wmun,$wbar,$wdep,$wzon,$wtus,$wofi,$wcea,$wnoa,$wtea,$wdia,$wpaa,$wnin,$wfei,$whin,$wsei,$wtin,$wcai,$wtpa,$wnit,$went,$word,$wpol,$wnco,$wdie,$wtee,$wtar,&$werr,&$e))
				{
					$ok=0;
					$estado="2";
				}
			...
			{
				if(ACT_ING($conex,$whis,$wtdo,$wdoc,$wtat,$wap1,$wap2,$wno1,$wno2,$wfna,$wsex,$west,$wdir,$wtel,$wmun,$wbar,$wdep,$wzon,$wtus,$wofi,$wcea,$wnoa,$wtea,$wdia,$wpaa,$wnin,$wfei,$whin,$wsei,$wtin,$wcai,$wtpa,$wnit,$went,$word,$wpol,$wnco,$wdie,$wtee,$wtar,$ambx,&$werr,&$e))
				{
					$ok=0;
					$estado="2";
				}
	...
	if(isset($ok)  and $ok == 3)
	{
		...
		{
			$wtdo=ver($wtdo);
			$querys = "select Pachis, Pactat, Pacap1, Pacap2, Pacno1, Pacno2, Pacfna, Pacsex, Pacest, Pacdir, Pactel, Paciu, Pacbar, Paczon, Pactus, Paccea, Pacnoa, Pactea, Pacdia, Pacpaa, Pacact, Pacdoc, Pactdo, Pacofi   from  ".$empresa."_000100 ";
	...
	echo "<tr><td align=center bgcolor=#000066 colspan=5><font color=#ffffff size=6><b>ADMISION DE PACIENTES</font><font color=#33CCFF size=4>&nbsp&nbsp&nbsp Ver. 2010-01-15 AJAX</font></b></font></td></tr>";
	$color="#dddddd";
	$color1="#000099";
	$color2="#006600";
	$color3="#cc0000";
	...
	if(!isset($wmaxing))
		$wmaxing=0;
	$id="ajaxquery('1','1','".$wdat."','".$wdep."','".$wnin."','".$weda."','".$empresa."','".$querys."','".$querysR."','".$wpos."','".$wposR."','".$numero."','".$numeroR."','".$wmaxing."','".$wact."','".$idCita."','".$wemp2."')";
	if($wdoc == "")
	...
	if($wdat == 0 and $ok != 3)
	{
		...
		$query = "select Pachis, Pactat, Pacap1, Pacap2, Pacno1, Pacno2, Pacfna, Pacsex, Pacest, Pacdir, Pactel, Paciu, Pacbar, Paczon, Pactus, Paccea, Pacnoa, Pactea, Pacdia, Pacpaa, Pacact, Pacofi   from  ".$empresa."_000100 where Pactdo='".$wtdo."' and Pacdoc='".$wdoc."'";
	...
	$err = mysql_query($query,$conex);
	$num = mysql_num_rows($err);
	echo "<select name='wtat' id=tipo1>";
	if ($num>0)
	{
		for ($i=0;$i<$num;$i++)
		{
	...
	if($wdat == 0)
	{
		if($wcea == "")
			$wcea=$wdoc;
		if($wnoa == "" or strlen($wnoa) < 5)
			$wnoa=$wno1." ".$wno2." ".$wap1." ".$wap2;
		if($wtea == "")
			$wtea=$wtel;
		if($wdia == "")
			$wdia=$wdir;
	...
	if(!isset($wmaxing))
		$wmaxing=0;
	$id="ajaxquery('1','2','".$wdat."','".$wdep."','".$wnin."','".$weda."','".$empresa."','".$querys."','".$querysR."','".$wpos."','".$wposR."','".$numero."','".$numeroR."','".$wmaxing."','".$wact."','".$idCita."','".$wemp2."')";
	...
	if(isset($okx) and $okx == "2")
	{
		...
		if(!isset($wmaxing))
			$wmaxing=0;
		$id="ajaxquery('1','3','".$wdat."','".$wdep."','".$wnin."','".$weda."','".$empresa."','".$querys."','".$querysR."','".$wpos."','".$wposR."','".$numero."','".$numeroR."','".$wmaxing."','".$wact."','".$idCita."','".$wemp2."')";
	...
	if(!isset($wmaxing))
		$wmaxing=0;
	$id="ajaxquery('1','6','".$wdat."','".$wdep."','".$wnin."','".$weda."','".$empresa."','".$querys."','".$querysR."','".$wpos."','".$wposR."','".$numero."','".$numeroR."','".$wmaxing."','".$wact."','".$idCita."','".$wemp2."')";
	...
	if(!isset($wmaxing))
		$wmaxing=0;
	$id="ajaxquery('1','5','".$wdat."','".$wdep."','".$wnin."','".$weda."','".$empresa."','".$querys."','".$querysR."','".$wpos."','".$wposR."','".$numero."','".$numeroR."','".$wmaxing."','".$wact."','".$idCita."','".$wemp2."')";
	if(isset($wofiw) and $wofiw != "")
		echo"<td bgcolor=".$color." align=center colspan=4>Oficio/Ocupacion : <br><input type='TEXT' name='wofiw' size=10 maxlength=30 id='w28' value='".$wofiw."' OnBlur=".$id." class=tipo3><br>";
	else
		echo"<td bgcolor=".$color." align=center colspan=4>Oficio/Ocupacion : <br><input type='TEXT' name='wofiw' size=10 maxlength=30 id='w28' OnBlur=".$id." class=tipo3><br>";
	...
	echo "</td>";
	echo "</tr>";
	echo "<tr><td align=center bgcolor=#999999 colspan=5><b>DATOS DEL ACUDIENTE</b></td></tr>";
	echo "<tr>";
	echo "<td bgcolor=".$color." align=center>Documento : <br><input type='TEXT' name='wcea' size=12 maxlength=12  id='w11' value='".$wcea."' class=tipo3></td>";	
	...
	if(isset($werr) and isset($e) and $e > -1)
	{
		...
		if($ingok > 0)
			echo "<center><br><br><A HREF='../Reportes/r001-admisionpru.php?wpachi=".$whisI."&amp;&wingni=".$wninI."&amp;empresa=".$empresa."'target='_blank'>Impresion de Ingreso</a><br><br></center>";
	}
		...
		if ($numeroR>=0)
		{
			...
			if ($numeroR >=  0)
			{
				...
				if(!isset($change))
				{
					...
					echo "<center><br><br><A HREF='../Reportes/r001-admisionpru.php?wpachi=".$whis."&amp;wingni=".$wnin."&amp;empresa=".$empresa."'target='_blank'>Impresion de Ingreso</a><br><br></center>";
					$wfei=$row[2];
					$whin=$row[3];
					$wsei=$row[4];
					$wtin=$row[5];
	...
	echo "</select>";
	echo "</td></tr>";
	echo "<tr><td align=center bgcolor=#999999 colspan=2><b>DATOS DEL RESPONSABLE DE LA CUENTA</b></td></tr>";
	if(isset($wnitw) and $wnitw != "" and ver($wtpa) == "E")
	{
		...
		if(!isset($wmaxing))
			$wmaxing=0;
		$id="ajaxquery('1','4','".$wdat."','".$wdep."','".$wnin."','".$weda."','".$empresa."','".$querys."','".$querysR."','".$wpos."','".$wposR."','".$numero."','".$numeroR."','".$wmaxing."','".$wact."','".$idCita."','".$wemp2."')";
	...
	if(isset($okx) and $okx == "4")
	{
		...
		{
			$query = "SELECT Empcod, Empnom, Empdir, Emptel, Emptar  from ".$empresa."_000024 where Empnom like '%".$wnitw."%'  order by Empnom";
			$err = mysql_query($query,$conex);
			$num = mysql_num_rows($err);
			if ($num>0)
			{
	...
	else
	{
		...
		{
			$wnit=ver($wnit);
			$query = "SELECT Empcod, Empnom from ".$empresa."_000024 where Empcod = '".$wnit."'";
			$err = mysql_query($query,$conex);
			$row = mysql_fetch_array($err);
			echo "<option value='".$row[0]."-".$row[1]."'>".$row[0]."-".$row[1]."</option>";
		}
	...
	{
		if(!isset($wnit))
			$query = "SELECT Empcod, Empnom, Empdir, Emptel, Emptar  from ".$empresa."_000024 where Empcod =  '".$row[0]."'  order by Empnom";
		else
			$query = "SELECT Empcod, Empnom, Empdir, Emptel, Emptar  from ".$empresa."_000024 where Empcod =  '".$wnit."'  order by Empnom";
		$err = mysql_query($query,$conex);
		$num = mysql_num_rows($err);
		$row = mysql_fetch_array($err);
		$went=$row[1];
