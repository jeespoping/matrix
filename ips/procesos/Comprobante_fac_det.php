...
//ACTUALIZACIONES                                                                                                                         \\
//========================================================================================================================================\\
// 2020-02-03 Camilo Zapata: se aplica strtoupper al campo fencod de las facturas para encontrar la empresa asociada correctamente. buscar "$entidadesResponsables" de ser necesario
// 2020-01-20 Camilo Zapata: Se mejora la lógica para que muestre los conceptos especiales de terceros, el nombre del tercero en lugar del nombre del paciente.
// 2019-12-19 Camilo Zapata: Se modifica el programa para que los conceptos especiales muestre los datos del pagador de movimiento específico, ejemplo: copagos.
...
//			      or die("No se ralizo Conexion");
  ...
  echo "<form name='comprobante_fac_det' action='Comprobante_fac_det.php' method=post>";
			   ...
			   if ($row[6] != 0)  //Si el valor es diferente cero
			      {
			       ...
			       $wnitnom="";
					...
					/*if( $row[1] == "CS-552002" and  in_array($row[11],$conceptosepeciales) ){
			        	echo "<br> factura: $row[1] - mostrarTercero: ".$mostrarTercero."  -  wnitter: $wnitter - wnomter: $wnomter -><br><pre>".print_r($row,true)."</pre>";
			        	//echo "<br><pre>".print_r($conceptosepeciales,true)."</pre>";
			        }*/
				 ...
				 for ($j=1;$j<=$numdoc;$j++)
				   {
					 ...
					 if( $mostrarTercero == "on" ){
					     $entidadesResponsables[$rowdoc[0]."_".$rowdoc[1]] = array(
														         			"nit" => $empresas[strtoupper($rowdoc[4])]['nit'],
														         			"nombre" => $empresas[strtoupper($rowdoc[4])]['nombre'],
														         			"tip"=>$rowdoc[2]
														         		);
					 }
