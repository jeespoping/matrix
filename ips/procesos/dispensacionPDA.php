...
//=========================================================================================================================================\\
  ...
  */
  ...
  //if (isset($user) and !isset($wusuario))
  //   {
  //	  $wusuario=substr($user,1);
  //	 }
...
echo $user."<br>";
  ...
  if (!isset($wusuario) )
	 {
		echo "<table>";
		echo "<tr><td class='titulo' align=center>CÓDIGO NOMINA: </font>";
		echo "<input type='text' cols='10' name='wusuario'></td></tr>";	
	  ...
	  if ($num > 0)
	     {
			     ...
			     for($i=1;$i<=$j-1;$i++)
			        {
				     ...
				     echo "<td align=left  ><A href='cargos.php?emp=".$wemp_pmla."&bd=".$wbasedato."&tipTrans=C&wemp=".$wemp_pmla."&user=".$wusuario."&cco[cod]=".$wccousu."&historia=".$wmat_estado[$i][1]."&fecDispensacion=".$wfecha."' target=_blank> Cargar </A></td>";
				     echo "</tr>";
				    }
			  }
			 else
		  ...
		  echo "<meta http-equiv='refresh' content='20;url=dispensacionPDA.php?wemp_pmla=".$wemp_pmla."&user=".$user."&wusuario=".$wusuario."'>";
