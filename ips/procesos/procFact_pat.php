        ...
        if($num > 0)
        {
            ...
            if(isset($_POST['btnProceed']))
            {
                ...
                for($i = 0; $i < $longitud; $i++)
                {
                    ...
                    $query1 = mysql_query("select id,Tcarvto,Tcarser,Tcarconcod,Tcartercod,Tcarterpor from".' '."$wbasedato"."_000106
                                           where Tcarfec BETWEEN '$fechaInicial' AND '$fechaFinal'
                    ...
                    $queryAbonos = mysql_query("SELECT sum(Tcarvto) from".' '."$wbasedato"."_000106
                                                where Tcarfec BETWEEN '$fechaInicial' AND '$fechaFinal'
                                                and Tcarres LIKE '$codResponsable%'
                                                and Tcarhis = '$his'
                                                and Tcaring = '$ing'
                ...
                mysql_query("update".' '."$wbasedato"."_000018 set Fenabo = '$valorAbonos', Fenval = '$valTotCargos1', Fensal = '$valTotCargos1' where Fenfac = '$newCons'");

                //ACTUALIZAR PATOL_000065 PARA AGRUPAR Y TOTALIZAR POR CONCEPTO:
                $queryConceptos = mysql_query("select sum(Fdevco) SUMA,Medico,Fecha_data,Hora_data,Fdefue,Fdedoc,Fdecco,Fdecon,Fdevco,Fdeter,
                ...
                while($datConcep = mysql_fetch_array($queryConceptos))
                {
                    ...
                    mysql_query("delete from".' '."$wbasedato"."_000065 where Fdedoc = '$newCons' and Fdecon = '$Fdecon'");

                    mysql_query("insert into".' '."$wbasedato"."_000065(Medico,Fecha_data,Hora_data,Fdefue,Fdedoc,Fdecco,Fdecon,Fdevco,Fdeter,
                                            Fdepte,Fdevde,Fdesal,Fdeest,Fdeffa,Fdefac,fdeviv,Seguridad)
