...
/**********************************************************************************************************************  
	   ...
	   Fecha de Liberaci�n : 2006-04-08
	   Autor : Ing. Pedro Ortiz Tamayo
	   Version Actual : 2010-08-09
	   
	   OBJETIVO GENERAL :Este programa ofrece al usuario una interface gr�fica que permite grabar la admision de pacientes
	   ...
	   .2007-06-19
	   		Se modifico el programa para incluir la subrrutina de validacion de a�o bisiesto que no habia sido incluida.
	   ...
	   .2006-11-22
	   		Se cambia el Metodo del AJAX de GET a POS para evitar problemas con caracteres especiales como la �.
...
else
{
	...
	echo "<tr><td align=center bgcolor=#000066 colspan=5><font color=#ffffff size=6><b>ADMISION DE PACIENTES</font><font color=#33CCFF size=4>&nbsp&nbsp&nbsp Ver. 2010-08-09 AJAX</font></b></font></td></tr>";
	$color="#dddddd";
	$color1="#000099";
	$color2="#006600";
	$color3="#cc0000";
