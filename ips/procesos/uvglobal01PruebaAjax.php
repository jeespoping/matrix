               ...
               data: {
                ...
                success: function(data)
                {
                    if( data.afectados*1 > 0 ){
                        if( campo == "wfre" )
                            alert( "Fecha de recepcion Actualizada");
                        else
...
else
{
    ...
    echo "<form name='uvglobal01' action='uvglobal01.php' method=post>";
...
*/
        ...
        */
        ...
        if (isset($wled) && $wled != "" && isset($wdoc) && isset($wffa) &&  isset($wfac))
        {
            // Valída disponibilidad en la factura - 2012-05-08
            if ($cantidad_lts > 0)
            {
    ...
    else
    {
        ...
        if (isset($wfre))
         echo "<INPUT TYPE='text' NAME='wfre' id='wfre' size=10 VALUE='".$wfre."' readonly ></INPUT></td>";
        else
         echo "<INPUT TYPE='text' NAME='wfre' id='wfre' size=10 readonly></INPUT></td>";if (isset($wfre))
