...
/**
 Programa       : gesapl_gestion_perfiles.php
...
function existeConfiguracion($conex, $wgrupotema, $valueArbol, $valueCosto, $valueCargo, $keyUser, $permisos, $esadministrador)
{
    ...
    $res = mysql_query($qExiste,$conex) or die("Error: " . mysql_errno() . " - Error al consultar existencia de configuracion - gesapl_gestion_perfiles.php): ".$qExiste." - " . mysql_error());
...
if(isset($_SESSION['user']) && isset($accion))
{
    ...
    if(isset($accion) && $accion=='guardar')
    {
        ...
        */
            ...
            foreach($arbol_chk as $keyArbol => $valueArbol) // Por cada menú del árbol se guarda todos los demás usuarios chequeados
            {
                foreach($wuse_pfls_chk as $keyUser => $valueUser) // Por cada usuario chequeado se guarda tantos cargos chequeados existan
                {
                    ...
                    else // Si centro de costos diferente a (*) y tambien hay cargos seleccionados
                    {
                        ...
                        $res = mysql_query($qUseCargoCco,$conex) or die("Error: " . mysql_errno() . " - Error al Insertar al consultar usuarios para los cargos seleccionados - gesapl_gestion_perfiles.php): " . $qUseCargoCco . " - " . mysql_error());
        ...
        if ($coma != "|,")
        {
            ...
            $res = mysql_query($insert,$conex) or die("Error: " . mysql_errno() . " - Error al Insertar en Perfiles por usuarios (root_000082) - gesapl_gestion_perfiles.php): " . $insert_all . " - " . mysql_error());
        }
        ...
        header("location:gesapl_gestion_perfiles.php?wemp_pmla=".$wemp_pmla.$temaUrl);//."&wtema=".$wtema
    }
    elseif(isset($accion) && $accion == 'load')
    {
        ...
        elseif(isset($form) && $form == 'agrupar_indicadores')
        {
            ...
            $menu = pintarMenuSeleccion ($conex, $arbol_menu['menus_cod'],$arbol_menu['menus_info'], $div, 'checks','','20',$id_check_padre,$propiedades,'','off','on',$tabla_sub_grp,$tabla_propiedades);
            // $data['menus_sin_ubicar'] = implode('|',$menus_sin_ubicar);
            // echo '<pre>Arbol completo:<br />';print_r($menus_sin_ubicar);echo '</pre>';
            $data['total_menus'] = count($menu);
            $data['menu'] = utf8_encode($menu);
...
<script type="text/javascript">
    ...
    /**
     * Cambia el estilo de la opción para borrar un registro de permisos. (usada en funciones.php)
     *
     * @return unknown
     */
    ...
    {
        $.post("gesapl_gestion_perfiles.php",
            {
    ...
    /**
     * Esta función es usada en la función generarDetalle(..) que se encuentra en funciones.php
    ...
    /**
     * Esta función está referenciada desde la función pintarMenuSeleccion(..) en funciones.php
     ...
     * Es usada en la función pintarMenuSeleccion() en el include que se hace a funciones.php
     *
                                                ...
                                                <td>
                                                    <div align="center" id="div_consulta_usuarios" class="borderDiv2">
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" align="center">
                                                            <tr>
                                                                <td align="center">
                                                                    <div id="div_arbol_usuario" style="width:300px; text-align:justify">&nbsp;</div>
