...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_procepriorx.php'; 
	}
	
	function enter()

	{
		document.forms.rep_procepriorx.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//rayosx_000002     : Tabla Procesos Priritarios.                                                                                            |
//rayosx_000001     : Tabla plan anual x proceso prioritario                                                                                 |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_procepriorx.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_procepriorx' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    echo "<tr><td align=center colspan=4 bgcolor=#FFFFFF><font text color=#003366 size=2><b>IMEGENOLOGIA.</b></font></td></tr>";
