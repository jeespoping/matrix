...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafproprirx.php'; 
	}
	
	function enter()
	{
		document.forms.grafproprirx.submit();
	}
...
else
{
	...
	//Forma
	echo "<form name='forma' action='grafproprirx.php' method='post'>";
	echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";

	if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
	{
		echo "<form name='grafproprirx' action='' method=post>";
