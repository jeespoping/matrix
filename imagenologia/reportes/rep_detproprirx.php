...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detproprirx.php'; 
	}
	
	function enter()
	{
		document.forms.rep_detproprirx.submit();
	}
...
//FECHA ULTIMA ACTUALIZACION  :22 de AGOSTO de 2011.                                                                                         |
//TABLAS UTILIZADAS :                                                                                                                       |
//rayosx_000001      : Tabla de Procesos prioritarios IMAGENOLOGIA.                                                                         |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detproprirx.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
 if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_detproprirx' action='' method=post>";
