...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_proceprioxevaneu.php'; 
	}
	
	function enter()

	{
		document.forms.rep_proceprioxevaneu.submit();
	}
...
//FECHA ULTIMA ACTUALIZACION  : JUNIO 25 DE 2010.                                                                                            |
//DESCRIPCION			      : Este reporte sirve para observar x evaluador a quienes a evaluado.                                          |
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//neumo_000001     : Tabla Procesos Priritarios.                                                                                              |                                                                      |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_proceprioxevaneu.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_proceprioxevaneu' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    echo "<tr><td align=center colspan=4 bgcolor=#FFFFFF><font text color=#003366 size=2><b>NEUMOLOGIA</b></font></td></tr>";
