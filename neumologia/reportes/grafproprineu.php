...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafproprineu.php'; 
	}
	
	function enter()
	{
		document.forms.grafproprineu.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//neumo_000002     : Tabla de Bases de datos totales por proceso prioritario.                                                               |
//neumo_000001     : Tabla de movimiento procesos prioritarios.                                                                             |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
	...
	//Forma
	echo "<form name='forma' action='grafproprineu.php' method='post'>";
	echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";

	if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
	{
		echo "<form name='grafproprineu' action='' method=post>";
