<html>
<head>
<title>MATRIX - [REPORTE PROCEDIMIENTOS X ENTIDAD]</title>

<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_procexentidad.php'; 
	}
	
	function enter()

	{
	 document.forms.rep_procexentidad.submit();
	}
...
/*******************************************************************************************************************************************
*                                             REPORTE PROCEDIMIENTO X ENTIDAD                                                              *
********************************************************************************************************************************************/

//==========================================================================================================================================
//PROGRAMA				      : Reporte para ver los procedimientos x entidad                                                               |
//AUTOR				          : Ing. Gustavo Alberto Avendano Rivera.                                                                       |
//FECHA CREACION			  : JULIO 1 DE 2010.                                                                                            |
//FECHA ULTIMA ACTUALIZACION  : JULIO 1 DE 2010.                                                                                            |
//DESCRIPCION			      : Este reporte es para ver los procedimientos x entidad.                                                      |
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
...
session_start();
//Encabezado
encabezado("Procedimiento x Entidad",$wactualiz,"clinica");
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_procexentidad.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_procexentidad' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    echo "<tr>";
    echo "<td align=center colspan='1' bgcolor=#FFFFFF><font size='3' text color=#003366><b>PROCEDIMIENTOS x ENTIDAD</b></font></td>";
    echo "</tr>";
    echo "<tr>";
    ...
    echo "<td bgcolor=#006699 align=center><font text color=#FFFFFF size=2><b></b></td>";
    ...
    $query = " SELECT siceenti,siceentres,siceproce,count(*) as cant"
            ."   FROM neumo_000003"
            ."  WHERE sicefec between '".$fec1."' and '".$fec2."'"
            ."  GROUP BY siceenti,siceentres,siceproce"
            ."  ORDER BY siceenti,siceentres,siceproce";
	...
	IF ($entiant==$row1[0] )
	 {
	  echo "<Tr bgcolor=".$wcf.">";
	  echo "<td align=center><font size=1></font></td>";
