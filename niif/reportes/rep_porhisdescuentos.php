<html>
<head>
<title>Impresión % Historico de Recibos con Descuentos- Unix</title>
</body>
</html>
...
//DESCRIPCION			      :Este programa sirve para imprimir el % historico de recibos con descuento por fecha, después de generar en   |
