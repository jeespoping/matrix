...
else
{
	...
	{
		echo "<form action='rep_hcczr1.php?empresa=$empresa' method=post>";
	...
	else
	{
		...
		$mesnac=date('m');
		$dianac=date('d');
		$fecdat=$anonac."-".$mesnac."-".$dianac; //Fecha del registro
		...
		echo "<img SRC='/MATRIX/images/medical/pediatra/logotorre.JPG' width='150' height='120'></td>";
		echo "<td align=center colspan='4' ><font size=4 color='#000080' face='arial'><B>Jorge Camilo Zuluaga Ruiz</b></font></td>";
		echo "</tr><tr><td  align=center colspan='4'><font size=3 color='#000080' face='arial'><B>Ortopedia y Traumatologia</b></font>";
		echo "</tr><tr><td  align=center colspan='4'><font size=1 color='#000080' face='arial'><B>Diag. 75B No 2 A- 80 Torre Médica Las Américas Cons:212";
		echo "<br>Teléfono: 3459200 - 3459202 Medellín - Colombia</b></font>";
		...
		echo "<table align=center border=1 width=725>";
		echo "<tr><td colspan='4'><font size=1 face='arial' ><B>FIRMADO ELECTRONICAMENTE POR:<b>DR. JORGE CAMILO ZULUAGA RUIZ &nbsp&nbsp&nbsp&nbspCC.&nbsp70094354&nbsp&nbsp&nbsp&nbsp REGISTRO:96406</B></td></tr>";
