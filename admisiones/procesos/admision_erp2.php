		...
		foreach( $responsablesNuevos as $codigoNuevoResponsable=> $valueNresponsable ){
			...
			if( $valueNresponsable != $responsableAnterior and $valueNresponsable != "" and $responsableAnterior != ""){//--> si hubo cambio de responsable se debe realizar el análisis y la correspondiente regrabación.
				...
				if( $cargosAregrabar > 0 ){
					guardarPendientesRegrabacion( $historia, $ingreso, $responsableAnterior, $valueNresponsable, "admision_erp2.php");
				}
			}else{
...
function buscarPaises()
{
	...
	$( "#pac_pantxtPaiNac, #pac_pahtxtPaiRes" ).autocomplete("admision_erp2.php?consultaAjax=&accion=consultarPais", {
		cacheLength:1,
		delay:300,
		max: 100,
		scroll: false,
...
function buscarDepartamentos()
{
	...
	$( "#pac_deptxtDepNac,#pac_dehtxtDepRes,#pac_dretxtDepResp,#AccConductordp,#AccDepPropietario,#Catdep,#Accdep" ).autocomplete( "admision_erp2.php?consultaAjax=&accion=consultarDepartamento",
	{
		extraParams: {
...
function buscarMunicipios()
{
	...
	$( "#pac_ciutxtMunNac,#pac_muhtxtMunRes,#pac_mretxtMunResp,#AccMunPropietario,#AccConductorMun,#Catmun,#Accmun" ).autocomplete( "admision_erp2.php?consultaAjax=&accion=consultarMunicipio",
	{
		extraParams: {
			dep: function( campo ){
...
function buscarBarrios()
{
	...
	$( "#pac_bartxtBarRes" ).autocomplete("admision_erp2.php?consultaAjax=&accion=consultarBarrio",
	{
		extraParams: {
			mun: function( campo ){
...
function buscarOcupaciones()
{
	...
	$( "#pac_ofitxtocu" ).autocomplete("admision_erp2.php?consultaAjax=&accion=consultarOcupacion",
	{
		cacheLength:1,
		delay:300,
		max: 100,
...
function buscarAseguradoras(tabla_referencia)
{
	...
	$( codEsp ).autocomplete("admision_erp2.php?consultaAjax=&wemp_pmla="+$("#wemp_pmla").val()+"&accion=consultarAseguradora&wbasedato="+wbasedato+"&origenConsulta=autoCompletar",
	{
		cacheLength:1,
		delay:300,
		max: 100,
...
function buscarCUPS( contenedor, indice )
{
	...
	//Asigno autocompletar para la busqueda de paises
	$( "[name=ing_cactxtcups]:eq("+indice+")", $("#"+contenedor )).autocomplete("admision_erp2.php?consultaAjax=&accion=consultarCUPS",
	{
		cacheLength:1,
		delay:300,
		max: 100,
...
function buscarImpresionDiagnostica()
{
	...
	$( "#ing_digtxtImpDia" ).autocomplete("admision_erp2.php?consultaAjax=&accion=consultarImpresionDiagnostica",
	{
		extraParams: {
			edad: function( campo ){
...
function buscarTarifaParticular()
{
	...
	//Asigno autocompletar para la busqueda de impresiones diagnosticas
	$( "#ing_tartxt" ).autocomplete("admision_erp2.php?consultaAjax=&accion=buscarTarifaParticular&wbasedato="+$("#wbasedato").val(),
	{
		cacheLength:0,
		delay:300,
		max: 100,
...
function buscarIpsRemite()
{
	...
	$( "#pac_iretxtIpsRem" ).autocomplete("admision_erp2.php?consultaAjax=&accion=consultarIpsRemite&wbasedato="+wbasedato,
	{
		cacheLength:1,
		delay:300,
		max: 100,
...
function buscarAseguradorasVehiculo()
{
	var wbasedato = $("#wbasedato").val();
	//Asigno autocompletar para la busqueda de aseguradoras
	$( "[name=_ux_accasn]" ).autocomplete("admision_erp2.php?consultaAjax=&accion=consultarAseguradoraVehiculo&wbasedato="+wbasedato,
	{
		cacheLength:1,
		delay:300,
		max: 100,
...
function buscarCcoTopes(tabla_referencia)
{
	...
	//Asigno autocompletar para la busqueda de paises
	$("[id^=top_ccotxtCcoTop]",$("#div_cont_tabla_topes"+idCodResp) ).autocomplete("admision_erp2.php?consultaAjax=&accion=consultarCcoTopes&wbasedato="+wbasedato+"&wemp_pmla="+wemp_pmla,
	{
		cacheLength:1,
		delay:300,
		max: 100,
...
function guardartopes(codRespGlobal ,DivTopes)
{
	...
	$(".trtopeppal").each(function(){
		...
		$(".detalletope_"+codigotope).each(function(){
			...
			//--valortopedetalle_	
			if($("#valortopedetalle_"+codigotope+"_"+clasificacion).val()>0 ||  $("#porcentajetopedetalle_"+codigotope+"_"+clasificacion).val()>0)
				{
		...
		if(($("#valortopeppal_"+codigotope).val() > 0 || $("#porcentajetopeppal_"+codigotope).val() > 0) && ( haydetalle =='no') )
		{
	...
	if(insertar=='')
	{
		if($("#valortopegeneral").val() > 0 || $("#porcentajegeneral").val() > 0)
		{
			// veo el tope general
...
function buscarClasificacionConceptosFac(tabla_referencia)
{
	...
	//Asigno autocompletar para la busqueda de paises
	$( "[id^=top_clatxtClaTop]",$("#div_cont_tabla_topes"+idCodResp) ).autocomplete("admision_erp2.php?consultaAjax=&accion=consultarClasificacinConceptos&tipo=02&wbasedato="+wbasedato+"&wemp_pmla="+wemp_pmla,
	{
		extraParams: {
			tipo: function( campo ){
...
function buscarMedicos(){
	...
	$("#ing_meitxtMedIng").autocomplete("admision_erp2.php?consultaAjax=&accion=consultarMedico&wbasedato="+wbasedato+"&filtraEspecialidadClinica="+filtraEspecialidadClinica+"&wemp_pmla="+wemp_pmla,
	{
		cacheLength:1,
		delay:300,
		max: 100,
...
function mostrarFormTopes($responsable,$historia,$ingreso,$documento , $tipodocumento,$esadmision)
{
	...
	$data['html'].="<br><div id='divtabletopes_".$responsable."' style='text-align: center;  width:100%;' ><table class='tablaTopes'  id='tablaTopes' width='100%'>
								<tr style='font-size:10pt' >
											 ...
											 <td   class='encabezadoTabla' align='center' width='10%' ><b>Fecha</b></td>		 
								</tr>";
	...
	for($i=1; $i<count($vectortexto) ; $i++)
	{
		...
		if($esadmision =='si')
		{
			$resultado ="INSERT INTO ".$wbasedato."_000204 ( Medico, Fecha_data, Hora_data, Tophis ,	Toping ,	Topres ,Toptco, 	Topcla, 	Topcco 	,Toptop ,	Toprec ,	Topdia 	,Topsal ,	Topest 	,Topfec ,Seguridad)
							VALUES ( '".$wbasedato."'  , '".$fechatope."' , '".$horatope."' ,'".$whistoria."', '".$wingreso."' , '".$responsable."' , '".$vectordetalle[2]."' , '".$vectordetalle[3]."','".$vectordetalle[4]."' , '".str_replace(',', '', $vectordetalle[5])."' , '".$vectordetalle[6]."', '".$vectordetalle[7]."'  , '".str_replace(',', '', $vectordetalle[5])."' , 'on' , '".$vectordetalle[8]."','C-".$wbasedato."' )";
		...
		else
		{
			$resultado ="INSERT INTO ".$wbasedato."_000215 ( Medico, Fecha_data, Hora_data, Toptdo ,	Topdoc ,	Topres ,Toptco, 	Topcla, 	Topcco 	,Toptop ,	Toprec ,	Topdia 	,Topsal ,	Topest 	,Topfec ,Seguridad)
							VALUES ( '".$wbasedato."'  , '".$fechatope."' , '".$horatope."' ,'".$tipodocumento."', '".$documento."' , '".$responsable."' , '".$vectordetalle[2]."' , '".$vectordetalle[3]."','".$vectordetalle[4]."' , '".str_replace(',', '', $vectordetalle[5])."' , '".$vectordetalle[6]."', '".$vectordetalle[7]."'  , '".str_replace(',', '', $vectordetalle[5])."' , 'on' , '".$vectordetalle[8]."','C-".$wbasedato."' )";
...
function listarPacientesConTurno()
{
	...
	<div style='height:280px;overflow:auto;background:none repeat scroll 0 0;'>
		...
		SELECT Atufat, Atutur, Atudoc, Atutdo, Atullv, Atuusu, Atunom, A.id, Ahthte, Prinom
		 ...
		 WHERE (UNIX_TIMESTAMP()-UNIX_TIMESTAMP(CONCAT(A.Fecha_data, ' ', A.Hora_data))) < 86400
		   AND Atuest  = 'on'
		   AND Atucta  = 'on'
		   AND Atupad != 'on'
		   AND Atuadm != 'on'
