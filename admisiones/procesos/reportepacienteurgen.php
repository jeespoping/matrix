	...
	<table width="1000" height="113" style="border: groove; width: 1500px">
      <tr>
        ...
        <td width="32%" colspan="2" style="border: groove; width: 35%"><table>
            ...
            <tr>
              <td>Fecha de Emision: <? echo '2019-02-27' ?></td>
            </tr>
        </table></td>
      </tr>
      <tr>
	...
	<?
			    while($resultado=mysql_fetch_array($select_paciente))
				{
					...
					if ($hora >=20 and $days<=10){
						...
						?>
						<tr>
						<td width="244" height="18"><? echo $Ubihis ?> <div align="center"></div></td>
						<td width="100"><? echo $Ubiing ?></td>
						<td width="198"><? echo $Ubisac.'-Urgencias' ?></td>
						<td width="244"><? echo $Ingfei ?></td>
						<td width="152"><? echo $Inghin ?></td>
						<td width="198"><? echo $Pactdo ?></td>
						<td width="244"><? echo $Pacdoc ?> <div align="center"></div></td>
						<td width="300"><? echo $nombre_completo ?></td>
										<? if ($motivo == '' and $hora>=24){
												?> 
												<td width="198" id="alerta" class="animacion"></td>
												<?
											}else{
												?>
												<td width="198"><? echo $motivo.'- PENDIENTE DE HABITACION'?></td>
												<?
											   }
											   ?>
						
						<td width="244"><? echo 'Las horas pasadas son: '.$hora.'<br>'; 	
										   echo	'Equivalente en dias es: '.$days?></td>
						<td width="152"><? echo $alta_proceso ?></td>
						<td width="152"><? echo $alta_definitiva ?></td>		   
						</tr>
				<?
					}
