...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafpropriurg.php'; 
	}
	
	function enter()
	{
		document.forms.grafpropriurg.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//urgen_000010     : Tabla de Bases de datos totales por proceso prioritario.                                                               |
//urgen_000009     : Tabla de movimiento procesos prioritarios.                                                                             |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
	...
	//Forma
	echo "<form name='forma' action='grafpropriurg.php' method='post'>";
	echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";

	if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
	{
		echo "<form name='grafpropriurg' action='' method=post>";
