...
<script type="text/javascript">
	function enter()
	{
		document.forms.rep_cumplixprourg.submit();
	}
...
//FECHA CREACION			  : AGOSTO 11 DE 2010.                                                                                          |
//FECHA ULTIMA ACTUALIZACION  : AGOSTO 11 DE 2010.                                                                                          |
//DESCRIPCION			      : Este reporte sirve para observar por proceso prioritarios cumplimiento por criterio                         |
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//urgen_000009      : Tabla de Procesos Prioritarios.                                                                                       |
//                                                                                                                                          |
//==========================================================================================================================================
...
//Conexion base de datos
 ...
 //Forma
 echo "<form name='forma' action='rep_cumplixprourg.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_cumplixprourg' action='' method=post>";
  ...
  $query = " SELECT ppproc,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppcrite16,ppcrite17,ppcrite18,ppcrite19,ppcrite20,ppcrite21,ppcrite22,ppcrite23"
           ."   FROM ".$empre1."_000009"
           ."  WHERE ppproc = '".$tpp."'" 
    ...
    for ($i=1;$i<=$num1;$i++)
	 {
      ...
      echo "<td align=left bgcolor=#FFFFFF width=65%><font size=2 color=#000000>&nbsp;<b>$tota</b></font></td>";
      echo "</tr >"; 
      echo "</table>";
