...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Segmentacion del Mercado Entre A&ntilde;os</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc30.php Ver. 2017-06-21</b></font></tr></td></table>
</center>
<?php
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc30.php' method=post>";
		...
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione"  or !isset($wper1)  or !isset($wper2) or ((!isset($wcco1)  or !isset($wcco2)) and !isset($wccof)) or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2)
		{
			...
			echo "<tr><td align=center colspan=2>SEGMENTACI&Oacute;N DEL MERCADO ENTRE A&Ntilde;OS</td></tr>";
		...
		else
		{
			...
			echo "<tr><td colspan=7 align=center>SEGMENTACI&Oacute;N DEL MERCADO ENTRE A&Ntilde;OS</td></tr>";
			...
			echo "<tr><td><b>SEGMENTO</b></td><td><b>A&Ntilde;O : ".$wanopa."</b></td><td><b>% PART</b></td><td><b>A&Ntilde;O : ".$wanop."</b></td><td><b>% PART</b></td><td align=right><b>DIFERENCIA</b></td><td align=right><b>% VARIACION</b></td></tr>";
			$wdata=array();
			$k1=0;
			$k2=0;
			$num=-1;
			...
			for ($i=0;$i<=$num;$i++)
			{
				...
				if($valact !=0 )
					...
					$proact=0;
				$path1="/matrix/presupuestos/reportes/000001_rc33.php?wanop=".$wanopa."&wper1=".$wper1."&wper2=".$wper2."&wcco1=".$wcco1."&wcco2=".$wcco2."&wseg=".$wdata[$i][5]."-".$wdata[$i][0]."&wgru=".$wgru."&empresa=".$empresa."&wemp=".$wempt;
				$path2="/matrix/presupuestos/reportes/000001_rc33.php?wanop=".$wanop."&wper1=".$wper1."&wper2=".$wper2."&wcco1=".$wcco1."&wcco2=".$wcco2."&wseg=".$wdata[$i][5]."-".$wdata[$i][0]."&wgru=".$wgru."&empresa=".$empresa."&wemp=".$wempt;
