...
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_pro111.php Ver. 2017-06-07</b></font></tr></td></table>
</center>
<?php
...
else
{
	...
	if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione")
	{
		...
		echo "<tr><td align=center colspan=2>MONTAJE DE INFORMACION MAESTRO DE PERSONAL</td></tr>";
