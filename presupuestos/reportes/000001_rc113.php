...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Movimiento de Cuentas (Presupuestal)</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc113.php Ver. 1.00</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc113.php' method=post>";
		...
		if(!isset($wanop) or !isset($wper1)  or !isset($wper2) or ((!isset($wcco1)  or !isset($wcco2)) and !isset($wccof)) or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2)
		{
			...
			echo "<tr><td align=center colspan=2>MOVIMIENTO DE CUENTAS (PRESUPUESTAL)</td></tr>";
		...
		else
		{
			...
			if(($num > 0 and $row[0] == "on") or $key=="costosyp" or (isset($call) and $call == "SIC"))
			{
				...
				echo "<tr><td colspan=3 align=center>MOVIMIENTO DE CUENTAS (PRESUPUESTAL)</td></tr>";
