...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Comparaci&oacute;n Entre A&ntilde;os de Costos de Apoyo Distribuidos x Unidad (T73)</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc73.php Ver. 2018-02-22</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc73.php' method=post>";
		echo "<center><input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($wres) or (strtoupper ($wres) != "R" and strtoupper ($wres) != "P") or !isset($wper1)  or !isset($wper2) or (!isset($wcco1) and !isset($wccof))  or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2)
		{
			echo "<center><table border=0>";
			echo "<tr><td align=center colspan=2><b>PROMOTORA MEDICA LAS AMERICAS S.A.<b></td></tr>";
			echo "<tr><td align=center colspan=2>COMPARACI&Oacute;N ENTRE A&Ntilde;OS DE COSTOS DE APOYO DISTRIBUIDOS X UNIDAD (T73)</td></tr>";
			...
			{
				echo "<tr><td bgcolor=#cccccc align=center>C.C Origen  de Proceso</td>";
		...
		else
		{
			...
			$query = $query."  group by Proccd,cconom";
			$query = $query."  order by Proccd,cconom";
			...
			echo "<tr><td colspan=9 align=center>COMPARACI&Oacute;N ENTRE A&Ntilde;OS DE COSTOS DE APOYO DISTRIBUIDOS X UNIDAD (T73)</td></tr>";
			echo "<tr><td colspan=9 align=center><b>EMPRESA : ".$wempt."</b></td></tr>";
			echo "<tr><td colspan=9 align=center>UNIDAD ORIGEN : ".$wcco1. "</td></tr>";
			echo "<tr><td colspan=9 align=center>PERIODO INICIAL : ".$wper1." PERIODO FINAL : ".$wper2. " A&Ntilde;O : ".$wanop."</td></tr>";
			echo "<tr><td><b>C.C. DESTINO</b></td><td><b>DESCRIPCION</b></td><td align=right><b>A&Ntilde;O : ".$wanopa."</b></td><td align=right><b>A&Ntilde;O : ".$wanop."</b></td><td align=right><b>% VARIACION</b></td><td align=right><b>DIFERENCIA</b></td></tr>";
			$wdata=array();
			$k1=0;
			$k2=0;
			$num=-1;
