...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Informe de Ejecucion Presupuestal de Ingresos</font></a></td></tr>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc25.php Ver. 2017-03-22</b></font></td></tr></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc25.php' method=post>";
		echo "<center><input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($wper1)  or !isset($wper2)  or !isset($wres)  or !isset($wter) or (strtoupper ($wres) != "R" and strtoupper ($wres) != "D") or (strtoupper ($wter) != "S" and strtoupper ($wter) != "N") or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2)
		{
			echo "<center><table border=0>";
			echo "<tr><td align=center colspan=2><b>PROMOTORA MEDICA LAS AMERICAS S.A.<b></td></tr>";
			echo "<tr><td align=center colspan=2>INFORME DE EJECUCION PRESUPUESTAL DE INGRESOS</td></tr>";
		...
		else
		{
			...
			echo "<tr><td colspan=5 align=center>INFORME DE EJECUCION PRESUPUESTAL DE INGRESOS</td></tr>";
			echo "<tr><td colspan=5 align=center>PERIODO INICIAL : ".$wper1." PERIODO FINAL : ".$wper2. " A&Ntilde;O : ".$wanop."<B> ACTUALIZADO A : ".$fecha_cierre."</B></td></tr>";
			echo "<tr><td colspan=5 align=center>EMPRESA : ".$wempt."</td></tr>";
			echo "<tr><td><b>UNIDAD</b></td><td><b>REAL</b></td><td><b>PRESUPUESTADO</b></td><td align=right><b>DIFERENCIA</b></td><td align=right><b>% CUMPLIMIENTO</b></td></tr>";
			$wdata=array();
			$k1=0;
			$k2=0;
			$num=-1;
			...
			for ($i=0;$i<=$num;$i++)
			{
				...
				if(isset($wdata[$i][4]) and isset($wdata[$i][3]) and $wres == "D")
					if($wdif < 0)
						echo"<tr><td>".$wdata[$i][1]."</td><td align=right>".number_format((double)$wdata[$i][4],0,'.',',')."</td><td align=right>".number_format((double)$wdata[$i][3],0,'.',',')."</td><td align=right bgcolor='#FFFF00'>".number_format((double)$wdif,0,'.',',')."</td><td align=right>".number_format((double)$wpor,2,'.',',')."</td></tr>";
					else
