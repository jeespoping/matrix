...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Protocolo de Un  Procedimiento Valorado Para Un A&ntilde;o Mes</font></a></td></tr>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc89.php Ver. 2016-09-30</b></font></td></tr></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc89.php' method=post>";
		...
		else
		{
			...
			if($num > 0)
			{
				...
				echo "<tr><td colspan=6 align=center>PROTOCOLO DE UN  PROCEDIMIENTO VALORADO PARA UN A&Ntilde;O MES</td></tr>";
				...
				$query = "SELECT procod,subdes,procan,cxapro,proccp from ".$empresa."_000100,".$empresa."_000083,".$empresa."_000104 ";
			    ...
			    $query = $query."   and Proemp = cxaemp ";
			    $query = $query."   and cxaano = ".$wanop;
			    $query = $query."   and cxames = ".$wper1;
			    $query = $query."   and cxacco = proccp";
