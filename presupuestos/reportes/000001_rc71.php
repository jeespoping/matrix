...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Costos de Apoyo Mensuales Distribuidos x Unidad (T73)</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc71.php Ver. 2018-02-22</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc71.php' method=post>";
		...
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione"  or !isset($wres) or (strtoupper ($wres) != "R" and strtoupper ($wres) != "P")  or !isset($wper1)  or !isset($wper2)   or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2)
		{
			...
			echo "<tr><td align=center colspan=2>COSTOS DE APOYO MENSUALES DISTRIBUIDOS X UNIDAD (T73)</td></tr>";
			echo "<tr><td bgcolor=#cccccc align=center>A&ntilde;o de Proceso</td>";
			echo "<td bgcolor=#cccccc align=center><input type='TEXT' name='wanop' size=4 maxlength=4></td></tr>";
			echo "<tr><td bgcolor=#cccccc align=center>Mes Inicial de Proceso<VARIACION ENTRE A&Ntilde;OS DE LA DISTRIBUCION DE UN CENTRO DE SERVICIOS/td>";
		...
		else
		{
			...
			echo "<tr><td colspan=16 align=center>COSTOS DE APOYO MENSUALES DISTRIBUIDOS X UNIDAD (T73)</td></tr>";
