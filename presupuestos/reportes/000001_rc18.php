...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Comparacion de Resultados Entre A&ntilde;os (Presupuestal vs Real)</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc18.php Ver. 2016-03-04</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc18.php' method=post>";
		...
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($wper1)  or !isset($wper2) or  ((!isset($wcco1)  or !isset($wcco2)) and !isset($wccof)) or !isset($wserv)or (strtoupper ($wserv) != "S" and strtoupper ($wserv) != "N") or !isset($wres)  or (strtoupper ($wres) != "R" and strtoupper ($wres) != "D") or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2 )
		{
			...
			echo "<tr><td align=center colspan=2>COMPARACION DE RESULTADOS ENTRE A&Ntilde;OS (PRESUPUESTAL VS REAL)</td></tr>";
		...
		else
		{
			...
			echo "<tr><td colspan=8 align=center>COMPARACION DE RESULTADOS ENTRE A&Ntilde;OS(PRESUPUESTAL VS REAL)</td></tr>";
             ...
             if(isset($wtotal1[90]))
    		{
				...
				if($ingresos2 != 0)
					...
					$i2=0;
				echo"<tr><td colspan=2 bgcolor=#999999><b>INGRESOS RECIBIDOS PARA TERCEROS</b></td><td align=right bgcolor=#999999><b>".number_format((double)$wtotal2[90],0,'.',',')."</b></td><td align=right bgcolor=#999999><b>".number_format((double)$i1,2,'.',',')."</b></td><td align=right bgcolor=#999999><b>".number_format((double)$wtotal1[90],0,'.',',')."</b></td><td align=right bgcolor=#999999><b>".number_format((double)$i2,2,'.',',')."</b></td><td align=right bgcolor=#999999><b>".number_format((double)$wdif,0,'.',',')."</b></td><td align=right bgcolor=#999999><b>".number_format((double)$wpor,2,'.',',')."</b></td></tr>";
             }
		}
		else
		{
