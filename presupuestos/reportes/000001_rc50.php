...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Facturacion Comparativa X Segmentos X A&ntilde;os</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc50.php Ver. 2016-02-26</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc50.php' method=post>";
		echo "<center><input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($winfla) or !isset($wper1)  or !isset($wper2) or !isset($wcco1)  or !isset($wcco2) or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2)
		{
			echo "<center><table border=0>";
			echo "<tr><td align=center colspan=2><b>PROMOTORA MEDICA LAS AMERICAS S.A.<b></td></tr>";
			echo "<tr><td align=center colspan=2>FACTURACION COMPARATIVA X SEGMENTOS X A&Ntilde;OS</td></tr>";
		...
		else
		{
			...
			$Graph="/matrix/images/medical/presupuestos/rc49_".$wanop."_".$wper2.".jpg";
			$d=array();
			$d[0]=31;
			$d[1]=28;
			$d[2]=31;
			...
			{
			$wanopi=$wanop-3;
			$query = "select empseg,segdes,mioano,sum(Mioito) as monto from ".$empresa."_000063,".$empresa."_000061,".$empresa."_000045 ";
			...
			$query = $query."   group by empseg,segdes,mioano  ";
			$query = $query."   order by empseg,mioano";
			$err = mysql_query($query,$conex);
			$num = mysql_num_rows($err);
			echo "<table border=1>";
			...
			echo "<tr><td colspan=12 align=center>FACTURACION COMPARATIVA  X SEGMENTOS X A&Ntilde;OS</td></tr>";
