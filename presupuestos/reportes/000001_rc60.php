...
<!--
	function enter()
	{
		document.forms.rc60.submit();
	}
//-->
</script>
<center>
<table border=0 align=center>
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Indirectos Comparativos Entre A&ntilde;os</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc60.php Ver. 2016-08-25</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form name= 'rc60' action='000001_rc60.php' method=post>";
		...
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($wper1)  or !isset($wper2) or ((!isset($wcco1)  or !isset($wcco2)) and !isset($wccof))  or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2)
		{
			...
			echo "<tr><td align=center colspan=2>INDIRECTOS COMPARATIVOS ENTRE A&Ntilde;OS</td></tr>";
		...
		else
		{
			...
			$num = mysql_num_rows($err);
			$row = mysql_fetch_array($err);
			if(($num > 0 and $row[0] == "on") or $key=="costosyp")
			{
			...
			echo "<tr><td colspan=8 align=center>INDIRECTOS COMPARATIVOS ENTRE A&Ntilde;OS</td></tr>";
			...
			echo "<tr><td><b>INDIRECTO</b></td><td align=right><b>A&Ntilde;O : ".$wanopa."</b></td><td align=right><b>A&Ntilde;O : ".$wanop."</b></td><td align=right><b>% VARIACION</b></td><td align=right><b>DIFERENCIA</b></td></tr>";
			$wdata=array();
			$k1=0;
			$k2=0;
			$num=-1;
