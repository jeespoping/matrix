...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Conjuntos con Elementos Sin Movimientos (CP)</font></a></td></tr>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc172.php Ver. 2016-04-22</b></font></td></tr></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc172.php' method=post>";
		...
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($wper1)  or !isset($wcco1)  or !isset($wcco2) or $wper1 < 1 or $wper1 > 12)
		{
			...
			echo "<tr><td align=center colspan=2>CONJUNTOS CON ELEMENTOS SIN MOVIMIENTOS (CP)</td></tr>";
		...
		else
		{
			...
			echo "<tr><td colspan=15 align=center>CONJUNTOS CON ELEMENTOS SIN MOVIMIENTOS (CP)</td></tr>";
