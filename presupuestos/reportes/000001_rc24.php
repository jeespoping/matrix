...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Ejecucion Operativa X Unidades de Negocio</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc24.php Ver. 2016-03-08</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc24.php' method=post>";
		...
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($wper1)  or !isset($wper2) or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2)
		{
			...
			echo "<tr><td align=center colspan=2>EJECUCION OPERATIVA X UNIDADES DE NEGOCIO</td></tr>";
		...
		else
		{
			...
			$query = "SELECT ccocod,cconom, sum(mopcan)  from ".$empresa."_000031,".$empresa."_000005,".$empresa."_000059 ";
			...
			echo "<tr><td colspan=8 align=center>EJECUCION OPERATIVA X UNIDADES DE NEGOCIO</td></tr>";
			...
			echo "<tr><td><b>LINEA DE INGRESOS</b></td><td align=right><b>CANTIDAD PPTO</b></td><td align=right><b>CANTIDAD REAL</b></td><td align=right><b>EJECUCION</b></td><td align=right><b>DIFERENCIA</b></td></tr>";
			$wdata=array();
			$k1=0;
			$k2=0;
			$num=-1;
