...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Facturacion Comparativa Para Segmento Para Un A&ntilde;o</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc45.php Ver. 2016-02-26</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc45.php' method=post>";
		echo "<center><input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($wseg) or !isset($wper1)  or !isset($wper2) or !isset($wcco1)  or !isset($wcco2) or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2)
		{
			echo "<center><table border=0>";
			echo "<tr><td align=center colspan=2><b>PROMOTORA MEDICA LAS AMERICAS S.A.<b></td></tr>";
			echo "<tr><td align=center colspan=2>FACTURACION COMPARATIVA PARA SEGMENTO PARA UN A&Ntilde;O</td></tr>";
		...
		else
		{
			...
			$Graph="/matrix/images/medical/presupuestos/rc45_".$wanop."_".$wper2.".jpg";
			$ini = strpos($wseg,"-");
			...
			{
			$query = "select empnit,empdes,miomes,sum(Mioito) as monto from ".$empresa."_000063,".$empresa."_000061 ";
			...
			$query = $query."  group by empnit,empdes,miomes  ";
			$query = $query."  order by empnit,miomes";
			$err = mysql_query($query,$conex);
			$num = mysql_num_rows($err);
			echo "<table border=1>";
			...
			echo "<tr><td colspan=16 align=center>FACTURACION COMPARATIVA  PARA SEGMENTO PARA UN A&Ntilde;O</td></tr>";
