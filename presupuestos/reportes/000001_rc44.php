...
<!--
	function enter()
	{
		document.forms.rc44.submit();
	}
//-->
</script>	
<center>
<table border=0 align=center>
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Facturacion Comparativa X Segmentos Para Un A&ntilde;o</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc44.php Ver. 2017-06-21</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form name= 'rc44' action='000001_rc44.php' method=post>";
		echo "<center><input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($wper1)  or !isset($wper2) or ((!isset($wcco1)  or !isset($wcco2)) and !isset($wccof)) or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2 or !isset($wres)  or (strtoupper ($wres) != "T" and strtoupper ($wres) != "P" and strtoupper ($wres) != "C"))
		{
			echo "<center><table border=0>";
			echo "<tr><td align=center colspan=2><b>PROMOTORA MEDICA LAS AMERICAS S.A.<b></td></tr>";
			echo "<tr><td align=center colspan=2>FACTURACION COMPARATIVA X SEGMENTOS PARA UN A&Ntilde;O</td></tr>";
			...
			echo "<tr><td bgcolor=#cccccc align=center>Tipo de Ingresos (T - Totales / P - Propios / C - Terceros)</td>";
		...
		else
		{
			...
			$Graph="/matrix/images/medical/presupuestos/rc44_".$wanop."_".$wper2.".jpg";
			$d=array();
			$d[0]=31;
			$d[1]=28;
			$d[2]=31;
			...
			{
				case "T":
					$query = "select segcod,segdes,miomes,sum(Mioito) as monto from ".$empresa."_000063,".$empresa."_000061,".$empresa."_000045 ";
				break;
				case "P":
					$query = "select segcod,segdes,miomes,sum(Mioinp) as monto from ".$empresa."_000063,".$empresa."_000061,".$empresa."_000045 ";
				break;
				case "C":
					$query = "select segcod,segdes,miomes,sum(Mioint) as monto from ".$empresa."_000063,".$empresa."_000061,".$empresa."_000045 ";
				break;
			}
			...
			$query = $query."   group by segcod,segdes,miomes  ";
			$query = $query."   order by segcod,segdes,miomes";
			$err = mysql_query($query,$conex);
			$num = mysql_num_rows($err);
			echo "<table border=1>";
			...
			echo "<tr><td colspan=16 align=center>FACTURACION COMPARATIVA X SEGMENTOS PARA UN A&Ntilde;O</td></tr>";
			...
			for ($i=1;$i<16;$i++)
				$wdatt[$i]=0;$query = $query."    and Emp = '".$wemp."' ";
			$seg=-1;
			$segn="";
			$wdatt[0]="TOTAL";
			for ($i=0;$i<$num;$i++)
