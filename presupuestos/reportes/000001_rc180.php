...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Estado de Resultados Consolidado por Matrix o Sucursal</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc180.php Ver. 2017-06-28</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc180.php' method=post>";
		echo "<center><input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
		if(!isset($wemp) or $wemp == "Seleccione" or !isset($wserv) or !isset($wcif) or (strtoupper ($wserv) != "S" and strtoupper ($wserv) != "N") or !isset($wres)  or (strtoupper ($wres) != "R" and strtoupper ($wres) != "D") or !isset($wtip)  or (strtoupper ($wtip) != "A" and strtoupper ($wtip) != "C") or !isset($wgru) or !isset($wanoi) or !isset($wperi1)  or !isset($wperi2) or $wperi1 < 1 or $wperi1 > 12 or $wperi2 < 1 or $wperi2 > 12 or $wperi1 > $wperi2 or !isset($wanof) or !isset($wperf1)  or !isset($wperf2) or $wperf1 < 1 or $wperf1 > 12 or $wperf2 < 1 or $wperf2 > 12 or $wperf1 > $wperf2)
		{
			echo "<center><table border=0>";
			echo "<tr><td align=center colspan=2><b>PROMOTORA MEDICA LAS AMERICAS S.A.<b></td></tr>";
			echo "<tr><td align=center colspan=2>ESTADO DE RESULTADOS CONSOLIDADO POR MATRIZ O SUCURSAL<td></tr>";
			...
			echo "<tr><td bgcolor=#cccccc align=center>Tipo de Unidades</td><td bgcolor=#cccccc align=center>";
			$query = "SELECT ccoseg  from ".$empresa."_000161 where ccoseg != 'NA' group by 1 order by 1";
		...
		else
		{
			...
			{
				//                  0     1           2           3
				$query = "SELECT rvpcpr,mganom,sum(rvpvre),sum(rvpvpr)   from ".$empresa."_000044,".$empresa."_000028,".$empresa."_000161 ";
				$query = $query."  where rvpano = ".$wanoi;
				$query = $query."    and rvpemp = '".$wemp."' ";
				$query = $query."    and rvpcco = Ccocod";
				$query = $query."    and ccoemp = '".$wemp."' ";
				if($wgru != "Todos")             
					$query = $query."    and Ccoseg = '".$wgru."' ";
			...
			{
				//                  0     1           2           3
				$query = "SELECT mgacoa,mganom,sum(rvpvre),sum(rvpvpr)   from ".$empresa."_000044,".$empresa."_000028,".$empresa."_000161 ";
				$query = $query."  where rvpano = ".$wanoi;
				$query = $query."    and rvpemp = '".$wemp."' ";
				$query = $query."    and rvpcco = Ccocod";
				$query = $query."    and ccoemp = '".$wemp."' ";
			...
			echo "<tr><td colspan=11 align=center>ESTADO DE RESULTADOS CONSOLIDADO POR MATRIZ O SUCURSAL</td></tr>";
			...
			echo "<tr><td colspan=11 align=center>TIPO : ".$wgru."</td></tr>";
