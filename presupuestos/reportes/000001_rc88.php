...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Procedimientos con Elementos Sin Movimientos</font></a></td></tr>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc88.php Ver. 2016-03-10</b></font></td></tr></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc88.php' method=post>";
		...
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($wper1)  or !isset($wcco1)  or !isset($wcco2) or $wper1 < 1 or $wper1 > 12)
		{
			...
			echo "<tr><td align=center colspan=2>PROCEDIMIENTOS CON ELEMENTOS SIN MOVIMIENTOS</td></tr>";
		...
		else
		{
			...
			echo "<tr><td colspan=15 align=center>PROCEDIMIENTOS CON ELEMENTOS SIN MOVIMIENTOS</td></tr>";
			...
			$query .= "  and Pqutip = '2' ";
			$query .= "  and Pqucod not in (SELECT mincod from ".$empresa."_000093  where minano = ".$wanop." and minmes = ".$wper1." and minemp = '".$wemp."') ";
			...
			$query .= "   and Mprpro not in (SELECT Pqupro from ".$empresa."_000099  where Pqucco = Mprcco and Pqugru = Mprgru and Pqucon = Mprcon and Mpremp = '".$wemp."') ";
			$query .= " Group by 1,2 ";
			$err1 = mysql_query($query,$conex);
			$num1 = mysql_num_rows($err1);
			for ($i=0;$i<$num1;$i++)
