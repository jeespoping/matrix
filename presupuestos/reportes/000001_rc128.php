...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Facturacion Total x Mes Entre A&ntilde;os x CC</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_rc128.php Ver. 2016-02-19</b></font></tr></td></table>
</center>
<?php
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_rc128.php' method=post>";
		echo "<center><input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione"  or !isset($wper1)  or !isset($wper2) or !isset($wccof) or $wper1 < 1 or $wper1 > 12 or $wper2 < 1 or $wper2 > 12 or $wper1 > $wper2)
		{
		...
		else
		{
			...
			echo "<tr><td colspan=7 align=center>CENTRO DE COSTOS : ".$wccof."</td></tr>";
