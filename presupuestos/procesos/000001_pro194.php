...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Replicacion de Porcentajes Distribucion Activos</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_pro194.php Ver. 2016-05-20</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_pro194.php' method=post>";
		...
		if(!isset($wanop1) or !isset($wemp) or $wemp == "Seleccione" or !isset($wcco1) or !isset($wcco2) or !isset($wper1) or !isset($wanop2) or !isset($wper2))
		{
			...
			echo "<tr><td align=center colspan=2>REPLICACION DE PORCENTAJES DISTRIBUCION ACTIVOS</td></tr>";
		...
		else
		{
			...
			{
				$count=0;
				$query = "delete from ".$empresa."_000084 ";
				$query = $query."  where Dacano = ".$wanop2;
				$query = $query."    and Dacemp = '".$wemp."'";
				$query = $query."    and Dacmes = ".$wper2;
				$query = $query."    and Daccco between '".$wcco1."' and '".$wcco2."' ";
				$err = mysql_query($query,$conex);
				$query = "SELECT Dacano, Dacmes, Daccco, Daccod, Dacsub, Dacpor  from ".$empresa."_000084 ";
				$query = $query."  where Dacano = ".$wanop1;
				$query = $query."    and Dacemp = '".$wemp."'";
				...
				for ($i=0;$i<$num;$i++)
				{
					...
					$query = "insert ".$empresa."_000084 (medico,fecha_data,hora_data,Dacemp, Dacano, Dacmes, Daccco, Daccod, Dacsub, Dacpor,seguridad) values ('".$empresa."','".$fecha."','".$hora."','".$wemp."',".$wanop2.",".$wper2.",'".$row[2]."','".$row[3]."','".$row[4]."',".$row[5].",'C-".$empresa."')";
