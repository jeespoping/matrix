...
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_pro69.php Ver. 2016-05-26</b></font></td></tr></table>
</center>
...
function protocolo($ano,$mes, $cco, $pro, $por, $gru, $con, $tip, $conex, $empresa)
{
	...
	if($tip == "T")
	    $query = "SELECT sum(procan*cxapro) as total from ".$empresa."_000100,".$empresa."_000083 ";
	else
		$query = "SELECT sum(procan*cxacvp) as total from ".$empresa."_000100,".$empresa."_000083 ";
				...
				for ($i=0;$i<$num;$i++)
				{
					...
					if($wtip == "T")
					{
						...
						if($row[2] == 1)
							...
							$wtmn=$wtotal / (1 - $row[2]);
						$query = "insert ".$empresa."_000097 (medico, fecha_data, hora_data,Pcaemp, Pcaano, Pcames, Pcacco, Pcacod, Pcagru, Pcacon, Pcapor, Pcactp, Pcatmn, Pcapro, Pcatip, seguridad) values ('".$empresa."','".$fecha."','".$hora."','".$wemp."',".$wanop.",".$wper1.",'".$row[0]."','".$row[1]."','".$row[3]."','".$row[6]."',".$row[2].",".$wtotal.",".$wtmn.",0,'P','C-".$empresa."')";
