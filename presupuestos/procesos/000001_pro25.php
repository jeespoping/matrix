...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5><b>Montaje de Informacion Cartera - Calculo Financiero</b></font></a></td></tr>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_pro25.php Ver. 1.00</b></font></tr></td></table>
</center>
<?php
...
else
{
	...
	echo "<form action='000001_pro25.php' method=post>";
		echo "<center><input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
	

	

	if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($wper1) or !isset($wfue) or !isset($wdel))
	{
		echo "<center><table border=0>";
		echo "<tr><td align=center colspan=2><b>PROMOTORA MEDICA LAS AMERICAS S.A.<b></td></tr>";
		echo "<tr><td align=center colspan=2>MONTAJE DE INFORMACION CARTERA - Calculo Financiero</td></tr>";
		...
		echo "<tr><td bgcolor=#cccccc align=center>Fuente de Factura</td>";
		echo "<td bgcolor=#cccccc align=center><input type='TEXT' name='wfue' size=2 maxlength=2></td></tr>";
		echo "<tr><td bgcolor=#cccccc align=center>Desea Borrar Informacion ?? (S/N)</td>";
		echo "<td bgcolor=#cccccc align=center><input type='TEXT' name='wdel' size=1 maxlength=1></td></tr>";
	...
	else
	{
		...
		$query=str_replace("FUE",$wfue,$query);
