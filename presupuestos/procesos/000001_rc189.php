...
<head>
  <title>MATRIX Ver. 2018-01-15</title>
	...
	<style type="text/css">
		...
		.tipoL011{color:#000066;background:#C3D9FF;font-size:9pt;font-family:Arial;font-weight:bold;text-align:center;height:2em;}
		.tipoL051{color:#000066;background:#CCCCCC;font-size:9pt;font-family:Arial;font-weight:bold;text-align:center;height:2em;}
		.tipoL05R1{color:#000066;background:#CCCCCC;font-size:9pt;font-family:Arial;font-weight:bold;text-align:right;height:2em;}
		
		.tipoL02R1{color:#000066;background:#E8EEF7;font-size:9pt;font-family:Arial;font-weight:normal;text-align:right;height:2em;}
		.tipoL02L1{color:#000066;background:#E8EEF7;font-size:9pt;font-family:Arial;font-weight:normal;text-align:left;height:2em;}
		
		.tipoL02R2{color:#000066;background:#FFFFFF;font-size:9pt;font-family:Arial;font-weight:normal;text-align:right;height:2em;}
		.tipoL02L2{color:#000066;background:#FFFFFF;font-size:9pt;font-family:Arial;font-weight:normal;text-align:left;height:2em;}
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		else
		{
			...
			echo "<tr>";
			echo "<td colspan=7><div id='amcharts".$id."' style='width:900px; height:200px;'></div></td>";
			echo "</tr>";
			echo "</table>";
			echo "</td></tr>";
			echo "</table></center>";
			...
			if($num > 0)
			{
				...
				echo "<tr><td bgcolor=#cccccc><font size=2><b>CODIGO<BR>CLIENTE</b></font></td><td bgcolor=#cccccc><font size=2><b>CLIENTE</b></font></td>";
				for ($i=$wperf1;$i<=$wperf2;$i++)
				{
					echo "<td bgcolor=#cccccc align=center><font size=2><b>Mes : ".$i."</b></font></td>";
				}
				echo "</tr>";
				$clave="";
				$s = -1;
				...
				for ($w=0;$w<$s;$w++)
				{
					...
					if($ncolor % 2 == 0)
						...
						$color="#99CCFF";
					echo "<tr><td bgcolor=".$color."><font size=2>".$data[$w][0]."</font></td><td bgcolor=".$color."><font size=2>".$data[$w][1]."</font></td>";
					for ($i=$wperf1;$i<=$wperf2;$i++)
			...
			echo "<tr>";
			echo "<td colspan=".$ncol."><table><tr><td><div id='amcharts".$id."1' style='width:400px; height:200px;'></div></td><td><div id='amcharts".$id."2' style='width:400px; height:200px;'></div></td><td><div id='amcharts".$id."3' style='width:400px; height:200px;'></div></td><td><div id='amcharts".$id."4' style='width:400px; height:200px;'></div></td><td><div id='amcharts".$id."5' style='width:400px; height:200px;'></div></td></tr></table></td>";
			echo "</tr>";
			echo "</table>";
			echo "</td></tr>";
			echo "</table></center>";
