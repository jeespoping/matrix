...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5><b>Montaje de Informacion de Activos Nuevos (T77)</b></font></a></td></tr>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_pro47.php Ver. 2016-12-05</b></font></tr></td></table>
</center>
<?php
...
else
{
	...
	echo "<form action='000001_pro47.php' method=post>";
	...
	if(!isset($wanop) or !isset($wper1) or !isset($wemp) or $wemp == "Seleccione")
	{
		...
		echo "<tr><td align=center colspan=2>MONTAJE DE INFORMACION DE ACTIVOS NUEVOS (T77)</td></tr>";
		echo "<tr><td bgcolor=#cccccc align=center>A&ntilde;o  Proceso</td>";
		echo "<td bgcolor=#cccccc align=center><input type='TEXT' name='wanop' size=4 maxlength=4></td></tr>";
		echo "<tr><td bgcolor=#cccccc align=center>Mes Proceso (Dos Digitos)</td>";
	...
	else
	{
		...
		$query = "delete from ".$empresa."_000077  ";
		...
		while (odbc_fetch_row($err_o))
		{
			...
			$query = "insert ".$empresa."_000077 (medico,fecha_data,hora_data,Minemp,Minano, Minmes, Mincco, Mincod, Mindes, Mingru, Minmon, Minpor, seguridad) values ('".$empresa."','".$fecha."','".$hora."','".$wemp."',".$wanop.",".$wper1.",'".$odbc[0]."','".$odbc[1]."','".$odbc[2]."','".$odbc[4]."',".$odbc[3].",".$odbc[5].",'C-".$empresa."')";
			//echo $query."<br>";
			$err1 = mysql_query($query,$conex) or die("Error en la Insercion de la Explicacion ".mysql_errno().":".mysql_error());
			$count++;
