...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5>Calculo Costo x Actividad Variable</font></a></tr></td>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_pro178.php Ver. 2014-08-19</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_pro178.php' method=post>";
		...
		if(!isset($wanop) or !isset($wemp) or $wemp == "Seleccione" or !isset($wper1) or !isset($wcco1) or !isset($wcco2) or $wper1 < 1 or $wper1 > 12)
		{
			...
			echo "<tr><td align=center colspan=2>CALCULO COSTO X ACTIVIDAD VARIABLE</td></tr>";
		...
		else
		{
			...
			{
				//                 0       1                   2     
				$query  = "SELECT Gascco,Gassub,sum((Gasval * (Rvbpor / 100)) / Mdacan) from ".$empresa."_000087,".$empresa."_000151,".$empresa."_000090 ";
				...
				$query .= "    and Rvbemp = Mdaemp ";
				$query .= "    and Rvbano = Mdaano ";
				$query .= "    and Rvbmes = Mdames ";
				$query .= "    and Rvbcco = Mdacco ";  
				$query .= "    and Gassub = Mdasub ";
				...
				{
					$row = mysql_fetch_array($err);
					$query = "update ".$empresa."_000083 set Cxacvm = ".$row[2]." where Cxaano=".$wanop." and Cxames=".$wper1." and Cxacco='".$row[0]."' and Cxasub='".$row[1]."' and Cxaemp='".$wemp."' ";
