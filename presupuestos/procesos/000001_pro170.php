...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5><b>Evaluacion Laboratorio de Patologia (Linea 31)</b></font></a></td></tr>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_pro170.php Ver. 2014-10-09</b></font></td></tr></table>
</center>
<?php
...
else
{
		...
		echo "<form action='000001_pro170.php' method=post>";
		echo "<center><input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
		if(!isset($wanop) or !isset($wmesi) or !isset($wporc))
		{
			echo "<center><table border=0>";
			echo "<tr><td align=center colspan=2><b>PROMOTORA MEDICA LAS AMERICAS S.A.<b></td></tr>";
			echo "<tr><td align=center colspan=2>EVALUACION DE HONORARIOS SIN COSTO (LINEA 31)</td></tr>";
			echo "<tr>";
