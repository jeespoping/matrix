...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5><b>Montaje de Informacion Activos Fijos - Calculo Financiero</b></font></a></td></tr>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_pro23.php Ver. 2016-12-05</b></font></tr></td></table>
</center>
<?php
...
else
{
	...
	echo "<form action='000001_pro23.php' method=post>";
	...
	if(!isset($wanop) or !isset($wper1) or !isset($wemp) or $wemp == "Seleccione")
	{
		...
		echo "<tr><td align=center colspan=2>MONTAJE DE INFORMACION ACTIVOS FIJOS - Calculo Financiero</td></tr>";
	...
	else
	{
		...
		while (odbc_fetch_row($err_o))
		{
			...
			$err1 = mysql_query($query,$conex) or die("Error en la Insercion del Movimiento de Activos Fijos");
			$count++;
