...
<tr><td align=center bgcolor="#cccccc"><A NAME="Arriba"><font size=5><b>Evaluacion de Honorarios Sin Costo (Linea 27)</b></font></a></td></tr>
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_pro169.php Ver. 2013-03-15</b></font></td></tr></table>
</center>
<?php
...
else
{
		...
		echo "<form action='000001_pro169.php' method=post>";
		echo "<center><input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
		if(!isset($wanop) or !isset($wmesi))
		{
			echo "<center><table border=0>";
			echo "<tr><td align=center colspan=2><b>PROMOTORA MEDICA LAS AMERICAS S.A.<b></td></tr>";
			echo "<tr><td align=center colspan=2>EVALUACION DE HONORARIOS SIN COSTO (LINEA 27)</td></tr>";
			echo "<tr>";
