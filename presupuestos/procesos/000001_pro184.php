...
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_pro184.php Ver. 2016-05-13</b></font></tr></td></table>
</center>
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='000001_pro184.php' method=post>";
		...
		else
		{
			...
			{
				$count=0;
				$query = "delete from ".$empresa."_000157 ";
				$query = $query."  where Mdpano = ".$wanop2;
				$query = $query."    and Mdpemp = '".$wemp."'";
				$query = $query."    and Mdpmes = ".$wper2;
				$query = $query."    and Mdpcco between '".$wcco1."' and '".$wcco2."' ";
				$err = mysql_query($query,$conex);
				$query = "SELECT Mdpano, Mdpmes, Mdpcco, Mdpsub, Mdpdri, Mdpcan  from ".$empresa."_000157 ";
				$query = $query."  where Mdpano = ".$wanop1;
				$query = $query."    and Mdpemp = '".$wemp."'";
				...
				for ($i=0;$i<$num;$i++)
				{
					...
					$query = "insert ".$empresa."_000157 (medico,fecha_data,hora_data,Mdpemp, Mdpano, Mdpmes, Mdpcco, Mdpsub, Mdpdri, Mdpcan,seguridad) values ('".$empresa."','".$fecha."','".$hora."','".$wemp."',".$wanop2.",".$wper2.",'".$row[2]."','".$row[3]."','".$row[4]."',".$row[5].",'C-".$empresa."')";
