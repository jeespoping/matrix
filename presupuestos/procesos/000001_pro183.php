...
<tr><td align=center bgcolor="#cccccc"><font size=2> <b> 000001_pro183.php Ver. 2015-07-03</b></font></td></tr></table>
</center>
<?php
...
else
{
		...
		echo "<form action='000001_pro183.php' method=post>";
		...
		else
		{
			...
			$query = "update ".$empresa."_000116 set Labanp=0, Labmep=0  ";
			$query = $query."  where Labanp =  ".$wanop;
			$query = $query."    and Labmep =  ".$wmesi;
			$err = mysql_query($query,$conex) or die (mysql_errno().":".mysql_error());
			...
			$query .= " 	and costosyp_000116.Labanp = 0 "; 
			$query .= " 	and costosyp_000116.Labmep = 0 "; 
			$query .= "  group by 1,2  ";
			$query .= " UNION ALL  ";
			$query .= " select lpad(costosyp_000116.Labhis,12,'0'),lpad(costosyp_000116.Labing,5,'0'),sum(costosyp_000116.Labmon)";
			$query .= "   from costosyp_000116 ";  
			$query .= "   where costosyp_000116.Labano = ".$wanoa; 
			$query .= " 	and costosyp_000116.Labmes between ".$wmesa." and 12 ";
			$query .= " 	and costosyp_000116.Labanp = 0 "; 
			$query .= " 	and costosyp_000116.Labmep = 0 ";  
			$query .= "  group by 1,2 ";
			$query .= "  order by 1,2 ";
				...
				for ($i=0;$i<$num;$i++)
				{
					...
					if($kla != str_pad($row[0], 12, "0", STR_PAD_LEFT).str_pad($row[1], 5, "0", STR_PAD_LEFT))
					{
						...
						if($pos != -1)
						{
							...
							$query  = "update  ".$empresa."_000116 set Labanp=".$wanop.", Labmep=".$wmesi."  ";
							$query .= "   where costosyp_000116.Labano = ".$wanop;
							$query .= " 	and costosyp_000116.Labmes between 1 and ".$wmesi; 
							$query .= " 	and costosyp_000116.Labanp = 0 "; 
							$query .= " 	and costosyp_000116.Labmep = 0 "; 
							$query .= " 	and costosyp_000116.Labhis = '".$row[0]."'";
							$query .= " 	and costosyp_000116.Labing = '".$row[1]."'";
