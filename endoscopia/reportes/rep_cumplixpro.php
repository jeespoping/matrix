...
<script type="text/javascript">
	function enter()
	{
		document.forms.rep_cumplixpro.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//endos_000001     : Tabla de Procesos Prioritarios.                                                                                        |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_cumplixpro.php' method='post'>";
...
if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
 ...
 else // Cuando ya estan todos los datos escogidos
  {
   ...
   echo "</table>";
    ...
    $query = " SELECT ppproce,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppcrite16,ppcrite17,ppcrite18"
            ."   FROM ".$empre1."_000001"
            ."  WHERE ppproce = '".$tpp."'" 
