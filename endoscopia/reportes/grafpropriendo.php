...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafpropriendo.php'; 
	}
	
	function enter()
	{
		document.forms.grafpropriendo.submit();
	}
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='grafpropriendo.php' method='post'>";
