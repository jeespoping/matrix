...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detpropriendo.php'; 
	}
	
	function enter()
	{
		document.forms.rep_detpropriendo.submit();
	}
...
//FECHA CREACION			  :MAYO 4 DE 2010.                                                                                              |
//FECHA ULTIMA ACTUALIZACION  :4 de MAYO de 2010.                                                                                           |
//TABLAS UTILIZADAS :                                                                                                                       |
//pamec_000001      : Tabla de Procesos prioritarios VIDEOENDOSCOPIA.                                                                       |
//Modifica          :                                                                                                                       |
//                    2012-10-30. La jefe de enfermeria de endoscopia, pide cambiar los procesos, colocandole + criterio o menos.
//==========================================================================================================================================
include_once("root/comun.php");
$conex = obtenerConexionBD("matrix");

$wactualiz="1.0 4-Mayo-2010";
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detpropriendo.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
 if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_detpropriendo' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
   ...
   $query = " SELECT pppersoe1,ppcargoe1,pppersoe2,ppcargoe2,ppfecha,ppproce,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppcrite16,ppcrite17,ppcrite18,ppobser,ppporce"
           ."   FROM ".$empre1."_000001"
           ."  WHERE ppproce = '".$tpp."'" 
           ."    AND ppporce < 100"
           ."    AND ppfecha between '".$fec1."' and '".$fec2."'"
           ."  ORDER BY ppfecha,pppersoe1,pppersoe2";
	...
	for ($i=1;$i<=$num1;$i++)
	 {
      ...
      echo "<tr>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=150><font size='1' color='#000000'><b>PERSONA EVALUADA 1:</b></font></td>";  
      echo "<td  bgcolor=#FFFFFF align=center width=200><font size=1>&nbsp;$row2[0]</font></td>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=200><font size='1' color='#000000'><b>CARGO PERSONA EVALUADA 1:</b></font></td>"; 
      echo "<td  bgcolor=#FFFFFF align=center width=200><font size=1>&nbsp;$row2[1]</font></td>";
      echo "</tr>";
      echo "</table>";
      
      echo "<table border=0 size='750'>";	
      echo "<tr>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=150><font size='1' color='#000000'><b>PERSONA EVALUADA 2:</b></font></td>";  
      echo "<td  bgcolor=#FFFFFF align=center width=200><font size=1>&nbsp;$row2[2]</font></td>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=200><font size='1' color='#000000'><b>CARGO PERSONA EVALUADA 2:</b></font></td>"; 
      echo "<td  bgcolor=#FFFFFF align=center width=200><font size=1>&nbsp;$row2[3]</font></td>";
      echo "</tr>";
      echo "</table>";
      
      echo "<table border=0 size='350'>";	
      echo "<tr>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=150><font size='1' color='#000000'><b>FECHA EVALUACION:</b></font></td>"; 
      echo "<td  bgcolor=#FFFFFF align=center width=200><font size=1>&nbsp;$row2[4]</font></td>";
      echo "</tr>";
      echo "</table>";
