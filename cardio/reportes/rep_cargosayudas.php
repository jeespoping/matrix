<html>
<head>
<title>Impresión Cargos de Ayudas Diagnosticas - Unix</title>
<style type="text/css">
BODY           
{   
    font-family: Verdana;
...
/*******************************************************************************************************************************************
*                                           IMPRESION DEL DETALLE DE LOS EXAMENES DE AYUDAS DIAGNOSTICAS - UNIX                            *
********************************************************************************************************************************************/
//==========================================================================================================================================
//PROGRAMA				      :Impresión cargos ayudas.                                                                                     |
//AUTOR				          :Ing. Gustavo Alberto Avendano Rivera.                                                                        |
//FECHA CREACION			  :Noviembre 28 DE 2011.                                                                                        |
//FECHA ULTIMA ACTUALIZACION  :28 de Noviembre de 2011.                                                                                     |
//DESCRIPCION			      :Este programa sirve para imprimir el detalle del cargo de ayudas diagnosticas.                               |
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
...
$wactualiz="1.0 28-Noviembre-2011";
...
else
{
 ...
 $conexi=odbc_connect('facturacion','','')
	       ...
	       //Forma
 echo "<form name='forma' action='rep_cargosayudas.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($carg) or $carg == '' )
  {
  	echo "<form name='rep_cargosayudas' action='' method=post>";
  ...
  echo "<tr><td colspan='1' align=center><IMG SRC='/MATRIX/images/medical/paf/logo.png' WIDTH=280 HEIGHT=100></td>"; //trae el logo de la clinica.
  echo "</tr>";
  echo "</table>";
  ...
  $query3="SELECT cardetcon,connom,cardetcod cod,cupdes des,cardetcan,cardetnit,cardettot"
         ...
         ."   and cardetanu='0'"
         ." UNION ALL "
		 ." SELECT cardetcon,connom,cardetcod cod,'' des,cardetcan,cardetnit,cardettot"
         ."  FROM aycardet,facon"
         ." WHERE cardetfue='".$fue."'"
         ."   and cardetdoc='".$carg."'"
         ."   and cardetcon=concod"
         ...
         ."   and cardetanu='0'"
         ." UNION ALL "
         ."SELECT cardetcon,connom,drodetart cod,artnom des,cardetcan,cardetnit,cardettot"
         ...
         ."   and cardetanu='0'"
         ." UNION ALL "
         ."SELECT cardetcon,connom,cardetcod cod,cupdes des,cardetcan,cardetnit,cardettot"
  ...
  echo "<td align=LEFT bgcolor=#FFFFFF ><font size='2' text color='#003366'><b>Tercero</b></font></td>";
  ...
  while (odbc_fetch_row($err_o3))
   {
	...
	$nit3   = odbc_result($err_o3,6);//TERCERO
    ...
    echo "<td align=LEFT bgcolor=#FFFFFF ><font size='2' text color='#003366'>".$nit3."</font></td>";
