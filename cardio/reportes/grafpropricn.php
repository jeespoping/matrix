<html>
<head>
<title>MATRIX - [REPORTE GRAFICA PROCESOS PRIORITARIOS ENDOSCOPIA]</title>

<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafpropricn.php'; 
	}
	
	function enter()
	{
		document.forms.grafpropricn.submit();
	}
...
//FECHA ULTIMA ACTUALIZACION  : MAYO 7 DE 2010.                                                                                           |
//DESCRIPCION			      : Sirve para graficar.                                                                           |
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//cardio_000005     : Tabla de Bases de datos totales por proceso prioritario.                                                               |
//cardio_000004     : Tabla de movimiento procesos prioritarios.                                                                             |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='grafpropricn.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
 {
	echo "<form name='grafpropri' action='' method=post>";
