...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detpropricn.php'; 
	}
	
	function enter()
	{
		document.forms.rep_detpropricn.submit();
	}
...
//FECHA CREACION			  :MAYO 7 DE 2010.                                                                                              |
//FECHA ULTIMA ACTUALIZACION  :7 de MAYO de 2010.                                                                                           |
//TABLAS UTILIZADAS :                                                                                                                       |
//cardio_000001      : Tabla de Procesos prioritarios CARDIOLOGIA.                                                                           |
//==========================================================================================================================================
include_once("root/comun.php");
$conex = obtenerConexionBD("matrix");

$wactualiz="1.0 7-Mayo-2010";
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detpropricn.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
 if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_detpropricn' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
   ...
   $query = " SELECT ppfecha,ppident,ppingr,ppperseva,ppcargoeva,ppproce,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcrite5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppcrite16,ppcrite17,ppobser,ppporc"
           ."   FROM ".$empre1."_000005"
           ."  WHERE ppproce = '".$tpp."'" 
           ."    AND ppporc < 100"
           ."    AND ppfecha between '".$fec1."' and '".$fec2."'"
           ."  ORDER BY ppfecha,ppident,ppingr";
	...
	for ($i=1;$i<=$num1;$i++)
	 {
      ...
      echo "<tr>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=150><font size='1' color='#000000'><b>FECHA DE EVALUACION:</b></font></td>";  
      echo "<td  bgcolor=#FFFFFF align=center width=100><font size=1>&nbsp;$row2[0]</font></td>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=150><font size='1' color='#000000'><b>DOCUMENTO DE IDENTIDAD:</b></font></td>"; 
      echo "<td  bgcolor=#FFFFFF align=center width=100><font size=1>&nbsp;$row2[1]</font></td>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=150><font size='1' color='#000000'><b>NRO INGRESO EN CARDIOLOGIA:</b></font></td>"; 
      echo "<td  bgcolor=#FFFFFF align=center width=100><font size=1>&nbsp;$row2[2]</font></td>";
      echo "</tr>";
      echo "</table>";
      
      echo "<table border=0 size='750'>";	
      echo "<tr>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=150><font size='1' color='#000000'><b>PERSONA EVALUADA:</b></font></td>";  
      echo "<td  bgcolor=#FFFFFF align=center width=200><font size=1>&nbsp;$row2[3]</font></td>";
      echo "<td align=LEFT bgcolor=#FFFFFF width=200><font size='1' color='#000000'><b>CARGO PERSONA EVALUADA:</b></font></td>"; 
      ...
      echo "<table border=0 >";
      echo "<Tr >";
      echo "<td  bgcolor=#FFFFFF align=left width=100%><font size=1>&nbsp;$row2[23]</font></td>";
      echo "</tr >"; 
      echo "</table>";
      ...
      echo "<td  bgcolor=#FFFFFF align=left width=65%><font size=2 color=#FF0000>&nbsp;<b>".number_format($row2[24])."%</b></font></td>";
      echo "</tr >"; 
      echo "</table>";
