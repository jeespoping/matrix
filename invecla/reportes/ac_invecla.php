...
else
{
	...
	echo "<form name='ac' action='ac_invecla.php' method=post>";
	...
	if(!isset($wano))
	{
		...
		{
			case "cominf":
				$query = "SELECT Actano from cominf_000035 GROUP BY Actano";
			break;
			case "juntacs":
	...
	else
	{
		...
		{
			case "cominf":
				$query = "select Actano, Actcod, Actfec, Actnom   from  cominf_000035 ";
		...
		{
			case "cominf":
				echo "<tr><td align=center colspan=2><IMG SRC='/matrix/images/medical/cominf/promotora.png' width=50%></td></tr>";
			break;
			case "juntacs":
