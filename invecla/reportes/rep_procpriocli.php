<html>
<head>
<title>MATRIX - [Formulario de Evaluación Técnica]</title>
...
<script language="JavaScript"> 
  ...
  function inicio()
	{ 
	 document.location.href='rep_procpriocli.php'; 
	}
	
  function enter()
	{
		document.forms.rep_procpriocli.submit();
	}
...
/*******************************************************************************************************************************************
*                                             REPORTE FORMULARIO DE PROCESOS PRIORITARIOS CLINICA                                          *
********************************************************************************************************************************************/

//==========================================================================================================================================
//PROGRAMA				      : Reporte para ver el formulario de procesos prioritarios de la clinica.                                      |
//AUTOR				          : Ing. Gustavo Alberto Avendano Rivera.                                                                       |
//FECHA CREACION			  : ENERO 30 DE 2012.                                                                                           |
//FECHA ULTIMA ACTUALIZACION  : 17 de Septiembre de 2013.                                                                                   |
//TABLAS UTILIZADAS :                                                                                                                       |
//cominf_000047     : Tabla de procesos prioritarios de clinica-nuevos.                                                                     |
//==========================================================================================================================================
include_once("root/comun.php");
$conex = obtenerConexionBD("matrix");

$wactualiz="2.0 17-Septiembre-2013";
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_procpriocli.php' method='post'>";
 ...
 $hoy=date("Y-m-d");	
   ...
   echo "<tr>";
   echo "<td align=center colspan='1' bgcolor=#FFFFFF><font size='3' text color=#003366><b>EVALUACIÓN TÉCNICA CLINICA</b></font></td>";
   echo "</tr>";
   echo "</table>";
   ...
   $query1=" SELECT `Ppcfecha`,`Ppccco`,`Ppccodnom`,`Ppccargo1`,`Ppcproce` ,`Ppcdetcri1`,`Ppccrite1` ,`Ppcdetcri2`, `Ppccrite2` ,`Ppcdetcri3`,`Ppccrite3` ,`Ppcdetcri4`,`Ppccrite4` ,`Ppcdetcri5`,`Ppccrite5` ,`Ppcdetcri6`,`Ppccrite6` ,`Ppcdetcri7`,`Ppccrite7` ,`Ppcdetcri8`,`Ppccrite8`,`Ppctotal` ,`Ppcporce` ,`Ppcevalua` ,`Ppccargoeva` ,`Ppcobserva` ,`id` " 
          ."   FROM ".$empre1."_000047" 
          ."  WHERE `Ppccco` LIKE '$row[0]%'";
   ...
   $num1 = mysql_num_rows($err1);       
     ...
     echo "<Tr>";
	 echo "<td>";
     echo "<align=left><INPUT type=button value='NUEVO' onclick='javascript: abrirVentana(\"/matrix/det_registro.php?id=0&pos1=cominf&pos2=0&pos3=0&pos4=000047&pos5=0&pos6=cominf&tipo=P&Valor=&Form=000047-cominf-C-Procesos P. Clinica&call=0&change=0&key=cominf&Pagina=1\")'>";
     echo "</td>";
     ...
     echo "<td bgcolor='#FFFFFF'align=center width=50><font text color=#003366 size=1><b>FUNCIONARIO EVALUADO</b></td>";
     echo "<td bgcolor='#FFFFFF'align=center width=50><font text color=#003366 size=1><b>CARGO FUNCIONARIO EVALUADO</b></td>";
     echo "<td bgcolor='#FFFFFF'align=center width=50><font text color=#003366 size=1><b>PROCEDIMIENTO EVALUADO</b></td>";
	...
	for ($i=1;$i<=$num1;$i++)
	 {
	  $row2 = mysql_fetch_array($err1);
       ...
       $hyper="<A HREF='/matrix/det_registro.php?id=".$row2[26]."&pos1=cominf&pos2=0&pos3=0&pos4=000047&pos5=0&pos6=cominf&tipo=P&Valor=&Form=000047-cominf-C-Procesos P. Clinica&call=0&change=0&key=cominf&Pagina=1' target='new' >Editar</a>";
