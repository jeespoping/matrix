<HTML>
<HEAD>
<TITLE>Consolidado general del programa cardiovascular en un periodo</TITLE>
</HEAD>
<BODY>
...
//Forma
echo "<form name='paf08' action='paf08.php' method=post>";  
 ...
 if (!isset($wfec1) or !isset($wfec2))
 {
    ...
    echo "<tr>";
	echo "<tr><td align=CENTER colspan=4 bgcolor=#DDDDDD><b><font text color=#003366 size=2>Consolidado general del programa cardiovascular en un periodo<br></font></b>";   
	echo "</tr>";
 ...
 else      // Cuando ya estan todos los datos escogidos
 {
    ...
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=4><i>Estadisticas generales del programa cardiovascular</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=4><i>Periodo: ".$wfec1." Al ".$wfec2."</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>PROGRAMA: paf08.php Ver. 2011/12/09<br>AUTOR: JairS</font></b><br>";
    echo "</table>";
    ...
    $query="SELECT count(*) as Ordenes From paf_000001 "
