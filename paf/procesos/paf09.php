...
echo "<tr><td align=center bgcolor=#DDDDDD colspan=2><b><font text color=#003366 size=3><i>NUEVA EPS - CLINICA LAS AMERICAS</font></b><br>";

     $query="SELECT Id,paffec,pafnom,pafape,pafced,paftel,pafran,paftip,pafdia,pafexa,pafcco,Seguridad,pafobs From paf_000001 WHERE Id =".$wid; 
     ...
     if ($nroreg > 0)      //  Encontro 
     {
      ...
      $query = "SELECT Excento_pago_moderador,Afi_fechanaci FROM paf_000002 Where Afi_identific='".$registro[4]."'";  
