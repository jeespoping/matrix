...
$query = "SELECT Afi_sexo,count(*)  FROM paf_000002 GROUP BY Afi_sexo "; 
//$query = "SELECT Afi_tip_cotiza_ ,count(*)  FROM paf_000002 GROUP BY Afi_tip_cotiza_  "; 
...
$graph->title->Set("PROGRAMA CARDIOVASCULAR - USUARIOS POR SEXO - TOTAL USUARIOS ".$wtot ); 
