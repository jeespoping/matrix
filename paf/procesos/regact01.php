                        ...
                        <div class="form-horizontal; position: absolute" align="center">
                            <table align="center">
                                <tr>
                                    <td>
                                        <?php
                                        if($dia != '' and $parametro == '0'){?><label>Dia Seleccionado : <?phpecho $dia ?></label> <?php}
                                        if($caso != '' and $parametro == '1'){?><label>Palabra Clave : <?phpecho $caso ?></label> <?php}
                                        if($responsable != '' and $parametro == '2'){?><label>Responsable de la Actividad : <?phpecho $responsable ?></label> <?php}
                                        ?>
                                    </td>
                                </tr>
                            </table>
