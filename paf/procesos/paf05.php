...
$query = "SELECT YEAR(CURDATE())-substr(Afi_fechanaci,7,4)  AS EDAD  FROM paf_000002"; 
...
$graph->title->Set("PROGRAMA CARDIOVASCULAR - USUARIOS POR EDADES - TOTAL USUARIOS ".$wtot ); 
