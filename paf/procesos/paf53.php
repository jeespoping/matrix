...
echo "<form name='paf53' action='paf53.php' method=post>";  
 ...
 if ($wproceso=="Borrar")
 {   
	 $query = "DELETE FROM paf_000003 Where ateced = '".$wced."' And atefec = '".$wfec."' And atehor = '".$whor."'";   
    ...
    {   
        ...
        if ( $registroB = mysql_fetch_row($resultadoB) )      //  Encontro 
		 ...
		 {		
            ...
            echo "<td><A HREF='paf51.php?wfec=".$registro[1]."&whor=".$registro[2]."&wced=".$registro[3]."&windicador=PrimeraVez&wproceso=Modificar' TARGET='_blank' >Editar</A>";	     
            echo "<td><A HREF='paf53.php?wfec=".$registro[1]."&whor=".$registro[2]."&wced=".$registro[3]."&windicador=PrimeraVez&wproceso=Borrar' >Borrar</A></td></tr>";	     
