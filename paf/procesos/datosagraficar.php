  ...
  if (!isset($wfec2))   // Si no esta seteada entonces la inicializo en el ultimo dia del mes actual con formato aaaa-mm-dd
  {
	...
	{ 
      if (isset($PrimeraVez))  //La primera vez no muestre esta linea
        echo "<tr><td align=CENTER colspan=4 bgcolor=#DDDDDD><A HREF='graficos_paf.php?wind=".$wind."&wfec1=".$wfec1."&wfec2=".$wfec2."' >Graficar <IMG SRC='Icon_05.ico' ALT='Genera Grafico de los datos'></A></td>";	     
      else
        $PrimeraVez="N";
    }
echo "</table>";
