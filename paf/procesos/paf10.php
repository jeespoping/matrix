...
echo "<form name='paf10' action='paf10.php' method=post>";  
  
     $query="SELECT * From paf_000001 WHERE Id =".$wid; 
     ...
     if ($nroreg > 0)      //  Encontro 
     {
      ...
      echo "<tr><td align=center colspan=6 bgcolor=#C0C0C0>";
   	  ...
   	  $f = date("Y-m-d");
   	  if ( $conf == "on")
   	  { $query="UPDATE paf_000001 SET pafest='X',pafanu='".$user."-".$f."' WHERE Id =".$wid;
