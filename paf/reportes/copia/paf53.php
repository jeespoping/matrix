<HTML>
<HEAD>
<TITLE>Reporte de atenciones Programa cardiovascular NUEVA EPS</TITLE>
</HEAD>
<BODY>
...
//Forma
echo "<form name='paf53' action='paf53.php' method=post>";  
...
/*****/	
   ...
   $query = "SELECT codigo,Descripcion FROM citaspaf_000010 Group By codigo,Descripcion Order By codigo"; 	         
...
/****/	
 ...
 else      // Cuando ya estan todos los datos escogidos
 {
    ...
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=4><i>Reporte de atenciones programa cardiovascular NUEVA EPS</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=4><i>Periodo: ".$wfec1." Al ".$wfec2."</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>PROGRAMA: paf53.php Ver. 2015/10/26<br>AUTOR: JairS</font></b><br>";
    echo "</table>";
    ...
    {   
        ...
        $query = "SELECT Descripcion FROM citaspaf_000010 WHERE codigo='".$registro[0]."' Group By Descripcion"; 
        ...
        if ( $registroB = mysql_fetch_row($resultadoB) )      //  Encontro 
		 ...
		 {		
            echo "<tr><td colspan=2 align=center bgcolor='CCFFFF'><font text color=#003366 size=3>".$registro[1]."</td>";
			...
			echo "<td colspan=2 align=center bgcolor='CCFFFF'><font text color=#003366 size=3>".$registro[4]."</td>";
			echo "<td colspan=2 align=LEFT   bgcolor='CCFFFF'><font text color=#003366 size=3>".$registro[5]."</td>";
			echo "<td colspan=2 align=LEFT   bgcolor='CCFFFF'><font text color=#003366 size=3>".$registro[6]."</td>";
			echo "<td colspan=2 align=LEFT   bgcolor='CCFFFF'><font text color=#003366 size=3>".$registro[7]."</td>";
            switch ($registro[8])
			{ 
             case "1":
              $wcon = "Alta";
			...
			echo "<td colspan=2 align=LEFT   bgcolor='CCFFFF'><font text color=#003366 size=3>".$wcon."</td>";
            If ( $registro[9] == "1")
			 $wcit = "Control";
            else
             $wcit = "1ra Vez";
			...
			echo "<td colspan=2 align=center bgcolor='CCFFFF'><font text color=#003366 size=3>".$wcit ."</td>";
			echo "<td colspan=2 align=LEFT   bgcolor='CCFFFF'><font text color=#003366 size=3>".$registro[10]."</td>";
			echo "<td colspan=2 align=LEFT   bgcolor='CCFFFF'><font text color=#003366 size=3>".$registro[11]."</td>";
             ...
             $resultadoB=mysql_query($query); 
             if ( $registroB = mysql_fetch_row($resultadoB) )      //  Encontro 
               echo "<td colspan=2 align=LEFT   bgcolor='CCFFFF'><font text color=#003366 size=3>(".$registroB[0].") ".$registroB[1]."</td>";
			 else
			...
			echo "<td colspan=2 align=LEFT   bgcolor='CCFFFF'><font text color=#003366 size=3>".$registro[14]."</td>";
			
            echo "<td><A HREF='paf51.php?wfec=".$registro[1]."&whor=".$registro[2]."&wced=".$registro[3]."&windicador=PrimeraVez&wproceso=Modificar' TARGET='_blank' >Editar</A></td></tr>";	     
        ...
        echo "<td colspan=22 align=center bgcolor='#CC99CC'><font text color=#003366 size=3>TOTAL PACIENTES ATENDIDOS: </td>";
        echo "<td colspan=6 align=LEFT   bgcolor='#CC99CC'><font text color=#003366 size=3>".$wtotmed."</td>";
	    echo "</tr>";
	} 
	echo "<td colspan=22 align=center bgcolor='#CC99CC'><font text color=#003366 size=3>TOTAL GENERAL PACIENTES ATENDIDOS: </td>";
    echo "<td colspan=6 align=LEFT   bgcolor='#CC99CC'><font text color=#003366 size=3>".$wtotgrl."</td>";
	echo "</tr>";
    echo "</table>";
 }  
echo "</Form>"; 
