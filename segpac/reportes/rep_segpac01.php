			...
			if ($wccocod!=$row['Segpaccco'])
				{	
					...
					echo "<tr><td align='left' colspan='5'>&nbsp;</td></tr>";
						...
						echo"<tr><td align=left border=1 colspan='9' bgcolor=".$color2.">IDENTIFICACION CORRECTA DEL PACIENTE</td></tr>";
						...
						echo"<tr><td align=left border=1 colspan='9' bgcolor=".$color2.">RIESGO DE CAIDA</td></tr>";
