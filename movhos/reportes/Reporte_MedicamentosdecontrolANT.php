              ...
              while($row = mysql_fetch_assoc($res_con)){
                  ...
                  /* Construyo el array principal para posteriormente pintar en la tabla principal del formulario 
                   ...
                   if( $wusuarioent != '' ){
						...
						list($identificaEntrega,$nombreEntrega) = split('[|]',$datosEntrega);
						...
						list($Medno1,$Medno2,$Medap1,$Medap2,$Medreg,$Medtdo,$Meddoc,$Espnom) = split('[|]',$datosMedico);
						...
						list($identificaRecibe,$nombreRecibe) = split('[|]',$datosRecibe);
                        ...
                        $arr_resultado[] = array("codigo_formula"      => $row['Ctrcon'],
                                               ...
                                               "identifica_recibe"     => $identificaRecibe == '' ? $identificaEntrega : $identificaRecibe,
                                               "nombre_recibe"         => $identificaRecibe == '' ? utf8_encode($nombreEntrega) : utf8_encode($nombreRecibe),
                                               "identifica_entrega"    => $identificaEntrega,
                                               "nombre_entrega"        => utf8_encode($nombreEntrega),
