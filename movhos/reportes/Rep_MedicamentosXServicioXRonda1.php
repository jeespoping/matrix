...
{	            
  ...
  include_once("movhos/movhos1.inc.php");
  ...
  //===========================================================================================================================================
  //===========================================================================================================================================
  echo "<form name='separacionXRonda' action='Rep_MedicamentosXServicioXRonda1.php' method=post>";
  ...
  if (!isset($wcco) or !isset($wccoo))
     {
      elegir_centro_de_costo();
	...
	else
       {
		...
		echo "<b>Notas:</b><br>** Los medicamentos <b>'a necesidad'</b> que no pertenezcan a esta ronda no salén; salén siempre y cuando esten como enviables en esta ronda. <br>";
		...
		//echo "<th colspan=1><font size=4>Estado</font></th>";
		echo "</tr>";
					...
					if ($row[7] == "on")                           //Indica si esta aprobado en el perfil
					   {
						...
						echo "<td align=center>".$row[4]."</td>";  //Presentacion 
						 ...
						 if ($wccotim == "SF")
							 echo "<td align=center colspan=5 bgcolor=FFFFCC>Sin Aprobar en el perfil</td>";
							else
							   if ($row[8] == "off")               //No confirmado. Es antibiotico
								  echo "<td align=center colspan=5 bgcolor=FFFFCC>Medicamento Sin Confirmar en el Kardex</td>";
								 else
									echo "<td align=center colspan=5 bgcolor=FFFFCC>Sin Aprobar en el perfil</td>";
		...
		echo "<br><br>";
		echo "<table>";
		echo "<tr><td><A HREF='Rep_MedicamentosXServicioXRonda1.php?wemp_pmla=".$wemp_pmla."&user=".$user."' class=tipo4V>Retornar</A></td></tr>";
		echo "</table>";	

        echo "<meta http-equiv='refresh' content='120;url=Rep_MedicamentosXServicioXRonda1.php?wemp_pmla=".$wemp_pmla."&wuser=".$user."&wcco=".$wcco."&wccoo=".$wccoo."&whora_par_actual=".$whora_par_actual."'>";   		    		
	   }
