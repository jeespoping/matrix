 ...
 ******************************************************************************************************************************/
  ...
  function consultarDetalleDiaCamaOcupada(ele, servicio, wfechaInicial, wfechaFinal){
	...
	$.post('indicadores_hospitalarios_dia2.php', { 
  ...
  function consultarDetalle(ele, wfecha, wcco, wcconom, wtipo){
	...
	if( ele.text() == "0" ) return;
	$.blockUI({ message: $('#msjEspere') });
	$.post('indicadores_hospitalarios_dia2.php', { wemp_pmla: wemp_pmla, wfechap:wfecha, wcco:wcco, wcconom:wcconom, wtipo:wtipo, consultaAjax: 'consultarDetalle' } ,
		function(data) {
			$.unblockUI();
