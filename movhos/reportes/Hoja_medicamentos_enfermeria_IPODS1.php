						  ...
						  if ($Mrondas[$i][$j] == 0)            
							 {
							  if (isset($Mrondas[$i]["jus".$j]) and  $Mrondas[$i]["jus".$j] != '')	 
								 echo "<td align=center title='".$wmsg.", No se aplicó: ".$Mrondas[$i]["jus".$j]."'><img src=/matrix/images/medical/movhos/info.png></td>";
								else 
							...
							else  
							   {
								...
								if ($wsuspendido and $wultapl=="on")
								   echo "<td align=center bgcolor='FEAAA4' title='".$wmsg.", Luego de esta aplicación fue Suspendido'><img src=/matrix/images/medical/movhos/checkmrk.ico alt='".$wmsg.", Luego de esta aplicación fue Suspendido'> ".$Mrondas[$i][$j]."<br>".$Mrondas[$i]["fraccion".$j]."<br>"."</td>";
								  else
