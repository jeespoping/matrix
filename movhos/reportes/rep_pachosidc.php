...
<script type="text/javascript">
	...
	function inicioReporte(wfecini,wfecfin,wcco,wemp_pmla,bandera){
	 	document.location.href='rep_pachosidc.php?wfecini='+wfecini+'&wfecfin='+wfecfin+'&wccocod='+wcco+'&wemp_pmla='+wemp_pmla+'&bandera='+bandera;
	}
...
<?php
  ...
  /******************************************************************************
   *     REPORTE PACIENTES HOSPITALIZADOS Y DADOS DE ALTA		                *
   ******************************************************************************/
   
	/*------------------------------------------------------------------------------
	| DEDSCRIPCIÓN: Reporte de pacientes hospitalizados dados de alta  por fecha|
...
//RESULTADO DE CONSULTA DEL REPORTE
else
  {
	...
	// Subtítulo del reporte
 	echo "<tr>";
	echo "<td height='37' colspan='2' class='titulo'><p align='left'><strong> &nbsp; Pacientes Hospitalizados&nbsp;  &nbsp; </strong></p></td>";
 	echo "</tr>";
 	echo "<tr>";
	...
	$num = mysql_num_rows($err);
	      ...
	      // Abro el archivo
   	      $archivo = fopen("rep_pachosidc.txt","w"); 
		  //Coloco los titulos
...
$color3="#aaaaaa";
	...
	for ($i=1;$i<=$num;$i++) 
		...
		echo "</table>";
		fclose($archivo);
		echo "<li><A href='rep_pachosidc.txt'>Presione Clic Derecho Para Bajar El Archivo ...</A>";
       	echo "<br>";
