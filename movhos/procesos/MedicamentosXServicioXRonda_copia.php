...
/****************************************************************************************************************************************************************
 * Actualizaciones:
 * Julio 07 de 2018 Juan Felipe Balcero - 
...
function pintarAritculos( $articulos ){
  ...
  //===========================================================================================================================================
  //===========================================================================================================================================
  echo "<form name='separacionXRonda' action='MedicamentosXServicioXRonda_copia.php' method=post>";
  ...
  if (!isset($wcco) or !isset($wccoo))
     {
      elegir_centro_de_costo();
	...
	else
       {
		...
		echo "<br><br>";
		echo "<table>";
		echo "<tr><td><A HREF='MedicamentosXServicioXRonda_copia.php?wemp_pmla=".$wemp_pmla."&user=".$user."' class=tipo4V>Retornar</A></td></tr>";
		echo "</table>";

		echo "<meta http-equiv='refresh' content='120;url=MedicamentosXServicioXRonda_copia.php?wemp_pmla=".$wemp_pmla."&wuser=".$user."&wcco=".$wcco."&wccoo=".$wccoo."&whora_par_actual=".$whora_par_actual."&diaSelecionada=".$diaSelecionada."&tipoMedicamento=".$tipoMedicamento."'>";
