...
else
{
 ...
 //    echo "Fallo la conexión UNIX";
  ...
  //echo "<center><table border=2 width=400 BACKGROUND='/INVE_TRAS/procesos/images/fondo de bebida de limón.gif'>";
  ...
  if(!isset($wanoi) or !isset($wmesi) or !isset($wdiai) or !isset($wanof) or !isset($wmesf) or !isset($wdiaf) or !isset($wcco))
    {
	 ...
	 //echo "Año : ".$wano." Mes : ".$wmes." Dia : ".$wdia;
     ...
     echo"<tr><td align=center bgcolor=#cccccc colspan=3 ><input type='submit' value='ACEPTAR'></td></tr></form>";
      ...
      /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      {
       ...
       //CENTRO DE COSTO
       echo "<td colspan=5 align=center bgcolor=#66CC99><b>Centro de Costo: ".$wwcco."</b></td>";
            ...
            if ($row[0] == 0 )    //Si es 0 indica que no ha sido procesado
               {
		        ...
		        echo "<td align=center bgcolor=#99FFCC><font size=3><b>".odbc_result($res,2)."</b></font></td>";
		        echo "<td align=center bgcolor=#99FFCC><font size=3><b>".odbc_result($res,3)."</b></font></td>";
		        ...
		        echo "<td align=center bgcolor=#99FFCC><font size=3><b><A href='tras_detalle.php?fuente=".$wfue."&amp;documento=".$wdoc."&amp;wanoi=".$wanoi."&amp;wmesi=".$wmesi."&amp;wdiai=".$wdiai."&amp;wanof=".$wanof."&amp;wmesf=".$wmesf."&amp;wdiaf=".$wdiaf."&amp;wcco=".$wcco."'>Detallar</A></b></font></td>";
		        echo "</tr>";
	           }
