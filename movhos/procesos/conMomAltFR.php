...
{	            
  ...
  //FORMA ================================================================
  echo "<form name='altas' action='conMomAltFR.php' method=post>";
  ...
  //===============================================================================================================================================
   if ( (!isset($whis) || trim($whis) == "" ) && (!isset($wced) || trim($wced) == "") )
     {     
      ...
      echo "</tr>";
      echo "<tr  class=seccion1><td><b>NO. DE IDENTIFICACION:</b>";
...
//			      echo "<td align=center><font size=3><b><A href='conmomalt.php?whis=".$whis."&wing=".$wing."&wemp_pmla=".$wemp_pmla."&wpac=".$wpac."&wver=on '>Ver</A></b></font></td>";
			      echo "<td align=center><font size=3><b><A href='conMomAltFR.php?whis=".$whis."&wing=".$wing."&wemp_pmla=".$wemp_pmla."&wpac=".$wpac."&wver=on&wced=$wced '>Ver</A></b></font></td>";
			      echo "</tr>"; 
			     }
			  echo "</table>";  
			  echo "<center><table>"; 
		      echo "<td align=centercolspan=11><A href='conMomAltFR.php?wemp_pmla=".$wemp_pmla."'><b><font size=3 color=660099>Retornar</font></b></A></td>";
		      echo "</table>";
	         }
          }
         else
...
//			    echo "<td colspan='3' align='center'><A href='conmomalt.php?whis=".$whis."&wemp_pmla=".$wemp_pmla."'><b><font size=3 color=660099>Grabar</font></b></A></td>";
			    ...
			    echo "<tr>";
			    echo "<td align=center colspan=14 class=link><A href='conMomAltFR.php?whis=".$whis."&wemp_pmla=".$wemp_pmla."'><b><font size=3 color=660099>Retornar</font></b></A></td>";
