...
else
{
  	...
  	echo "<form action='etq_Neonatos.php' method=post>";
	...
	else
	{
		...
		$paquete=$paquete."A380,200,1,2,1,1,N,".chr(34)."HISTORIA".chr(34).chr(13).chr(10);
		$paquete=$paquete."B360,200,1,1,2,5,70,B,V00".chr(13).chr(10);
		$paquete=$paquete."A410,400,1,4,1,1,N,".chr(34)."CLINICA LAS AMERICAS".chr(34).chr(13).chr(10);
		$paquete=$paquete."A380,400,1,2,1,1,N,V01".chr(13).chr(10);
		$paquete=$paquete."A360,400,1,1,1,1,N,V02".chr(13).chr(10);
		$paquete=$paquete."A340,400,1,1,1,1,N,V06".chr(13).chr(10);
		$paquete=$paquete."A320,400,1,1,1,1,N,V03".chr(13).chr(10);
		$paquete=$paquete."A300,400,1,1,1,1,N,V04".chr(13).chr(10);
		$paquete=$paquete."A280,400,1,1,1,1,N,V08".chr(13).chr(10);
		$paquete=$paquete."A260,400,1,1,1,1,N,V05".chr(13).chr(10);
		$paquete=$paquete."B340,610,1,1,2,5,70,B,V07".chr(13).chr(10);
