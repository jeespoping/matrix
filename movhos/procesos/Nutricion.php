...
//========================================================================================================================================\\
//Se agrega la dieta básica COM(COMPLEMENTARIA) y todas las combinaciones pertinentes de esta con las demas dietas, de manera que el      \\ 
		  ...
		  if ($num > 0)
		     {
			  for($i=1;$i<=$num;$i++)
				...
				//acá empezamos a agregar las opciones para las nuevas combinaciones.
					if ($row[10] == "NPT+COM")
