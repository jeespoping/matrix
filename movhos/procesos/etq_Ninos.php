...
else
{
  	...
  	echo "<form action='etq_Ninos.php' method=post>";
  	echo "<input type='HIDDEN' name= 'empresa' value='".$empresa."'>";
  	if(!isset($wced) or !isset($wcod))
	{
		echo "<center><table border=0>";
		echo "<tr><td align=center colspan=2><b>PROMOTORA MEDICA LAS AMERICAS S.A.<b></td></tr>";
		echo "<tr><td align=center colspan=2>STIKERS DE PACIENTES NIÑOS</td></tr>";
	...
	{
		$conex_o = odbc_connect('admisiones','','') or die("No se ralizo Conexion");
		...
		$paquete=$paquete."FK".chr(34)."INGNIN".chr(34).chr(13).chr(10);
		$paquete=$paquete."FS".chr(34)."INGNIN".chr(34).chr(13).chr(10);; 
		$paquete=$paquete."V00,".$longH.",L,".chr(34)."HISTORIA".chr(34).chr(13).chr(10);
		...
		$paquete=$paquete."V05,40,L,".chr(34)."INGRESO".chr(34).chr(13).chr(10);
		$paquete=$paquete."V06,40,L,".chr(34)."EDAD".chr(34).chr(13).chr(10);
		$paquete=$paquete."V07,3,L,".chr(34)."TARIFA".chr(34).chr(13).chr(10);
		$paquete=$paquete."V08,40,L,".chr(34)."HISTORIAT".chr(34).chr(13).chr(10);
		...
		$paquete=$paquete."A380,220,1,2,1,1,N,".chr(34)."HISTORIA".chr(34).chr(13).chr(10);
		$paquete=$paquete."B360,220,1,1,2,5,70,B,V00".chr(13).chr(10);
		$paquete=$paquete."A410,450,1,4,1,1,N,".chr(34)."CLINICA LAS AMERICAS".chr(34).chr(13).chr(10);
		$paquete=$paquete."A380,450,1,2,1,1,N,V01".chr(13).chr(10);
		$paquete=$paquete."A360,450,1,1,1,1,N,V02".chr(13).chr(10);
		$paquete=$paquete."A340,450,1,1,1,1,N,V06".chr(13).chr(10);
		$paquete=$paquete."A320,450,1,1,1,1,N,V03".chr(13).chr(10);
		$paquete=$paquete."A300,450,1,1,1,1,N,V04".chr(13).chr(10);
		$paquete=$paquete."A280,450,1,1,1,1,N,V08".chr(13).chr(10);
		$paquete=$paquete."A260,450,1,1,1,1,N,V05".chr(13).chr(10);
		$paquete=$paquete."B340,700,1,1,2,5,70,B,V07".chr(13).chr(10);
		$paquete=$paquete."FE".chr(13).chr(10);
		$paquete=$paquete.".".chr(13).chr(10);
		$paquete=$paquete."FR".chr(34)."INGNIN".chr(34).chr(13).chr(10);
		$paquete=$paquete."?".chr(13).chr(10);
		...
		{
			fputs($fp,$paquete);
			//echo $paquete." PAQUETE ENVIADO $errstr ($errno)<br>\n";
