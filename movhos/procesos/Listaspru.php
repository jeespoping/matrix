...
function validar_medins($conex,$whis,$wnin, $wcontrol)
{
    ...
    $query = "select sum((spamen + spauen -spaaen) - (spamsa + spausa - spaasa)) ";
    ...
    //echo "alta:".$alta." num:".$num." nums:".$nums." suma:".$suma."<br>";
...
else
{
    ...
    echo "<form name='listas' action='Listaspru.php' method=post>";
                    ...
                    if ($num>0)
                    {
                        ...
                        for ($i=0;$i<$num;$i++)
                        {
                            ...
                            if (($whora > $wformatohorainicial or $whora < $wformatohorafinal) and $wcontrol[$i] > 0 and isset($wval[$i]))
                                {
                                  $wporfacturar[$i] = "<hr>FALTA GRABAR ".$wmsgglucos.$wmsginsumos.$wmsgnebus.$wmsgoxigenos.$wmsgtransfusiones;
                                }
                        ...
                        if(isset($wval[$i]))
                            {
                               // echo $wglucomerias."-".$winsumos."-".$wnebulizaciones."-".$woximetrias."-".$wtrasfusiones."-".$row[0]."-control:".$wcontrol[$i]."<br>";
                                $wres=array();
...
//                                      echo "<input type='RADIO' name='wf[".$i."]' value=1 onclick='enter()'>Pagar <input type='RADIO' name='wf[".$i."]' value=2 onclick='enter()'>Sin Pago";
            ...
            case 97:
                ...
                {
                    echo "<input type='HIDDEN' name= 'wcco' value='".$wcco."'>";
                    echo "<meta http-equiv='refresh' content='60;url=/matrix/movhos/procesos/listas.php?ok=97&empresa=".$empresa."&codemp=".$codemp."&wcco=".$wcco."&wlogo=".$wlogo."'>";
