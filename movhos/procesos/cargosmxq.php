		...
		if(!isset($pac['act']))
		{
			...
			if($pac['act'] )
			{
				...
				if($pac['act'])
				{
					...
					{
						$warning = "EL PACIENTE CON HISTORIA:".$pac['his']." FUE DADO DE ALTA DE LA INSTITUCIÓN!!! N14";
						$error['codInt']='0009';
						$error['codSis']=".";
						$error['descSis']=".";
						$error['clas']="#ff0000";
		...
		if(!isset($pac['act']))
		{
			...
			if($pac['act'])
			{
				...
				if($pac['act'])
				{
					...
					{
						$warning = "EL PACIENTE CON HISTORIA:".$pac['his']." FUE DADO DE ALTA DE LA INSTITUCIÓN!!! N15";
						$error['codInt']='0009';
						$error['codSis']=".";
						$error['descSis']=".";
						$error['clas']="#ff0000";
