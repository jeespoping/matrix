		...
		if(!isset($pac['act']))
		{
			...
			if($pac['act'] )
			{
				...
				if($pac['act'])
				{
					...
					{
						$warning = "EL PACIENTE CON HISTORIA:".$pac['his']." FUE DADO DE ALTA DE LA INSTITUCIÓN!!! N09";
						$error['codInt']='0009';
						$error['codSis']=".";
						$error['descSis']=".";
						$error['clas']="#ff0000";
				...
				if($artValido and !$art['cva'])
				{
					...
					if($artValido)
					{
						...
						if($artValido)
						{
							...
							{
								                               //Febrero 19 de 2009
								if($artValido and ($cco['apl'] or $art['apl']))
								{
									/**
		...
		if(!isset($pac['act']))
		{
			...
			if($pac['act'])
			{
				...
				if($pac['act'])
				{
					...
					{
						$warning = "EL PACIENTE CON HISTORIA:".$pac['his']." FUE DADO DE ALTA DE LA INSTITUCIÓN!!! N10";
						$error['codInt']='0009';
						$error['codSis']=".";
						$error['descSis']=".";
						$error['clas']="#ff0000";
