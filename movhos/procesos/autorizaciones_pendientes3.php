...
include_once("conex.php");
 ...
 /*  * *******************************************************
     ...
     * ******************************************************* */
//==================================================================================================================================
//PROGRAMA                   : autorizaciones_pendientes3.php
    ...
    */
            ...
            if ($wurgencias==true){
                ...
                if($sala == '%' and $sala != ''){
                   ...
                   $pacientes_urgencias_24horas = "    UNION
                                                        SELECT 'Urg' as habcod, ubihis as 'habhis', ubiing as 'habing', pacno1, pacno2, pacap1, pacap2, pacnac, pactid, pacced, Ingnre AS ent_responsable, ubiptr, ubialp, ingres, ubiald, ubifad, ubihad, 'on' as Altadef, ubisac, Cconom
                                                           FROM root_000036, root_000037, ".$wmovhos."_000018, ".$wmovhos."_000016,
                                                                ".$wmovhos."_000011, ".$whce."_000022
                                                          WHERE ubihis = orihis
                                                            AND ubiing = oriing
                ...
                $query = "SELECT * FROM (
                            SELECT 'Urg' as habcod, ubihis as 'habhis', ubiing as 'habing', pacno1, pacno2, pacap1, pacap2, pacnac, pactid, pacced, Ingnre AS ent_responsable, ubiptr, ubialp, ingres, ubiald, ubifad, ubihad, '' as AltaDef, ubisac, Cconom
                               FROM root_000036, root_000037, ".$wmovhos."_000018, ".$wmovhos."_000016,
                                    ".$wmovhos."_000011, ".$whce."_000022
                              WHERE ubihis = orihis
                                AND ubiing = oriing
                ...
                if (!isset($selpostegreso) || $selpostegreso =='0'){
                  ...
                  for ($i = 1; $i <= $num; $i++)
                  {
                    ...
                    if ($wtipouni != 'A'){
                        ...
                        $path_procedimientos = "/matrix/movhos/procesos/autorizaciones_pendientes3.php?wemp_pmla=".$wemp_pmla."&key=".$key."&whis=".$whis."&wing=".$wing."&wcco=".$wcco."&wfec=".$wfecha1."";
    ...
    function consultarPendientesGestion($conex, $wcliame, $whis, $wing, $codCierre)
    {
          ...
          if( $resExiste && $resExiste->num_rows > 0)
          {
              ...
              $resExiste = mysqli_query($conex,$sqlRespon) or die("ERROR EN QUERY MATRIX(".$sqlRespon.")<br>".mysqli_error());
...
<script type="text/javascript">
    ...
    {                  
        ...
        $.ajax({
              url: "autorizaciones_pendientes3.php",
              type: "POST",
              data:{
    ...
    function llamarPacienteAtencion(historia, ingreso, turno, tema)
    {
        ...
        $.post("autorizaciones_pendientes3.php",
        {
   ...
   function cerrarVentana()
   {
    ...
    function grabarObservaciongnral(wfec, wing, whis, wemp_pmla, campo)
    {
        ...
        {
            var ajax = nuevoAjax();
            ajax.open("POST", "autorizaciones_pendientes3.php",false);
