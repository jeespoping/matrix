...
else
{
	...
	echo "<form name='ac' action='ac_soe.php' method=post>";
	...
	if(!isset($wano))
	{
		...
		{
			case "soe":
				$query = "SELECT Actano from soe1_000015 GROUP BY Actano";
			break;
			case "juntacs":
	...
	else
	{
		...
		{
			case "soe":
				$query = "select Actano, Actcod, Actfec, Actnom   from  soe1_000015 ";
		...
		{
			case "soe":
				echo "<tr><td align=center colspan=2><IMG SRC='/matrix/images/medical/soe/promotora.png' width=50%></td></tr>";
			break;
			case "juntacs":
