...
<head>
    ...
    <script language="javascript">
        ...
        {
            miPopup4 = window.open("estado_pac02.php?idRegistro="+idRegistro.value+"&tabla="+tabla.value,"miwin1","width=750,height=300,top=300,left=550");
            miPopup4.focus()
        }
    </script>
                    ...
                    <form method="post" name="loginform" id="loginform" class="form-horizontal" role="form" action="estado_pac01.php">
                        <table align="center">
                            ...
                            <tr style="background-color: #EEEEEE; border-radius: 50px 50px">
                                <td colspan="6">
                                    <div class="input-group">
                                        <label>cliame_000100</label>&nbsp;<input type="checkbox" name="cliame100" value="1" checked readonly>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label>cliame_000101</label>&nbsp;<input type="checkbox" name="cliame101" value="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label>root_000036</label>&nbsp;<input type="checkbox" name="root36" value="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label>root_000037</label>&nbsp;<input type="checkbox" name="root37" value="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label>hce_000022</label>&nbsp;<input type="checkbox" name="hce22" value="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label>hce_000036</label>&nbsp;<input type="checkbox" name="hce36" value="1">
                                    </div>
                                </td>
                            </tr>
                            <tr style="background-color: #EEEEEE">
                                <td colspan="6">
                                    <div class="input-group">
                                        <label>movhos_000004</label>&nbsp;<input type="checkbox" name="movhos4" value="1">&nbsp;&nbsp;
                                        <label>movhos_000015</label>&nbsp;<input type="checkbox" name="movhos15" value="1">&nbsp;&nbsp;
                                        <label>movhos_000016</label>&nbsp;<input type="checkbox" name="movhos16" value="1">&nbsp;&nbsp;
                                        <label>movhos_000018</label>&nbsp;<input type="checkbox" name="movhos18" value="1">&nbsp;&nbsp;
                                        <label>movhos_000020</label>&nbsp;<input type="checkbox" name="movhos20" value="1">&nbsp;&nbsp;
                                        <label>movhos_000228</label>&nbsp;<input type="checkbox" name="movhos228" value="1">
                                    </div>
                                </td>
                            </tr>
                            <tr><td>&nbsp;</td></tr>
                            ...
                            <form id="encabezado">
                                <table class="table" style="min-width: 1280px">
                                    ...
                                    <tr>
                                        ...
                                        <td>Número de HC</td>
                                        <td>Número de Ingreso</td>
                                        <td>Centro de costos del paciente</td>
                                        <td>Habitacion</td>
                                        <td>Cantidad</td>
                                        <td>Usuario</td>
                                        <td>Justificacion</td>
                                        <td>Traslado</td>
                                        <td>Codigo responsable anterior</td>
                                        <td>Estado</td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                                ...
                                                <form id="formDATOS" method="post" action="estado_pac02.php">
                                                    ...
                                                    if($hcFind12 != null)
                                                    {
                                                        ...
                                                        <tr id="rowDATOS" class="alternar">
                                                            ...
                                                            <td><?php echo $dato12['Movtra'] ?></td>
                                                            <td><?php echo $dato12['Movant'] ?></td>
                                                            <td><?php echo $dato12['Movest'] ?></td>
