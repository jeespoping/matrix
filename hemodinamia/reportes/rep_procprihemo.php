...
<script type="text/javascript">
	function enter()
	{
		document.forms.rep_procprihemo.submit();
	}
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_procprihemo.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
   	echo "<form name='rep_procprihemo' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    echo "<tr><td align=center colspan=4 bgcolor=#FFFFFF><font text color=#003366><b>HEMODINAMIA</b></font></td></tr>";
    ...
    $quer1 = "CREATE TEMPORARY TABLE if not exists tempora1 as "
            ...
            ."  FROM ".$empre1."_000007 left join ".$empre1."_000006"
            ."    ON papp=ppproc"
	...
	$query1 = "SELECT SUBSTRING(ppfecha,6,2) as mes,ppproc as pp,count(*) as cant,patotal as total"
            ."   FROM ".$empre1."_000006 left join ".$empre1."_000007"
            ."     ON ppproc=papp" 
