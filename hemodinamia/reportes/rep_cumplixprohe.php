<html>
<head>
<title>MATRIX - [REPORTE PROCESOS PRIORITARIOS %CUMPLIMIENTO]</title>


<script type="text/javascript">
	function enter()
	{
		document.forms.rep_cumplixprohe.submit();
	}
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_cumplixprohe.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_cumplixprohe' action='' method=post>";
