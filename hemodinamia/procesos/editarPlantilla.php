...
?>
	...
	<?php 
		...
		$id=$_GET['actualizar'];
		$select_cliame_329 = mysql_query ("select * from cliame_000329 where Codpla = '$id'");
		...
		if($accion == 'guardar')
		{
			...
			mysql_query("update cliame_000329 set Nompla='$Nom_pla',Estado='$Est' where Codpla='$Cod_pla'");
			?>
...
<form action="editarPlantilla.php" method="post">
