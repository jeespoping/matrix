...
/**********************************************************************************************************************  
	   PROGRAMA : ac.php
	   Fecha de Liberacion : 2006-05-09
...
else
{
	...
	if(!isset($wano))
	{
		...
		echo "<tr><td bgcolor=#cccccc align=center>A&ntilde;o</td><td bgcolor=#cccccc align=center>";
		switch($grupo)
		{
			case "junta":
	...
	else
	{
		...
		echo "<tr><td align=center bgcolor=#000066><font color=#ffffff >A&Ntilde;O</font></td><td align=center bgcolor=#000066><font color=#ffffff >CONSECUTIVO</font></td><td align=center bgcolor=#000066><font color=#ffffff >FECHA</font></td><td align=center bgcolor=#000066><font color=#ffffff >NOMBRE</font></td></tr>";
		for ($i=0;$i<$num;$i++)
		{
			$row = mysql_fetch_array($err);
			if($i % 2 == 0)
