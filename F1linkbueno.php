		...
		elseif($accion != "W")
		{
			...
			switch($accion)
			{
				...
				case "M": 	
					...
					echo "<tr><td align=center colspan=2>Haga Click En La Imagen<br><A HREF='https://intranetlasamericas.co/' target='_blank'><IMG SRC='/matrix/images/medical/root/ingenia.jpg' style='vertical-align:middle;'></A></td></tr>";
