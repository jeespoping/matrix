<HTML>
<HEAD>
<TITLE>Orden de servicios PAF FALLA CARDIACA</TITLE>
</HEAD>
<BODY>
...
echo "<tr><td align=center bgcolor=#DDDDDD colspan=2><b><font text color=#003366 size=3><i>AUTORIZACION DE SERVICIOS PROGRAMA PAF FALLA CARDIACA</font></b>";
echo "<tr><td align=center bgcolor=#DDDDDD colspan=2><b><font text color=#003366 size=3><i>FALLA CARDIACA - CLINICA LAS AMERICAS</font></b><br>";

     $query="SELECT paffau,pafnom,pafap1,pafap2,pafced,paftel,pafdia,pafexa,pafcco,Seguridad,pafobs,paffci From paffaca_000001 WHERE Id =".$wid; 
