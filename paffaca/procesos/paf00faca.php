...
<html> 
<head> 
<title>Sistema de Informacion Programa falla Cardiaca</title> 
...
<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Sistema de Informacion Programa PAF FALLA CARDIACA
<br><td colspan=1 align=center><A HREF='paf01faca.php?windicador=PrimeraVez&wproceso=Nuevo' TARGET='_blank' >Adicionar nueva Orden</A></td>
</font></strong> 
</div> 
...
$sql="SELECT * FROM paffaca_000001 Where pafest='X'";
$res=mysql_query($sql); 
$NumeroAnulados=mysql_num_rows($res);


$sql="SELECT paffre,pafced,pafap1,pafnom,pafcco,pafser,id,pafest,paffre,paffci,pafexa  FROM paffaca_000001 ".$criterio.$criterio2;
$res=mysql_query($sql); 
 ...
 { 
  ...
  if ( $diferencia_dias > 14 )    // Con color rojo
  {
   ...
   <!-- Si utilizo la sigiente linea definida asi, cada que den clic sobre la tabla muestra unos datos que yo defina con la fn 'muestra'   
    <tr bgcolor="#DDDDDD" onMouseOver="this.style.backgroundColor='#0099CC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#DDDDDD';" onClick="javascript:muestra('<? echo "Para Consultar por Unidad o Examen digite el codigo como criterio."; ?>');" > 
    -->   
<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><b><? echo $registro["paffre"]; 
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><b><? echo $registro["pafap1"]; ?></b></font></td> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><b><? echo $registro["pafnom"]; ?></b></font></td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><b><? echo $registro["pafcco"]."-".$nomcco; ?></b></font></td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><b><? echo $registro["pafser"]; ?></b></font></td>
	<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><b><? echo $registro["pafexa"]."-".$nomexa; ?></b></font></td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><b><? echo $registro["id"]; ?></b></font></td>
    <?php	  
  }	  
  else    // No tiene cita con Color Amarillo
  {
   ...
   <!-- Si utilizo la sigiente linea definida asi, cada que den clic sobre la tabla muestra unos datos que yo defina con la fn 'muestra'   
    <tr bgcolor="#DDDDDD" onMouseOver="this.style.backgroundColor='#0099CC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#DDDDDD';" onClick="javascript:muestra('<? echo "Para Consultar por Unidad o Examen digite el codigo como criterio."; ?>');"> 
    --> 
<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF9900"><b><? echo $registro["paffre"]; 
    if ($registro["pafser"]=="4")	
      echo "</b></font></td> <td><font size='2' face='Verdana, Arial, Helvetica, sans-serif' color='#9370DB'><b>".$registro["pafced"]."</b></font></td>";   
    else
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF9900"><b><? echo $registro["pafap1"]; ?></b></font></td> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF9900"><b><? echo $registro["pafnom"]; ?></b></font></td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF9900"><b><? echo $registro["pafcco"]."-".$nomcco; ?></b></font></td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF9900"><b><? echo $registro["pafser"]; ?></b></font></td>
	<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF9900"><b><? echo $registro["pafexa"]."-".$nomexa; ?></b></font></td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FF9900"><b><? echo $registro["id"]; ?></b></font></td>
    <?php
   }	
 }
 ...
 { 
   ...
   <!-- tabla de resultados --> 
   <!-- Si utilizo la sigiente linea definida asi, cada que den clic sobre la tabla muestra unos datos que yo defina con la fn 'muestra'  
    <tr bgcolor="#DDDDDD" o onMouseOver="this.style.backgroundColor='#0099CC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#DDDDDD';" onClick="javascript:muestra('<? echo "Para Consultar por Unidad o Examen digite el codigo como criterio."; ?>');"> 
   --> 
<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b><? echo $registro["paffre"]; 
    if ($registro["pafser"]=="4")	
      echo "</b></font></td> <td><font size='2' face='Verdana, Arial, Helvetica, sans-serif' color='#9370DB'><b>".$registro["pafced"]."</b></font></td>";   
    else
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b><? echo $registro["pafap1"]; ?></b></font></td> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b><? echo $registro["pafnom"]; ?></b></font></td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b><? echo $registro["pafcco"]."-".$nomcco; ?></b></font></td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b><? echo $registro["pafser"]; ?></b></font></td>
	<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b><? echo $registro["pafexa"]."-".$nomexa; ?></b></font></td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b><? echo $registro["id"]; ?></b></font></td>
    <?php 
 }
     if ($registro["pafest"] == "A") 
     {    
	   $wid=$registro[6];
       echo "<td><A HREF='paf01faca.php?wid=".$wid."&windicador=PrimeraVez&wproceso=Modificar' TARGET='_blank' >Editar</A></td>";
       ...
       if ($registro[0]=="1")    // Si prioridad es 1 permito anular
        echo "<td><A HREF='paf10faca.php?wid=".$wid."' TARGET='_blank' >Anular</A></td>";	     	  
	 } 
     else
     {
...
<hr noshade style="color:CC6666;height:1px"> 
<div align="center"><font face="verdana" size="-2"><a class="p" href="paf00faca.php">::Inicio::</a></font></div> 
<form action="paf00faca.php" method="get"> 
<center>
<table border="0" cellspacing="0" cellpadding="0" align="center">    
<?php
...
echo "<meta http-equiv='refresh' content='900;url=paf00faca.php'>";
?> 
