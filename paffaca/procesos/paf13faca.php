<HTML>
<HEAD>
<TITLE>Reporte General de Ordenes PAF FALLA CARDIACA</TITLE>
	<style type="text/css">
...
//Forma
echo "<form name='paf13faca' action='paf13faca.php' method=post>";  
 ...
 if (!isset($wfec1) or !isset($wfec2))
 {
    ...
    echo "<tr>";
	echo "<tr><td align=CENTER colspan=1 bgcolor=#DDDDDD><b><font text color=#003366 size=2>Reporte General de Ordenes PAF FALLA CARDIACA<br></font></b>";   
	echo "</tr>";
...
/****/
 ...
 else      // Cuando ya estan todos los datos escogidos     **********************************************************************
 {
    ...
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>Reporte General de Ordenes PAF FALLA CARDIACA</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>Periodo: ".$wfec1." Al ".$wfec2."</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>PROGRAMA: paf13faca.php Ver. 2015/11/26<br>AUTOR: JairS</font></b><br>";
    echo "</table>";
    ...
    echo "<td colspan=1 align=center bgcolor=#DDDDDD><b>1er Apellido<b></td>";
    echo "<td colspan=1 align=center bgcolor=#DDDDDD><b>2do Apellido<b></td>";
    ...
    $query="SELECT Id,PAFFAU,pafced,pafap1,pafap2,pafnom,paftel,pafran,paftip,pafdia,pafexa,pafrem,pafcco,pafest,pafser,paffre,paford,paffem,paffci,pafhor,paffca,pafcau,pafobs"
          ." FROM paffaca_000001"
		  ." WHERE PAFFAU BETWEEN '".$wfec1."' AND '".$wfec2."'"
   ...
   { 
     ...
     $archivo = fopen("ordenessura.txt","w"); 
  
    $LineaDatos="Nro Orden|Fecha|Documento|1er Apellido|2do Apellido|Nombres|Telefonos|Rango|Tipo Afil|Diagnostico|Examen|Medico|Unidad|Estado|Tipo Serv|F. Vigencia|"
	           ."Orden NEPS|F. Emision|F. Cita|Hora|F. Cancelacion|Causa|Observaciones";  
    ...
    {        
       ...
       // TOMO EL NOMBRE DEL DX
        $query = "SELECT codigo,descripcion FROM root_000011 Where codigo='".$registro[9]."'"; 
        ...
        $query = "SELECT Meduma,Medno1,Medno2,Medap1,Medap2 FROM movhos_000048 Where Meduma='".$registro[11]."' And Meduma <> '' ";
        $resultadoB=mysql_query($query); 
        if ( $registroB = mysql_fetch_row($resultadoB) )      //  Encontro
        {
        ...
        echo "<td colspan=1 align=center bgcolor='".$wcf."'><font text color=#003366 size=1>".$registro[13]."</td>";     
        ...
        echo "<td colspan=1 align=center bgcolor='".$wcf."'><font text color=#003366 size=1>".$registro[22]."</td>";
	...
	echo "<li><A href='ordenessura.txt'>Presione Clic Derecho Para Bajar El Archivo ...</A>";
