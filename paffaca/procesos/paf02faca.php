...
<html> 
<head> 
<title>Sistema de Informacion Programa PAF FALLA CARDIACA</title> 
...
<div align="center"><strong><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Sistema de Informacion Programa PAF FALLA CARDIACA
<br><td colspan=1 align=center></td><br>Archivo de Usuarios PAF FALLA CARDIACA</font></strong></div> 
...
$sql="SELECT Docaf,Apeaf1,Apeaf2,Nomaf,Sexo,Fec_nacimiento, Tip_afiliado,  Telaf, Codips FROM paffaca_000002 ".$criterio;
    // ." GROUP BY Docaf,Apeaf1,Apeaf2,Nomaf,Sexo,Fec_nacimiento, Tip_afiliado, Telaf, Codips";
...
?> 
   ...
   -->
    ...
    <?php
     ...
     if ($reg["empresa"]<>"99")   // Si es un usuario de la empresa 99 no lo deja generar ordenes
       echo "<td><A HREF='paf01faca.php?wid=".$wid."&windicador=PrimeraVez&wproceso=Nuevo' TARGET='_blank'>Generar</A></td>";	     
    ?>
...
<hr noshade style="color:CC6666;height:1px"> 
<div align="center"><font face="verdana" size="-2"><a class="p" href="paf02faca.php">::Inicio::</a></font></div> 
<form action="paf02faca.php" method="get"> 
