...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='grafpropriciru.php'; 
	}
	
	function enter()
	{
		document.forms.grafpropriciru.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//cirucli_000008     : Tabla de Bases de datos totales por proceso prioritario.                                                               |
//cirucli_000001     : Tabla de movimiento procesos prioritarios.                                                                             |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
	...
	//Forma
	echo "<form name='forma' action='grafpropriciru.php' method='post'>";
	echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";

	if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
	{
		echo "<form name='grafpropriciru' action='' method=post>";
