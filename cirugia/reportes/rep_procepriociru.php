...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_procepriociru.php'; 
	}
	
	function enter()

	{
		document.forms.rep_procepriociru.submit();
	}
...
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//cirucli_000001     : Tabla Procesos Priritarios.                                                                                              |
//cirucli_000002     : Tabla plan anual x proceso prioritario                                                                                   |
//                                                                                                                                          |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_procepriociru.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_procepriociru' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
    ...
    echo "<tr><td align=center colspan=4 bgcolor=#FFFFFF><font text color=#003366 size=2><b>CIRUGIA.</b></font></td></tr>";
    ...
    $quer1 = "CREATE TEMPORARY TABLE if not exists tempora1 as "
            ."SELECT pames as mes,papp as pp,pproc as proc,patotal as total"
	...
	$query1 = "SELECT SUBSTRING(ppfecha,6,2) as mes,pproc as pp,count(*) as cant,patotal as total"
