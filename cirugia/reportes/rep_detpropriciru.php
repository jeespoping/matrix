...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detpropriciru.php'; 
	}
...
//FECHA CREACION			  :Septiembre 7 DE 2010.                                                                                             |
//FECHA ULTIMA ACTUALIZACION  :Septiembre 7 de 2010.                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
//cirucli_000001      : Tabla de Procesos prioritarios U.C.I.                                                                                 |
//==========================================================================================================================================
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detpropriciru.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
 if (!isset($pp) or $pp=='-' or !isset($fec1) or !isset($fec2))
  {
  	echo "<form name='rep_detpropriciru' action='' method=post>";
 ...
 else // Cuando ya estan todos los datos escogidos
  {
   ...
   $query = " SELECT pphist,pping,ppfecha,ppperseva,ppcargoe,pproc,ppcrite1,ppcrite2,ppcrite3,ppcrite4,ppcirte5,ppcrite6,ppcrite7,ppcrite8,ppcrite9,ppcrite10,ppcrite11,ppcrite12,ppcrite13,ppcrite14,ppcrite15,ppobserva,pppor"
           ."   FROM ".$empre1."_000001"
           ."  WHERE pproc = '".$tpp."'" 
           ."    AND pppor < 100"
	...
	for ($i=1;$i<=$num1;$i++)
	 {
      ...
      echo "<table border=0 >";
      echo "<Tr >";
      echo "<td  bgcolor=#FFFFFF align=left width=100%><font size=1>&nbsp;$row2[21]</font></td>";
      echo "</tr >"; 
      echo "</table>";
      ...
      echo "<td  bgcolor=#FFFFFF align=left width=65%><font size=2 color=#FF0000>&nbsp;<b>".number_format($row2[22])."%</b></font></td>";
      echo "</tr >"; 
      echo "</table>";
