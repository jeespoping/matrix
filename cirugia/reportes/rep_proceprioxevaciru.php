...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_proceprioxevaciru.php'; 
	}
	
	function enter()

	{
		document.forms.rep_proceprioxevaciru.submit();
	}
...
$wactualiz="1.0 7-Septiembre-2010";
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_proceprioxevaciru.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fec1) or $fec1 == '' or !isset($fec2) or $fec2 == '')
  {
  	echo "<form name='rep_proceprioxevaciru' action='' method=post>";
