...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='bienfar_000001_rep6.php' method=post>";
		if(!isset($numero))
		{
			echo "<center><table border=0>";
			echo "<tr><td align=center><b>PATOLOGIA LAS AMERICAS S.A.<b></td></tr>";
		...
		else
		{
			...
			if ($num>0)
			{
				...
				echo "<table border=1>";
				echo "<tr><td rowspan=4><IMG SRC='/matrix/images/medical/FARMASTORE/logo farmastore.png' ></td>";
				echo "<td colspan=2><font size=5>LAS AMERICAS FARMASTORE S.A.</font></td></tr>";
				echo "<tr><td colspan=2><font size=4 aling=center>NIT :900.016.094-7</font><td></tr>";
