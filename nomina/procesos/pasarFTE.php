<?php
	...
	//				de Promotora y Fundaci�n, filtrando en Sql7 por movempresa=3
	// 2021-03-08: Luis F Meneses. Adicionar a Fundaci�n como empresa de la misma fuente
	//				de Promotora, filtrando en Sql7 por movempresa=1 (promotora), movempresa=7 (Fundaci�n)
?>
...
<div class="container general" style="margin-left: 0">
    ...
    <div align="center" class="panel panel-info contenido">
        ...
        if($conexion != null and $fuente != null and $documento != null and $anoFuente != null and $mesFuente != null)
        {
            ...
            if ($conexion == 1)
            {
				// CONEXIONES COMPARTIDAS ENTRE PROMOTORA, FUNDACI�N Y LABORATORIO
            ...
            if ($conexion == 3)
            {
                ...
                $conexSql7 = odbc_connect('queryx7PAT','','') or die("No se realizo conexi�n con la BD de Patolog�a");
            ...
            if ($conexion == 5)
            {
                ...
                $conexSql7 = odbc_connect('queryx7','','') or die("No se realizo conexi�n con la BD de Fundaci�n");
...
{
	// Vista COMOVENC: Se agreg� columna MOVENCEMPRESA. En el momento los valores ser�an 1 para Cl�nica y 7 para Fundaci�n
	// Vista COMOV       : Se agreg� columna MOVEMPRESA. En el momento los valores ser�an 1 para Cl�nica y 7 para Fundaci�n
    //DEFINIR EL CONEX DE UNIX PARA CADA EMPRESA:
    switch($empresa)
    {
        case 'promotora': $conexUnix = odbc_connect('nomina','informix','sco') or die("No se realizo conexi�n con la BD de Promotora/Fundaci�n"); break;
		case 'fundacion':$conexUnix = odbc_connect('cofunda','informix','sco') or die("No se realizo conexi�n con la BD de Promotora/Fundaci�n"); break;
        case 'laboratorio': $conexUnix = odbc_connect('nomlab','informix','sco') or die("No se realizo conexi�n con la BD de Laboratorio"); break;
        case 'patologia': $conexUnix = odbc_connect('nompat','informix','sco') or die("No se realizo conexi�n con la BD de Patolog�a"); break;
