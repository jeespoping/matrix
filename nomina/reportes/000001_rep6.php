...
include_once("conex.php");
 ...
 /*******************************************************************************
   *     PROGRAMA PARA LA CONSULTA DE NOMINA PATOLOGIA                          *
   *****************************************************************************/

//===============================================================================
//PROGRAMA				     : REPORTE DE LA COLILLA DE PAGO                    |
//AUTOR                      : Gustavo Avendaño y Gabriel Agudelo		   		|
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		if(!isset($cedula) or !isset($ano) or !isset($mes))
		{
			...
			echo "<tr><td align=center>LABORATORIO DE PATOLOGIA</td></tr>";
		...
		else
		{
			...
			if (odbc_fetch_row($err))
			{
				...
				echo "<table border=1>";
				echo "<tr><td colspan=5 align=center><IMG SRC='/MATRIX/images/medical/root/bannersoe.jpg'></td>";
							...
							<tr>
								<td align='center'>&nbsp;&nbsp;&nbsp;
									<div class='fondoAmarillo' style='font-size	: 11pt;font-family: verdana;width:900px;border: 1px solid #2A5DB0;padding: 5px;' align='center'>
										...
										por concepto de cesantías del año ".($ano-1)." en el Fondo de Cesantías <b>".$rowConsig['Csefon']."</b>.
									</div>
									<br>
								</td>
							</tr>
