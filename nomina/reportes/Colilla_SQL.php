<html>
<head>
  <title>MATRIX Colilla de Pago</title>
</head>
<body BGCOLOR="">
<BODY TEXT="#000066">
<?php
...
if(!isset($_SESSION['user']))
...
else
	{
		...
		echo "<form action='Colilla_SQL.php' method=post>";
		

		//phpinfo(INFO_ENVIRONMENT);
		//$conex = odbc_connect('nomina','','') or die("No se ralizo Conexion ODBC a INFORMIX");
		$conex = odbc_connect("queryx7","","") or die(odbc_errormsg());
