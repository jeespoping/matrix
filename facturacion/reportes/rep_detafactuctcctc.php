...
<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detafactuctcctc.php'; 
	}
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detafactuctcctc.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fte) or $fte=='' or !isset($fac) or $fac == '' )
  {
  	
  	echo "<form name='rep_detafactuctcctc' action='' method=post>";
  ...
  $query_o3=" SELECT carfuo,carhis,carnum,carpac,pacinftip tip,carcep"
   ...
   while (odbc_fetch_row($err_o))
	...
	echo "<td align=CENTER bgcolor=#FFFFFF ><font size='2' text color='#003366'><b>TIPO DOCUMENTO</font></td>";
    ...
    $query_o1="SELECT cardetcan,movdoc,cardetvun,carfacval,carpac,pactid,pacced,egring,'HOSPITARIO' tipo,artnom"
             ...
             ."   AND egrhos<>'H'"
			 ." UNION ALL"
			 ." SELECT cardetcan,movdoc,cardetvun,carfacval,carpac,pactid,pacced,egring,'HOSPITARIO' tipo,exanom artnom"
	         ."  FROM famov,facarfac,cacar,facardet,inmegr,inexa,inpaci,facon"
             ." WHERE movfue='$fte'"
             ."   AND movdoc=$fac"
             ."   AND movfue=carfacfue"
             ."  AND movdoc=carfacdoc"
			 ...
			 ."  AND conarc='INEXATAR'"
             ." union all"
             ." SELECT cardetcan,movdoc,cardetvun,carfacval,carpac,pactid,pacced,egring,'AMBULATORIO' tipo,exanom artnom"
             ."   FROM famov,facarfac,cacar,facardet,inmegr,inexa,inpaci,facon"
			 ." WHERE movfue='$fte'"
             ."   AND movdoc=$fac"
             ."   AND movfue=carfacfue"
			 ...
			 ."  AND conarc='INEXATAR'"
			 ." UNION ALL"
			 ." SELECT cardetcan,movdoc,cardetvun,carfacval,carpac,pactid,pacced,egring,'HOSPITARIO' tipo,pronom artnom"
	         ."  FROM famov,facarfac,cacar,facardet,inmegr,inpro,inpaci,facon"
             ." WHERE movfue='$fte'"
             ."   AND movdoc=$fac"
             ."   AND movfue=carfacfue"
             ."  AND movdoc=carfacdoc"
			 ...
			 ."  AND conarc='INPROTAR'"
             ." UNION ALL"
             ." SELECT cardetcan,movdoc,cardetvun,carfacval,carpac,pactid,pacced,egring,'AMBULATORIO' tipo,pronom artnom"
             ."   FROM famov,facarfac,cacar,facardet,inmegr,inpro,inpaci,facon"
			 ." WHERE movfue='$fte'"
             ."   AND movdoc=$fac"
             ."   AND movfue=carfacfue"
