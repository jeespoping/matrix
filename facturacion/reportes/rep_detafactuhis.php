<html>
<head>
<title>MATRIX - [REPORTE PARA VER EL DETALLE DE UNA HISTORIA CLINICA]</title>


<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_detafactuhis.php'; 
	}
	
	function enter()
	{
		document.forms.rep_detafactuhis.submit();
	}
...
/*******************************************************************************************************************************************
*                                             REPORTE PARA VER EL DETALLE DE CARGOS X HISTORIA                                             *
********************************************************************************************************************************************/

//==========================================================================================================================================
//PROGRAMA				      :Reporte para ver el detalle de una factura en unix.                                                         |
//AUTOR				          :Ing. Gustavo Alberto Avendaño Rivera.                                                                       |
//FECHA CREACION			  :OCTUBRE 23 DE 2017.                                                                                           |
//FECHA ULTIMA ACTUALIZACION  :23 de Octubre de 2017.                                                                                      |
//TABLAS UTILIZADAS   :                                                                                                                    | 
//                                                                                                                                         |
...
session_start();
//Encabezado
encabezado("DETALLE DE MATERIALES Y MEDICAMENTOS DE UNA HISTORIA CLINICA",$wactualiz,"clinica");
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_detafactuhis.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";
 
if (!isset($fte) or $fte=='' or !isset($fac) or $fac == '' or !isset($com) or $com=='' or !isset($atc) or $atc=='')
  {
  	
  	echo "<form name='rep_detafactuhis' action='' method=post>";
   ...
   echo "<Tr>";
   echo "<td align=center bgcolor=#DDDDDD><b><font text color=#003366 size=2><i>HISTORIA<i><br></font><bgcolor='#dddddd' aling=center><input type='input' size=7 maxlength=10 name='fte'></td>";
   echo "</Tr>";
   ...
   echo "<Tr>";
   echo "<td align=center bgcolor=#DDDDDD><b><font text color=#003366 size=2><i>INGRESO<i><br></font><bgcolor='#dddddd' aling=center><input type='input' name='fac' size=3 maxlength=5 id='fac'></td>";
   echo "</Tr>";
  ...
  $query_o3=" SELECT '01' carfuo,pacinfhis carhis,pacinfnum carnum,pacnom,pacap1,pacap2,pacinftip tip,pacced"
             ."  FROM inpacinf,inpac"
             ." WHERE pacinfhis=$fte"
             ."   AND pacinfnum=$fac"
			 ."   AND pacinfhis=pachis"
			 ."   AND pacinfnum=pacnum"
           	 ." UNION ALL "
			 ." SELECT '01' carfuo,pacinfhis carhis,pacinfnum carnum,pacnom,pacap1,pacap2,pacinftip tip,pacced"
             ."  FROM inpacinf,inmegr,inpaci"
             ." WHERE pacinfhis=$fte"
             ."   AND pacinfnum=$fac"
			 ."   AND pacinfhis=egrhis"
			 ."   AND pacinfnum=egrnum"
			 ."   AND pacinfhis=pachis"
			 ."   AND pacinfnum<=pacnum"
   ...
   while (odbc_fetch_row($err_o))
	  {
		...
		$pacnom = odbc_result($err_o,4);//Nombres
		$pacap1 = odbc_result($err_o,5);//Apellido1
		$pacap2 = odbc_result($err_o,6);//Apellido2
		$tip    = odbc_result($err_o,7);//tipo identificacion
		$cep    = odbc_result($err_o,8);//cedula paciente
	  }
	...
	echo "<td align=CENTER colspan='1' bgcolor=#FFFFFF><font size='2' text color=#003366><b>&nbsp;</b></font></td>";
	echo "<td align=CENTER colspan='1' bgcolor=#FFFFFF><font size='2' text color=#003366><b>PACIENTE_NOMBRES</b></font></td>";
	echo "<td align=CENTER colspan='1' bgcolor=#FFFFFF><font size='2' text color=#003366><b>&nbsp;</b></font></td>";
	echo "<td align=CENTER colspan='1' bgcolor=#FFFFFF><font size='2' text color=#003366><b>PACIENTE_APELLIDO1</b></font></td>";
	echo "<td align=CENTER colspan='1' bgcolor=#FFFFFF><font size='2' text color=#003366><b>&nbsp;</b></font></td>";
	echo "<td align=CENTER colspan='1' bgcolor=#FFFFFF><font size='2' text color=#003366><b>PACIENTE_APELLIDO2</b></font></td>";
	echo "<td align=CENTER colspan='1' bgcolor=#FFFFFF><font size='2' text color=#003366><b>&nbsp;</b></font></td>";
	...
	echo "<td align=CENTER colspan='1' bgcolor=#FFFFFF><font size='2' text color=#003366><b>&nbsp;</b></font></td>";
	echo "<td align=CENTER bgcolor=#FFFFFF ><font size='2' text color='#003366'><b>".$pacnom."</b></font></td>";
	echo "<td align=CENTER colspan='1' bgcolor=#FFFFFF><font size='2' text color=#003366><b>&nbsp;</b></font></td>";
		echo "<td align=CENTER bgcolor=#FFFFFF ><font size='2' text color='#003366'><b>".$pacap1."</b></font></td>";
	echo "<td align=CENTER colspan='1' bgcolor=#FFFFFF><font size='2' text color=#003366><b>&nbsp;</b></font></td>";
		echo "<td align=CENTER bgcolor=#FFFFFF ><font size='2' text color='#003366'><b>".$pacap2."</b></font></td>";
	echo "<td align=CENTER colspan='1' bgcolor=#FFFFFF><font size='2' text color=#003366><b>&nbsp;</b></font></td>";
   ...
   ELSE
   {
    ...
    $query_o1="SELECT cardetcon con,connom,cod,nombre,gen,nomg,artcum,uninom,sum(cardetcan*-1) can,cardetvun,sum(cardettot) valf,codneps,nombreneps"
             ."  FROM facardet,ivdrodet,ivart,ivuni,facon,outer ameartmed"
             ." WHERE cardethis=$fte"
             ."   AND cardetnum=$fac"
             ."   AND cardetfac='S'"
			 ."   and cardettot<>cardetvfa"
             ...
             ." UNION ALL "
             ." SELECT cardetcon con,connom,cod,nombre,gen,nomg,'0' artcum,uninom,sum(cardetcan*-1) can,cardetvun,sum(cardettot) valf,codneps,nombreneps"
             ."   FROM facardet,ivdrodet,ivart,ivuni,facon,outer ameartmed"
             ." WHERE cardethis=$fte"
             ."   AND cardetnum=$fac"
             ."   AND cardetfac='S'"
             ...
             ." GROUP by 1,2,3,4,5,6,7,8,10,12,13"
             ." UNION ALL "
             ." SELECT cardetcon con,connom,cod,nombre,gen,nomg,artcum,uninom,sum(cardetcan) can,cardetvun,sum(cardettot) valf,codneps,nombreneps"
             ."  FROM facardet,ivdrodet,ivart,ivuni,facon,outer ameartmed"
             ." WHERE cardethis=$fte"
             ."   AND cardetnum=$fac"
             ."   AND cardetfac='S'"
             ...
             ." GROUP by 1,2,3,4,5,6,7,8,10,12,13"
             ." UNION ALL "
             ." SELECT cardetcon con,connom,cod,nombre,gen,nomg,'0' artcum,uninom,sum(cardetcan) can,cardetvun,sum(cardettot) valf,codneps,nombreneps"
             ."  FROM facardet,ivdrodet,ivart,ivuni,facon,outer ameartmed"
             ." WHERE cardethis=$fte"
             ."   AND cardetnum=$fac"
             ."   AND cardetfac='S'"
