...
<div id="divGeneral" class="divGeneral">
    <div id="divContenido" class="divContenidoPrint">
        ...
        <div id="divDatosGenerales" class="divDatosGenerales">
            <table>
                ...
                <tr>
                    ...
                    <td>&ensp;</td>
                    <td colspan="5"><label>SE�ORES: &ensp;</label><label class="lblNormal" id="senores"><?php echo $descnitced ?></label></td>
                </tr>
                <tr>
        ...
        <hr><label class="lblNormal">&ensp;NO SE DEFINIO DETALLE DE CONCEPTOS CONTABLES</label>
            ...
            <div id="divDatosEspecificos" class="divDatosEspecificos" style="height: 400px">
                <div align="center">
                ...
                <table class="tblDatosEspecificos">
                    ...
                    while (odbc_fetch_row($dato_4))
                    {
                        ...
                        $valPac = odbc_result($dato_4,5);       $valorPac = number_format($valPac,0);
                        ?>
                        <tbody>
                        <tr>
                            ...
                            <td><label class="lblNormal" id="ape2Pac"><?php echo $ape2Pac ?></label></td>
