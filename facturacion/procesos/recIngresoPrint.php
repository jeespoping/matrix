...
<head>
    ...
    else
    {
        ...
        $wactualiz = "Versi�n: 1.0 07-Febrero-2020";
    }
    session_start();
    ...
    <div id="divContenido" class="divContenidoPrint">
        <div id="divEncabezado" class="divEncabezado" align="center">
            ...
            <div align="right" style="width: 145px; float: right; margin-top: -50px; margin-right: 120px">
                <img src="//mx.lasamericas.com.co/matrix/images/medical/paf/logo.png" width="250" height="120">
            </div>
        </div>
        ...
        <div id="divDatosGenerales" class="divDatosGenerales">
            <table>
                ...
                <tr>
                    <td><label>SE�ORES: &ensp;</label><label class="lblNormal" id="senores"><?php echo $empNom ?></label></td>
                    <td>&ensp;</td>
