                        ...
                        <div id="tabs-1">
                            ...
                            <div style="margin-bottom: 15px" class="input-group">
                                <div class="input-group">
                                    ...
                                    {
                                        ?>
                                        <input id="datepicker7" type="text" class="form-control" style="width: 150px" name="fecha_cx" placeholder="aaaa-mm-dd" onchange="validarFecha7()" title="INGRESO AL PAF ES OBLIGATORIO">
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div style="margin-bottom: 15px" class="input-group">
                                <div class="input-group">
                                    ...
                                    <input id="datepicker8" type="text" class="form-control" style="width: 150px" name="fecha_reint" value="<?php echo $H_fecha_Reint ?>" onchange="validarFecha8()" placeholder="aaaa-mm-dd">
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    {
                                                        ?>
                                                        <input id="datepicker9" type="text" class="form-control" style="width: 135px" name="ingreso_uci" value="<?php echo $H_ingreso_Uci ?>" onchange="validarFecha9()" placeholder="aaaa-mm-dd">
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                        <input id="datepicker9" type="text" class="form-control" style="width: 135px" name="ingreso_uci" onchange="validarFecha9()" placeholder="aaaa-mm-dd">
                                                        <?php
                                                    }
                                                    ?>
                                                    ...
                                                    if($H_ingreso_Uci != null)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <input id="datepicker10" type="text" class="form-control" style="width: 135px" name="egreso_uci" value="<?php echo $H_egreso_Uci ?>" onchange="validarFecha10()" placeholder="aaaa-mm-dd">
                                                            <?php
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <input id="datepicker10" type="text" class="form-control" style="width: 135px" name="egreso_uci" placeholder="aaaa-mm-dd" onchange="validarFecha10()">
                                                            <?php
                                                        }
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                        <input id="datepicker10" type="text" class="form-control" style="width: 135px" name="egreso_uci" placeholder="aaaa-mm-dd" title="INGRESO A UCI ES REQUERIDO" onchange="validarFecha10()">
                                                        <?php
                                                    }
                                                    ?>
                                                    ...
                                                    if($H_egreso_Uci != null)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <input id="datepicker11" type="text" class="form-control" style="width: 135px" name="reingreso_uci" value="<?php echo $H_reingreso_Uci ?>" onchange="validarFecha11()" placeholder="aaaa-mm-dd">
                                                            <?php
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <input id="datepicker11" type="text" class="form-control" style="width: 135px" name="reingreso_uci" placeholder="aaaa-mm-dd" onchange="validarFecha11()">
                                                            <?php
                                                        }
                                                    }
                                                    else
                                                    ...
                                                    if($H_reingreso_Uci != null)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <input id="datepicker12" type="text" class="form-control" style="width: 135px" name="egreso2_uci" value="<?php echo $H_egreso2_Uci ?>" onchange="validarFecha12()" placeholder="aaaa-mm-dd">
                                                            <?php
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <input id="datepicker12" type="text" class="form-control" style="width: 135px" name="egreso2_uci" placeholder="aaaa-mm-dd" onchange="validarFecha12()">
                                                            <?php
                                                        }
                                                    }
                                                    else
                                        ...
                                        <tr>
                                            <td>
                                                <div style="margin-bottom: -5px" class="input-group">
                                                    ...
                                                    {
                                                        ?>
                                                        <input id="datepicker13" type="text" class="form-control" style="width: 150px" name="indicacion_hemod" value="<?php echo $H_indicacion_Hemod ?>" onchange="validarFecha13()" placeholder="aaaa-mm-dd">
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                        <input id="datepicker13" type="text" class="form-control" style="width: 150px" name="indicacion_hemod" placeholder="aaaa-mm-dd" onchange="validarFecha13()">
                                                        <?php
                                                    }
                                                    ?>
                                                    ...
                                                    if($H_indicacion_Hemod != null)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <input id="datepicker14" type="text" class="form-control" style="width: 150px" name="fecha_hemod" value="<?php echo $H_fecha_Hemod ?>" onchange="validarFecha14()" placeholder="aaaa-mm-dd">
                                                            <?php
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <input id="datepicker14" type="text" class="form-control" style="width: 150px" name="fecha_hemod" placeholder="aaaa-mm-dd" onchange="validarFecha14()">
                                                            <?php
                                                        }
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                        <input id="datepicker14" type="text" class="form-control" style="width: 150px" name="fecha_hemod" placeholder="aaaa-mm-dd" title="INDICACION DE HEMODINAMIA ES REQUERIDA" onchange="validarFecha14()">
                                                        <?php
                                                    }
                                                    ?>
                                                </div>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    if($H_interv_Hemod != null)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <input id="datepicker15" type="text" class="form-control" style="width: 175px" name="indicacion_hemod2" value="<?php echo $H_indicacion_Hemod2 ?>" onchange="validarFecha15()" placeholder="aaaa-mm-dd">
                                                            <?php
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <input id="datepicker15" type="text" class="form-control" style="width: 175px" name="indicacion_hemod2" placeholder="aaaa-mm-dd" onchange="validarFecha15()">
                                                            <?php
                                                        }
                                                    }
                                                    else
                                                    ...
                                                    if($H_indicacion_Hemod2 != null)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <input id="datepicker16" type="text" class="form-control" style="width: 175px" name="fecha_hemod2" value="<?php echo $H_fecha_Hemod2 ?>" onchange="validarFecha16()" placeholder="aaaa-mm-dd">
                                                            <?php
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <input id="datepicker16" type="text" class="form-control" style="width: 175px" name="fecha_hemod2" placeholder="aaaa-mm-dd" onchange="validarFecha16()">
                                                            <?php
                                                        }
                                                    }
                                                    else
                                        ...
                                        <tr>
                                            <td>
                                                <div style="margin-bottom: -5px" class="input-group">
                                                    ...
                                                    {
                                                        ?>
                                                        <input id="datepicker17" type="text" class="form-control" style="width: 175px" name="indicacion_electrof" value="<?php echo $H_indicacion_Electrof ?>" onchange="validarFecha17()" placeholder="aaaa-mm-dd">
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                        <input id="datepicker17" type="text" class="form-control" style="width: 175px" name="indicacion_electrof" placeholder="aaaa-mm-dd" onchange="validarFecha17()">
                                                        <?php
                                                    }
                                                    ?>
                                                    <div class="input-group-addon" style="background-color: #F2F5F7; width: 50px; border: none"></div>
                                                    ...
                                                    if($H_indicacion_Electrof != null)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <input id="datepicker18" type="text" class="form-control" style="width: 175px" name="fecha_electrof" value="<?php echo $H_fecha_Electrof ?>" onchange="validarFecha18()" placeholder="aaaa-mm-dd">
                                                            <?php
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <input id="datepicker18" type="text" class="form-control" style="width: 175px" name="fecha_electrof" placeholder="aaaa-mm-dd" onchange="validarFecha18()">
                                                            <?php
                                                        }
                                                    }
                                                    else
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    if($H_interv_Electrof != null)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <input id="datepicker19" type="text" class="form-control" style="width: 175px" name="indicacion_electrof2" value="<?php echo $H_indicacion_Electrof2 ?>" onchange="validarFecha19()" placeholder="aaaa-mm-dd">
                                                            <?php
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <input id="datepicker19" type="text" class="form-control" style="width: 175px" name="indicacion_electrof2" placeholder="aaaa-mm-dd" onchange="validarFecha19()">
                                                            <?php
                                                        }
                                                    }
                                                    else
                                                    ...
                                                    if($H_indicacion_Electrof2 != null)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <input id="datepicker20" type="text" class="form-control" style="width: 175px" name="fecha_electrof2" value="<?php echo $H_fecha_Electrof2 ?>" onchange="validarFecha20()" placeholder="aaaa-mm-dd">
                                                            <?php
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <input id="datepicker20" type="text" class="form-control" style="width: 175px" name="fecha_electrof2" placeholder="aaaa-mm-dd" onchange="validarFecha20()">
                                                            <?php
                                                        }
                                                    }
                                                    else
