...
else
{
    ...
    $query_o2="SELECT numcosec,numconrec,numtiprad,numradant,codent,ateidetii,ateideide,ateideap1,ateideap2,ateideno1,ateideno2,pacarsafi,nivcta,
        ...
        ."	SELECT numcosec,numconrec,numtiprad,numradant,codent,ateidetii,ateideide,ateideap1,ateideap2,ateideno1,ateideno2,pacarsafi,nivcta,
                numacta,fechaact,fecsolmed,indperirec,mesper,anoper,numentre,movfue,movdoc,cardetfec,mdiadia,porsema,nitprov,nomprov,
                cardetcod codi,connom nomcodi,'PD' sigla,cardetcon,cardetcod,cardetcan,cardetvun,cardettot,vlrctamod,carfacval,cardetfue,
                cardetdoc,cardetite,cardetreg"
        ."	FROM tmpmty,facon"
        ."	WHERE cardetcon='0172'"
        ."    and cardetcod = '0'"
            ...
            <div class="panel-body">
                <table class="table table-bordered table-list">
                    ...
                    <tr>
                        ...
                        <th>N�mero de tipo de radicaci�n</th>
                        ...
                        <th>N�mero del acta del comit� t�cnico cient�fico</th>
                        <th>Fecha del acta del comit� t�cnico cient�fico</th>
                        ...
                        <th>N�mero de entrega del acta del ctc para el periodo</th>
                        ...
                        <th>Cantidad de folios correspondientes al n�mero de actas de CTC</th>
                        <th>Cantidad de facturas</th>
                        <th>Cantidad de folios correspondientes a las facturas</th>
                        <th>Cantidad de formulas m�dicas</th>
                        <th>Cantidad de folios correspondientes al n�mero de formulas m�dicas</th>
                        ...
                        <th>N�mero de radicaci�n del formato MTY-01</th>
                    ...
                    while (odbc_fetch_row($err_o3))
                    {
                        ...
                        if(odbc_result($err_o3, 11) == ''){$nom2pac = 'N';}
                        ...
                        $anpersu = odbc_result($err_o3, 20);//A�o periodo suministrado
                        ...
                        <tr id="rowDATOS" class="alternar">
                            ...
                            <td><?php echo $anioAct ?></td> <!-- A�o periodo suministrado -->
                            ...
                            <td>&nbsp;</td> <!-- Unidades diarias del medicamento, servicio medico o prestaci�n de salud -->
                            <td>&nbsp;</td> <!-- Cantidad d�as que dura el servicio -->
                            <td>&nbsp;</td> <!-- Cantidad total suministrada del medicamento, servicio medico o prestaci�n de salud -->
                            <td>&nbsp;</td> <!-- Valor unitario del servicio suministrado por item -->
                            <td>&nbsp;</td> <!-- Valor total del servicio suministrado por item -->
                            <td>&nbsp;</td> <!-- C�digo del medicamento, servicios m�dicos o prestaciones de salud similar o que sustituye -->
                            <td>&nbsp;</td> <!-- Nombre del medicamento, servicios m�dicos o prestaciones de salud suministrado similar o que sustituye -->
                            <td>&nbsp;</td> <!-- Unidades diarias del medicamento, servicio m�dico o prestaci�n de salud que sustituye o similar -->
                            <td>&nbsp;</td> <!-- Cantidad d�as que dura el servicio del numeral 46 -->
                            <td>&nbsp;</td> <!-- Cantidad total del medicamento, servicio m�dico o prestaci�n de salud que sustituye o similar -->
                            ...
                            <td>&nbsp;</td> <!-- Cantidad de folios correspondientes al n�mero de actas de CTC -->
                            <td>&nbsp;</td> <!-- Cantidad de facturas -->
                            <td>&nbsp;</td> <!-- Cantidad de folios correspondientes a las facturas -->
                            <td>&nbsp;</td> <!-- Cantidad de formulas m�dicas -->
                            <td>&nbsp;</td> <!-- Cantidad de folios correspondientes al n�mero de formulas m�dicas -->
                            ...
                            <td>&nbsp;</td> <!-- N�mero de radicaci�n del formato MTY-01 -->
