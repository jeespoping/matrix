<html>
<head>
  	<title>MATRIX Camas Proyectadas Para Pacientes de Cirugia CamasCXF.php</title>
...
else
{
	...
	echo "<tr><td align=center colspan=4 id=tipo14>CAMAS PROYECTADAS PARA PACIENTES DE CIRUGIA</td></tr>";
	if (!isset($wfecha))
		$wfecha=date("Y-m-d");
