<html>
<head>
  	<title>MATRIX Generacion de Peticiones de Camas Para Pacientes de Cirugia CamasCX.php</title>
...
else
{
			...
			if($row[0] == 0)
			{
				...
				for ($i=0;$i<$num;$i++)
				{
					if(substr($tcam[$i],strpos($tcam[$i],"-")+1) != "NO ASIGNAR")
					{
						...
						$fecha = date("Y-m-d");
						$hora = (string)date("H:i:s");
						$query = "insert cencam_000003 (medico, fecha_data, hora_data, Origen, Motivo, Habitacion, Observacion, Destino, Solicito, Ccosto, Camillero, Hora_respuesta, Hora_llegada, Hora_cumplimiento, Anulada, Observ_central, Central, Usu_central, Seguridad) values ('";
						$query .=  "cencam','";
						$query .=  $fecha."','";
						$query .=  $hora."','";
						$query .=  "CAMAS CX','";
						...
						$query .=  $wobser."','";
						$query .=  "ADMISIONES','".$key."','CIRUGIA','','00:00:00','00:00:00','00:00:00','No','','CAMAS',";
						$query .=  "'','C-cencam')";
	...
	echo "<tr><td align=center colspan=4 id=tipo19> Ver. 2015-03-17</td></tr>";
	...
	if($row[0] == 0)
	{
		...
		$query = "SELECT Turtur, Turdoc, Turhis, Turnin, Turnom, Tureps, Turcir, Entdes, Turhin, Turhfi, Turtel, Turuci, Turfec FROM ".$empresa."_000011,".$empresa."_000003 ";
