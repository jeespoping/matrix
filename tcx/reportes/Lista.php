<html>
<head>
  	<title>MATRIX Lista de Turnos de Cirugia Lista.php</title>
...
/**********************************************************************************************************************
	   PROGRAMA : Lista.php
	   Fecha de Liberacion : 2007-12-28
	   ...
	   .2015-03-17
	   		Se modifico el select para traer los turnos activos en on.

	   .2008-01-08
	   		Se modifico el select para traer los turnos activos en on.

	   .2008-01-03
	   		Se modifico el font de 6 puntos a 7 puntos.
...
else
{
	...
	echo "<form name='Lista' action='Lista.php' method=post>";
			...
			While( $i < $fin)
			{
				...
				switch ($wimpre[$i][$j]["west"])
				{
					...
					Case "on":
						...
						echo "<td id=".$tipo."02>".$j."</td><td id=".$tipo."17>".$wimpre[$i][$j]["word"]."</td><td id=".$tipo."03>".$wimpre[$i][$j]["wins"]."</td><td id=".$tipo."04>".$wimpre[$i][$j]["wnom"]."</td><td id=".$tipo."05>".$wimpre[$i][$j]["wtel"]."</td><td id=".$tipo."06>".$wimpre[$i][$j]["wtcx"]."</td><td id=".$tipo."07>".number_format((double)$wimpre[$i][$j]["weda"],0,'.',',').$wimpre[$i][$j]["wted"]."</td><td id=".$tipo."08>".$wimpre[$i][$j]["weps"]."</td><td id=".$tipo."09>".$wimpre[$i][$j]["wcir"]."</td><td id=".$tipo."10>".$wimpre[$i][$j]["wmed"]."</td><td id=".$tipo."11>".$wimpre[$i][$j]["wtan"]."</td><td id=".$tipo."15>".$wimpre[$i][$j]["wane"]."</td></tr>";
						$lin++;
						$i = $wimpre[$i][$j]["wpof"];
					break;
					Case "off":
