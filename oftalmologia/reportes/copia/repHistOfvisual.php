...
function Historia ($row){
	...
	if ($row['Queratom_od']!='NO APLICA') 
		echo "<tr><td colspan=12><font size=3 face='arial' ><B>Queratomia OD: </b>".$row['Queratom_od']."</td></tr>";
    if ($row['Queratom_os']!='NO APLICA') 
		echo "<tr><td colspan=12><font size=3 face='arial' ><B>Queratomia OS: </b>".$row['Queratom_os']."</td></tr>";	
	//GENERAL
