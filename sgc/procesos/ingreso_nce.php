...
if (isset($accion) AND $accion == 'registros_en_correccion'){
	...
	while($row_cco1 = mysql_fetch_array($res_cco1))
	{
		...
		//Aqui se forma el arreglo, con clave el servicio => codigo del cco y su INFORMACI?.
					...
					causas,caso, claseEvento, procAsociadoCco)  //falta enviarle las variables wbasedato, datos, wemp_pmla y otra**
{
	...
	//buscar todos los td del tr que llego y a toda la tabla que los contiene se le pone tama? 10
	...
	else
	{
		...
		if (caso!="enviadas")
		{
				...
				if (caso == 'todas')
				 {
					//Si el estado de la accion es correccion mostrar?el seleccionador de estados y el boton de editar, sino seguiran estando ocultos. Jonatan Lopez 19 Marzo 2014
					if(estadoEvento == '04'){
					$("#estados").css("display", ""); // mostrar div estados
					$("#editar").css("display", ""); // mostrar div editar
					}else{
...
//***************************************************************************
// 2019-04-15 Jessica Madrid Mej?:	Se agrega utf8_encode() en la descripci? del cargo para solucionar problema de tildes que
// 									da?ba la respuesta ajax y por tal motivo no se mostraban los resultados de las consultas.
//***************************************************************************
//2018-07-24 camilo zapata: se modifica la consulta de opciones en eventos adversos para que incluya los permisos especiales asignados a trav? de la tabla _000022 para los usuarios que no son coordinadores pero pueden ver la pesta? de reporte de eventos.
