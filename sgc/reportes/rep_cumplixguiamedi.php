<html>
<head>
<title>MATRIX - [REPORTE DE GUIAS MEDICAS X UNIDADES]</title>
   ...
   //para graficar
	function pintarGrafica ()
    {
		$('#tablareporte').LeerTablaAmericas({
				empezardesdefila: 1,
				dimension : '3d' ,
				titulo : 'Guias Adherencias Medicas' ,
...
/*******************************************************************************************************************************************
*                                             REPORTE GUIAS ADHERENCIAS MEDICAS %CUMPLIMIENTO                                              *
********************************************************************************************************************************************/
...
//DESCRIPCION			      : Este reporte sirve para observar las guias adherencias medicas                                              |
//                                                                                                                                          |
//TABLAS UTILIZADAS :                                                                                                                       |
...
session_start();
//Encabezado
encabezado("Guias Adherencias Medicas",$wactualiz,"clinica");
...
else
{
 ...
 //Forma
 echo "<form name='forma' action='rep_cumplixguiamedi.php' method='post'>";
 echo "<input type='HIDDEN' NAME= 'usuario' value='".$wuser."'/>";

 if (!isset($pp) or $pp=='-' or !isset($ccos) or $ccos=='-' or !isset($anofec) )
  {
  	echo "<form name='rep_cumplixguiamedi' action='' method=post>";
 ...
 ELSE // Cuando ya estan todos los datos escogidos
  {
   ...
   echo "<tr>";
   echo "<td align=center colspan='1' bgcolor=#FFFFFF><font size='3' text color=#003366><b>GUIAS ADHERENCIAS MEDICAS</b></font></td>";
   echo "</tr>";
   echo "<tr>";
   ...
   $query = " SELECT evunidad,evdesc1sino,evdesc2sino,evdesc3sino,evdesc4sino"
           ."   FROM pamec_000009"
