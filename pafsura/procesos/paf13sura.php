<HTML>
<HEAD>
<TITLE>Reporte General de Ordenes PAF SURA</TITLE>
	<style type="text/css">
...
//Forma
echo "<form name='paf13sura' action='paf13sura.php' method=post>";  
 ...
 if (!isset($wfec1) or !isset($wfec2))
 {
    ...
    echo "<tr>";
	echo "<tr><td align=CENTER colspan=1 bgcolor=#DDDDDD><b><font text color=#003366 size=2>Reporte General de Ordenes PAF SURA<br></font></b>";   
	echo "</tr>";
...
/****/
 ...
 else      // Cuando ya estan todos los datos escogidos     **********************************************************************
 {
    ...
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>Reporte General de Ordenes PAF SURA</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>Periodo: ".$wfec1." Al ".$wfec2."</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>PROGRAMA: paf13sura.php Ver. 2015/11/26<br>AUTOR: JairS</font></b><br>";
    echo "</table>";
   ...
   { 
    ...
    {        
       ...
       // color de la fila
        ...
        $wid=$registro[0];
        echo "<td><A HREF='paf01sura.php?wid=".$wid."&windicador=PrimeraVez&wproceso=Modificar' TARGET='_blank' >Editar</A></td>";	
