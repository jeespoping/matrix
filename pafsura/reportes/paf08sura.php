<HTML>
<HEAD>
<TITLE>Consolidado general del programa cardiovascular SURA en un periodo</TITLE>
</HEAD>
<BODY>
...
//Forma
echo "<form name='paf08sura' action='paf08sura.php' method=post>";  
 ...
 else      // Cuando ya estan todos los datos escogidos
 {
    ...
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=4><i>Estadisticas generales del programa cardiovascular SURA</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=4><i>Periodo: ".$wfec1." Al ".$wfec2."</font></b><br>";
    echo "<tr><td align=center bgcolor=#DDDDDD colspan=><b><font text color=#003366 size=2><i>PROGRAMA: paf08sura.php Ver. 2015/09/09<br>AUTOR: JairS</font></b><br>";
    echo "</table>";
    ...
    $query="SELECT count(*) as Ordenes From pafsura_000001 "
    ."  WHERE paffau BETWEEN '".$wfec1."' AND '".$wfec2."' AND pafest='A'"; 
    ...
    ." from pafsura_000001"
    ." where pafest='A' "
    ." and paffau BETWEEN '".$wfec1."' AND '".$wfec2."'" 
    ." group by pafced"
    ." order by 2 desc";
    $resultado = mysql_query($query);
    $nroreg = mysql_num_rows($resultado);
    ...
    //  CONSOLIDADO DE EXAMENES AUTORIZADOS EN ESTE PERIODO
    echo "<td colspan=4 align=center bgcolor='DDDDDD'><font text color=#003366 size=3>Consolidado de examenes autorizados en el periodo con fecha de vigencia a hoy </td>";  
    echo "</tr>"; 

    $query="Select  pafexa,nombre,count(*) from pafsura_000001,root_000012"
    ." where paffre BETWEEN '".$wfec1."' AND '".$wfec2."'"
    ." And paffre <= CURDATE() "       // Solo ordenes con fecha de Vigencia a la fecha
    ." And pafest='A' "
	." and pafexa=codigo"
    ." group by pafexa,nombre"
    ." order by 3 desc";
    ...
    {
	    $registro = mysql_fetch_row($resultado);  	
        echo "<td colspan=2 align=center bgcolor='CCFFFF'><font text color=#003366 size=3>".$registro[0]." - ".$registro[1]."</td>";
        echo "<td colspan=2 align=LEFT   bgcolor='CCFFFF'><font text color=#003366 size=3>".$registro[2]."</td>";
        echo "</tr>";
		$wsuma=$wsuma+$registro[2]; 
        $i=$i+1;
    }	  
