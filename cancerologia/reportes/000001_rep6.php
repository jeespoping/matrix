...
if(!isset($_SESSION['user']))
...
else
	{
		...
		if(!isset($numero))
		{
			...
			echo "<tr><td align=center><b>INSTITUTO DE CANCEROLOGIA S.A.<b></td></tr>";
		...
		else
		{
			...
			if ($num>0)
			{
				...
				echo "<table border=1>";
				echo "<tr><td rowspan=4><IMG SRC='/MATRIX/images/medical/root/inscan.png' ></td>";
				echo "<td colspan=2 bgcolor=#dddddd align=center><font size=5><b>INSTITUTO DE CANCEROLOGIA S.A.</b></font></td></tr>";
				echo "<tr><td colspan=2><font size=4 aling=center>NIT : 800.149.026-4</font><td></tr>";
