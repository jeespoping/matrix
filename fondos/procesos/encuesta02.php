...
echo "<form name='encuesta02' action='encuesta02.php' method=post>";  
echo "<center>";
echo "<table border=1>";
echo "<FONT COLOR='RED'>";
...
//echo "<td rowspan=2 colspan=1 align=center><a class='p' href='encuesta02a.php' target='_blank' >Aceptar politicas y continuar...";
//echo "<br>";	
...
// Si el usuario ya lleno la encuesta va directo a la pagina si no va a diligenciar la encuesta
	$query = "SELECT * FROM fondos_000100 Where encced='".$documento_id."'";
	$rs = mysql_query($query,$conex);
	$num = mysql_num_rows($rs);
	echo "<td rowspan=2 colspan=1 align=center><a class='p' href='encuesta02a.php?wcedula=".$documento_id."&windicador=PrimeraVez' target='_blank' >Aceptar politicas y continuar...";
	/*if($num > 0)
	{
