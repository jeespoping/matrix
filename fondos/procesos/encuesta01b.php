...
<script>
    function ira()
    {
	 document.encuesta01b.wap1.focus();
	}
</script>
...
<script type="text/javascript">
	...
	function enter()
	{
		document.forms.encuesta01b.submit();   // Ojo para la funcion encuesta01b <> Encuesta01b  (sencible a mayusculas)
	}
...
$wactualiz="PROGRAMA: encuesta01b.php Ver. Mayo 28 de 2015   JairS";
...
echo "<form name='encuesta01b' action='encuesta01b.php' method=post>";  
