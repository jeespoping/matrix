...
else
{
	...
	echo "<form name='ac' action='ac_fondos.php' method=post>";
	...
	if(!isset($wano))
	{
		...
		{
			case "fondos":
				$query = "SELECT Actano from fondos_000001 GROUP BY Actano";
			break;
			case "juntacs":
	...
	else
	{
		...
		{
			case "fondos":
				$query = "select Actano, Actcod, Actfec, Actnom   from  fondos_000001 ";
