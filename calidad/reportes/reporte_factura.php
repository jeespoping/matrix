...
else
{
	...
	IF(!isset($fact))
	{
		echo "<form action='reporte_factura.php' method=post>";
	...
	else
	{
		...
		$query = "SELECT * FROM calidad_000001 where factura='".$fact."'";
		...
		if($num>0)
		{
			...
			$query = "SELECT * FROM calidad_000004 where Historia='".$row[9]."' and Ingreso='".$row[10]."'";
			...
			echo "<tr><td colspan=2><font face='Arial' size='2' color='#004477'><B>Auditor:</b> <font face='Arial' size='2' color='#00000'>".$row1["Auditor"]."</td></table>";
				$query2 = "SELECT * FROM calidad_000005 where Historia='".$row[9]."' and Ingreso='".$row[10]."'";
				...
				if($num2>0)
				{
					...
					echo "<tr><td colspan='2'><font face='Arial' size='2' color='".$color2."' ><B>Tipo Inc.:</b> <font face='Arial' size='2' color='#00000'>".$row2["Tipo_inc"]."</td>";
					...
					echo "<tr><td width=35% align=left  bgcolor='".$color1."' rowspan='2'><font size='2' face='arial'color=#FFFFFF><b>Observaciones</b>";
					echo "<fieldset  style='background-color: #FFFFFF' cols=30><font size='2' face='arial'color=#000000>".$row2["Observaciones"]."</fieldset></TD>";
			...
			$query = "SELECT * FROM calidad_000003 where factura='".$fact."'";
			$err = mysql_query($query,$conex);
			$num = mysql_num_rows($err);
			if($num>0)
			{
				for ($j=0;$j<$num;$j++)
					{
						...
						echo "<CENTER><table align=center border=1 width=680 >";
						$row = mysql_fetch_array($err);
						echo "<tr><td bgcolor=".$color1." colspan=3><font face='Arial' size='2'COLOR=#FFFFFF><b>INFORME INCONSISTENCIAS ".$row["Codigo"]." </td></tr>";
						
						echo "<tr><td ><font face='Arial' size='2' color='".$color2."'><B>Recibida:</b> <font face='Arial' size='2' color='#00000'>".$row["Recibido"]."</td>";						
						echo "<td ><font face='Arial' size='2' color='".$color2."'><B>Auditada:</b> <font face='Arial' size='2' color='#00000'>".$row["Audito"]."</td>";
						echo "<td ><font face='Arial' size='2' color='".$color2."'><B>Fecha Inc.:</b> <font face='Arial' size='2' color='#00000'>".$row["Fecha_inconsistencia"]."</td></tr>";
						
						echo "<tr><td colspan='2'><font face='Arial' size='2' color='".$color2."'><B>Tipo Inconsistencia:</b> <font face='Arial' size='2' color='#00000'>".$row["Tipo_inc"]."</td>";
						echo "<td><font face='Arial' size='2' color='".$color2."'><B>Valor Unitario:</b> <font face='Arial' size='2' color='#00000'>".$row["Valor_unitario"]."</td></tr>";
						
						echo "<tr><td><font face='Arial' size='2' color='".$color2."'><B>Cantidad:</b> <font face='Arial' size='2' color='#00000'>".$row["Cantidad"]."</td>";
						echo "<td><font face='Arial' size='2' color='".$color2."'><B>Tipo Nota:</b> <font face='Arial' size='2' color='#00000'>".$row["Tipo_nota"]."</td>";
						echo "<td><font face='Arial' size='2' color='".$color2."'><B>Valor Nota:</b> <font face='Arial' size='2' color='#00000'>".$row["Valor_nota"]."</td></tr>";
						
						echo "<tr><td colspan=3><font face='Arial' size='2' color='".$color2."'><B>Unidad Responsable:</b> <font face='Arial' size='2' color='#00000'>".$row["Unidad_inc"]."</td></tr>";
						
						echo "<tr><td colspan=3><font face='Arial' size='2' color='".$color2."'><B>Responsable:</b> <font face='Arial' size='2' color='#00000'>".$row["Responsable_inc"]."</td></tr>";
						
						echo "<tr><td colspan=3><font face='Arial' size='2' color='".$color2."'><B>Causa:</b> <font face='Arial' size='2' color='#00000'>".$row["Causa"]."</td>";
						
						echo "<tr><td width=35% align=left  bgcolor='".$color1."' rowspan='2'><font size='2' face='arial'color=#FFFFFF><b>Observaciones</b>";
						echo "<fieldset  style='background-color: #FFFFFF' cols=30><font size='2' face='arial'color=#000000>".$row["Observaciones"]."</fieldset></TD>";
						echo "<td colspan=2><font face='Arial' size='2' color='".$color2."'><B>Estado:</b> <font face='Arial' size='2' color='#00000'>".$row["Estado_factura"]."</td>";
						
						echo "<tr><td ><font face='Arial' size='2' color='".$color2."'><B>Concilio:</b> <font face='Arial' size='2' color='#00000'>".$row["Concilio"]."</td>";
						echo "<td ><font face='Arial' size='2' color='".$color2."'><B>Devolvio:</b> <font face='Arial' size='2' color='#00000'>".$row["Devolvio"]."</td></tr>";
						
						echo "<tr><td><font face='Arial' size='2' color='".$color2."'><B>Unidad Audito:</b> <font face='Arial' size='2' color='#00000'>".$row["Unidad_audito"]."</td>";
						echo "<td colspan=2><font face='Arial' size='2' color='".$color2."'><B>Unidad Devolvio:</b> <font face='Arial' size='2' color='#00000'>".$row["Unidad_devolvio"]."</td></tr>";
						
						echo "<tr><td colspan=3><font face='Arial' size='2' color='".$color2."'><B>Auditor:</b> <font face='Arial' size='2' color='#00000'>".$row["Auditor_a"]."</td></tr>";
