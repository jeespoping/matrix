...
include_once("conex.php");
   ...
   //$filename = "PHPCe";
    ...
    $output = str_replace( "<<responsable>>",$responsable, $output );
    $output = str_replace( "<<idresp>>",$idresp, $output );
    ...
    $output = str_replace( "<<idmed>>",$idmed, $output );
    $output = str_replace( "<<diagnostico>>",$diagnostico, $output );
    $output = str_replace( "<<procedimiento>>", $procedimiento, $output );
    $output = str_replace( "<<anestesia>>", $anestesia, $output );
