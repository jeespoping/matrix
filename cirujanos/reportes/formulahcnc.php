...
else
{
	...
	{
		echo "<form action='formulahcnc.php?empresa=$empresa' method=post>";
		...
		echo "<tr><td align=center colspan=3><font color=#000066><b>DR. CARLOS JAIME YEPES</b></td></tr>";
		echo "<tr></tr>";
	  ...
	  ********************************/
	{
		...
		echo "<br>Medico Neurocirujano<BR>Reg.: 09136<BR>Telefono: 3459192</b></font>";
		echo "</tr></table><br>";	
			...
			if ( $pacien[1] == 'NO APLICA')
				$pacien[1] = " ";
			if ( $pacien[2] = 'NO APLICA')
				$pacien[2] = " ";
			if ( $pacien[3] == 'NO APLICA')
				$pacien[3] = " ";
			if ( $pacien[4] == 'NO APLICA')
				$pacien[4] = " ";
			...
			echo "<table align=left border=1 width=725>";
			echo "<tr><td colspan='2'><font size=1 face='arial' ><B>FIRMADO ELECTRONICAMENTE POR:<b>DR. CARLOS JAIME YEPES &nbsp&nbsp&nbsp&nbsp REGISTRO:09136</B></td></tr>";
		    //echo "<tr><td colspan='2'><img SRC='/matrix/images/medical/hce/Firmas/".$key.".png ' width='140' height='90'></td></tr>";
			echo "<tr><td colspan='2'><img SRC='/matrix/images/medical/hce/Firmas/0800038.png ' width='140' height='90'></td></tr>";
			echo "</table>";
