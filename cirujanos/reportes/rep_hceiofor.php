...
else
{
	  ...
	  ********************************/
	{
		...
		echo "<td align='left'><font size=2 color='#000080' face='arial'><B>Dr. Edgar Idarraga Ocampo<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Médico Internista<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Reg. 5029395</td>";
		echo"</tr></table>";
		echo "<table border=0 width=800>";
		//echo "<tr><td ><b>FECHA: </b>".$fecha."</td></tr><tr><td >".$pacn."</td></tr><tr><td><br><br></td></tr>";
