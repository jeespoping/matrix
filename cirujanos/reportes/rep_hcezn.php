...
else
{
	...
	else
	{
		...
		echo "</tr><tr><td  align=center colspan='4'><font size=2 color='#000080' face='arial'><B>".$nomed."";
			echo "<br>Medicina Física y Rehabilitación<BR></b>";
			echo "<br>Electromiografía y Potenciales Evocados<BR>Reg.:</b>".$reg."</b>";
			echo "<br>Torre Médica - Consultorio 723 Telefono: 3459268</b></font>";
		echo "</tr></table>";
