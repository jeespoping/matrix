...
else
{
	...
	{
		echo "<form action='rep_hcaku.php?empresa=$empresa' method=post>";
	...
	else
	{
		...
		echo "<table align=center border=1 width=725>";
		echo "<tr><td colspan='4'><font size=1 face='arial' ><B>FIRMADO ELECTRONICAMENTE POR:<b>DR. AMADO JOSE KARDUSS URUETA &nbsp&nbsp&nbsp&nbsp REGISTRO:076-89</B></td></tr>";
		//echo "<tr><td colspan='4'><img SRC='/matrix/images/medical/hce/Firmas/".$key.".png ' width='140' height='90'></td></tr>";
		echo "<tr><td colspan='4'><img SRC='/matrix/images/medical/hce/Firmas/0800111.png ' width='140' height='90'></td></tr>";
		echo "</table>";
	}
