...
else
{
	...
	{
		echo "<form action='rep_hccerg.php?empresa=$empresa' method=post>";
	...
	else
	{
		...
		if($empresa=="hccerg")
			echo "<br>MEDICO ANESTESIÓLOGO Y MEDICINA DEL DOLOR<BR>Reg.:</b>".$reg."</b></font>";
		echo "</tr></table>";
		...
		for ($y=0;$y<$nfechas;$y++)
		{
			...
			if($num>0)
			{
				...
				if ($row['Ayudas_dx']!='.')
					echo "<tr><td colspan=4><font size=3 face='arial' ><B>AYUDAS DIAGNOSTICAS: </b>".$row['Ayudas_dx']."</td></tr>";
				...
				if ($row['Eva']!='.')
					echo "<tr><td colspan='4'><font size=3  face='arial'><b>E.V.A.:</b> ".$row['Eva']."</td></tr></table>";
		...
		echo "<table align=center border=1 width=725>";
		echo "<tr><td colspan='4'><font size=1 face='arial' ><B>FIRMADO ELECTRONICAMENTE POR:<b>DR. CARLOS EDUARDO RESTREPO GARCES &nbsp&nbsp&nbsp&nbsp REGISTRO:050619-96</B></td></tr>";
		echo "<tr><td colspan='4'><img SRC='/matrix/images/medical/hce/Firmas/0800059.png ' width='140' height='90'></td></tr>";
		echo "</table>";
	}
