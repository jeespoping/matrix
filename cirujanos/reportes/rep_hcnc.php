...
include_once("conex.php");
  /***************************************************
	...
	*		  PARA EL DOCTOR CARLOS JAIME YEPES	V.1.00	 *
	*				CONEX, FREE => OK                *
	**************************************************/
...
else
{
	...
	{
		echo "<form action='rep_hcnc.php?empresa=$empresa' method=post>";
	...
	else
	{
		...
		echo "</tr><tr><td  align=center colspan='4'><font size=2 color='#000080' face='arial'><B>Dr. Carlos Jaime Yepes";
		echo "<br>Medico Neurocirujano<BR>Reg.:</b> 09136<BR>Telefono: 3459192</b></font>";
		echo "</tr></table>";
		...
		for ($y=0;$y<$nfechas;$y++)
		{
			...
			if($num>0)
			{
				...
				if ($row['Revision_sitemas']!='.') 
					echo "<tr><td colspan=4><font size=3 face='arial' ><B>Revision de Sistemas: </b>".$row['Revision_sitemas']."</td></tr>";
				if ($row['Antecedentes']!='.') 
					echo "<tr><td colspan=4><font size=3 face='arial' ><B>Antecedentes y Alergias: </b>".$row['Antecedentes']."</td></tr>";
				// EXAMEN FISICO
				...
				if ($row['Conciencia']!='.')
					echo "<tr><td colspan=4 bgcolor='#F2F2F2'><font size=3 face='arial' ><B>Consciencia: </b>".$row['Conciencia']."</td></tr>";
				if ($row['Fx_cogn_leng']!='.')
				...
				if ((file_exists ("/var/www/matrix/images/medical/neurohc/".$row['Exam1']))==1)
					echo "<tr><td colspan=12 align='center'><img SRC='/matrix/images/medical/neurohc/".$row['Exam1']."' width='300' height='200'></td></tr>";
				if ((file_exists("/var/www/matrix/images/medical/neurohc/".$row['Exam2']))==1)
					echo "<tr><td colspan=12 align='center'><img SRC='/matrix/images/medical/neurohc/".$row['Exam2']."' width='300' height='200'></td></tr>";
				if ((file_exists("/var/www/matrix/images/medical/neurohc/".$row['Exam3']))==1)
					echo "<tr><td colspan=12 align='center'><img SRC='/matrix/images/medical/neurohc/".$row['Exam3']."' width='300' height='200'></td></tr>";
				if ((file_exists("/var/www/matrix/images/medical/neurohc/".$row['Exam4']))==1)
					echo "<tr><td colspan=12 align='center'><img SRC='/matrix/images/medical/neurohc/".$row['Exam4']."' width='300' height='200'></td></tr>";
				if ((file_exists("/var/www/matrix/images/medical/neurohc/".$row['Exam5']))==1)
					echo "<tr><td colspan=12 align='center'><img SRC='/matrix/images/medical/neurohc/".$row['Exam5']."' width='300' height='200'></td></tr>";
				...
				if ($row['Esp_plan']!='.')
					echo "<tr><td colspan=4 bgcolor='#F2F2F2'><font size=3 face='arial' ><B>Especificacion del plan: </b>".$row['Esp_plan']."</td></tr>";
		...
		echo "<table align=center border=1 width=725>";
		echo "<tr><td colspan='4'><font size=1 face='arial' ><B>FIRMADO ELECTRONICAMENTE POR:<b>DR. CARLOS JAIME YEPES &nbsp&nbsp&nbsp&nbsp REGISTRO:09136</B></td></tr>";
		//echo "<tr><td colspan='4'><img SRC='/matrix/images/medical/hce/Firmas/".$key.".png ' width='140' height='90'></td></tr>";
		echo "<tr><td colspan='4'><img SRC='/matrix/images/medical/hce/Firmas/0800038.png ' width='140' height='90'></td></tr>";
		echo "</table>";
	}
