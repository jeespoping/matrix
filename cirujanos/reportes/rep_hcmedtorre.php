...
else
{
	...
	{
		echo "<form action='rep_hcmedtorre.php?empresa=$empresa' method=post>";
	...
	else
	{
		...
		if ($empresa=="hcjgrr")
			echo "<br>MEDICO GENERAL<BR>Reg.:</b>".$reg."</b></font>";
		if ($empresa=="hcrpf")	
			echo "<br>MEDICO HEMATOLOGO INTERNISTA<BR>Reg.:</b>".$reg."</b></font>";
		if ($empresa=="hcjjvg")	
			echo "<br>MEDICO ALGESIOLOGO<BR>Reg.:</b>".$reg."</b></font>";
		if ($empresa=="hcawl")	
			echo "<br>MEDICO PEDIATRA GASTROENTEROLOGA<BR>Reg.:</b>".$reg."</b></font>";
		if ($empresa=="hccme")	
			echo "<br>MEDICO GASTROENTEROLOGO INTERNISTA<BR>Reg.:</b>".$reg."</b></font>";
		if ($empresa=="hcaku")	
			echo "<br>MEDICO HEMATOLOGO INTERNISTA<BR>Reg.:</b>".$reg."</b></font>";
		if ($empresa=="hcevgr")	
			echo "<br>MEDICO ONCOLOGO - CLINICO<BR>Reg.:</b>".$reg."</b></font>";
		...
		for ($y=0;$y<$nfechas;$y++)
		{
			...
			if($num>0)
			{
				...
				echo "<tr><td><font size=3 face='arial' ><B>ANTECEDENTES PERSONALES: </b>".$row['Antecedentes_personales']."</td>"; 
				...
				echo "<tr><td><font size=3  face='arial'><b>OTROS:</b> ".$row['Otros']."</td></tr>";
				echo "<tr><td colspan='4'><font size=3  face='arial'><b>DIAGNOSTICO:</b> ".$row['Diagnostico']."</td></tr>";
				if ($empresa=="hccme" or $empresa=="hcaku")
					echo "<tr><td><font size=3  face='arial'><b>OTROS DIAGNOSTICOS:</b> ".$row['Otros_diagnosticos']."</td></tr>";
