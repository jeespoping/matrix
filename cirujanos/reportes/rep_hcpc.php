...
include_once("conex.php");
  /***************************************************
	...
	*		  PARA EL DOCTOR PEDRO CORREA	V.1.00	 *
	*				CONEX, FREE => OK                *
	**************************************************/
...
else
{
	...
	{
		echo "<form action='rep_hcpc.php?empresa=$empresa' method=post>";
	...
	else
	{
		...
		$proced=$row['Procedencia'];// Procedencia
		...
		echo "</tr><tr><td  align=center colspan='4'><font size=2 color='#000080' face='arial'><B>Dr. Pedro J. Correa Viloria";
		echo "<br>Especialista Cirugía General<BR>Endoscopista<BR>Reg.:</b> 5680</b></font>";
		echo "</tr></table>";
		...
		for ($y=0;$y<$nfechas;$y++)
		{
			...
			if($num>0)
			{
				...
				if(!isset($primero))
				{
					...
					echo "<tr><td><font size=3  face='arial'><b>Procedencia:</b> ".$proced." </td>";
				...
				echo "<tr><td colspan=4><font size=3 face='arial' ><B>MC: </b>".$row['Mc']."</td></tr>";
				echo "<tr><td colspan=4><font size=3 face='arial' ><B>EA: </b>".$row['Ea']."</td></tr>";
				echo "<tr><td colspan=4><font size=3 face='arial' ><B>R.S: </b>".$row['Rs']."</td></tr>";
				echo "<tr><td colspan=4><font size=3 face='arial' ><B>AP: </b>".$row['Ap']."</td></tr>";
				echo "<tr><td colspan=4><font size=3 face='arial' ><B>AQ: </b>".$row['Aq']."</td></tr>";
				echo "<tr><td colspan=4><font size=3 face='arial' ><B>AF: </b>".$row['Af']."</td></tr>";
				echo "<tr><td colspan=4><font size=3 face='arial' ><B>E. FISICO: </b>".$row['E_fisico']."</td></tr>";
				echo "<tr><td colspan=4><font size=3 face='arial' ><B>EXÁMENES DX: </b>".$row['Examenes_dx']."</td></tr>";
				echo "<tr><td colspan=4><font size=3 face='arial' ><B>DIAGNÓSTICO: </b>".$row['Diagnostico']."</td></tr>";
				echo "<tr><td colspan=4><font size=3 face='arial' ><B>TRATAMIENTO: </b>".$row['Tratamiento']."</td></tr></table>";
