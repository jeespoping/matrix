...
else
{
	...
	{
		echo "<form action='rep_hcx.php?empresa=$empresa' method=post>";
	...
	else
	{
		...
		if ($empresa=="ciruhc")
			echo "<img SRC='/MATRIX/images/medical/cirujanos/logoadolfo1.JPG' width='180' height='117'></td>";
		else
		...
		else if($empresa=="ciruhc")
			{	
				echo "<br>Cirugía Bariatrica";
				echo "<br>Cirugía Laparoscópica Avanzada";
				echo "<br>Endoscopia Digestiva<BR>Reg.:</b>".$reg."</b></font>";
			}
			else
			{
		...
		for ($y=0;$y<$nfechas;$y++)
		{
			...
			if($num>0)
			{
				...
				echo "<tr><td colspan=4><font size=3 face='arial' ><B>REMITE: </b>".$row['Remite']."</td></tr>";
