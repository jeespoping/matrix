...
else
{
	...
	{
		echo "<form action='rep_hcnuevatorre.php?empresa=$empresa' method=post>";
	...
	else
	{
		...
		if($empresa=="hcchmu")
			echo "<br>MEDICO CIRUJANO GENERAL<BR>Reg.:</b>".$reg."</b></font>";
		if($empresa=="hcjrrz")
			echo "<br>MEDICO INTERNISTA NEUMÓLOGO<BR>Reg.:</b>".$reg."</b></font>";
		if($empresa=="hcamv")
			echo "<br>MEDICO CARDIOLOGO INTERNISTA<BR>Reg.:</b>".$reg."</b></font>";
		if($empresa=="hcjgrr")
			echo "<br>MEDICO GENERAL<BR>Reg.:</b>".$reg."</b></font>";
		if($empresa=="hcjhgr")
			echo "<br>NEUROCIRUJANO DE COLUMNA</b></font>";
		...
		for ($y=0;$y<$nfechas;$y++)
		{
			...
			if($num>0)
			{
				...
				echo "<table align=center border=1 width=725 >";
				echo "<tr><td align=left colspan='4' bgcolor='#cccccc' height='15'><font size='3'  face='arial'><b>FECHA: ".$fec[$y]."</b></font></td></tr>";
				echo "<tr><td align=center colspan=4 bgcolor='#cccccc' height='15'><font size=3 face='arial' ><B>HISTORIA CLINICA</b></td></tr>";
				if ($row['Historia_clinica']!='.')
					echo "<tr><td colspan='4'><font size=3  face='arial'> ".str_replace( "\n", "<br>", ($row['Historia_clinica'])  )."</td></tr></table>";
