...
else
{
	...
	else
	{
		...
		echo "<br>MEDICO GINECOLO-ONCOLOGO<BR>Reg.:</b>".$reg."</b></font>";
		echo "</tr></table>";
		...
		for ($y=0;$y<$nfechas;$y++)
		{
			...
			if($num>0)
			{
				...
				echo "<tr><td rowspan=11 colspan=2 align='left'><img SRC='/matrix/images/medical/ginehc/".$row['Imagen']."' width='300' height='200'></td></tr>";
				if ($row['Fsci']!='NO APLICA')
				echo "<tr><td colspan=10><font size=3 face='arial' ><B>Fosa Supraclavicular Izquierda: </b>".$row['Fsci']."</td></tr>";
				if ($row['Fscd']!='NO APLICA')
				echo "<tr><td colspan=10><font size=3 face='arial' ><B>Fosa Supraclavicular Derecha: </b>".$row['Fscd']."</td></tr>";
				if ($row['Axi']!='NO APLICA') 
				echo "<tr><td colspan=10><font size=3 face='arial' ><B>Axila Izquierda: </b>".$row['Axi']."</td></tr>";
				if ($row['Axd']!='NO APLICA') 
				echo "<tr><td colspan=10><font size=3 face='arial' ><B>Axila Derecha: </b>".$row['Axd']."</td></tr>";
				if ($row['Mami']!='NO APLICA')
				echo "<tr><td colspan=10><font size=3 face='arial' ><B>Mama Izquierda: </b>".$row['Mami']."</td></tr>";
				if ($row['Mamd']!='NO APLICA')
				echo "<tr><td colspan=10><font size=3 face='arial' ><B>Mama Derecha: </b>".$row['Mamd']."</td></tr>";
				if ($row['Abd']!='.') 
				echo "<tr><td colspan=10><font size=3 face='arial' ><B>Abdomen: </b>".$row['Abd']."</td></tr>";
				if ($row['Genitales']!='.') 
				echo "<tr><td colspan=10><font size=3 face='arial' ><B>Genitales: </b>".$row['Genitales']."</td></tr>";
				if ($row['Diag']!='NO APLICA') 
				echo "<tr><td colspan=10><font size=3 face='arial' ><B>Diagnostico: <i>".$row['Diag']."</b></td></tr>";
				if ($row['Esp_diag']!='.') 
				echo "<tr><td colspan=10><font size=3 face='arial' ><B>Especificacion Diagnostico: <i>".$row['Esp_diag']."</b></td></tr>";
				
				
				//CONDUCTA
				echo "<tr><td align=center colspan='12' bgcolor='#cccccc' height='15'><font size='3'  face='arial'><b>CONDUCTA</b></font></td></tr>";
				...
				if ($row['Cons']!='.') 
				echo "<tr><td colspan=12><font size=3 face='arial' ><B>Consentimiento Informado: </b>".$row['Cons']."</td></tr>";
