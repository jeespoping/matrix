...
else
{
	...
	{
		echo "<form action='rep_hccirujano.php?empresa=$empresa' method=post>";
		...
		echo "<tr><td bgcolor=#cccccc colspan=1><font color=#000066>MEDICO: </font></td>";	
			/* Si el medico no ha sido escogido Buscar a los cirujanos de la seleccion para 
		...
		for ($y=0;$y<$nfechas;$y++)
		{
			...
			if($num>0)
			{
				...
				if(!isset($primero))
				{
					...
					echo "<td><font size=3  face='arial'><b>PARENTESCO:</b> ".$parent." </td></tr>";
					echo "<tr><td colspan=4><font size=3 face='arial' ><b>CORREO:</b>".$correo." </td></tr></table>";
					$primero="OK";
				}
				echo "<table align=center border=1 width=725 >";
