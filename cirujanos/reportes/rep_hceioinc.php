...
else
{
	...
	{
		echo "<form action='rep_hceioinc.php?empresa=$empresa' method=post>";
		...
		if(isset($pac1))
		{
			...
			/* Si el medico  ya esta set traer los pacientes a los cuales les ha hecho incapacidad*/
	  ...
	  ********************************/
	{
		...
		if($err)
		{
			...
			echo "NO EXISTE INCAPACIDAD PARA ESE PACIENTE EN ESA FECHA";
		...
		echo "</tr><tr><td  colspan='4'><font size=2 color='#000080' face='arial'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<B>Médico Internista";
		...
		echo "</td><tr><td ><b>INCAPACIDAD:</b></td></tr><br><br>";
		echo "<tr><td >".$row['Incapacidad']."</td></tr>";
		echo"</table>";
	}
