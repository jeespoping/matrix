...
<head>
  <title>HISTORIA UROLOGIA V.1.00</title>
</head>
<body BGCOLOR="">
<BODY TEXT="#000066">
<?php
...
else
{
	...
	{
		echo "<form action='rep_hcurol.php?empresa=$empresa' method=post>";
	...
	else
	{
		...
		echo "<br>MEDICO UROLOGO<BR>Reg.:</b>".$reg."</b></font>";
		echo "</tr></table>";
		...
		for ($y=0;$y<$nfechas;$y++)
		{
			...
			if($num>0)
			{
				...
				if(!isset($primero))
				{
					...
					echo "<tr><td><font size=3  face='arial'><b>FECHA NACIMIENTO:</b> ".$fecnac."<br>(EDAD al momento de consultar: ".$edad.")</td>";
				...
				if ($row['Mc_ea']!='.')
					echo "<tr><td colspan=4><font size=3 face='arial' ><B>MOTIVO DE CONSULTA Y ENFERMEDAD ACTUAL: </b>".$row['Mc_ea']."</td></tr>";
				if ($row['Antec_pers']!='.') 
					echo "<tr><td colspan=4><font size=3 face='arial' ><B>ANTECEDENTES PERSONALES: </b>".$row['Antec_pers']."</td></tr>";
				if ($row['Antec__quirurgico']!='.') 
					echo "<tr><td colspan=4><font size=3 face='arial' ><B>ANTECEDENTES QUIRURGICOS: </b>".$row['Antec__quirurgico']."</td></tr>";
				...
				echo "<tr><td align=center colspan=4 bgcolor='#cccccc' height='15'><font size=3 face='arial' ><B>SIGNOS VITALES</b></td></tr>";
				if ($row['Pa']!='NO APLICA')
		...
		//ECHO $queryseg;
				...
				if($num1>0)
				{
					for ($x=0;$x<$num1;$x++)
					{
						...
						echo "<fieldset style='background-color: #FFFFFF; '>".$seg[6]."</fieldset></TR>";		
						if ($seg['Exam_laboratorio']!='.')
							{
								echo "<td  align=left colspan='4'  bgcolor='#AADDFF'><font size='3' face='arial'><b>EXAMEN LABORATORIO</b>";
								echo "<fieldset style='background-color: #FFFFFF; '>".$seg['Exam_laboratorio']."</fieldset></TR>";		
							}
						if ($seg['Exam_patologia']!='.')
							{
								echo "<td  align=left colspan='4'  bgcolor='#AADDFF'><font size='3' face='arial'><b>PATOLOGIA</b>";
								echo "<fieldset style='background-color: #FFFFFF; '>".$seg['Exam_patologia']."</fieldset></TR></table>";		
							}
					}
				}
			}
