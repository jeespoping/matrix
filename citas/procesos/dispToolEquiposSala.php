	...
	function disponibilidadEquipos($wfec,$wbasedato)
{
	...
	{ 
		...
		echo "<th colspan='2'><font color='#ffffff'><font size='4'>No se asignan salas, dia Festivo</font></th>";
		echo "</table>";
	}
	else
	{
		...
		echo "<tr><td colspan='2' align='center'><font color='#ffffff'>Salas del Dia</font></td></tr>";
						...
						if ($num4==0)  //todas las citas disponibles
							{
								...
								echo "<tr>";
								echo "<td><font size='2'><font color='#ffffff'> ".$wequ."</font></td> ";
								echo "<td><font size='2'><font color='#ffffff'>Todas los horarios de sala disponibles </font></td></tr>";
								$j++;
							}
							elseif( $num2 == 0 ){
								$rojo++;
								echo "<tr>";
								echo "<td><font size='2'><font color='#ffffff'> ".$wequ."</font></td> ";
								echo "<td><font size='2'><font color='#ffffff'> No se asignan salas este dia</font></td>";
								echo "</tr>";
								$j++;
							}
							else{
								...
								{	
									...
									echo "<tr>";
									echo "<td><font size='2'><font color='#ffffff'> ".$wequ."</font></td> ";
									echo "<td><font size='2'><font color='#ffffff'> No tiene horas sala disponibles</font></td>";
									echo "</tr>";
									$j++;
								...
								{	
									...
									echo "<tr>";
									echo "<td><font size='2'><font color='#ffffff'>".$wequ."</font></td> ";
									echo "<td><font size='2'><font color='#ffffff'>Horas Sala Disponibles: ".$citasDisp."</font></td>";
									echo "</tr>";
									$j++;
								 }
							}
					...
					if ($num2 > 0)
					{
							...
							if ($num4>0)  //tiene citas para asignar
							{
								...
								if ($citasDisp==0)
								{
									...
									echo "<tr>";
									echo "<td><font size='2'><font color='#ffffff'> ".$wequ."</font></td> ";
									echo "<td><font size='2'><font color='#ffffff'> No tiene horas en Sala disponibles</font></td>";
									echo "</tr>";
									$j++;
								...
								if ($num4==0)  //todas las citas disponibles
									{
										...
										echo "<tr>";
										echo "<td><font size='2'><font color='#ffffff'> ".$wequ."</font></td> ";
										echo "<td><font size='2'><font color='#ffffff'>Todas las Horas Sala disponibles </font></td></tr>";
										$j++;
									}
					}
					else
	...
	echo "<meta content='30;URL=dispToolEquiposSala.php?wemp_pmla=$wemp_pmla&wbasedato=$wbasedato&consultaAjax=10&wfec=$wfec&caso=$caso&fest=$fest' http-equiv='REFRESH'> </meta>";
	echo "</form>";
