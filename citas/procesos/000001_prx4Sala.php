...
{		
	...
	if ($num > 0)
	{
		...
		echo "<tr><td><font size=2>Administrador : ".$row[1]."</font></td></tr>";
		echo "<tr><td><font size=2>Solicitud : ".$row[5]."</font></td></tr>";
		...
		echo "<tr><td><font size=2>Nombre : ".$row[9]."</font></td></tr>";
		echo "<tr><td><font size=2>C.Costos : ".$row[11]."</font></td></tr>";
		echo "<tr><td><font size=2>Telefono : ".$row[12]."</font></td></tr>";
		echo "<tr><td><font size=2>Personas : ".$row[13]."</font></td></tr>";
