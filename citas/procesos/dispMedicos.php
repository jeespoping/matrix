...
Modificacion:
            ...
            2020-03-25 Arleyda Insignares. Se adiciona campo Sedcod y tabla root_000128 para adicionar sede a la asignaci�n de las citas
			2020-01-20 Arleyda Insignares. Se adiciona input para busqueda por texto en la tabla que contiene el listado de m�dicos.
								...
								else
								{
										...
										else
										{
											...
											echo "<td><font size='2'><a href='agendaMedicos.php?empresa=$wbasedato&wfec=$wfec&wequ=$wequ&nomdia=$nomdia&colorDiaAnt=$colorDiaAnt&caso=$caso&wemp_pmla=$wemp_pmla{$parametrosExtras}' >".$wequ."</a></font></td> ";
											 ...
											 echo "<td><font size='2'>".$sede." </td>";
											 echo "</tr>"; //aca salia con tama�o 10pt
										}
								}
...
//Devuelve la fecha en formato descriptivo dia mes a�o
