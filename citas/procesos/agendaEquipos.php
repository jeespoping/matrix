...
Modificacion:
 2020-04-01 Arleyda Insignares Ceballos
           El llamado del presente script queda desde el iframe de calendar.php, adicionalmente se 
           coloca el link retornar en la parte superior.
...
{	
	...
	echo "<BODY width=100% TEXT='#000066' onLoad='javascript:estado(\"".$fechaAct."\",\"".$wfec."\")'>";


	echo "<table border=0 align=center>";
	echo "<tr><td align=center bgcolor='#cccccc'><A NAME='Arriba'><font size=6><b>Turnos x Equipo</b></font></a></tr></td>";
	echo "<tr><td align=center bgcolor='#cccccc'><font size=2> <b> agendaEquipos.php Ver. 2013-07-03</b></font></tr></td></table>";
	echo "</center>";
	echo "<form  name='citas' action='agendaEquipos.php' method=post>";
	...
	echo "<tr>";
	echo "<td bgcolor='#cccccc'><b><h3>Equipo: ".$wequ."</h3></b></td>";
	echo "</tr>";
	...
	echo "</tr>";
	echo "</table>";
	echo "<center><b><A HREF='dispEquipos.php?wemp_pmla=".@$wemp_pmla."&wbasedato=$empresa&consultaAjax=10&wfec=$wfec&wsw=$wsw&colorDiaAnt=$colorDiaAnt&caso=$caso'>Retornar</A></b><br></center>";
	...
	if ( ( $caso == 3 && $num == 0 ) || $caso == 1 )
	{
		if(isset($wequ))
		{
			...
			if( $num > 0 )
			{
				echo "<table border=0 class='clsagenda' align=left>";
				$color="#999999";
				if($caso==3)
				{
					echo "<tr>";
					...
					echo "<td bgcolor=".$color." style='width:5px'><font size=2><b>Examen</b></font></td>";
					...
					echo "<td bgcolor=".$color." style='width:5%'><font size=2><b>Telefono</b></font></td>";
				...
				else
				{
					...
					echo "<td bgcolor=".$color."><font size=2><b>Hora Final</b></font></td>"; 
					echo "<td bgcolor=".$color."><font size=2><b>Medico</b></font></td>";
					echo "<td bgcolor=".$color." style='width:5%'><font size=2><b>Examen</b></font></td>";
					
					echo "<td bgcolor=".$color."><font size=2><b>Paciente</b></font></td>";	
					echo "<td bgcolor=".$color."><font size=2><b>Responsable</b></font></td>";	
					echo "<td bgcolor=".$color." width=5px><font size=2><b>Telefono</b></font></td>";
					echo "<td bgcolor=".$color."><font size=2><b>Edad</b></font></td>";
					echo "<td bgcolor=".$color."><font size=2><b>Estado</b></font></td>";
					echo "<td bgcolor=".$color."><font size=2><b>Asiste</b></font></td>";
				    echo "<td bgcolor=".$color."><font size=2><b>Cancelar</b></font></td>";
						...
						{ 
							...
							if ( $num3 >0 )
							{
									...
									{	
										...
										if ($caso==3)
										{
											echo "<td bgcolor=".$color." width=10px><font size=2>".$row[13]."</font></td>";
										}
										echo "<td bgcolor=".$color." width=10px><font size=2>".$row[6]."</font></td>";
										$query = "select nit,descripcion from ".$empresa."_000002 where nit='".$row[7]."'";
										$err1 = mysql_query($query,$conex);
										$num1 = mysql_num_rows($err1);
										$row3 = mysql_fetch_array($err1);
										echo "<td bgcolor=".$color." width=10px><font size=2>".$row3[0]."-".$row3[1]."</font></td>";
										echo "<td bgcolor=".$color." width=10px><font size=2>".$row[8]."</font></td>";
										echo "<td bgcolor=".$color." width=10px><font size=2>".$row[9]."</font></td>";
										switch ($row[12])
										{
											case "A":
	...
	else
	{
		...
		echo "<table border=0 align=center width=400px>";
		echo "<tr><td><A HREF='#Arriba'><B>Arriba</B></A></td></tr></table>";
				
		echo "<meta content='30;URL=agendaEquipos.php?wemp_pmla=$wemp_pmla&empresa=$empresa&wequ=$wequ&consultaAjax=10&wfec=$wfec&wsw=".@$wsw."&colorDiaAnt=$colorDiaAnt&caso=$caso' http-equiv='REFRESH'> </meta>";
		...
		//echo $cau;
		echo "</div>";
		//<a href='agendaEquipos.php?empresa=$wbasedato&wequ=$wequ&wsw=$wsw&colorDiaAnt=$colorDiaAnt&wfec=$wfec&caso=$caso&wemp_pmla=$wemp_pmla' >"
