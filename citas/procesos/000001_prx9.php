...
echo "<tr><td align=center bgcolor='#cccccc'><font size=2> <b> 000001_prx9.php Ver. 2007-04-03</b></font></tr></td></table>";
echo "</center>";
echo "<form  name='citas' action='000001_prx9.php' method=post>";
session_start();
...
{		
	...
	if ($num == 0)
	{
		if(isset($wequ))
		{
			...
			$i = 0;
			$fila = 0;
			$query = "select cod_med,cod_equ,cod_exa,fecha,hi,hf,nom_pac,nit_resp,telefono,edad,comentarios,usuario,activo,cedula,Asistida from ".$empresa."_000001 where fecha='".$wfec."' and cod_equ='".substr($wequ,0,strpos($wequ,"-"))."' order by hi";
			$err = mysql_query($query,$conex);
			$num = mysql_num_rows($err);
			if ($num > 0)
			{
			...
			while ($whi < $wul)
			{
				...
				{	
					...
					if ($prioridad > 0)
						echo "<td bgcolor=".$color." align=center><font size=2><A HREF='000001_prx10.php?pos1=".$row1[0]."&amp;pos2=".substr($wequ,0,strpos($wequ,"-"))."&amp;pos3=".$row2[0]."&amp;pos4=".$wfec."&amp;pos5=".$whi."&amp;pos6=".$whf."&amp;pos7=".$wul."&amp;pos8=".$row[9]."&amp;pos9=".$inc."&amp;empresa=".$empresa."&amp;wsw=".$wsw."&amp;wtit=".$wtit."'>Editar</font></td>";
					else
				...
				else
				{
					...
					echo "<td bgcolor=".$color." align=center><IMG SRC='/matrix/images/medical/root/indefinido.gif' ></td>";
					if ($prioridad > 0)
						echo "<td bgcolor=".$color." align=center><font size=2><A HREF='000001_prx10.php?pos1=0&amp;pos2=".substr($wequ,0,strpos($wequ,"-"))."&amp;pos3=0&amp;pos4=".$wfec."&amp;pos5=".$whi."&amp;pos6=".$whf."&amp;pos7=".$wul."&amp;pos8=0&&amp;pos9=".$inc."&amp;empresa=".$empresa."&amp;wsw=".$wsw."&amp;wtit=".$wtit."'>Editar</font></td>";
					else
						echo "<td bgcolor=".$color." align=center><font size=2>Sin Edicion</font></td>";
					echo "</tr>";
				}
