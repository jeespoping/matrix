...
<script type="text/javascript">
	...
	window.onload = function(){
		...
		$("#FecSol").datepicker({
			dateFormat:"yy-mm-dd",
			fontFamily: "verdana",
			dayNames: [ "Lunes", "Martes", "Mi茅rcoles", "Jueves", "Viernes", "S谩bado", "Domingo" ],
...
[DOC]
	   ...
	   Fecha de Liberaci贸n : 2007-05-03
	   Autor : Ing. Pedro Ortiz Tamayo
	   Version Actual : 2011-01-07
	   
	   OBJETIVO GENERAL :Este programa ofrece al usuario una interface gr谩fica que permite grabar los  de las
	   ...
	   REGISTRO DE MODIFICACIONES :
	    ...
	    2020-04-02: Arleyda Insignares C. Se adicionan parametros en la funci贸n envioEmailCita() para implementar 
	                citas de teleorientacion.
	    2020-03-25: Arleyda Insignares C. Se adiciona campo de correo electr贸nico para ser diligenciado en caso de dar una cita por telemedicina, solo en este caso el programa enviar谩 un correo informando los datos de la cita y especificaciones seg煤n par谩metro 'EmailAgendamiento' y 'telemedicina' en la tabla root_000051. 
	    2020-01-20: Arleyda Insignares C. se mejora la consulta de citas posteriores por identificaci贸n del paciente mediante la consulta consultarCitas() localizada en el include de citas.
...
function sendToEmail( $wasunto, $mensaje, $altbody, $wremitente, $wdestinatarios, $ruta_archivo = "", $nombre_adjunto = "" ){
	...
	//Puede llevar un nombre de destino por posici贸n y debe ser separado por - entre el correo y el nombre
	...
	if(!$mail->Send()) {
		$data[ 'Error' ] 	 =  "0";
		$data[ 'mensError' ] =  "No se envi贸 el correo";
	}
	else{
		$accion 	    	 = "envio email";
		$tabla		    	 = "";
...
{		
	...
	{
		//filtrar la opci贸n examen en el men煤
