...
<?php
/**
 * Programa:	impresionAgendaPaf.php
 * Fecha:		2013-04-10
	...
	if( $num > 0 )
	{
		...
		for( $i = 0; $rows = mysql_fetch_array( $res ); $i++ )
		{
			...
			if( $i == 0  and ($caso ==1 or $caso==3)){
				...
				echo "		<td style='width:3%' align='center'>";
				echo "			<b>Nro</b>";
				echo "		</td>";
			...
			if ($caso ==1 or $caso==3)
			{
				...
				echo "		</td>";
				echo "		<td>";
				echo "			".utf8_encode($rows2['Nombre'])."";
				echo "		</td>";
				echo "		<td>";
				echo "			".utf8_encode($rows1['Descripcion'])."";
				echo "		</td>";
				echo "		<td>";
				echo "			".utf8_encode($rows3['Descripcion'])."";
				echo "		</td>";
				if ($tipoAtencion=='on')
				{
					echo "		<td>";
