...
<script>
	...
	{
		var v = window.open( '../procesos/impresionAgendaPaf.php?wemp_pmla='+wemp_pmla+'&caso='+caso+'&wsw='+wsw+'&solucionCitas='+solucionCitas+'&slDoctor='+slDoctor+'&valCitas='+valCitas+'&wfec='+wfec,'','scrollbars=1', 'width=300', 'height=300' );
...
$wentidad = $institucion->nombre;
	...
	if ($wemp_pmla == 01)
	{
		encabezado("CITAS ASIGNADAS", "2013-04-10", $wbasedato );
	}
	else
	{
		encabezado("CITAS ASIGNADAS", "2013-04-10", "logo_".$wbasedato );
	}
	...
	echo "<table align='center'>";
	echo "<tr>";
	echo "<td><a href='../../citas/procesos/pantallaAdmision.php?solucionCitas=".$solucionCitas."&wemp_pmla=".$wemp_pmla."&caso=".$caso."&wsw=".@$wsw."&wfec=".$wfecAnt."&valCitas=".@$valCitas."' title='Atras'><img src='../../images/medical/citas/atras.jpg' alt='Atras'  height='30' width='30' border=0/></a></td>";
	if ($wfec == date("Y-m-d"))
	{
		$hoy = "Hoy:";
	}
	...
	echo "<td><a href='../../citas/procesos/pantallaAdmision.php?solucionCitas=".$solucionCitas."&wemp_pmla=".$wemp_pmla."&caso=".$caso."&wsw=".@$wsw."&wfec=".$wfecSig."&valCitas=".@$valCitas."' title='Adelante'><img src='../../images/medical/citas/adelante.jpg' alt='Adelante'  height='30' width='30' border=0/></a></td>";
	echo "</tr>";
	echo "</table>";
	...
	echo "<meta name='met' id='met' http-equiv='refresh' content='40;url=rep_citaspaf.php?solucionCitas=".$solucionCitas."&wemp_pmla=$wemp_pmla&caso=".$caso."&wsw=".@$wsw."&slDoctor=$slDoctor&valCitas=".$valCitas."&wfec=".$wfec."'>";
