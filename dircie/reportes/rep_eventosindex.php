...
<div id="container">
    ...
    <div id="divInforme" class="panel-body" style="padding-top: 1px">
        ...
        <form id="frmInforme">
            ...
            $Dcfecnotpat = $datoRegistro['Dcfecnotpat']; //Fecha Notificacion al Patrocinador de �ste reporte
            $Dcfecnotpat = explode("-",$Dcfecnotpat);
            $Dcfecnotpat = "$Dcfecnotpat[2]-$Dcfecnotpat[1]-$Dcfecnotpat[0]";
            $Dcfecsitent = $datoRegistro['Dcfecsitent']; //Fecha en el que el sitio se entero de �ste reporte
            ...
            $Dcnomcometiinv = explode("-",$Dcnomcometiinv1); //Nombre del Comit� de Etica en Investigacion (CEI)
            ...
            ?>
                <div style="width: 900px" class="table-bordered">
                                ...
                                <table>
                                    <?php
										...
										if ($Dccodigo == 'NO APLICA'){
											echo "<td>C�digo: F-EC-7</td>";
										}else{
											echo "<td>C�digo:".$Dccodigo."</td>";
										}
										echo "</tr>";
										echo "<tr>";
										if ($Dcversion == 'NO APLICA'){
											echo "<td>Versi�n: 01</td>";
										}else{
											echo "<td>Versi�n:".$Dcversion."</td>";
										}
										echo "</tr>";
									?>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Fecha de Emisi�n: <?php echo $fechaEmision; ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table style="border: groove; width: 900px; border-top: none">
                        ...
                        <tr>
                            <td style="border: groove; width: 50%">
                                <b>Centro de Investigaci�n Reportante</b>
                            </td>
                            <td style="border: groove; width: 50%">
                        ...
                        <tr>
                            <td style="border: groove">
                                <b>Fecha Notificaci�n al Patrocinador del Reporte</b>
                            </td>
                            <td style="border: groove">
                        ...
                        <tr>
                            <td style="border: groove">
                                <b>Fecha en el que el sitio se enter� del reporte</b>
                            </td>
                            <td style="border: groove">
                    ...
                    <table style="border: groove; width: 900px; border-top: none">
                        ...
                        <tr>
                            <td style="border: groove" colspan="3">
                                <b>Titulo del Protocolo de Investigaci�n</b>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table style="border: groove; width: 900px; border-top: none">
                        ...
                        <tr>
                            <td style="border: groove; width: 33%">
                                <b>Diagn�stico del Evento Adverso CIE-10</b>
                            </td>
                    ...
                    <table style="border: groove; width: 900px; border-top: none">
                        ...
                        <tr>
                            <td style="border: groove" colspan="3">
                                <b>Acci�n Tomada por el Investigador:</b>
                            </td>
                        ...
                        <tr>
                            <td style="border: groove" colspan="3">
                                <b>Se Present� Desviaci�n al Protocolo?:</b>
                            </td>
                            <td style="border: groove" colspan="2">
                                <?php echo $Dcdespro[1] ?>
                            </td>
                        ...
                        <tr>
                            <td style="border: groove; width: 20%">
                                <b>Se Rompi� el Ciego?</b>
                            </td>
                            <td style="border: groove; width: 18%">
                                <?php echo $Dcromcie[1] ?>
                            </td>
                            <td style="border: groove; width: 30%" colspan="2">
                                <b>Si se Rompi� el Ciego, cual es el brazo del sujeto?</b>
                            </td>
                            <td style="border: groove; width: 20%">
                        ...
                        <tr>
                            <td style="border: groove; width: 60%" colspan="3" align="center">
                                <b>Nombre del Comit� de �tica en Investigacion (CEI)</b>
                            </td>
                            <td style="border: groove" colspan="1" align="center">
                                <b>Fecha de Notificaci�n al CEI:</b>
                            </td>
							<td style="border: groove" colspan="1" align="center">
                    ...
                    <table style="border: groove; width: 900px; border-top: none">
                        ...
                        <tr>
                            <td style="border: groove" colspan="4">
                                <b>Nombre del Producto de Investigaci�n</b>
                            </td>
                            <td style="border: groove">
                                <b>No de Lote</b>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="border: groove" colspan="3">
                                <b>Fecha de Inicio de Administraci�n</b>
                            </td>
                            <td style="border: groove" colspan="2">
                                <b>Fecha de Terminaci�n de Administraci�n</b>
                            </td>
                        </tr>
                        <tr>
                            <td style="border: groove">
                        ...
                        <tr>
                            <td style="border: groove" colspan="3">
                                <b>Se Suspendi� el Producto de Investigaci�n</b>
                            </td>
                            <td style="border: groove" colspan="3">
						...
						<tr>
                            <td style="border: groove; width: 65%" colspan="3">
                                <b>Relacion Causal Evento y Producto de Investigaci�n</b>
                            </td>
						...
						<tr>
                            <td style="border: groove; width: 65%" colspan="3">
                                <b>Relacion Causal Evento y Proceso de Investigaci�n</b>
                            </td>
                            <td style="border: groove; width: 35%" colspan="3">
