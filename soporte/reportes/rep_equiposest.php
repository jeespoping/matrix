<html>
<head>
<title>MATRIX - [REPORTE ESTADISTICO DE OFF - LINE]</title>

<script type="text/javascript">
	function inicio()
	{ 
	 document.location.href='rep_equiposest.php'; 
	}
	
	function enter()
	{
		document.forms.rep_equiposest.submit();
	}
...
/*******************************************************************************************************************************************
*                                             REPORTE ESTADISTTICO DE OFF - LINE                                                           *
********************************************************************************************************************************************/

//==========================================================================================================================================
//PROGRAMA				      :Reporte para ver las estadisticas de las caidas en sistemas.                                                 |
//AUTOR				          :Ing. Gustavo Alberto Avendano Rivera.                                                                        |
//FECHA CREACION			  :ABRIL 14 DE 2011.                                                                                            |
//FECHA ULTIMA ACTUALIZACION  :14 de ABRIL de 2011.                                                                                         |
//TABLAS UTILIZADAS :                                                                                                                       |
//equipos_000001    : Tabla de equipos de off-line.                                                                                         |
//==========================================================================================================================================
include_once("root/comun.php");
$conex = obtenerConexionBD("matrix");

$wactualiz="1.0 14-Abril-2011";
...
session_start();
//Encabezado
encabezado("Estadisticas OFF - LINE",$wactualiz,"clinica");
...
{
  //Forma
 echo "<form name='rep_equiposest' action='' method=post>";
 ...
 if (!isset($fec1) or !isset($fec2))
 ...
 else // Cuando ya estan todos los datos escogidos
  {
   ...
   echo "<tr>";
   echo "<td align=center colspan='1' bgcolor=#FFFFFF><font size='3' text color=#003366><b>ESTADISTICAS OFF-LINE</b></font></td>";
   echo "</tr>";
   echo "<tr>";
   ...
   $query1 = " SELECT COUNT(*)"
            ."   FROM equipos_000002"
            ."  WHERE fecha_evento between '".$fec1."' and '".$fec2."'";
   ...
   $query2 = " SELECT conexion,DATEDIFF(fecha_final,fecha_evento) as dias,fecha_evento,hora_evento,fecha_final,hora_final,causa"
            ."   FROM equipos_000002"
            ."  WHERE fecha_evento between '".$fec1."' and '".$fec2."'"
            ."  ORDER BY 1,2,3,4";
   ...
   echo "<tr>";
   echo "<td bgcolor=#006699 align=center><font text color=#FFFFFF size=2><b>CONEXION</b></td>";
   echo "<td bgcolor=#006699 align=center><font text color=#FFFFFF size=2><b>FECHA_EVENTO</b></td>";
   echo "<td bgcolor=#006699 align=center><font text color=#FFFFFF size=2><b>HORA_INICIAL</b></td>";
   echo "<td bgcolor=#006699 align=center><font text color=#FFFFFF size=2><b>FECHA_FINAL</b></td>";
   echo "<td bgcolor=#006699 align=center><font text color=#FFFFFF size=2><b>HORA_FINAL</b></td>";
   echo "<td bgcolor=#006699 align=center><font text color=#FFFFFF size=2><b>TOTAL_DIAS</b></td>";
   echo "<td bgcolor=#006699 align=center><font text color=#FFFFFF size=2><b>TOTAL_TIEMPO</b></td>";
   echo "<td bgcolor=#006699 align=center><font text color=#FFFFFF size=2><b>CAUSA</b></td>";
   echo "</tr>";
   ...
   echo "<tr>";
   echo "<td align=LEFT><font size=1 color='#000000'><b>TOTAL DE EVENTOS:</b></font></td>";  
   echo "<td aling=left><font size=1>&nbsp;$totevento</font></td>";
   echo "</tr>";
   echo "</table>";
   ...
   echo "<tr>";
   echo "<td bgcolor=#006699 align=center><font text color=#FFFFFF size=2><b>CONEXION</b></td>";
   echo "<td bgcolor=#006699 align=center><font text color=#FFFFFF size=2><b>TOTAL X CONEXION</b></td>";
   echo "</tr>";
