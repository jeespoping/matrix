...
function consultarDatosCausas($mesActual,$a�oActual)
{
    ...
    while($datoCountCausaxMes = mysql_fetch_array($queryCountCausaxMes))
    {
        ...
        $queryTotalA = mysql_queryV("SELECT COUNT(id) FROM equipos_000006 WHERE Causareq = '$descCausa1' AND Fecini BETWEEN '$a�oInicial' AND '$a�oFinal'");
...
function consultarDatosA�o($a�oActual)
{
    ...
    $queryA�o = mysql_queryV("SELECT COUNT(id) from equipos_000006 WHERE Fecini BETWEEN '$fechaInicial' AND '$fechaFinal'");
