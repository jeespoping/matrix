    ...
    <div class="contenido">
        ...
        <div class="panel-body divselecciones" align="center" >
            <table align="center" class="tblselecciones">
                <tr>
                    <td colspan="7">
                        <h5 class="text-primary"><strong>Selecci�n de Etiqueta: </strong></h5>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <div class="input-group divEtiqueta2" id="etiqueta2">
                ...
                <div class="divContainerEtq2">
                    <table align="center" border="0">
                        ...
                        <tr>
                            <td><label for="etq2Codigo">CODIGO: </label></td>
                            <td colspan="7">
                                <input type="text" style="width: 350px" id="etq2Codigo" name="etq2Codigo">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><label for="etq2NReproceso"># EQUIPO: </label></td>
                            <td colspan="7">
                        ...
                        <tr>
                            <td colspan="8" class="lblLeyenda">
                                <label>MANTENGASE EN LUGAR FRESCO Y SECO - TEMPERATURA: 17�C - 25�C<br>
                                    NO USAR SI EL EMPAQUE SE ENCUENTRA DETERIORADO.
                                </label>
                            </td>
                        </tr>
            ...
            <div class="input-group divEtiqueta4" id="etiqueta4">
                ...
                <div class="divContainerEtq4">
                    <table align="center" border="0">
                        ...
                        <tr>
                            <td><label for="etq4Equipo">EQUIPO: </label></td>
                            <td><input type="text" id="etq4Equipo" name="etq4Equipo" required></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><label for="etq4NReproceso"># EQUIPO: </label></td>
                            <td colspan="5">
