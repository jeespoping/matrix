 ...
 * Modificaciones:
 *
 * 2020-03-20:	Se crea link que lleva al reporte detallado por articulo
 ******************************************************************************************************************************************/
...
else
{
	...
	else
	{
		...
		$link = "<a href='./icompinv_articulos.php?empresa=$empresa&wano=$wano&wmes=$wmes&wserv=$wserv&wfec=$wfec&wcons=$wcons'>Detalle por articulos</a>";
		...
		echo "<tr><td bgcolor=".$color." align=center><font face='tahoma'>".$link."</td></tr>";	
		echo "</tr></table><br><br>";
