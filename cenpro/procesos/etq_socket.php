...
<body BGCOLOR="">
	...
	<script type="text/javascript">
		...
		/**
		 * Acutalizacion:
		 * 03 de Junio de 2022      Sebastian Alvarez B.  Se filtra por sedes el listado de las impresoras, se crea validaci�n javascript para que los campos del formulario sean obligatorios y se cambio un poco el dise�o del formulario.
		 ...
		 * 
		 * Febrero 01 del 2022		Sebastian Alvarez B.  Se crea la funci�n obetenrLotePaciente() que nos trae el lote que esta asociado a una historia de un paciente.
		 * 												  Esto con el fin de que cuando se da�a un sticker de medicamentos en central de mezclas se opta por sacar
		 * 												  uno nuevo desde la opcion gestion central - impresion de codigo de barras. La modificaci�n que se realizo
		 * 												  fue que cuando se da�e un sticker y se saque por esta opcion debe de salir tambien con la informaci�n
		 * 												  del paciente unificado al del medicamento.
		 * 
		 * Noviembre 30 del 2021    Sebastian Alvarez B.  Se hace la unificaci�n del sticker del medicamento con la informaci�n del paciente, anteriormente
		 * 												  se hacian por separado, entonces para mas practicidad se opto por unificar las dos informaciones en uno solo. 
		 *
		 * Septiembre 14 de 2018	Jessica 	Se aumenta el tama�o de la letra del TIEMPO DE INFUSION y la nota de CONSERVAR EN NEVERA.
		 * Abril 18 de 2018			Jessica 	En la impresi�n de la etiqueta en zpl la posicion inicial de algunos elementos que estaban 
		 ...
		 * Febrero 20 de 2018		Jessica 	Se comenta la impresi�n de la etiqueta en html y se agrega la impresi�n de la etiqueta en zpl
		 * Febrero 15 de 2018		Jessica 	Se comenta la impresi�n de la etiqueta en epl ya que se agrega la etiqueta en html en el 
		 *										script stickerProductos.php porque se deben imprimir las firmas.
		 * Enero 24 de 2018			Jessica 	Modificacion en la impresi�n de la etiqueta, se quitan algunos espacios ya que algunos 
		 *										datos no quedaban legibles
		 * Enero 23 de 2018			Jessica 	Modificaciones en la impresi�n de la etiqueta, se cambian los textos:
		 * 										- POR: - PREPARADO POR QF: y REVISADO POR: - APROBO:
		 * Enero 22 de 2018			Jessica 	Modificaciones en la impresi�n de la etiqueta: 
		 *										- Se cambia el orden de algunos campos (Codigo del producto, lote y fecha de vencimiento,quien prepara y quien revisa)
		 *										- Se agregan nuevos datos (Hora de preparaci�n, tiempo de infusi�n y una nota fija para todos los productos)
		 * Septiembre 12 de 2017	Jessica 	Se registra la preparaci�n de las dosis adaptadas despues de imprimir los stickers.	
		 ...
		 *										y se disminuye el tama�o de la letra, estaba en 2 y queda en 1.
		 *										
		 */
...
function registrarPreparacion($historia,$ingreso,$ido,$wnom1,$wnom2,$codDA,$wlot,$wfpr,$ronda,$fechaPreparacion)
{
	...
	else
	{
		...
		if($resInsert)
		{
			$mensajeInsert = "Se env�o el producto: ".$wcod." al monitor de preparacion";
		}
		else
		{
 ...
 * 
 * @param $producto			C�digo del producto
	...
	$hpr = "";
	 ...
	 return $nombre;
		...
		*/
		 ...
		 * Descripcion : Creamos una funci�n en donde nos traeremos 
		 ...
		 * Date: 26-05-2022
		 * By: Sebastian Alvarez Barona
		 * Descripci�n: Se crea funci�n para preguntar si un articulo se conserva en nevera o es fotosensible
		 ...
		 * Date: 26-05-2022
		 * By: Sebastian Alvarez Barona
		 * Descripci�n: Se crea funci�n para preguntar si un articulo es fotosensible
...
//			echo "<input type='HIDDEN' name= 'wfev' value='".$wfev."'>";
		...
		else
		{
			...
			// echo "	<script>
					...
					// 				^FX Fecha y hora de preparaci�n
					// 				^CFP
					...
					/**26 de mayo de 2022
					 * Llamamos a las funci�nes que creamos y Se crea validaci�n para mostrar los mensajes de conservacion de cada producto
					...
					/**Noviembre 30 del 2021
					 * Llamado de los datos del paciente y construcci�n del sticker del paciente.s
					 */
					...
					if ($StickerPacienteDA == 'on' && $whistoria != "" && $wingreso != "") // Si el parametro esta en on entonces el sticker DA sale unificado con el del paciente.
					{
						...
						$Tidentificacion = $informacion_paciente['Oritid']; // Tipo de identificaci�n 
						$NroIdentificacion = $informacion_paciente['Oriced']; // Numero de identificaci�n
					...
					// $paquete=$paquete."D4".chr(13).chr(10);                                            //D4 : Define el formato de fecha a imprimirse, 4 : Indica que se muestra ela�o de 4 digitos
					...
					// $paquete=$paquete."TDy2.mn.dd".chr(13).chr(10);                                    //TD: Setea el formato de la fecha y2=A�o 2 digitos, mn:Mes dos digitos y dd:dia de dos digitos 
					// $paquete=$paquete."B145,10,0,1,2,5,70,N,V00".chr(13).chr(10); //Imprime en la columna=215, fila=20, Parametros del c�digo de Barras
					// $paquete=$paquete."A355,10,0,4,1,1,N,V00".chr(13).chr(10);   //Imprime en la columna=140, fila=110, tama�o=4, V00=Codigo
					// $paquete=$paquete."A355,35,0,3,1,1,N,V01".chr(13).chr(10);   //Imprime en la columna=140, fila=140, tama�o=3, V01=Lote
					// $paquete=$paquete."A355,60,0,2,1,1,N,V02".chr(13).chr(10);   //Imprime en la columna=140, fila=200, tama�o=3, V02=F.Vencimiento
					// $paquete=$paquete."A140,100,0,4,1,1,N,V03".chr(13).chr(10);   //Imprime en la columna=140, fila=230, tama�o=3, V03=Nombre1 (27 Caracteres)
					// $paquete=$paquete."A140,130,0,4,1,1,N,V04".chr(13).chr(10);   //Imprime en la columna=140, fila=260, tama�o=3, V04=Nombre2 (27 Caracteres)
					// $paquete=$paquete."A140,160,0,1,1,1,N,V05".chr(13).chr(10);   //Imprime en la columna=140, fila=170, tama�o=3, V05=Fecha de Preparacion o de Reempaque
					// $paquete=$paquete."A355,160,0,1,1,1,N,V06".chr(13).chr(10);   //Imprime en la columna=140, fila=170, tama�o=3, V05=Fecha de Preparacion o de Reempaque
					// $paquete=$paquete."A140,190,0,1,1,1,N,V07".chr(13).chr(10);   //Imprime en la columna=140, fila=210, tama�o=3, V06=POR
					// $paquete=$paquete."A140,210,0,1,1,1,N,V08".chr(13).chr(10);   //Imprime en la columna=140, fila=250, tama�o=1, V08=REVISADO POR.	Diciembre 10 de 2012
					// $paquete=$paquete."A140,240,0,1,1,1,N,V09".chr(13).chr(10);   //Imprime en la columna=140, fila=270, tama�o=1, V09=Quien elabora el lote.	Diciembre 10 de 2012
					// $paquete=$paquete."A140,260,0,1,1,1,N,V10".chr(13).chr(10);   //Imprime en la columna=140, fila=270, tama�o=1, V09=Quien elabora el lote.	Diciembre 10 de 2012
					// $paquete=$paquete."FE".chr(13).chr(10);
					// $paquete=$paquete.".".chr(13).chr(10);
					// $paquete=$paquete."FR".chr(34)."CENPRO".chr(34).chr(13).chr(10);
					// $paquete=$paquete."?".chr(13).chr(10);
					// $paquete=$paquete.$wcod.chr(13).chr(10);                      //Imprime el c�digo normal
