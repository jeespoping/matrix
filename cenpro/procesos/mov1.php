...
else
{
	...
	if(!isset($wfeci) or !isset($wfecf) or !isset($wins))
	{
		...
		echo "<tr><td class='texto4'>Insumo</td>";
	...
	else
	{
		...
		$query = "SELECT   Mencon, Menfec, Mendoc, Mdecan, Conind, Connom, Mencco, Menccd, Mdenlo from ".$empresa."_000006, ".$empresa."_000007 , ".$empresa."_000008 ";
		...
		echo "<tr>";
		echo "<td bgcolor=#cccccc align=right COLSPAN=6><font face='tahoma' size=2><b>TOTALES</b></font></td>";
