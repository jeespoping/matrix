...
2017-09-12	Se agrega encabezado Matrix
...
function consultarLoteVencido( $lote, $producto ){
	...
	$res = mysql_query( $sql, $conex ) or die( "Error - Consulta 17" );
...
function pintarInsumos($insumos, $inslis, $unidades, $lotes, $pintar, $cantidad)
{
	...
	$pre_tmp = '';
	if (is_array($insumos))
	{ $pre_tmp = $insumos[0]['pre']; }

	echo "<tr><td class='texto1' colspan='4' align='center'>Cantidad: <input type='TEXT' name='cantidad' value='".$cantidad."'  class='texto5' onchange='validarFormulario()'><input type='TEXT' name='nompro' value='".$pre_tmp."'  class='texto5' >";
	echo "</td>";
