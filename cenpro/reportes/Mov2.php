...
else
{
    ...
    else
    {
        ...
        echo "<td align=center bgcolor=#999999 ><font face='tahoma' size=2><b>HISTORIA CLINICA-INGRESO</b></font></td>";
         echo "<td align=center bgcolor=#999999 ><font face='tahoma' size=2><b>HABITACION</b></font></td>";
        ...
        $query .= "     and   Concar='on'";
        $query .= "    Order by Menfec, A.Hora_data ";
        ...
        for ($i = 0;$i < $num;$i++)
        {
            ...
            echo "<tr>";
            echo "<td bgcolor=#cccccc align=left><font face='tahoma' size=2><b>" . $row[1] . "</b></font></td>";
            echo "<td bgcolor=#cccccc align=left><font face='tahoma' size=2><b>" . $row[9] . "</b></font></td>";

            $exp = explode('-', $row[10]);

            $q = "SELECT  Descripcion from usuarios ";
            $q .= " where  codigo='" . $exp[1] . "' ";
            $q .= "     and   Activo='A' ";

            $err2 = mysql_query($q, $conex) or die (mysql_errno() . ":" . mysql_error());
            $row2 = mysql_fetch_array($err2);

            echo "<td bgcolor=#cccccc align='left'><font face='tahoma' size=2><b>" . $exp[1] . "-" . $row2[0] . "</b></font></td>";

            echo "<td bgcolor=#cccccc align='left'><font face='tahoma' size=2><b>" . $row[0] . "-" . $row[5] . "</b></font></td>";
            echo "<td bgcolor=#cccccc align='left'><font face='tahoma' size=2><b>" . $row[2] . "</b></font></td>";
            $exp = explode('-', $row[8]);
            echo "<td bgcolor=#cccccc align='left'><font face='tahoma' size=2><b>" . $exp[0] . "</b></font></td>";
            ...
            if ($row[4] == '-1')
            {
                ...
                echo "<td bgcolor=#cccccc align='left'><font face='tahoma' size=2><b>" . $row2 [0] . "</b></font></td>";
